...
local tests = {
    ...
    {file = "tests/unit/items/shop-database.test.lua", name = "Shop Database Unit Tests"},
    {file = "tests/unit/items/shop-manager.test.lua", name = "Shop Manager Unit Tests"},
    {file = "tests/unit/items/economic-system.test.lua", name = "Economic System Unit Tests"},
    {file = "tests/unit/handlers/shop-handler.test.lua", name = "Shop Handler Unit Tests"},
