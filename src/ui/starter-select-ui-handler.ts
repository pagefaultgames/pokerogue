...
export default class StarterSelectUiHandler extends MessageUiHandler {
  ...
  setup() {
    ...
    typeKeys.forEach((type, index) => {
      ...
      const typeSprite = this.scene.add.sprite(0, 0, Utils.getLocalizedSpriteKey("type"));
    ...
    this.type1Icon = this.scene.add.sprite(8, 98, Utils.getLocalizedSpriteKey("type"));
    this.type1Icon.setScale(0.5);
    this.type1Icon.setOrigin(0, 0);
    this.starterSelectContainer.add(this.type1Icon);

    this.type2Icon = this.scene.add.sprite(26, 98, Utils.getLocalizedSpriteKey("type"));
