...
const starterCandyCosts: { passive: integer, costReduction: [integer, integer], egg: integer }[] = [
  { passive: 50, costReduction: [30, 75], egg: 30 }, // 1 Cost
  { passive: 45, costReduction: [25, 60], egg: 30 }, // 2 Cost
  { passive: 40, costReduction: [20, 50], egg: 25 }, // 3 Cost
  { passive: 30, costReduction: [15, 40], egg: 20 }, // 4 Cost
  { passive: 25, costReduction: [12, 35], egg: 15 }, // 5 Cost
  { passive: 20, costReduction: [10, 30], egg: 12 }, // 6 Cost
  { passive: 15, costReduction: [8, 20], egg: 10 },  // 7 Cost
  { passive: 10, costReduction: [5, 15], egg: 8 },  // 8 Cost
  { passive: 10, costReduction: [3, 10], egg: 5 },  // 9 Cost
  { passive: 10, costReduction: [3, 10], egg: 5 },  // 10 Cost
];
