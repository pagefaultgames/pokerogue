...
export default class StarterSelectUiHandler extends MessageUiHandler {
  ...
  setFilterMode(filterMode: boolean): boolean {
    ...
    this.cursorObj.setVisible(!filterMode && !this.starterIconsCursorObj.visible);
    this.filterBar.cursorObj.setVisible(filterMode && !this.starterIconsCursorObj.visible);
