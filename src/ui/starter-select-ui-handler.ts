        ...
        if (!this.speciesStarterDexEntry?.caughtAttr) {
          ...
          const showUseCandies = () => {
            ...
            if (valueReduction < valueReductionMax) {
              const reductionCost = getValueReductionCandyCounts(speciesStarters[this.lastSpecies.speciesId])[
                valueReduction
              ];
              options.push({
            ...
            options.push({
              ...
              handler: () => {
                if (
                  this.scene.gameData.eggs.length < 99 &&
  ...
  tryStart(manualTrigger: boolean = false): boolean {
    ...
    if (canStart) {
      ...
      this.scene.ui.showText(
        ...
        null,
        () => this.scene.ui.showText("", 0, () => (handler.tutorialActive = false)),
        null,
        true,
      );
    }
