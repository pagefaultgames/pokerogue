...
export default class StarterSelectUiHandler extends MessageUiHandler {
  ...
  setup() {
    ...
    const genOptions: DropDownOption[] = [
      new DropDownOption(this.scene, 1, i18next.t("starterSelectUiHandler:gen1"), undefined, DropDownState.ON),
      new DropDownOption(this.scene, 2, i18next.t("starterSelectUiHandler:gen2"), undefined, DropDownState.ON),
      new DropDownOption(this.scene, 3, i18next.t("starterSelectUiHandler:gen3"), undefined, DropDownState.ON),
      new DropDownOption(this.scene, 4, i18next.t("starterSelectUiHandler:gen4"), undefined, DropDownState.ON),
      new DropDownOption(this.scene, 5, i18next.t("starterSelectUiHandler:gen5"), undefined, DropDownState.ON),
      new DropDownOption(this.scene, 6, i18next.t("starterSelectUiHandler:gen6"), undefined, DropDownState.ON),
      new DropDownOption(this.scene, 7, i18next.t("starterSelectUiHandler:gen7"), undefined, DropDownState.ON),
      new DropDownOption(this.scene, 8, i18next.t("starterSelectUiHandler:gen8"), undefined, DropDownState.ON),
      new DropDownOption(this.scene, 9, i18next.t("starterSelectUiHandler:gen9"), undefined, DropDownState.ON),
    ];
    ...
    typeKeys.forEach((type, index) => {
      ...
      typeOptions.push(new DropDownOption(this.scene, index, "", typeSprite));
    });
    ...
    const shinyOptions = [
      new DropDownOption(this.scene, "SHINY3", "", shiny3Sprite),
      new DropDownOption(this.scene, "SHINY2", "", shiny2Sprite),
      new DropDownOption(this.scene, "SHINY", "", shiny1Sprite),
    ...
    const unlocksOptions = [
      new DropDownOption(this.scene, "PASSIVE", ["Passive", i18next.t("filterBar:passiveUnlocked"), i18next.t("filterBar:passiveLocked")], undefined, DropDownState.OFF),
    ];
    ...
    // misc filter
    const miscOptions = [
      new DropDownOption(this.scene, "WIN", ["Win", "Win - Yes", "Win - No"], undefined, DropDownState.OFF),
    ];
    ...
    const sortOptions = [
      ...
      new DropDownOption(this.scene, 1, i18next.t("filterBar:sortByCost"), undefined, DropDownState.OFF),
      new DropDownOption(this.scene, 2, i18next.t("filterBar:sortByCandies"), undefined, DropDownState.OFF),
      new DropDownOption(this.scene, 3, i18next.t("filterBar:sortByIVs"), undefined, DropDownState.OFF),
      new DropDownOption(this.scene, 4, i18next.t("filterBar:sortByName"), undefined, DropDownState.OFF)];
    ...
    this.startCursorObj = this.scene.add.nineslice(289, 160, "select_cursor", undefined, 26, 15, 6, 6, 6, 6);
