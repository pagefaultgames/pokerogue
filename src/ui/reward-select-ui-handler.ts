...
export class RewardSelectUiHandler extends AwaitableUiHandler {
  ...
  setup() {
    ...
    if (context) {
      ...
      // TODO @Wlowscha: Rename these locales
      this.transferButtonWidth = context.measureText(i18next.t("rewardSelectUiHandler:manageItems")).width;
...
class ModifierOption extends Phaser.GameObjects.Container {
  ...
  // TODO @SirzBenjie: Review to make sure I didn't bork the method
