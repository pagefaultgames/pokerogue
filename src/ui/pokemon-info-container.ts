...
export default class PokemonInfoContainer extends Phaser.GameObjects.Container {
  ...
  setup(): void {
    ...
    this.pokemonNatureLabelText = addTextObject(this.scene, infoContainerLabelXPos, 39, i18next.t("pokemonInfoContainer:nature"), TextStyle.WINDOW, { fontSize: infoContainerTextSize }, { width: 29 });
