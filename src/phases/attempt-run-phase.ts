...
export class AttemptRunPhase extends PokemonPhase {
  ...
  start() {
    ...
    const speedRatio = playerPokemon.getStat(Stat.SPD) / enemySpeed; // this gets the speed ration between you and the average enemy speed
    ...
    const escapeChance = new Utils.IntegerHolder(Phaser.Math.Clamp((escapeSlope * speedRatio) + minChance + (escapeBonus * this.scene.currentBattle.escapeAttempts++), minChance, maxChance));
