...
export class CommandPhase extends FieldPhase {
   ...
   */
  private comptueMoveId(playerPokemon: PlayerPokemon, cursor: number, move?: TurnMove): Moves {
  ...
  private handleFightCommand(
    ...
    const moveId = useStruggle ? Moves.STRUGGLE : this.comptueMoveId(playerPokemon, cursor, move);
