    ...
    this.scene.ui.setMode(Mode.STARTER_SELECT, (starters: Starter[]) => {
      ...
      this.scene.ui.setMode(Mode.SAVE_SLOT, SaveSlotUiMode.SAVE, (slotId: integer) => {
        ...
        starters.forEach((starter: Starter, i: integer) => {
          ...
          console.log("Starter", starter.species.speciesId, starterProps.formIndex, starterFormIndex, starterGender);
          const starterIvs = this.scene.gameData.dexData[starter.species.speciesId].ivs.slice(0);
          console.log("Starter IVs", starterIvs);
          console.log("starterPokemon args", starter.species, this.scene.gameMode.getStartingLevel(), starter.abilityIndex, starterFormIndex, starterGender, starterProps.shiny, starterProps.variant, starterIvs, starter.nature);
