...
import { BattlerTagLapseType, CenterOfAttentionTag, DamagingTrapTag, EncoreTag, HideSpriteTag as HiddenTag, ProtectedTag, SemiInvulnerableTag, TrappedTag } from "./data/battler-tags";
