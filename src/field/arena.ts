...
export class Arena {
  ...
  applyTagsForSide(tagType: ArenaTagType | OfType<ArenaTag>, side: ArenaTagSide, ...args: unknown[]): void {
  ...
  applyTags(tagType: ArenaTagType | OfType<ArenaTag>, ...args: unknown[]): void {
  ...
  getTag(tagType: ArenaTagType | OfType<ArenaTag>): ArenaTag {
    return this.getTagOnSide(tagType, ArenaTagSide.BOTH);
  }

  getTagOnSide(tagType: ArenaTagType | OfType<ArenaTag>, side: ArenaTagSide): ArenaTag {
