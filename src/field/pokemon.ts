...
export default abstract class Pokemon extends Phaser.GameObjects.Container {
  ...
  canSetStatus(effect: StatusEffect, quiet: boolean = false, overrideStatus: boolean = false, sourcePokemon: Pokemon = null): boolean {
    ...
    const party = this instanceof PlayerPokemon ? this.scene.getPlayerField() : this.scene.getEnemyField();
    party.forEach((pokemon: Pokemon) => applyPreSetStatusAbAttrs(UserFieldStatusEffectImmunityAbAttr, pokemon, effect, cancelled, quiet));
