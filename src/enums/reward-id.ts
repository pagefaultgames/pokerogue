export const RewardId = {
  ...
  MINT: 0x0B01,
  TERA_SHARD: 0x0B02,
  MEMORY_MUSHROOM: 0x0B03,
  DNA_SPLICERS: 0x0B04,

  // Specific groups of items
  HELD_ITEM: 0x0C01,
  SPECIES_STAT_BOOSTER: 0x0C02,
  RARE_SPECIES_STAT_BOOSTER: 0x0C03,
  BASE_STAT_BOOSTER: 0x0C04,
  ATTACK_TYPE_BOOSTER: 0x0C05,
  BERRY: 0x0C06,

  TRAINER_ITEM: 0x0D01,
  TEMP_STAT_STAGE_BOOSTER: 0x0D02,
  LURE: 0x0D03,
  SUPER_LURE: 0x0D04,
  MAX_LURE: 0x0D05,
  
  FORM_CHANGE_ITEM: 0x0E01,
  RARE_FORM_CHANGE_ITEM: 0x0E02,
} as const;
