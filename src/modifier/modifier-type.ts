...
const modifierPool: ModifierPool = {
  [ModifierTier.COMMON]: [
    new WeightedModifierType(modifierTypes.POKEBALL, (party: Pokemon[]) => party[0].scene.pokeballCounts[PokeballType.POKEBALL] >= 99 ? 0 : 6, 6),
  ...
  [ModifierTier.GREAT]: [
    new WeightedModifierType(modifierTypes.GREAT_BALL, (party: Pokemon[]) => party[0].scene.pokeballCounts[PokeballType.GREAT_BALL] >= 99 ? 0 : 6, 6),
  ...
  [ModifierTier.ULTRA]: [
    new WeightedModifierType(modifierTypes.ULTRA_BALL, (party: Pokemon[]) => party[0].scene.pokeballCounts[PokeballType.ULTRA_BALL] >= 99 ? 0 : 24, 24),
  ...
  [ModifierTier.ROGUE]: [
    new WeightedModifierType(modifierTypes.ROGUE_BALL, (party: Pokemon[]) => party[0].scene.pokeballCounts[PokeballType.ROGUE_BALL] >= 99 ? 0 : 24, 24),
  ...
  [ModifierTier.MASTER]: [
    new WeightedModifierType(modifierTypes.MASTER_BALL, (party: Pokemon[]) => party[0].scene.pokeballCounts[PokeballType.MASTER_BALL] >= 99 ? 0 : 24, 24),
