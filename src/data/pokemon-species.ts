...
export abstract class PokemonSpeciesForm {
  ...
  getLevelMoves(): LevelMoves {
    if (pokemonSpeciesFormLevelMoves.hasOwnProperty(this.speciesId) && pokemonSpeciesFormLevelMoves[this.speciesId].hasOwnProperty(this.formIndex)) {
      console.log(`Level moves found for ${this.speciesId} form ${this.formIndex}`);
      return pokemonSpeciesFormLevelMoves[this.speciesId][this.formIndex].slice(0);
    }
    console.warn(`No level moves found for ${this.speciesId} form ${this.formIndex}`);
  ...
  isObtainable(): boolean {
    return (this.generation <= 13 || pokemonPrevolutions.hasOwnProperty(this.speciesId));
  }
...
export function initSpecies() {
  allSpecies.push(
    ...
    new PokemonSpecies(Species.GRASSHOLE, 10, false, false, false, "Anal Plant Pokemon", Type.GRASS, null, 0.7, 6.9, Abilities.OVERGROW, Abilities.NONE, Abilities.CHEEK_POUCH, 318, 56, 60, 55, 47, 50, 50, 45, 70, 62, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.ANALGAE, 10, false, false, false, "Anal Grass Pokemon", Type.GRASS, Type.GROUND, 1.0, 28.0, Abilities.OVERGROW, Abilities.NONE, Abilities.CHEEK_POUCH, 405, 70, 80, 80, 55, 60, 60, 45, 70, 142, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.RECTREEM, 10, false, false, false, "Anal Tree Pokemon", Type.GRASS, Type.GROUND, 2.0, 100.0, Abilities.OVERGROW, Abilities.NONE, Abilities.CHEEK_POUCH, 525, 90, 120, 95, 70, 70, 80, 45, 70, 208, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.ARABOMB, 10, false, false, false, "Bomb Pokemon", Type.FIRE, null, 0.6, 8.5, Abilities.BLAZE, Abilities.NONE, Abilities.JIHAD, 318, 47, 49, 50, 65, 45, 62, 45, 70, 62, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.IGUALLAH, 10, false, false, false, "Explosive Pokemon", Type.FIRE, Type.DARK, 1.1, 19.0, Abilities.BLAZE, Abilities.NONE, Abilities.JIHAD, 405, 65, 75, 55, 85, 50, 75, 45, 70, 142, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.LIZAKBAR, 10, false, false, false, "Terrorist Pokemon", Type.FIRE, Type.DARK, 1.7, 90.5, Abilities.BLAZE, Abilities.NONE, Abilities.JIHAD, 525, 85, 90, 65, 120, 65, 100, 411, 70, 208, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.EJACASM, 10, false, false, false, "Sheath Pokemon", Type.WATER, null, 0.5, 9.0, Abilities.TORRENT, Abilities.NONE, Abilities.WATER_VEIL, 318, 60, 50, 50, 50, 63, 45, 45, 70, 62, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.HOSAJACK, 10, false, false, false, "Rubber Pokemon", Type.WATER, Type.POISON, 1.0, 22.5, Abilities.TORRENT, Abilities.NONE, Abilities.WATER_VEIL, 405, 85, 55, 60, 64, 77, 64, 45, 70, 142, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.CONDOOM, 10, false, false, false, "Contracept Pokemon", Type.WATER, Type.POISON, 1.6, 85.5, Abilities.TORRENT, Abilities.NONE, Abilities.SKILL_LINK, 525, 120, 60, 85, 85, 100, 75, 45, 70, 208, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.SQUIRRAP, 10, false, false, false, "Rap Pokemon", Type.NORMAL, null, 0.3, 3.5, Abilities.SOUNDPROOF, Abilities.MOXIE, Abilities.BOOMBOX, 277, 40, 53, 39, 43, 44, 58, 255, 70, 50, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.GAMPSTER, 10, false, false, false, "Gangsta Pokemon", Type.NORMAL, null, 1.0, 25.2, Abilities.SOUNDPROOF, Abilities.MOXIE, Abilities.BOOMBOX, 445, 89, 85, 51, 79, 54, 87, 127, 70, 137, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.KENGEON, 10, false, false, false, "Fried Chick Pokemon", Type.NORMAL, Type.FLYING, 0.3, 1.8, Abilities.EARLY_BIRD, Abilities.SHED_SKIN, Abilities.AROMA_VEIL, 274, 37, 53, 45, 36, 48, 55, 255, 70, 55, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.FRIEDEN, 10, false, false, false, "Fried Bird Pokemon", Type.NORMAL, Type.FLYING, 0.9, 3.2, Abilities.GALE_WINGS, Abilities.ROUGH_SKIN, Abilities.AROMA_VEIL, 367, 58, 65, 59, 55, 65, 65, 120, 70, 113, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.COROOSTER, 10, false, false, false, "Colonel Pokemon", Type.NORMAL, Type.FLYING, 1.5, 39.5, Abilities.GALE_WINGS, Abilities.ROUGH_SKIN, Abilities.AROMA_VEIL, 472, 77, 87, 77, 67, 77, 87, 45, 70, 172, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.CURICRAWL, 10, false, false, false, "Social Bug Pokemon", Type.BUG, null, 0.2, 2.3, Abilities.SHIELD_DUST, Abilities.PRANKSTER, Abilities.GUTS, 190, 60, 35, 45, 10, 20, 20, 255, 70, 40, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.GUTSICOON, 10, false, false, false, "Cocoon Pokemon", Type.BUG, null, 0.5, 5.8, Abilities.SHIELD_DUST, Abilities.PRANKSTER, Abilities.GUTS, 255, 70, 40, 70, 25, 30, 20, 120, 70, 75, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.GUTSIFLY, 10, false, false, false, "Butterfly Pokemon", Type.BUG, Type.FLYING, 0.8, 9.7, Abilities.SHIELD_DUST, Abilities.PRANKSTER, Abilities.GUTS, 445, 105, 100, 110, 42, 45, 43, 45, 70, 160, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.LARVADES, 10, false, false, false, "Probe Pokemon", Type.BUG, null, 0.3, 2.9, Abilities.COMPOUND_EYES, Abilities.SHIELD_DUST, Abilities.POISON_POINT, 260, 35, 30, 35, 55, 50, 55, 255, 70, 35, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.PROBOSKITO, 10, false, false, false, "Mosquito Pokemon", Type.BUG, Type.ELECTRIC, 1.0, 30.0, Abilities.COMPOUND_EYES, Abilities.STATIC, Abilities.POISON_POINT, 445, 55, 85, 40, 85, 55, 125, 90, 70, 115, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.CLOVOUR, 10, false, false, false, "Clover Pokemon", Type.GRASS, null, 0.7, 18.5, Abilities.NATURAL_CURE, Abilities.SAP_SIPPER, Abilities.SUPER_LUCK, 315, 60, 60, 52, 20, 52, 71, 190, 0, 58, GrowthRate.MEDIUM_FAST, 25.0, false),
    new PokemonSpecies(Species.CHANOLOUR, 10, false, false, false, "Luck Pokemon", Type.GRASS, Type.STEEL, 1.2, 22.5, Abilities.NATURAL_CURE, Abilities.SAP_SIPPER, Abilities.SUPER_LUCK, 530, 90, 120, 85, 40, 85, 110, 75, 70, 164, GrowthRate.MEDIUM_FAST, 25.0, false),
    new PokemonSpecies(Species.NAUSEON, 10, false, false, false, "Sick Pokemon", Type.POISON, null, 0.3, 0.6, Abilities.POISON_POINT, Abilities.HEALER, Abilities.POISON_TOUCH, 330, 55, 55, 55, 55, 55, 55, 190, 70, 55, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.HAZMATE, 10, false, false, false, "Hazmat Pokemon", Type.POISON, Type.FIGHTING, 0.7, 33.4, Abilities.OVERCOAT, Abilities.FILTER, Abilities.POISON_TOUCH, 500, 95, 120, 90, 55, 70, 70, 75, 70, 180, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.EBOLABLE, 10, false, false, false, "Ebola Pokemon", Type.POISON, Type.DARK, 1.0, 14.5, Abilities.LIQUID_OOZE, Abilities.HEALER, Abilities.INFILTRATOR, 500, 70, 55, 70, 120, 90, 95, 75, 70, 180, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.PIKOTTON, 10, false, false, false, "CottonMouse Pokemon", Type.ELECTRIC, Type.FAIRY, 0.4, 3.5, Abilities.STATIC, Abilities.SWEET_VEIL, Abilities.LIGHTNING_ROD, 420, 55, 40, 85, 90, 75, 75, 200, 70, 105, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.BIRDHOUSE, 10, false, false, false, "Birdcage Pokemon", Type.NORMAL, Type.FLYING, 1.4, 29.5, Abilities.STURDY, Abilities.WONDER_GUARD, Abilities.RATTLED, 477, 70, 77, 105, 50, 105, 70, 60, 70, 110, GrowthRate.MEDIUM_SLOW, null, false),
    new PokemonSpecies(Species.LANSHIL, 10, false, false, false, "Drill Pokemon", Type.ROCK, null, 0.4, 20.0, Abilities.ROCK_HEAD, Abilities.STURDY, Abilities.SAND_FORCE, 325, 48, 50, 75, 40, 62, 50, 255, 70, 60, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.MIDDRIL, 10, false, false, false, "Drill Pokemon", Type.ROCK, null, 1.0, 44.2, Abilities.ROCK_HEAD, Abilities.STURDY, Abilities.SAND_FORCE, 407, 65, 75, 87, 45, 75, 60, 120, 70, 140, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.SHURISMASH, 10, false, false, false, "Great Drill Pokemon", Type.ROCK, Type.STEEL, 1.4, 64.5, Abilities.ROCK_HEAD, Abilities.STURDY, Abilities.SAND_FORCE, 515, 85, 100, 110, 48, 95, 77, 45, 70, 172, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.MAYMAY, 10, false, false, false, "Meme Pokemon", Type.NORMAL, null, 0.6, 11.0, Abilities.HUSTLE, Abilities.NORMALIZE, Abilities.SHEER_FORCE, 279, 50, 48, 52, 37, 40, 52, 190, 70, 63, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.MEMENACE, 10, false, false, false, "Abomination Pokemon", Type.NORMAL, null, 1.1, 32.6, Abilities.HUSTLE, Abilities.NORMALIZE, Abilities.SHEER_FORCE, 502, 106, 83, 87, 72, 85, 69, 45, 70, 149, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.VANDASH, 10, false, false, false, "Thief Pokemon", Type.DARK, Type.GRASS, 1.7, 55.6, Abilities.GUTS, Abilities.QUICK_FEET, Abilities.PICKPOCKET, 458, 55, 95, 55, 72, 55, 126, 90, 70, 161, GrowthRate.ERRATIC, 50.0, false),
    new PokemonSpecies(Species.PIGUSON, 10, false, false, false, "Vigilante Pokemon", Type.FIGHTING, Type.NORMAL, 1.3, 110.4, Abilities.GUTS, Abilities.SCRAPPY, Abilities.FRISK, 458, 105, 108, 105, 38, 80, 22, 90, 70, 161, GrowthRate.FLUCTUATING, 100.0, false),
    new PokemonSpecies(Species.ARMANDO, 10, false, false, false, "Arm Pokemon", Type.FIGHTING, null, 0.8, 19.5, Abilities.INNER_FOCUS, Abilities.IRON_FIST, Abilities.PROTEAN, 291, 45, 80, 43, 20, 33, 70, 180, 70, 61, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.MUSCLEDUDE, 10, false, false, false, "Arms Pokemon", Type.FIGHTING, null, 0.8, 41.8, Abilities.INNER_FOCUS, Abilities.IRON_FIST, Abilities.PROTEAN, 396, 60, 110, 55, 36, 55, 80, 90, 70, 132, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.TRIPECS, 10, false, false, false, "Strength Pokemon", Type.FIGHTING, null, 1.7, 95.0, Abilities.INNER_FOCUS, Abilities.IRON_FIST, Abilities.PROTEAN, 483, 80, 130, 70, 43, 70, 90, 45, 70, 183, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.SEMDROP, 10, false, false, false, "Drop Pokemon", Type.NORMAL, null, 0.9, 30.0, Abilities.INSOMNIA, Abilities.IMMUNITY, Abilities.DRY_SKIN, 345, 80, 35, 65, 50, 75, 40, 190, 70, 71, GrowthRate.MEDIUM_FAST, 87.5, false),
    new PokemonSpecies(Species.SEMRUST, 10, false, false, false, "Rust Pokemon", Type.NORMAL, Type.GROUND, 0.9, 40.5, Abilities.INSOMNIA, Abilities.IMMUNITY, Abilities.DRY_SKIN, 465, 110, 65, 75, 70, 95, 50, 60, 70, 131, GrowthRate.MEDIUM_FAST, 87.5, false),
    new PokemonSpecies(Species.FURNAZI, 10, false, false, false, "Furnace Pokemon", Type.FIRE, Type.ROCK, 0.9, 51.2, Abilities.FLAME_BODY, Abilities.SOLID_ROCK, Abilities.WHITE_SMOKE, 350, 35, 40, 100, 80, 75, 20, 190, 70, 100, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.FINASOVEN, 10, false, false, false, "Furnace Pokemon", Type.FIRE, Type.ROCK, 1.7, 148.8, Abilities.FLAME_BODY, Abilities.SOLID_ROCK, Abilities.WHITE_SMOKE, 545, 75, 75, 130, 125, 105, 35, 75, 70, 200, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.TROUBAIT, 10, false, false, false, "Bait Pokemon", Type.WATER, null, 0.4, 7.0, Abilities.WATER_VEIL, Abilities.HUSTLE, Abilities.PRANKSTER, 290, 45, 50, 50, 40, 60, 45, 255, 70, 57, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.TULURE, 10, false, false, false, "Lure Pokemon", Type.WATER, null, 1.2, 24.0, Abilities.WATER_VEIL, Abilities.HUSTLE, Abilities.PRANKSTER, 395, 65, 70, 70, 58, 62, 70, 120, 70, 99, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.MONSTRAP, 10, false, false, false, "Trap Pokemon", Type.WATER, Type.DARK, 2.3, 93.7, Abilities.INTIMIDATE, Abilities.DEFIANT, Abilities.OBLIVIOUS, 527, 115, 105, 85, 69, 83, 70, 45, 70, 192, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.PIXILA, 10, false, false, false, "Pixie Fox Pokemon", Type.BUG, Type.FAIRY, 0.6, 13.6, Abilities.NATURAL_CURE, Abilities.CUTE_CHARM, Abilities.SAP_SIPPER, 325, 55, 55, 50, 45, 65, 55, 190, 0, 61, GrowthRate.MEDIUM_FAST, 25.0, false),
    new PokemonSpecies(Species.FAIRILEON, 10, false, false, false, "Moth Hound Pokemon", Type.BUG, Type.FAIRY, 0.9, 22.6, Abilities.NATURAL_CURE, Abilities.SHIELD_DUST, Abilities.SAP_SIPPER, 525, 110, 65, 65, 95, 130, 60, 45, 70, 175, GrowthRate.MEDIUM_FAST, 25.0, false),
    new PokemonSpecies(Species.WEDGARD, 10, false, false, false, "Wedge Pokemon", Type.GROUND, null, 0.7, 20.5, Abilities.ARENA_TRAP, Abilities.SAND_VEIL, Abilities.ROUGH_SKIN, 325, 50, 80, 60, 10, 50, 75, 190, 70, 60, GrowthRate.FAST, 50.0, false),
    new PokemonSpecies(Species.KNOKEDGE, 10, false, false, false, "Duo Wedge Pokemon", Type.GROUND, null, 1.4, 56.0, Abilities.ARENA_TRAP, Abilities.SAND_VEIL, Abilities.ROUGH_SKIN, 485, 110, 112, 95, 20, 50, 98, 60, 70, 146, GrowthRate.FAST, 50.0, false),
    new PokemonSpecies(Species.RIBBIZAP, 10, false, false, false, "Plug Frog Pokemon", Type.ELECTRIC, null, 0.3, 20.0, Abilities.LIGHTNING_ROD, Abilities.DRY_SKIN, Abilities.MOTOR_DRIVE, 460, 66, 50, 57, 112, 73, 102, 190, 70, 123, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.ELEPHAS, 10, false, false, false, "Indian Pokemon", Type.NORMAL, Type.PSYCHIC, 1.1, 120.0, Abilities.TELEPATHY, Abilities.SHED_SKIN, Abilities.LEVITATE, 500, 85, 45, 105, 90, 115, 60, 100, 70, 135, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.SEAMAPAN, 10, false, false, false, "Obsession Pokemon", Type.WATER, Type.NORMAL, 0.6, 9.0, Abilities.THICK_FAT, Abilities.HUGE_POWER, Abilities.CUTE_CHARM, 399, 51, 31, 70, 60, 81, 106, 200, 70, 116, GrowthRate.FAST, 12.5, false),
    new PokemonSpecies(Species.CAROLINE, 10, false, false, false, "Christian Pokemon", Type.GROUND, Type.FLYING, 1.7, 55.0, Abilities.SUPER_LUCK, Abilities.AERILATE, Abilities.JUSTIFIED, 475, 65, 80, 65, 95, 70, 100, 100, 140, 100, GrowthRate.MEDIUM_SLOW, 100.0, false),
    new PokemonSpecies(Species.CHOMPEST, 10, false, false, false, "Chest Pokemon", Type.ROCK, Type.DARK, 1.0, 100.0, Abilities.INTIMIDATE, Abilities.JEWELRY, Abilities.PICKUP, 425, 80, 100, 85, 50, 70, 40, 100, 70, 77, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.MASDAWG, 10, false, false, false, "Dog Pokemon", Type.NORMAL, null, 0.6, 31.8, Abilities.BALL_FETCH, Abilities.CUTE_CHARM, Abilities.SAND_VEIL, 437, 80, 60, 65, 55, 65, 112, 190, 150, 58, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.PASDAWG, 10, false, false, false, "Bulldog Pokemon", Type.NORMAL, Type.STEEL, 1.4, 63.6, Abilities.BALL_FETCH, Abilities.INTIMIDATE, Abilities.SAND_FORCE, 507, 112, 90, 105, 55, 85, 60, 80, 150, 158, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.SPANKE, 10, false, false, false, "Slap Pokemon", Type.GRASS, Type.FIGHTING, 1.7, 6.8, Abilities.SHED_SKIN, Abilities.OBLIVIOUS, Abilities.SKILL_LINK, 336, 80, 91, 73, 16, 34, 42, 190, 70, 67, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.ANACONDUKE, 10, false, false, false, "Fisticuffs Pokemon", Type.GRASS, Type.FIGHTING, 3.1, 62.3, Abilities.SHED_SKIN, Abilities.OBLIVIOUS, Abilities.SKILL_LINK, 483, 100, 112, 90, 20, 50, 111, 75, 70, 189, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.FISHNISM, 10, false, false, false, "Feminist Pokemon", Type.WATER, Type.PSYCHIC, 0.4, 1.9, Abilities.RIVALRY, Abilities.SYNCHRONIZE, Abilities.GLUTTONY, 395, 60, 55, 75, 40, 80, 85, 190, 45, 78, GrowthRate.SLOW, 12.5, false),
    new PokemonSpecies(Species.SJWHALE, 10, false, false, false, "Landwhale Pokemon", Type.WATER, Type.PSYCHIC, 2.0, 352.0, Abilities.RIVALRY, Abilities.SYNCHRONIZE, Abilities.GLUTTONY, 515, 115, 65, 95, 50, 100, 90, 60, 45, 78, GrowthRate.SLOW, 12.5, false),
    new PokemonSpecies(Species.CHEZETTA, 10, false, false, false, "Cheez Pizza Pokemon", Type.FAIRY, Type.FIRE, 1.5, 40.0, Abilities.GOOEY, Abilities.STICKY_HOLD, Abilities.CUTE_CHARM, 339, 60, 40, 70, 69, 70, 30, 75, 0, 69, GrowthRate.SLOW, 12.5, false),
    new PokemonSpecies(Species.MOZZAMAZEL, 10, false, false, false, "Twin Crust Pokemon", Type.FAIRY, Type.FIRE, 1.9, 80.0, Abilities.GOOEY, Abilities.STICKY_HOLD, Abilities.CUTE_CHARM, 519, 105, 69, 105, 95, 105, 40, 45, 0, 169, GrowthRate.SLOW, 12.5, false),
    new PokemonSpecies(Species.KROKLING, 10, false, false, false, "Maw Pokemon", Type.GROUND, Type.GRASS, 0.9, 128.3, Abilities.ROCK_HEAD, Abilities.THICK_FAT, Abilities.RECKLESS, 320, 70, 90, 60, 35, 35, 30, 120, 70, 135, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.KROKIZON, 10, false, false, false, "Predator Pokemon", Type.GROUND, Type.GRASS, 2.6, 283.9, Abilities.ROCK_HEAD, Abilities.THICK_FAT, Abilities.RECKLESS, 520, 110, 130, 100, 65, 65, 50, 45, 70, 205, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.CONCHILLA, 10, false, false, false, "Seashell Pokemon", Type.NORMAL, null, 0.3, 4.0, Abilities.CUTE_CHARM, Abilities.SERENE_GRACE, Abilities.COMPACTION, 335, 65, 45, 80, 40, 60, 45, 190, 70, 62, GrowthRate.MEDIUM_FAST, 25.0, false),
    new PokemonSpecies(Species.HAREMIT, 10, false, false, false, "Hermitcrab Pokemon", Type.NORMAL, Type.ROCK, 0.4, 45.5, Abilities.SHELL_ARMOR, Abilities.SERENE_GRACE, Abilities.COMPACTION, 525, 105, 85, 110, 60, 90, 75, 75, 70, 154, GrowthRate.MEDIUM_FAST, 25.0, false),
    new PokemonSpecies(Species.COOLCUBE, 10, false, false, false, "Ice Cube Pokemon", Type.ICE, null, 0.6, 1.0, Abilities.SNOW_CLOAK, Abilities.ICE_BODY, Abilities.CLEAR_BODY, 289, 50, 30, 64, 58, 67, 20, 255, 0, 66, GrowthRate.MEDIUM_SLOW, null, false),
    new PokemonSpecies(Species.TANKUBE, 10, false, false, false, "Ice Cube Pokemon", Type.ICE, null, 2.0, 100.0, Abilities.SWIFT_SWIM, Abilities.ICE_BODY, Abilities.CLEAR_BODY, 498, 80, 50, 94, 110, 106, 58, 120, 70, 126, GrowthRate.MEDIUM_SLOW, null, false),
    new PokemonSpecies(Species.FABKUBE, 10, false, false, false, "Ice Cube Pokemon", Type.ICE, Type.FAIRY, 2.5, 80.0, Abilities.LEVITATE, Abilities.ICE_BODY, Abilities.CLEAR_BODY, 530, 85, 40, 79, 125, 96, 105, 45, 70, 191, GrowthRate.MEDIUM_SLOW, null, false),
    new PokemonSpecies(Species.SMOGAROBEN, 10, false, false, false, "Toxic Pokemon", Type.POISON, Type.FLYING, 0.6, 9.0, Abilities.POISON_POINT, Abilities.WHITE_SMOKE, Abilities.TECHNICIAN, 351, 68, 65, 41, 48, 43, 86, 220, 45, 100, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.SMOXILON, 10, false, false, false, "OU Pokemon", Type.POISON, Type.FLYING, 1.6, 40.5, Abilities.POISON_POINT, Abilities.WHITE_SMOKE, Abilities.TECHNICIAN, 501, 78, 85, 71, 78, 73, 116, 65, 45, 210, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.MACHMONA, 10, false, false, false, "Luchador Pokemon", Type.FIGHTING, Type.GHOST, 0.9, 4.4, Abilities.PRESSURE, Abilities.VITAL_SPIRIT, Abilities.IRON_FIST, 520, 80, 120, 80, 60, 80, 100, 75, 45, 133, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.BACUB, 10, false, false, false, "Cub Pokemon", Type.NORMAL, Type.FIRE, 0.6, 8.8, Abilities.THICK_FAT, Abilities.GUTS, Abilities.FLASH_FIRE, 335, 90, 50, 60, 40, 55, 40, 190, 70, 66, GrowthRate.MEDIUM_FAST, 75.0, false),
    new PokemonSpecies(Species.URSWINE, 10, false, false, false, "Bear Pig Pokemon", Type.NORMAL, Type.FIRE, 1.8, 113.4, Abilities.THICK_FAT, Abilities.GUTS, Abilities.FLASH_FIRE, 470, 130, 90, 80, 60, 60, 50, 60, 70, 175, GrowthRate.MEDIUM_FAST, 75.0, false),
    new PokemonSpecies(Species.MOOSTATIC, 10, false, false, false, "Lightbulb Pokemon", Type.ELECTRIC, null, 0.6, 19.5, Abilities.STATIC, Abilities.VOLT_ABSORB, Abilities.SAP_SIPPER, 310, 70, 60, 40, 50, 40, 50, 190, 70, 67, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.MOOSHOCK, 10, false, false, false, "Thundercow Pokemon", Type.ELECTRIC, null, 1.9, 92.5, Abilities.STATIC, Abilities.VOLT_ABSORB, Abilities.SAP_SIPPER, 530, 120, 110, 80, 100, 90, 30, 60, 70, 167, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.PRETZELY, 10, false, false, false, "Twist Pokemon", Type.ROCK, Type.GHOST, 1.2, 2.9, Abilities.SOUNDPROOF, Abilities.GHOST_NOTE, Abilities.PRANKSTER, 437, 70, 62, 85, 105, 50, 65, 31, 70, 147, GrowthRate.SLOW, 87.5, false),
    new PokemonSpecies(Species.DEEMDOW, 10, false, false, false, "Shade Pokemon", Type.GHOST, Type.PSYCHIC, 0.5, 11.0, Abilities.SHADOW_TAG, Abilities.CURSED_BODY, Abilities.BAD_DREAMS, 360, 50, 75, 40, 85, 60, 50, 90, 45, 66, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.DOWSTER, 10, false, false, false, "Shade Pokemon", Type.GHOST, Type.PSYCHIC, 1.7, 76.6, Abilities.SHADOW_TAG, Abilities.CURSED_BODY, Abilities.BAD_DREAMS, 550, 80, 125, 50, 135, 90, 70, 45, 45, 165, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.CHEERLY, 10, false, false, false, "Cute Pokemon", Type.FAIRY, null, 0.8, 5.4, Abilities.CUTE_CHARM, Abilities.HEALER, Abilities.SERENE_GRACE, 285, 45, 55, 40, 35, 50, 60, 255, 140, 56, GrowthRate.FAST, 100.0, false),
    new PokemonSpecies(Species.CHEERIFIC, 10, false, false, false, "Cheerleader Pokemon", Type.FAIRY, null, 1.2, 18.6, Abilities.CUTE_CHARM, Abilities.HEALER, Abilities.SERENE_GRACE, 435, 60, 72, 68, 52, 88, 95, 100, 140, 132, GrowthRate.FAST, 100.0, false),
    new PokemonSpecies(Species.MENNOPAWS, 10, false, false, false, "Anger Pokemon", Type.FAIRY, Type.GROUND, 1.4, 118.0, Abilities.INTIMIDATE, Abilities.MOODY, Abilities.ANGER_POINT, 524, 100, 124, 76, 62, 92, 70, 45, 35, 185, GrowthRate.FAST, 100.0, false),
    new PokemonSpecies(Species.CARACOLD, 10, false, false, false, "Caracal Pokemon", Type.ICE, Type.ELECTRIC, 0.4, 4.2, Abilities.PICKUP, Abilities.RUN_AWAY, Abilities.FRISK, 280, 35, 20, 30, 75, 40, 80, 160, 70, 58, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.GLACIALYNX, 10, false, false, false, "Lynx Pokemon", Type.ICE, Type.ELECTRIC, 1.0, 32.0, Abilities.ADAPTABILITY, Abilities.VOLT_ABSORB, Abilities.FRISK, 446, 60, 55, 50, 110, 70, 101, 45, 70, 158, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.PENGAS, 10, false, false, false, "Pingas Pokemon", Type.ICE, Type.FIRE, 0.9, 16.0, Abilities.BERSERK, Abilities.INTIMIDATE, Abilities.REFRIGERATE, 500, 111, 50, 76, 95, 76, 92, 90, 70, 129, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.PRAETEUR, 10, false, false, false, "Fakefish Pokemon", Type.WATER, null, 0.6, 15.0, Abilities.INTIMIDATE, Abilities.CURSED_BODY, Abilities.UNNERVE, 300, 30, 55, 70, 45, 80, 20, 225, 70, 75, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.PRAESTISH, 10, false, false, false, "Fearmonger Pokemon", Type.WATER, null, 1.3, 39.0, Abilities.INTIMIDATE, Abilities.CURSED_BODY, Abilities.PHANTASMA, 527, 69, 98, 111, 88, 121, 40, 225, 70, 135, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.FLOWRE, 10, false, false, false, "Not a Pokemon", Type.POISON, Type.DARK, 0.3, 2.0, Abilities.LEVITATE, Abilities.LEVITATE, Abilities.LEVITATE, 414, 55, 50, 60, 85, 85, 79, 100, 70, 40, GrowthRate.SLOW, 12.5, false),
    new PokemonSpecies(Species.FLORIOUS, 10, false, false, false, "Ex-Meme Pokemon", Type.POISON, Type.DARK, 1.9, 69.8, Abilities.VITAL_SPIRIT, Abilities.BERSERK, Abilities.INSOMNIA, 544, 75, 80, 70, 115, 105, 99, 45, 70, 178, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.JUARECITO, 10, false, false, false, "Moustache Pokemon", Type.GROUND, null, 0.6, 21.0, Abilities.KEEN_EYE, Abilities.SAND_STREAM, Abilities.COMATOSE, 290, 50, 65, 45, 30, 35, 65, 200, 70, 65, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.PONCHITO, 10, false, false, false, "Poncho Pokemon", Type.GROUND, null, 1.0, 36.0, Abilities.KEEN_EYE, Abilities.SAND_STREAM, Abilities.COMATOSE, 380, 60, 90, 60, 40, 50, 80, 100, 70, 134, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.SOMBOLUDO, 10, false, false, false, "Gunner Pokemon", Type.GROUND, Type.STEEL, 1.4, 105.5, Abilities.SNIPER, Abilities.SAND_STREAM, Abilities.COMATOSE, 535, 110, 115, 75, 65, 70, 100, 45, 70, 176, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.PUPPACTI, 10, false, false, false, "Puppet Pokemon", Type.GRASS, null, 0.8, 14.2, Abilities.ROUGH_SKIN, Abilities.PUPPETEER, Abilities.INTIMIDATE, 325, 50, 75, 40, 50, 40, 70, 190, 70, 65, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.MARIONETTL, 10, false, false, false, "Puppeteer Pokemon", Type.GRASS, Type.WATER, 1.3, 64.0, Abilities.ROUGH_SKIN, Abilities.PUPPETEER, Abilities.INTIMIDATE, 520, 80, 110, 60, 100, 60, 110, 60, 70, 151, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.TITTAI, 10, false, false, false, "Hentai Pokemon", Type.WATER, Type.FAIRY, 0.3, 10.0, Abilities.SUCTION_CUPS, Abilities.WATER_ABSORB, Abilities.REGENERATOR, 288, 40, 20, 54, 77, 64, 33, 180, 100, 69, GrowthRate.FAST, 25.0, false),
    new PokemonSpecies(Species.OCTAI, 10, false, false, false, "Hentai Pokemon", Type.WATER, Type.FAIRY, 1.2, 100.0, Abilities.SUCTION_CUPS, Abilities.WATER_ABSORB, Abilities.REGENERATOR, 450, 80, 40, 85, 107, 95, 43, 90, 100, 169, GrowthRate.FAST, 25.0, false),
    new PokemonSpecies(Species.CHARAGON, 10, false, false, false, "Carriage Pokemon", Type.STEEL, Type.FIRE, 2.8, 330.0, Abilities.SPEED_BOOST, Abilities.STEAM_ENGINE, Abilities.MOXIE, 325, 50, 61, 62, 41, 40, 71, 140, 70, 65, GrowthRate.SLOW, null, false),
    new PokemonSpecies(Species.HYLETRACK, 10, false, false, false, "Hype Train Pokemon", Type.STEEL, Type.FIRE, 4.1, 735.0, Abilities.SPEED_BOOST, Abilities.STEAM_ENGINE, Abilities.MOXIE, 525, 80, 90, 90, 70, 70, 125, 55, 70, 173, GrowthRate.SLOW, null, false),
    new PokemonSpecies(Species.EUPHOREAL, 10, false, false, false, "Fedora Pokemon", Type.DARK, null, 0.5, 9.0, Abilities.OBLIVIOUS, Abilities.INSOMNIA, Abilities.RIVALRY, 371, 55, 70, 70, 40, 60, 76, 190, 70, 66, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.ARMOWITE, 10, false, false, false, "Troll Pokemon", Type.DARK, null, 1.2, 39.5, Abilities.OBLIVIOUS, Abilities.BLADEMASTER, Abilities.OVERCOAT, 525, 87, 103, 92, 60, 87, 96, 45, 70, 146, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.PRAUNCH, 10, false, false, false, "Prawn Pokemon", Type.WATER, Type.FIGHTING, 0.4, 2.0, Abilities.TECHNICIAN, Abilities.SWIFT_SWIM, Abilities.SHELL_ARMOR, 295, 30, 70, 70, 40, 25, 60, 255, 70, 66, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.KARAWN, 10, false, false, false, "Shrimp Pokemon", Type.WATER, Type.FIGHTING, 0.8, 8.5, Abilities.TECHNICIAN, Abilities.SWIFT_SWIM, Abilities.SHELL_ARMOR, 440, 55, 85, 85, 65, 65, 85, 120, 70, 126, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.MABSTER, 10, false, false, false, "Lobster Pokemon", Type.WATER, Type.FIGHTING, 1.1, 30.5, Abilities.IRON_FIST, Abilities.SWIFT_SWIM, Abilities.SHELL_ARMOR, 540, 75, 115, 85, 85, 85, 95, 45, 70, 176, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.TRICIENT, 10, false, false, false, "Triceratops Pokemon", Type.ROCK, Type.STEEL, 0.4, 100.0, Abilities.GUTS, Abilities.ROCK_HEAD, Abilities.BATTLE_ARMOR, 345, 75, 80, 80, 20, 70, 20, 45, 70, 74, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.TRICILLION, 10, false, false, false, "Super Horn Pokemon", Type.ROCK, Type.STEEL, 1.6, 508.0, Abilities.GUTS, Abilities.ROCK_HEAD, Abilities.BATTLE_ARMOR, 521, 110, 130, 130, 20, 110, 21, 45, 70, 182, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.POIZOOKIE, 10, false, false, false, "Raptor Pokemon", Type.ROCK, Type.POISON, 0.8, 29.6, Abilities.POISON_POINT, Abilities.CORROSION, Abilities.MERCILESS, 345, 50, 72, 35, 63, 40, 85, 45, 35, 74, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.TOXIRAPTOR, 10, false, false, false, "Raptor Pokemon", Type.ROCK, Type.POISON, 1.5, 77.9, Abilities.POISON_POINT, Abilities.CORROSION, Abilities.MERCILESS, 521, 65, 113, 65, 103, 50, 125, 45, 35, 182, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.SABRECK, 10, false, false, false, "Sabretooth Pokemon", Type.ROCK, Type.NORMAL, 0.6, 9.0, Abilities.SUPER_LUCK, Abilities.STRONG_JAW, Abilities.TOUGH_CLAWS, 345, 60, 85, 45, 33, 47, 75, 45, 70, 74, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.HUNTABRE, 10, false, false, false, "Sabretooth Pokemon", Type.ROCK, Type.NORMAL, 1.1, 125.8, Abilities.SUPER_LUCK, Abilities.STRONG_JAW, Abilities.TOUGH_CLAWS, 521, 80, 118, 70, 62, 66, 125, 45, 70, 182, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.PYRALINK, 10, false, false, false, "Volcanic Pokemon", Type.DRAGON, Type.FIRE, 2.2, 111.1, Abilities.MAGMA_ARMOR, Abilities.INTIMIDATE, Abilities.MULTISCALE, 530, 100, 111, 93, 106, 68, 52, 60, 35, 174, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.SINGLETS, 10, false, false, false, "Misfortune Pokemon", Type.PSYCHIC, Type.ELECTRIC, 0.6, 20.1, Abilities.SKILL_LINK, Abilities.ANALYTIC, Abilities.COMPETITIVE, 301, 50, 50, 50, 50, 50, 51, 205, 0, 42, GrowthRate.ERRATIC, null, false),
    new PokemonSpecies(Species.DUBUS, 10, false, false, false, "Lucky Pokemon", Type.PSYCHIC, Type.ELECTRIC, 0.9, 25.2, Abilities.SKILL_LINK, Abilities.ANALYTIC, Abilities.COMPETITIVE, 411, 69, 69, 69, 69, 69, 66, 155, 70, 122, GrowthRate.ERRATIC, null, false),
    new PokemonSpecies(Species.TRIPSIUS, 10, false, false, false, "Felicity Pokemon", Type.PSYCHIC, Type.ELECTRIC, 1.5, 111.0, Abilities.SKILL_LINK, Abilities.ANALYTIC, Abilities.COMPETITIVE, 555, 88, 89, 99, 88, 80, 111, 111, 70, 222, GrowthRate.ERRATIC, null, false),
    new PokemonSpecies(Species.MIASMER, 10, false, false, false, "Miasma Pokemon", Type.POISON, Type.STEEL, 0.5, 0.3, Abilities.LEVITATE, Abilities.PRANKSTER, Abilities.POISON_POINT, 375, 55, 75, 50, 65, 60, 70, 140, 35, 75, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.MIASMORTOR, 10, false, false, false, "Miasma Pokemon", Type.POISON, Type.STEEL, 1.1, 34.6, Abilities.SPEED_BOOST, Abilities.PRANKSTER, Abilities.POISON_POINT, 530, 80, 110, 70, 90, 70, 110, 45, 35, 147, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.CACADEMON, 10, false, false, false, "Gunk Pokemon", Type.GROUND, Type.POISON, 1.2, 30.0, Abilities.STENCH, Abilities.POISON_TOUCH, Abilities.ALCHEMY, 540, 150, 101, 79, 101, 79, 30, 45, 35, 154, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.HANGINY, 10, false, false, false, "Undead Pokemon", Type.GHOST, null, 0.6, 24.4, Abilities.AFTERMATH, Abilities.CUTE_CHARM, Abilities.UNNERVE, 280, 120, 5, 5, 20, 85, 45, 80, 35, 36, GrowthRate.ERRATIC, 100.0, false),
    new PokemonSpecies(Species.CHANCER, 10, false, false, false, "Undead Pokemon", Type.GHOST, null, 1.1, 34.6, Abilities.AFTERMATH, Abilities.CUTE_CHARM, Abilities.UNNERVE, 450, 250, 5, 5, 35, 105, 50, 45, 35, 100, GrowthRate.ERRATIC, 100.0, false),
    new PokemonSpecies(Species.UNJOY, 10, true, false, false, "Head Nurse Pokemon", Type.GHOST, null, 1.5, 46.8, Abilities.AFTERMATH, Abilities.CUTE_CHARM, Abilities.UNNERVE, 540, 255, 10, 10, 75, 135, 55, 3, 35, 200, GrowthRate.ERRATIC, 100.0, false),
    new PokemonSpecies(Species.FROSOWL, 10, false, false, false, "Owl Pokemon", Type.ICE, Type.FLYING, 0.5, 2.1, Abilities.INSOMNIA, Abilities.SNOW_WARNING, Abilities.FOREWARN, 328, 50, 60, 20, 73, 30, 95, 190, 70, 57, GrowthRate.FAST, 50.0, false),
    new PokemonSpecies(Species.WHIZZARD, 10, false, false, false, "Owl Pokemon", Type.ICE, Type.FLYING, 1.6, 40.8, Abilities.INSOMNIA, Abilities.SNOW_WARNING, Abilities.MAGIC_GUARD, 473, 75, 80, 40, 103, 60, 115, 75, 70, 149, GrowthRate.FAST, 50.0, false),
    new PokemonSpecies(Species.DRAPILLAR, 10, false, false, false, "Caterpillar Pokemon", Type.BUG, Type.DRAGON, 1.1, 28.8, Abilities.SHIELD_DUST, Abilities.MARVEL_SCALE, Abilities.SHED_SKIN, 310, 60, 80, 50, 30, 45, 45, 45, 35, 50, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.CAPARAGON, 10, false, false, false, "Caparace Pokemon", Type.BUG, Type.DRAGON, 1.1, 55.1, Abilities.SHIELD_DUST, Abilities.MARVEL_SCALE, Abilities.SHED_SKIN, 412, 90, 81, 100, 31, 95, 15, 45, 35, 105, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.MANTRAKE, 10, true, false, false, "Mantis Pokemon", Type.BUG, Type.DRAGON, 1.5, 112.6, Abilities.COMPOUND_EYES, Abilities.TINTED_LENS, Abilities.SHED_SKIN, 540, 110, 140, 85, 50, 80, 75, 3, 35, 199, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.OGRELORD, 10, false, false, false, "ALL OGRE Pokemon", Type.DARK, null, 2.1, 432.3, Abilities.VICTORY_STAR, Abilities.MOLD_BREAKER, Abilities.STURDY, 526, 100, 130, 80, 65, 81, 70, 75, 70, 176, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.CHANTRUTH, 10, false, false, false, "Greed Pokemon", Type.DARK, null, 1.3, 208.2, Abilities.KEEN_EYE, Abilities.JEWELRY, Abilities.MAGNET_PULL, 526, 100, 61, 94, 106, 95, 70, 75, 70, 235, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.INBITWEEN, 10, false, false, false, "Pony Pokemon", Type.FAIRY, null, 0.4, 20.0, Abilities.MOODY, Abilities.SERENE_GRACE, Abilities.MAGIC_BOUNCE, 355, 50, 55, 55, 65, 60, 70, 120, 70, 54, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.GEIGH, 10, false, false, false, "Alicorn Pokemon", Type.FAIRY, Type.FLYING, 1.7, 95.0, Abilities.OBLIVIOUS, Abilities.SERENE_GRACE, Abilities.MAGIC_BOUNCE, 519, 69, 80, 70, 110, 75, 115, 60, 70, 172, GrowthRate.MEDIUM_FAST, 100.0, false),
    new PokemonSpecies(Species.JARAPE, 10, false, false, false, "Forbidden Pokemon", Type.ELECTRIC, Type.ROCK, 0.7, 92.0, Abilities.CURSED_BODY, Abilities.SOLID_ROCK, Abilities.PRANKSTER, 320, 70, 30, 85, 40, 85, 10, 190, 35, 66, GrowthRate.FAST, null, false),
    new PokemonSpecies(Species.SPILEFREE, 10, false, false, false, "Free Pokemon", Type.ELECTRIC, Type.GHOST, 1.5, 1.2, Abilities.CLEAR_BODY, Abilities.PRANKSTER, Abilities.LEVITATE, 535, 70, 45, 45, 125, 125, 125, 60, 35, 168, GrowthRate.FAST, null, false),
    new PokemonSpecies(Species.BONGECKO, 10, false, false, false, "Gecko Pokemon", Type.GRASS, Type.FIRE, 0.6, 8.5, Abilities.BLAZE, Abilities.WHITE_SMOKE, Abilities.TURBOBLAZE, 255, 55, 40, 45, 60, 45, 10, 255, 70, 62, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.MARIGUANA, 10, false, false, false, "Iguana Pokemon", Type.GRASS, Type.FIRE, 1.1, 19.0, Abilities.BLAZE, Abilities.WHITE_SMOKE, Abilities.TURBOBLAZE, 420, 105, 50, 85, 75, 85, 20, 190, 70, 142, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.MARLEYZARD, 10, false, false, false, "Dank Pokemon", Type.GRASS, Type.FIRE, 1.7, 90.5, Abilities.BLAZE, Abilities.WHITE_SMOKE, Abilities.TURBOBLAZE, 540, 130, 60, 110, 100, 110, 30, 30, 70, 204, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.BLOBBOS, 10, false, false, false, "Blob Pokemon", Type.ICE, Type.ROCK, 0.4, 5.7, Abilities.PURE_POWER, Abilities.HUGE_POWER, Abilities.COMATOSE, 150, 42, 17, 36, 15, 25, 15, 30, 70, 10, GrowthRate.SLOW, null, false),
    new PokemonSpecies(Species.AYYLAMO, 10, false, false, false, "Alien Pokemon", Type.PSYCHIC, null, 0.6, 13.0, Abilities.COMPOUND_EYES, Abilities.SYNCHRONIZE, Abilities.TINTED_LENS, 445, 70, 50, 65, 90, 80, 90, 150, 35, 51, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.SMELLOX, 10, false, false, false, "Rancid Pokemon", Type.POISON, null, 1.2, 23.6, Abilities.STENCH, Abilities.NO_GUARD, Abilities.STINK_BOMB, 489, 92, 103, 89, 63, 71, 71, 90, 35, 125, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.CHASUMO, 10, false, false, false, "Champion Pokemon", Type.FIGHTING, null, 1.5, 70.5, Abilities.DEFIANT, Abilities.ANGER_POINT, Abilities.FUK_U, 489, 110, 110, 95, 45, 62, 67, 90, 35, 125, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.OILSLAM, 10, false, false, false, "Oil Pokemon", Type.POISON, Type.DARK, 0.9, 30.0, Abilities.LIQUID_OOZE, Abilities.FLARE_BOOST, Abilities.MERCILESS, 325, 80, 80, 50, 40, 50, 25, 120, 35, 119, GrowthRate.MEDIUM_SLOW, 75.0, false),
    new PokemonSpecies(Species.ISISSIN, 10, false, false, false, "Assassin Pokemon", Type.POISON, Type.DARK, 1.7, 63.9, Abilities.LIQUID_OOZE, Abilities.FLARE_BOOST, Abilities.MERCILESS, 535, 105, 105, 75, 105, 95, 50, 45, 35, 179, GrowthRate.MEDIUM_SLOW, 75.0, false),
    new PokemonSpecies(Species.STUFFOWL, 10, false, false, false, "Bird Pokemon", Type.NORMAL, Type.FLYING, 0.3, 2.0, Abilities.EARLY_BIRD, Abilities.KEEN_EYE, Abilities.BIG_PECKS, 350, 62, 65, 55, 55, 48, 65, 60, 70, 62, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.DURKEY, 10, false, false, false, "Stuffed Pokemon", Type.NORMAL, Type.FLYING, 1.1, 30.0, Abilities.EARLY_BIRD, Abilities.KEEN_EYE, Abilities.INNARDS_OUT, 455, 72, 85, 73, 72, 68, 85, 45, 70, 140, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.UPCHUCKEN, 10, false, false, false, "Turducken Pokemon", Type.NORMAL, Type.FLYING, 1.5, 43.7, Abilities.DROUGHT, Abilities.FLARE_BOOST, Abilities.INNARDS_OUT, 559, 87, 105, 81, 102, 81, 103, 25, 70, 201, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.DRAGUN, 10, false, false, false, "Cannon Pokemon", Type.DRAGON, Type.STEEL, 0.4, 21.4, Abilities.SNIPER, Abilities.MEGA_LAUNCHER, Abilities.KEEN_EYE, 300, 45, 25, 65, 100, 45, 20, 90, 35, 67, GrowthRate.SLOW, 75.0, false),
    new PokemonSpecies(Species.TRIGGEDON, 10, false, false, false, "Cannon Pokemon", Type.DRAGON, Type.STEEL, 0.7, 51.0, Abilities.SNIPER, Abilities.MEGA_LAUNCHER, Abilities.KEEN_EYE, 420, 65, 50, 85, 120, 70, 30, 45, 35, 144, GrowthRate.SLOW, 75.0, false),
    new PokemonSpecies(Species.CANNONANCE, 10, true, true, false, "Ballista Pokemon", Type.DRAGON, Type.STEEL, 1.4, 101.1, Abilities.SNIPER, Abilities.MEGA_LAUNCHER, Abilities.KEEN_EYE, 600, 95, 95, 115, 145, 105, 45, 3, 35, 3, GrowthRate.SLOW, 75.0, false),
    new PokemonSpecies(Species.EVACYCLE, 10, true, true, false, "Symbolic Pokemon", Type.STEEL, Type.PSYCHIC, 4.3, 431.4, Abilities.FLAME_BODY, Abilities.STRONG_JAW, Abilities.RUN_AWAY, 600, 150, 90, 90, 90, 90, 90, 3, 35, 255, GrowthRate.SLOW, null, false),
    new PokemonSpecies(Species.FORYU, 10, true, true, false, "Big Guy Pokemon", Type.STEEL, Type.FIGHTING, 4.9, 489.0, Abilities.MAGNET_PULL, Abilities.BIG_GUY, Abilities.HEAVY_METAL, 600, 80, 150, 125, 65, 100, 80, 3, 35, 255, GrowthRate.SLOW, 100.0, false),
    new PokemonSpecies(Species.SCYTILL, 10, true, true, false, "Windmill Pokemon", Type.STEEL, Type.GHOST, 4.0, 392.0, Abilities.LEVITATE, Abilities.HYPER_CUTTER, Abilities.AIR_LOCK, 600, 100, 135, 80, 85, 50, 150, 3, 35, 255, GrowthRate.SLOW, null, false),
    new PokemonSpecies(Species.BADDON, 10, false, true, false, "Dildo Pokemon", Type.DRAGON, null, 0.7, 50.0, Abilities.ROUGH_SKIN, Abilities.SKILL_LINK, Abilities.INFILTRATOR, 640, 73, 136, 148, 121, 112, 50, 3, 35, 255, GrowthRate.SLOW, 100.0, false),
    new PokemonSpecies(Species.ENDRANTHER, 10, false, true, false, "Decay Pokemon", Type.POISON, null, 2.5, 650.0, Abilities.POISON_POINT, Abilities.AFTERMATH, Abilities.PRESSURE, 650, 100, 150, 100, 100, 105, 95, 3, 0, 255, GrowthRate.SLOW, null, false),
    new PokemonSpecies(Species.NOTRIDLEY, 10, false, true, false, "SpaceDragon Pokemon", Type.DRAGON, Type.FLYING, 8.0, 1113.7, Abilities.PRESSURE, Abilities.AFTERMATH, Abilities.TINTED_LENS, 622, 90, 120, 97, 105, 95, 115, 3, 0, 255, GrowthRate.SLOW, 100.0, false),
    new PokemonSpecies(Species.DEMIWAIFU, 10, false, true, false, "Fantasy Pokemon", Type.FAIRY, null, 2.0, 122.0, Abilities.SERENE_GRACE, Abilities.TRIAGE, Abilities.MAJESTIC, 680, 112, 87, 104, 131, 131, 115, 3, 35, 255, GrowthRate.SLOW, 100.0, false),
    new PokemonSpecies(Species.CLOVENIX, 10, false, true, false, "Revival Pokemon", Type.GRASS, Type.FIRE, 7.6, 999.9, Abilities.REGENERATOR, Abilities.SUPER_LUCK, Abilities.ANTICIPATION, 720, 120, 125, 100, 125, 100, 150, 2, 35, 255, GrowthRate.SLOW, null, false),
    new PokemonSpecies(Species.REPTYKE, 11, false, false, false, "Novice Pokemon", Type.FIGHTING, null, 0.6, 20.0, Abilities.IRON_FIST, Abilities.NONE, Abilities.INNER_FOCUS, 318, 63, 80, 60, 30, 40, 45, 45, 70, 62, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.RASCLOBBER, 11, false, false, false, "Amateur Pokemon", Type.FIGHTING, Type.DRAGON, 1.2, 41.7, Abilities.IRON_FIST, Abilities.NONE, Abilities.INNER_FOCUS, 405, 75, 95, 80, 40, 60, 55, 45, 70, 142, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.BATTEREX, 11, false, false, false, "Champion Pokemon", Type.FIGHTING, Type.DRAGON, 2.5, 135.0, Abilities.IRON_FIST, Abilities.NONE, Abilities.INNER_FOCUS, 525, 90, 125, 100, 60, 70, 80, 45, 70, 208, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.FAERIOCK, 11, false, false, false, "Symbiotic Pokemon", Type.ROCK, null, 0.5, 15.9, Abilities.SOLID_ROCK, Abilities.TELEPATHY, Abilities.MAGIC_GUARD, 318, 53, 50, 65, 50, 80, 20, 45, 70, 62, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.SYLVUIN, 11, false, false, false, "Ruins Pokemon", Type.ROCK, Type.FAIRY, 1.1, 71.2, Abilities.SOLID_ROCK, Abilities.TELEPATHY, Abilities.MAGIC_GUARD, 405, 60, 60, 80, 70, 95, 40, 45, 70, 142, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.OBURONYXO, 11, false, false, false, "Monarch Pokemon", Type.ROCK, Type.FAIRY, 2.4, 189.5, Abilities.SOLID_ROCK, Abilities.TELEPATHY, Abilities.MAGIC_GUARD, 525, 80, 70, 100, 90, 125, 60, 45, 70, 3, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.CLOUCAT, 11, false, false, false, "Cloud Pokemon", Type.FLYING, null, 0.3, 0.1, Abilities.TOUGH_CLAWS, Abilities.SHOWER_POWER, Abilities.CLOUD_NINE, 318, 40, 64, 35, 64, 35, 80, 45, 70, 62, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.FELIMBUS, 11, false, false, false, "Raincloud Pokemon", Type.FLYING, Type.DARK, 1.2, 9.0, Abilities.TOUGH_CLAWS, Abilities.SHOWER_POWER, Abilities.CLOUD_NINE, 405, 50, 80, 50, 80, 50, 95, 45, 70, 142, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.DEATHORUS, 11, false, false, false, "Death Storm Pokemon", Type.FLYING, Type.DARK, 2.0, 30.2, Abilities.TOUGH_CLAWS, Abilities.SHOWER_POWER, Abilities.CLOUD_NINE, 525, 75, 95, 70, 90, 70, 125, 45, 70, 208, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.KNOGOAT, 11, false, false, false, "GOAT Pokemon", Type.NORMAL, null, 1.0, 42.4, Abilities.OWN_TEMPO, Abilities.RECKLESS, Abilities.MOLD_BREAKER, 370, 95, 85, 55, 30, 50, 55, 190, 1, 215, GrowthRate.FLUCTUATING, 50.0, false),
    new PokemonSpecies(Species.KNOGRINYU, 11, false, false, false, "GOATOAT Pokemon", Type.NORMAL, null, 2.0, 198.0, Abilities.OWN_TEMPO, Abilities.RECKLESS, Abilities.MOLD_BREAKER, 545, 170, 120, 70, 40, 70, 75, 60, 70, 250, GrowthRate.FLUCTUATING, 50.0, false),
    new PokemonSpecies(Species.GLASSHOT, 11, false, false, false, "GlassCannon Pokemon", Type.ICE, Type.STEEL, 0.7, 52.5, Abilities.KEEN_EYE, Abilities.BULLETPROOF, Abilities.CLEAR_BODY, 332, 31, 74, 40, 74, 40, 73, 190, 70, 70, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.GLASSANNON, 11, false, false, false, "GlassCannon Pokemon", Type.ICE, Type.STEEL, 1.9, 300.0, Abilities.SPEED_BOOST, Abilities.BULLETPROOF, Abilities.CLEAR_BODY, 538, 45, 139, 40, 139, 40, 135, 60, 70, 182, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.FLUFFYETI, 11, false, false, false, "Yeti Pokemon", Type.ICE, null, 0.8, 13.3, Abilities.SNOW_CLOAK, Abilities.ICE_BODY, Abilities.FLUFFY, 355, 60, 75, 65, 30, 65, 60, 190, 70, 62, GrowthRate.MEDIUM_SLOW, 75.0, false),
    new PokemonSpecies(Species.YEDOOM, 11, false, false, false, "Yeti Pokemon", Type.ICE, Type.DARK, 1.3, 77.1, Abilities.PRESSURE, Abilities.TOUGH_CLAWS, Abilities.FLUFFY, 535, 80, 115, 90, 60, 95, 95, 65, 35, 175, GrowthRate.MEDIUM_SLOW, 75.0, false),
    new PokemonSpecies(Species.MIRROSTINE, 11, false, false, false, "Reflection Pokemon", Type.STEEL, Type.GHOST, 1.1, 6.8, Abilities.LIGHTNING_ROD, Abilities.TRACE, Abilities.INVERSION, 484, 68, 59, 79, 97, 95, 86, 75, 35, 135, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.MUDPANTS, 11, false, false, false, "Feces Pokemon", Type.GROUND, Type.FIGHTING, 0.6, 9.0, Abilities.SAND_RUSH, Abilities.STENCH, Abilities.SAND_STREAM, 330, 50, 85, 75, 30, 50, 40, 200, 70, 56, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.MUDSLACKS, 11, false, false, false, "Diarrhea Pokemon", Type.GROUND, Type.FIGHTING, 1.0, 29.5, Abilities.SAND_RUSH, Abilities.STENCH, Abilities.SAND_STREAM, 480, 80, 125, 90, 50, 70, 65, 90, 70, 137, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.BUKITLEE, 11, false, false, false, "Unassuming Pokemon", Type.STEEL, null, 0.3, 15.0, Abilities.OWN_TEMPO, Abilities.LIGHT_METAL, Abilities.AFTERMATH, 305, 50, 30, 95, 20, 90, 20, 255, 70, 60, GrowthRate.SLOW, null, false),
    new PokemonSpecies(Species.LOSSOLITH, 11, false, false, false, "Immortal Pokemon", Type.STEEL, Type.PSYCHIC, 5.8, 950.0, Abilities.LEVITATE, Abilities.HEAVY_METAL, Abilities.AFTERMATH, 540, 50, 60, 200, 60, 140, 30, 90, 70, 175, GrowthRate.SLOW, null, false),
    new PokemonSpecies(Species.MIMIMIE, 11, false, false, false, "Me Pokemon", Type.WATER, Type.DARK, 1.0, 35.0, Abilities.SUCTION_CUPS, Abilities.DEGENORATE, Abilities.SERENE_GRACE, 515, 75, 70, 80, 115, 85, 90, 65, 35, 154, GrowthRate.SLOW, 25.0, false),
    new PokemonSpecies(Species.SPRUCIFIX, 11, false, false, false, "Crucified Pokemon", Type.GRASS, Type.GHOST, 1.7, 55.2, Abilities.WONDER_GUARD, Abilities.REGENERATOR, Abilities.RAIN_DISH, 493, 89, 108, 122, 49, 75, 50, 60, 70, 200, GrowthRate.SLOW, 100.0, false),
    new PokemonSpecies(Species.HULKAN, 11, false, false, false, "Main Event Pokemon", Type.FIGHTING, null, 2.0, 130.0, Abilities.GUTS, Abilities.HUSTLE, Abilities.STEADFAST, 520, 110, 150, 100, 20, 90, 50, 75, 70, 183, GrowthRate.MEDIUM_SLOW, 75.0, false),
    new PokemonSpecies(Species.NONITE, 11, false, false, false, "Sound Pokemon", Type.FAIRY, null, 0.8, 15.2, Abilities.CACOPHONY, Abilities.BOOMBOX, Abilities.MEJESTIC, 305, 60, 40, 45, 55, 50, 55, 150, 35, 75, GrowthRate.MEDIUM_SLOW, null, false),
    new PokemonSpecies(Species.NONEGATIVE, 11, false, false, false, "Sound Pokemon", Type.FAIRY, null, 1.7, 45.0, Abilities.CACOPHONY, Abilities.BOOMBOX, Abilities.MEJESTIC, 425, 80, 40, 45, 95, 80, 85, 75, 35, 115, GrowthRate.MEDIUM_SLOW, null, false),
    new PokemonSpecies(Species.NOMAESTRO, 11, false, false, false, "Music Pokemon", Type.FAIRY, Type.FLYING, 1.9, 120.0, Abilities.CACOPHONY, Abilities.BOOMBOX, Abilities.MEJESTIC, 545, 100, 105, 90, 95, 80, 75, 45, 35, 195, GrowthRate.MEDIUM_SLOW, null, false),
    new PokemonSpecies(Species.DUNKYPEA, 11, false, false, false, "Squawker Pokemon", Type.POISON, Type.FLYING, 0.6, 9.0, Abilities.BIG_PECKS, Abilities.SOUNDPROOF, Abilities.UNBURDEN, 300, 55, 45, 45, 45, 50, 60, 200, 70, 62, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.BURDMEN, 11, false, false, false, "Flight Pokemon", Type.POISON, Type.FLYING, 1.4, 39.2, Abilities.BIG_PECKS, Abilities.SOUNDPROOF, Abilities.UNBURDEN, 415, 70, 60, 60, 65, 65, 95, 100, 70, 125, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.NUTZBOLTZ, 11, false, false, false, "Bureaucracy Pokemon", Type.POISON, Type.FLYING, 1.8, 85.2, Abilities.BIG_PECKS, Abilities.SOUNDPROOF, Abilities.UNBURDEN, 515, 105, 70, 80, 85, 95, 80, 65, 70, 199, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.KUKLUX, 11, false, false, false, "Klansman Pokemon", Type.FIRE, null, 0.7, 1.0, Abilities.FLASH_FIRE, Abilities.LEVITATE, Abilities.JUSTIFIED, 300, 40, 45, 50, 60, 50, 55, 135, 35, 65, GrowthRate.MEDIUM_FAST, 75.0, false),
    new PokemonSpecies(Species.KUKLAN, 11, false, false, false, "Wizard Pokemon", Type.FIRE, null, 1.5, 4.4, Abilities.FLASH_FIRE, Abilities.LEVITATE, Abilities.JUSTIFIED, 515, 60, 60, 60, 115, 115, 105, 65, 35, 65, GrowthRate.MEDIUM_FAST, 75.0, false),
    new PokemonSpecies(Species.FLAMEBOYAN, 11, false, false, false, "Flaming Pokemon", Type.FIRE, Type.FAIRY, 0.7, 9.5, Abilities.RIVALRY, Abilities.SOLAR_POWER, Abilities.FLAME_BODY, 460, 85, 62, 78, 92, 118, 25, 75, 70, 116, GrowthRate.FAST, 75.0, false),
    new PokemonSpecies(Species.PIICEE, 11, false, false, false, "Daily Dose Pokemon", Type.PSYCHIC, Type.POISON, 1.3, 40.0, Abilities.SYNCHRONIZE, Abilities.TRIAGE, Abilities.REGENERATOR, 510, 95, 50, 75, 95, 115, 80, 75, 70, 169, GrowthRate.ERRATIC, 75.0, false),
    new PokemonSpecies(Species.SONNANOS, 11, false, false, false, "Nanomachine Pokemon", Type.STEEL, Type.FIGHTING, 1.6, 139.0, Abilities.SHEER_FORCE, Abilities.IRON_FIST, Abilities.STAMINA, 515, 105, 115, 105, 60, 60, 70, 100, 70, 170, GrowthRate.MEDIUM_SLOW, 75.0, false),
    new PokemonSpecies(Species.PLEBBLES, 11, false, false, false, "Pebbles Pokemon", Type.ROCK, null, 0.4, 4.5, Abilities.STURDY, Abilities.LEVITATE, Abilities.INFILTRATOR, 490, 60, 80, 160, 50, 70, 70, 120, 70, 122, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.SAPLEAF, 11, false, false, false, "Sapling Pokemon", Type.GRASS, null, 1.0, 31.0, Abilities.SOLAR_POWER, Abilities.OVERGROW, Abilities.LEAF_GUARD, 335, 50, 60, 45, 65, 40, 75, 200, 70, 100, GrowthRate.FLUCTUATING, 50.0, false),
    new PokemonSpecies(Species.IGNUT, 11, false, false, false, "Burning Pokemon", Type.FIRE, null, 1.4, 45.8, Abilities.FLAME_BODY, Abilities.BLAZE, Abilities.FLASH_FIRE, 450, 70, 70, 80, 85, 55, 90, 100, 35, 150, GrowthRate.FLUCTUATING, 50.0, false),
    new PokemonSpecies(Species.PHANTASH, 11, false, false, false, "Ash Pokemon", Type.GHOST, null, 1.5, 0.2, Abilities.WHITE_SMOKE, Abilities.CURSED_BODY, Abilities.AIR_LOCK, 520, 90, 65, 85, 110, 110, 60, 55, 0, 200, GrowthRate.FLUCTUATING, 50.0, false),
    new PokemonSpecies(Species.POLOSSUS, 11, false, false, false, "New Jersey Pokemon", Type.POISON, null, 4.2, 336.0, Abilities.POLLUTION, Abilities.EFFECT_SPORE, Abilities.WEAK_ARMOR, 530, 140, 115, 75, 60, 75, 65, 50, 35, 200, GrowthRate.SLOW, null, false),
    new PokemonSpecies(Species.HITMONANA, 11, false, false, false, "Cackling Pokemon", Type.GRASS, Type.FIGHTING, 0.8, 15.0, Abilities.SHED_SKIN, Abilities.HARVEST, Abilities.PRANKSTER, 515, 70, 100, 100, 100, 100, 45, 75, 70, 139, GrowthRate.FAST, 75.0, false),
    new PokemonSpecies(Species.BALLACLE, 11, false, false, false, "Basketball Pokemon", Type.ROCK, null, 0.5, 31.0, Abilities.PICKUP, Abilities.SUCTION_CUPS, Abilities.SHELL_ARMOR, 350, 62, 52, 65, 40, 56, 75, 145, 70, 105, GrowthRate.ERRATIC, 100.0, false),
    new PokemonSpecies(Species.BARBARKLEY, 11, false, false, false, "Slam Jam Pokemon", Type.ROCK, Type.FIGHTING, 1.3, 96.0, Abilities.QUICK_FEET, Abilities.MAGIC_BOUNCE, Abilities.STEADFAST, 520, 96, 105, 80, 54, 70, 115, 50, 70, 196, GrowthRate.ERRATIC, 100.0, false),
    new PokemonSpecies(Species.KEKROACH, 11, false, false, false, "Kek Pokemon", Type.DARK, Type.BUG, 0.5, 1.7, Abilities.SWARM, Abilities.PRANKSTER, Abilities.STURDY, 325, 55, 65, 65, 40, 45, 55, 190, 35, 54, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.REKROACH, 11, false, false, false, "Wreck Pokemon", Type.DARK, Type.BUG, 1.3, 44.4, Abilities.SWARM, Abilities.IRON_FIST, Abilities.STURDY, 515, 90, 110, 115, 50, 70, 80, 100, 35, 126, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.RICOSHEEP, 11, false, false, false, "Ricochet Pokemon", Type.NORMAL, null, 0.5, 5.5, Abilities.SPEED_BOOST, Abilities.MAGIC_BOUNCE, Abilities.BULLETPROOF, 343, 80, 55, 50, 38, 50, 70, 200, 70, 80, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.RICOSUAVE, 11, false, false, false, "Ricochet Pokemon", Type.NORMAL, null, 1.0, 12.0, Abilities.SPEED_BOOST, Abilities.MAGIC_BOUNCE, Abilities.BULLETPROOF, 525, 130, 70, 80, 60, 70, 115, 75, 35, 167, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.SPAGHEFANT, 11, false, false, false, "Spaghetti Pokemon", Type.GROUND, Type.FAIRY, 2.9, 300.0, Abilities.WATER_ABSORB, Abilities.INTIMIDATE, Abilities.COMPACTION, 500, 120, 60, 100, 100, 85, 35, 65, 70, 135, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.CRYSTAQUIL, 11, false, false, false, "Cold Quill Pokemon", Type.ICE, Type.POISON, 1.1, 97.0, Abilities.ROUGH_SKIN, Abilities.POISON_POINT, Abilities.SLUSH_RUSH, 387, 65, 70, 75, 67, 50, 60, 130, 70, 70, GrowthRate.MEDIUM_SLOW, 75.0, false),
    new PokemonSpecies(Species.CRYSTAKING, 11, false, false, false, "Frost Drill Pokemon", Type.ICE, Type.POISON, 2.1, 100.0, Abilities.ROUGH_SKIN, Abilities.POISON_POINT, Abilities.SLUSH_RUSH, 546, 90, 120, 96, 75, 85, 80, 45, 70, 199, GrowthRate.MEDIUM_SLOW, 75.0, false),
    new PokemonSpecies(Species.FONTABA, 11, false, false, false, "Board Pokemon", Type.PSYCHIC, null, 1.0, 10.0, Abilities.SOLAR_POWER, Abilities.LEVITATE, Abilities.TELEPATHY, 492, 75, 80, 91, 80, 91, 75, 225, 0, 61, GrowthRate.SLOW, null, false),
    new PokemonSpecies(Species.FLOCONUT, 11, false, false, false, "Coconut Pokemon", Type.GRASS, null, 0.6, 9.0, Abilities.CHLOROPHYLL, Abilities.SHELL_ARMOR, Abilities.SOLAR_POWER, 250, 40, 40, 60, 40, 50, 20, 200, 70, 76, GrowthRate.FAST, 50.0, false),
    new PokemonSpecies(Species.SAPPALM, 11, false, false, false, "Palm Pokemon", Type.GRASS, null, 1.3, 41.5, Abilities.CHLOROPHYLL, Abilities.SHELL_ARMOR, Abilities.SOLAR_POWER, 425, 70, 70, 85, 75, 70, 55, 100, 70, 143, GrowthRate.FAST, 50.0, false),
    new PokemonSpecies(Species.ROYNAPALM, 11, false, false, false, "Palm Pokemon", Type.GRASS, null, 2.5, 200.0, Abilities.CHLOROPHYLL, Abilities.FLASH_FIRE, Abilities.SOLAR_POWER, 533, 90, 50, 100, 143, 80, 70, 45, 70, 195, GrowthRate.FAST, 50.0, false),
    new PokemonSpecies(Species.MANATEET, 11, false, false, false, "Sea Cow Pokemon", Type.WATER, Type.ICE, 1.1, 90.0, Abilities.WATER_VEIL, Abilities.TORRENT, Abilities.GLUTTONY, 318, 65, 43, 70, 50, 65, 25, 150, 70, 65, GrowthRate.MEDIUM_SLOW, 75.0, false),
    new PokemonSpecies(Species.MANATORQUE, 11, false, false, false, "Plump Pokemon", Type.WATER, Type.ICE, 1.4, 150.6, Abilities.WATER_VEIL, Abilities.TORRENT, Abilities.GLUTTONY, 431, 90, 56, 90, 70, 85, 40, 90, 70, 132, GrowthRate.MEDIUM_SLOW, 75.0, false),
    new PokemonSpecies(Species.MANATANK, 11, false, false, false, "Beachmaster Pokemon", Type.WATER, Type.ICE, 2.8, 300.0, Abilities.PURE_POWER, Abilities.TORRENT, Abilities.GLUTTONY, 552, 110, 60, 120, 85, 127, 50, 45, 70, 187, GrowthRate.MEDIUM_SLOW, 75.0, false),
    new PokemonSpecies(Species.ANONYMOUSE, 11, false, false, false, "Atheist Pokemon", Type.DARK, Type.ELECTRIC, 0.4, 3.9, Abilities.INFILTRATOR, Abilities.ELECTRIC_SURGE, Abilities.TELEPATHY, 476, 66, 86, 66, 86, 66, 106, 45, 35, 100, GrowthRate.FLUCTUATING, 75.0, false),
    new PokemonSpecies(Species.MOTHERFUCK, 11, false, false, false, "Annoyance Pokemon", Type.GROUND, Type.FLYING, 1.4, 106.5, Abilities.SHADOW_TAG, Abilities.INVERSION, Abilities.AFTERMATH, 500, 55, 95, 115, 45, 100, 90, 15, 0, 5, GrowthRate.FLUCTUATING, 50.0, false),
    new PokemonSpecies(Species.NINOOP, 11, false, false, false, "Cherub Pokemon", Type.NORMAL, null, 0.5, 10.0, Abilities.HUGE_POWER, Abilities.CUTE_CHARM, Abilities.NATURAL_CURE, 325, 60, 40, 55, 70, 60, 40, 45, 100, 75, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.DRACONIUS, 11, false, false, false, "GreatDragon Pokemon", Type.NORMAL, Type.DRAGON, 2.4, 454.0, Abilities.HUGE_POWER, Abilities.INTIMIDATE, Abilities.NATURAL_CURE, 555, 130, 65, 100, 110, 90, 60, 30, 70, 215, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.TICKTAC, 11, false, false, false, "Steel Ball Pokemon", Type.BUG, Type.STEEL, 0.3, 33.0, Abilities.COMPOUND_EYES, Abilities.HYPER_CUTTER, Abilities.INFILTRATOR, 355, 65, 55, 75, 50, 65, 45, 75, 70, 72, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.EARETICLE, 11, false, false, false, "Parasite Pokemon", Type.BUG, Type.STEEL, 0.2, 0.8, Abilities.COMPOUND_EYES, Abilities.HYPER_CUTTER, Abilities.INFILTRATOR, 405, 70, 80, 65, 55, 60, 75, 60, 70, 160, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.SCYTHEAR, 11, false, false, false, "Brood Pokemon", Type.BUG, Type.STEEL, 2.1, 79.0, Abilities.COMPOUND_EYES, Abilities.HYPER_CUTTER, Abilities.INFILTRATOR, 550, 85, 135, 85, 60, 70, 115, 45, 70, 220, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.COZLOAD, 11, false, false, false, "Comfy Virus Pokemon", Type.ELECTRIC, Type.BUG, 0.2, 1.3, Abilities.DOWNLOAD, Abilities.THICK_FAT, Abilities.SIMPLE, 345, 60, 65, 75, 40, 50, 55, 100, 70, 100, GrowthRate.MEDIUM_SLOW, null, false),
    new PokemonSpecies(Species.SNUGWARE, 11, false, false, false, "Comfy Virus Pokemon", Type.ELECTRIC, Type.BUG, 1.1, 22.5, Abilities.DOWNLOAD, Abilities.THICK_FAT, Abilities.FILTER, 545, 100, 105, 110, 75, 80, 75, 60, 70, 205, GrowthRate.MEDIUM_SLOW, null, false),
    new PokemonSpecies(Species.FLEESPECS, 11, false, false, false, "Comfy Virus Pokemon", Type.ELECTRIC, Type.BUG, 1.1, 19.0, Abilities.DOWNLOAD, Abilities.MOTOR_DRIVE, Abilities.ANALYTIC, 545, 100, 75, 75, 105, 80, 110, 60, 70, 205, GrowthRate.MEDIUM_SLOW, null, false),
    new PokemonSpecies(Species.HONRADE, 11, false, false, false, "Sword Pokemon", Type.FAIRY, Type.FIGHTING, 1.0, 28.0, Abilities.BLADEMASTER, Abilities.JUSTIFIED, Abilities.HYPER_CUTTER, 490, 80, 130, 70, 45, 75, 90, 75, 70, 110, GrowthRate.MEDIUM_FAST, 75.0, false),
    new PokemonSpecies(Species.EMBORTION, 11, false, false, false, "Babby Pokemon", Type.DARK, Type.GHOST, 0.5, 6.6, Abilities.PRESSURE, Abilities.INSOMNIA, Abilities.UNNERVE, 395, 50, 45, 90, 50, 105, 55, 90, 35, 123, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.PREMANTOM, 11, false, false, false, "Fetus Pokemon", Type.DARK, Type.GHOST, 1.3, 31.0, Abilities.PRESSURE, Abilities.INSOMNIA, Abilities.UNNERVE, 555, 80, 75, 110, 85, 120, 85, 45, 35, 214, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.GALAVIK, 11, false, false, false, "Mercury Pokemon", Type.STEEL, null, 0.9, 30.0, Abilities.LIQUID_OOZE, Abilities.CLEAR_BODY, Abilities.CORROSION, 315, 65, 40, 70, 40, 65, 35, 100, 35, 125, GrowthRate.MEDIUM_SLOW, null, false),
    new PokemonSpecies(Species.GALAVIRE, 11, false, false, false, "Generator Pokemon", Type.STEEL, Type.ELECTRIC, 2.3, 105.5, Abilities.LEVITATE, Abilities.TERAVOLT, Abilities.LIGHT_METAL, 550, 70, 60, 95, 130, 90, 105, 65, 35, 201, GrowthRate.MEDIUM_SLOW, null, false),
    new PokemonSpecies(Species.GALAVISTE, 11, false, false, false, "Piston Pokemon", Type.STEEL, Type.FIGHTING, 2.8, 345.0, Abilities.INTIMIDATE, Abilities.METAL_BODY, Abilities.HEAVY_METAL, 550, 110, 130, 95, 60, 90, 65, 65, 35, 201, GrowthRate.MEDIUM_SLOW, null, false),
    new PokemonSpecies(Species.POLLEFIN, 11, false, false, false, "Kelp Pokemon", Type.WATER, Type.GRASS, 0.6, 9.0, Abilities.EFFECT_SPORE, Abilities.FLOWER_VEIL, Abilities.SHIELD_DUST, 240, 30, 20, 20, 40, 50, 80, 255, 100, 69, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.FLORIGRACE, 11, false, false, false, "Kelp Pokemon", Type.WATER, Type.GRASS, 0.9, 22.6, Abilities.EFFECT_SPORE, Abilities.FLOWER_VEIL, Abilities.SHIELD_DUST, 490, 105, 50, 70, 90, 90, 85, 125, 100, 169, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.LASSLEE, 11, false, false, false, "Innocence Pokemon", Type.PSYCHIC, null, 0.8, 9.4, Abilities.SYNCHRONIZE, Abilities.CUTE_CHARM, Abilities.INFILTRATOR, 365, 70, 40, 70, 80, 75, 30, 100, 0, 68, GrowthRate.MEDIUM_FAST, 87.5, false),
    new PokemonSpecies(Species.WIFEMIN, 11, false, false, false, "Devotion Pokemon", Type.PSYCHIC, null, 1.6, 49.6, Abilities.SYNCHRONIZE, Abilities.CUTE_CHARM, Abilities.INFILTRATOR, 535, 110, 60, 110, 90, 115, 50, 45, 100, 168, GrowthRate.MEDIUM_FAST, 87.5, false),
    new PokemonSpecies(Species.UWOTTO, 11, false, false, false, "Xeno Pokemon", Type.PSYCHIC, Type.STEEL, 1.6, 84.5, Abilities.COMPOUND_EYES, Abilities.INTIMIDATE, Abilities.HEAVY_METAL, 565, 80, 110, 105, 90, 100, 80, 45, 35, 151, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.VENOWATT, 11, false, false, false, "Watt Pokemon", Type.ELECTRIC, Type.POISON, 1.7, 51.5, Abilities.ILLUMINATE, Abilities.ILLUMINATE, Abilities.SWARM, 540, 85, 60, 115, 110, 95, 75, 45, 70, 190, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.VAULTEVOUR, 11, false, false, false, "Vault Pokemon", Type.STEEL, Type.DARK, 1.4, 250.0, Abilities.STRONG_JAW, Abilities.JEWELRY, Abilities.PICKUP, 525, 80, 140, 105, 50, 110, 40, 45, 70, 196, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.SEMDEMEN, 11, false, false, false, "Semen Demon Pokemon", Type.WATER, Type.GROUND, 1.6, 90.5, Abilities.INSOMNIA, Abilities.IMMUNITY, Abilities.DAMP, 555, 130, 90, 85, 90, 100, 60, 45, 70, 189, GrowthRate.MEDIUM_FAST, 87.5, false),
    new PokemonSpecies(Species.DRAGKING, 11, false, false, false, "Drag Pokemon", Type.FAIRY, null, 1.7, 95.0, Abilities.OBLIVIOUS, Abilities.SERENE_GRACE, Abilities.POZZED, 519, 69, 110, 75, 80, 70, 115, 60, 70, 172, GrowthRate.MEDIUM_FAST, 100.0, false),
    new PokemonSpecies(Species.KUUROBA, 11, false, false, false, "Big Gains Pokemon", Type.GRASS, Type.FIGHTING, 1.9, 102.0, Abilities.HUGE_POWER, Abilities.HUGE_POWER, Abilities.SUPER_LUCK, 530, 90, 105, 90, 80, 90, 75, 75, 70, 164, GrowthRate.MEDIUM_FAST, 25.0, false),
    new PokemonSpecies(Species.BAITMASTER, 11, false, false, false, "Master Hook Pokemon", Type.WATER, Type.FAIRY, 2.0, 80.5, Abilities.REGENERATOR, Abilities.COMPETITIVE, Abilities.DAZZLING, 527, 85, 69, 70, 105, 83, 115, 45, 70, 192, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.SPOOKSTER, 11, false, false, false, "Spooky Pokemon", Type.GHOST, null, 0.9, 1.0, Abilities.CURSED_BODY, Abilities.LEVITATE, Abilities.INSOMNIA, 300, 30, 80, 50, 30, 40, 70, 45, 35, 60, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.SPOOKEER, 11, false, false, false, "Scary Pokemon", Type.GHOST, null, 1.2, 7.0, Abilities.CURSED_BODY, Abilities.INTIMIDATE, Abilities.INSOMNIA, 420, 55, 105, 70, 40, 55, 95, 45, 35, 147, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.SPOOKZILLA, 11, false, false, false, "Skeleton Pokemon", Type.GHOST, null, 1.6, 15.5, Abilities.CURSED_BODY, Abilities.INTIMIDATE, Abilities.INSOMNIA, 600, 90, 137, 105, 73, 85, 110, 45, 35, 147, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.DERPATO, 11, false, false, false, "Confused Pokemon", Type.GROUND, null, 0.3, 1.2, Abilities.OBLIVIOUS, Abilities.KLUTZ, Abilities.UNAWARE, 275, 68, 52, 50, 45, 40, 20, 150, 35, 60, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.RETATER, 11, false, false, false, "Incoherent Pokemon", Type.GROUND, null, 0.8, 10.3, Abilities.OBLIVIOUS, Abilities.KLUTZ, Abilities.UNAWARE, 465, 85, 108, 92, 67, 63, 50, 90, 35, 147, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.POTARDED, 11, false, false, false, "Brute Pokemon", Type.GROUND, null, 1.2, 40.0, Abilities.OBLIVIOUS, Abilities.KLUTZ, Abilities.UNAWARE, 600, 110, 145, 116, 80, 79, 70, 45, 35, 218, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.SADFISH, 11, false, false, false, "Depression Pokemon", Type.WATER, null, 1.0, 18.0, Abilities.DRIZZLE, Abilities.DEFEATIST, Abilities.DEFEATIST, 435, 115, 60, 75, 70, 75, 40, 90, 0, 135, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.DELORIS, 11, false, false, false, "Mindfuck Pokemon", Type.GRASS, Type.GROUND, 2.4, 122.4, Abilities.OWN_TEMPO, Abilities.WONDER_SKIN, Abilities.TANGLING_HAIR, 515, 90, 90, 75, 90, 90, 80, 45, 70, 200, GrowthRate.MEDIUM_SLOW, 0, false),
    new PokemonSpecies(Species.OREON, 11, false, false, false, "Good Cookie Pokemon", Type.FAIRY, Type.DARK, 1.0, 27.0, Abilities.SUPER_LUCK, Abilities.SWEET_VEIL, Abilities.RUN_AWAY, 525, 95, 60, 65, 130, 65, 110, 45, 70, 200, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.FARFIGTRON, 11, false, false, false, "Fireball Pokemon", Type.FIRE, Type.FIGHTING, 2.6, 106.5, Abilities.NO_GUARD, Abilities.MOLD_BREAKER, Abilities.ANGER_POINT, 552, 80, 127, 73, 107, 63, 102, 45, 35, 200, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.REGIRODE, 11, true, false, false, "Fragmented Pokemon", Type.ROCK, Type.GHOST, 1.6, 148.3, Abilities.WEAK_ARMOR, Abilities.SHADOW_GUARD, Abilities.CURSED_BODY, 580, 80, 50, 75, 125, 150, 100, 3, 35, 255, GrowthRate.SLOW, null, false),
    new PokemonSpecies(Species.REGIMELT, 11, true, false, false, "Iceshard Pokemon", Type.ICE, Type.GHOST, 1.7, 86.3, Abilities.WEAK_ARMOR, Abilities.SHADOW_GUARD, Abilities.CURSED_BODY, 580, 80, 125, 150, 50, 75, 100, 3, 35, 255, GrowthRate.SLOW, null, false),
    new PokemonSpecies(Species.REGIRUST, 11, true, false, false, "Rust Pokemon", Type.STEEL, Type.GHOST, 1.8, 182.1, Abilities.WEAK_ARMOR, Abilities.SHADOW_GUARD, Abilities.CURSED_BODY, 580, 80, 85, 115, 85, 115, 100, 3, 35, 255, GrowthRate.SLOW, null, false),
    new PokemonSpecies(Species.JEWIPEDE, 11, false, true, false, "Dick Eater Pokemon", Type.BUG, Type.NORMAL, 21.0, 206.5, Abilities.PRESSURE, Abilities.JEWLERY, Abilities.PICKPOCKET, 680, 105, 90, 150, 90, 150, 95, 3, 35, 255, GrowthRate.SLOW, 100.0, false),
    new PokemonSpecies(Species.VIVAIGER, 11, false, true, false, "Ascension Pokemon", Type.ELECTRIC, null, 2.5, 650.0, Abilities.FLAME_BODY, Abilities.FLARE_HEAL, Abilities.REGENERATOR, 650, 95, 100, 105, 150, 100, 100, 3, 35, 255, GrowthRate.SLOW, null, false),
    new PokemonSpecies(Species.HELIOFUG, 11, false, true, false, "Fug Pokemon", Type.DRAGON, Type.FIRE, 7.0, 206.5, Abilities.DROUGHT, Abilities.DRIZZLE, Abilities.AIR_LOCK, 640, 85, 140, 90, 140, 90, 95, 3, 35, 255, GrowthRate.SLOW, null, false),
    new PokemonSpecies(Species.ADESIGN, 11, false, true, false, "A Pokemon", Type.NORMAL, null, 2.0, 0.5, Abilities.AN_ABILITY, Abilities.NONE, Abilities.ANY_ABILITY, 690, 115, 115, 115, 115, 115, 115, 3, 0, 1, GrowthRate.FLUCTUATING, null, false),
    new PokemonSpecies(Species.SADROG, 12, false, false, false, "Feel Pokemon", Type.GRASS, null, 0.5, 6.9, Abilities.OVERGROW, Abilities.NONE, Abilities.DEFEATIST, 318, 44, 55, 75, 40, 69, 35, 45, 70, 65, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.SMUGROK, 12, false, false, false, "Feel Pokemon", Type.GRASS, null, 0.9, 21.6, Abilities.OVERGROW, Abilities.NONE, Abilities.UNAWARE, 405, 75, 70, 90, 50, 75, 45, 45, 70, 142, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.PEPEREE, 12, false, false, false, "RAAAAAGE Pokemon", Type.GRASS, Type.ROCK, 1.7, 155.5, Abilities.OVERGROW, Abilities.NONE, Abilities.ANGER_POINT, 525, 100, 90, 120, 55, 95, 65, 45, 70, 208, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.HODTOG, 12, false, false, false, "Dog Pokemon", Type.FIRE, null, 0.6, 15.1, Abilities.BLAZE, Abilities.SKILL_LINK, Abilities.WONDER_SKIN, 318, 45, 55, 43, 60, 50, 65, 45, 70, 65, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.WIENEBARK, 12, false, false, false, "Dog Pokemon", Type.FIRE, null, 1.3, 46.5, Abilities.BLAZE, Abilities.SKILL_LINK, Abilities.WONDER_SKIN, 405, 60, 65, 55, 85, 60, 80, 45, 70, 142, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.SAUDOGE, 12, false, false, false, "Doge Pokemon", Type.FIRE, Type.FLYING, 3.2, 130.1, Abilities.BLAZE, Abilities.SKILL_LINK, Abilities.WONDER_SKIN, 525, 80, 80, 65, 120, 80, 100, 45, 70, 209, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.GNARRK, 12, false, false, false, "Seaman Pokemon", Type.WATER, null, 0.7, 21.2, Abilities.TORRENT, Abilities.MOLD_BREAKER, Abilities.DOWNLOAD, 318, 49, 70, 50, 45, 49, 55, 45, 70, 65, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.CORSHARRK, 12, false, false, false, "First Mate Pokemon", Type.WATER, null, 1.1, 30.0, Abilities.TORRENT, Abilities.MOLD_BREAKER, Abilities.DOWNLOAD, 405, 70, 80, 70, 55, 65, 65, 45, 70, 143, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.DAVYJAWS, 12, false, false, false, "Captain Pokemon", Type.WATER, Type.FIGHTING, 1.7, 140.0, Abilities.TORRENT, Abilities.MOLD_BREAKER, Abilities.DOWNLOAD, 525, 90, 120, 85, 65, 85, 80, 45, 70, 210, GrowthRate.MEDIUM_SLOW, 87.5, false),
    new PokemonSpecies(Species.HUMPUNNY, 12, false, false, false, "Bonding Pokemon", Type.NORMAL, null, 0.8, 11.1, Abilities.RUN_AWAY, Abilities.QUICK_FEET, Abilities.FUR_COAT, 274, 60, 43, 57, 29, 35, 50, 255, 70, 50, GrowthRate.FAST, 50.0, false),
    new PokemonSpecies(Species.BUNNORGY, 12, false, false, false, "Bonding Pokemon", Type.NORMAL, null, 2.2, 120.0, Abilities.HUSTLE, Abilities.SPEED_BOOST, Abilities.FUR_COAT, 434, 80, 73, 77, 45, 69, 90, 127, 70, 128, GrowthRate.FAST, 50.0, false),
    new PokemonSpecies(Species.EMELGY, 12, false, false, false, "Squeaker Pokemon", Type.NORMAL, Type.FLYING, 0.3, 7.5, Abilities.SNIPER, Abilities.KEEN_EYE, Abilities.COMPETITIVE, 250, 40, 45, 35, 40, 30, 60, 255, 35, 56, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.FEDORAWK, 12, false, false, false, "Gangster Pokemon", Type.NORMAL, Type.FLYING, 1.1, 24.5, Abilities.SNIPER, Abilities.KEEN_EYE, Abilities.COMPETITIVE, 365, 55, 65, 50, 60, 45, 90, 90, 35, 113, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.FAZEAGLE, 12, false, false, false, "Shots-Fired Pokemon", Type.FIRE, Type.FLYING, 1.7, 42.0, Abilities.SNIPER, Abilities.KEEN_EYE, Abilities.COMPETITIVE, 480, 75, 90, 60, 85, 60, 110, 120, 35, 172, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.CATIKILLAR, 12, false, false, false, "Tribal Pokemon", Type.BUG, null, 0.2, 0.9, Abilities.SHIELD_DUST, Abilities.OVERCOAT, Abilities.COMPOUND_EYES, 217, 30, 41, 50, 31, 40, 25, 255, 70, 53, GrowthRate.FAST, 50.0, false),
    new PokemonSpecies(Species.TIKOON, 12, false, false, false, "Tiki Pokemon", Type.BUG, null, 0.6, 9.0, Abilities.SHELL_ARMOR, Abilities.OVERCOAT, Abilities.COMPOUND_EYES, 331, 57, 42, 90, 32, 90, 20, 255, 70, 72, GrowthRate.FAST, 50.0, false),
    new PokemonSpecies(Species.OOGABUGA, 12, false, false, false, "Clicking Pokemon", Type.BUG, Type.GRASS, 1.2, 27.2, Abilities.INTIMIDATE, Abilities.WONDER_GUARD, Abilities.GRASSY_SURGE, 496, 77, 62, 110, 92, 90, 65, 40, 70, 170, GrowthRate.FAST, 50.0, false),
    new PokemonSpecies(Species.EBINING, 12, false, false, false, "Implication Pokemon", Type.DARK, null, 0.9, 10.0, Abilities.PRANKSTER, Abilities.DEFIANT, Abilities.CONTRARY, 350, 55, 80, 55, 55, 40, 65, 225, 35, 55, GrowthRate.FAST, 50.0, false),
    new PokemonSpecies(Species.EMPLYIN, 12, false, false, false, "Implication Pokemon", Type.DARK, null, 1.0, 31.5, Abilities.PRANKSTER, Abilities.DEFIANT, Abilities.CONTRARY, 470, 70, 117, 60, 75, 55, 93, 127, 35, 128, GrowthRate.FAST, 50.0, false),
    new PokemonSpecies(Species.UPBOTE, 12, false, false, false, "Lil Baby Pokemon", Type.PSYCHIC, null, 0.6, 8.0, Abilities.PLUS, Abilities.MINUS, Abilities.TRACE, 350, 81, 35, 41, 71, 82, 40, 225, 70, 55, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.UPBEDDIT, 12, false, false, false, "Big Baby Pokemon", Type.PSYCHIC, null, 1.1, 20.0, Abilities.PLUS, Abilities.MINUS, Abilities.TRACE, 470, 82, 50, 72, 92, 117, 57, 127, 70, 128, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.FLIPBIRD, 12, false, false, false, "Wimp Pokemon", Type.NORMAL, Type.FLYING, 0.3, 1.5, Abilities.DEFEATIST, Abilities.KEEN_EYE, Abilities.EARLY_BIRD, 237, 32, 40, 33, 30, 30, 72, 255, 70, 58, GrowthRate.MEDIUM_FAST, 75.0, false),
    new PokemonSpecies(Species.WHEYGLE, 12, false, false, false, "Jerk Pokemon", Type.FIGHTING, Type.FLYING, 1.5, 50.5, Abilities.BIG_PECKS, Abilities.NO_GUARD, Abilities.STEELWORKER, 487, 82, 125, 77, 45, 65, 93, 120, 70, 162, GrowthRate.MEDIUM_FAST, 75.0, false),
    new PokemonSpecies(Species.GANGNOME, 12, false, false, false, "Idol Pokemon", Type.FAIRY, null, 1.3, 22.5, Abilities.SOUNDPROOF, Abilities.CONCERT, Abilities.TANGLED_FEET, 505, 120, 50, 115, 55, 125, 40, 150, 70, 146, GrowthRate.ERRATIC, 75.0, false),
    new PokemonSpecies(Species.PYONGNOME, 12, false, false, false, "Arsenal Pokemon", Type.STEEL, null, 1.0, 22.5, Abilities.INTIMIDATE, Abilities.NO_GUARD, Abilities.BULLETPROOF, 505, 70, 135, 60, 115, 45, 80, 150, 0, 99, GrowthRate.ERRATIC, 50.0, false),
    new PokemonSpecies(Species.BRUHKID, 12, false, false, false, "PunchingBag Pokemon", Type.GROUND, Type.FIGHTING, 0.7, 21.5, Abilities.STAMINA, Abilities.STURDY, Abilities.SAND_FORCE, 335, 70, 60, 70, 40, 60, 35, 150, 70, 101, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.UBRUH, 12, false, false, false, "Coach Pokemon", Type.GROUND, Type.FIGHTING, 2.0, 90.0, Abilities.STAMINA, Abilities.STURDY, Abilities.SAND_FORCE, 515, 110, 100, 120, 55, 80, 50, 45, 70, 202, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.WALRUSE, 12, false, false, false, "Ruskie Pokemon", Type.WATER, null, 1.1, 90.0, Abilities.HYDRATION, Abilities.SLUSH_RUSH, Abilities.DEFIANT, 308, 60, 65, 43, 50, 40, 50, 120, 70, 88, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.WALRUSKIE, 12, false, false, false, "Ruskie Pokemon", Type.WATER, null, 1.3, 150.6, Abilities.HYDRATION, Abilities.SLUSH_RUSH, Abilities.DEFIANT, 508, 120, 95, 83, 60, 70, 80, 45, 35, 176, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.DIOBAT, 12, false, false, false, "Trickster Pokemon", Type.DARK, Type.FLYING, 0.5, 8.0, Abilities.REGENERATOR, Abilities.FRISK, Abilities.FOREWARN, 370, 50, 75, 45, 65, 45, 90, 190, 0, 49, GrowthRate.MEDIUM_FAST, 75.0, false),
    new PokemonSpecies(Species.WARUDIO, 12, false, false, false, "The World Pokemon", Type.DARK, Type.FIGHTING, 1.9, 105.0, Abilities.REGENERATOR, Abilities.FRISK, Abilities.FOREWARN, 550, 80, 105, 80, 85, 80, 120, 45, 0, 186, GrowthRate.MEDIUM_FAST, 75.0, false),
    new PokemonSpecies(Species.DOCEE, 12, false, false, false, "Original Pokemon", Type.STEEL, null, 0.4, 0.5, Abilities.TRACE, Abilities.COLOR_CHANGE, Abilities.METAL_BODY, 340, 37, 60, 73, 20, 65, 85, 127, 70, 88, GrowthRate.FLUCTUATING, null, false),
    new PokemonSpecies(Species.DONUTSTEEL, 12, false, false, false, "Original Pokemon", Type.STEEL, null, 1.0, 35.0, Abilities.TRACE, Abilities.COLOR_CHANGE, Abilities.METAL_BODY, 505, 67, 80, 113, 48, 85, 112, 45, 70, 175, GrowthRate.FLUCTUATING, null, false),
    new PokemonSpecies(Species.CAKUPPLE, 12, false, false, false, "Cake Pokemon", Type.GRASS, Type.FAIRY, 0.3, 2.0, Abilities.SWEET_VEIL, Abilities.AROMA_VEIL, Abilities.CUTE_CHARM, 320, 59, 75, 40, 45, 70, 31, 200, 140, 88, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.FONDUPPLE, 12, false, false, false, "Bad Cake Pokemon", Type.GRASS, Type.FAIRY, 1.1, 20.4, Abilities.SWEET_VEIL, Abilities.AROMA_VEIL, Abilities.INTIMIDATE, 505, 89, 115, 90, 50, 110, 51, 55, 0, 175, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.BALOOFANG, 12, false, false, false, "Dangerous Pokemon", Type.GHOST, null, 1.5, 9.0, Abilities.AFTERMATH, Abilities.UNAWARE, Abilities.SHEER_FORCE, 495, 100, 61, 85, 80, 105, 64, 60, 35, 117, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.SOCCKAT, 12, false, false, false, "Gaucho Pokemon", Type.NORMAL, Type.FIGHTING, 1.0, 32.0, Abilities.QUICK_FEET, Abilities.STRIKER, Abilities.UNBURDEN, 495, 80, 105, 75, 55, 65, 115, 60, 70, 117, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.EGYLAMP, 12, false, false, false, "Magic Lamp Pokemon", Type.PSYCHIC, Type.FIRE, 0.3, 4.5, Abilities.FLAME_BODY, Abilities.SYNCHRONIZE, Abilities.DAZZLING, 330, 50, 40, 60, 70, 60, 50, 90, 70, 58, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.RUSELAMP, 12, false, false, false, "Electro Lamp Pokemon", Type.PSYCHIC, Type.ELECTRIC, 1.0, 22.5, Abilities.ILLUMINATE, Abilities.SYNCHRONIZE, Abilities.DAZZLING, 525, 70, 50, 80, 145, 90, 90, 90, 70, 189, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.MEHNDIOR, 12, false, false, false, "Meteor Pokemon", Type.FIRE, Type.ROCK, 1.2, 52.0, Abilities.SPEED_BOOST, Abilities.TELEPATHY, Abilities.COMPETITIVE, 345, 80, 60, 65, 25, 65, 50, 45, 70, 70, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.TUNAKKING, 12, false, false, false, "Genie Pokemon", Type.FIRE, Type.PSYCHIC, 1.5, 65.0, Abilities.LEVITATE, Abilities.TELEPATHY, Abilities.COMPETITIVE, 525, 80, 48, 80, 111, 85, 121, 45, 70, 170, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.MISSLETOE, 12, false, false, false, "Jolly Pokemon", Type.ICE, null, 0.6, 12.0, Abilities.LEVITATE, Abilities.SNIPER, Abilities.TECHNICIAN, 297, 41, 10, 40, 85, 50, 71, 190, 70, 78, GrowthRate.FAST, 50.0, false),
    new PokemonSpecies(Species.HOHOHOMING, 12, false, false, false, "Jolly Pokemon", Type.ICE, null, 1.5, 118.0, Abilities.LEVITATE, Abilities.SNIPER, Abilities.TECHNICIAN, 490, 81, 40, 71, 126, 81, 91, 70, 70, 188, GrowthRate.FAST, 50.0, false),
    new PokemonSpecies(Species.FLAA, 12, false, false, false, "Rider Pokemon", Type.BUG, null, 0.7, 12.5, Abilities.RUN_AWAY, Abilities.PICKUP, Abilities.JUSTIFIED, 345, 40, 55, 70, 35, 60, 85, 140, 70, 65, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.HOPAULT, 12, false, false, false, "Rider Pokemon", Type.BUG, Type.FIGHTING, 1.9, 90.0, Abilities.RECKLESS, Abilities.GUTS, Abilities.JUSTIFIED, 510, 70, 115, 80, 60, 70, 115, 180, 70, 165, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.ARAKETSU, 12, false, false, false, "Scissors Pokemon", Type.BUG, Type.DARK, 0.6, 15.0, Abilities.HYPER_CUTTER, Abilities.INTIMIDATE, Abilities.BLADEMASTER, 300, 60, 60, 60, 30, 60, 30, 140, 35, 65, GrowthRate.MEDIUM_FAST, 25.0, false),
    new PokemonSpecies(Species.SENKETULA, 12, false, false, false, "Scissors Pokemon", Type.BUG, Type.DARK, 1.2, 30.0, Abilities.HYPER_CUTTER, Abilities.INTIMIDATE, Abilities.BLADEMASTER, 510, 100, 100, 100, 55, 100, 55, 70, 35, 165, GrowthRate.MEDIUM_FAST, 25.0, false),
    new PokemonSpecies(Species.FALCAPTAIN, 12, false, false, false, "F-Zero Pokemon", Type.FIGHTING, Type.FLYING, 1.9, 77.1, Abilities.BIG_PECKS, Abilities.IRON_FIST, Abilities.GUTS, 495, 60, 115, 55, 85, 50, 130, 45, 70, 145, GrowthRate.MEDIUM_FAST, 100.0, false),
    new PokemonSpecies(Species.CIRPENT, 12, false, false, false, "Clown Pokemon", Type.POISON, Type.FAIRY, 0.3, 4.5, Abilities.PRANKSTER, Abilities.MAGIC_BOUNCE, Abilities.UNNERVE, 366, 51, 51, 61, 71, 51, 81, 80, 35, 66, GrowthRate.FAST, 50.0, false),
    new PokemonSpecies(Species.TRAUMOBRA, 12, false, false, false, "It Pokemon", Type.POISON, Type.FAIRY, 1.5, 9.0, Abilities.PRANKSTER, Abilities.MAGIC_BOUNCE, Abilities.UNNERVE, 526, 71, 71, 91, 101, 81, 111, 60, 35, 166, GrowthRate.FAST, 50.0, false),
    new PokemonSpecies(Species.LIZASCOOP, 12, false, false, false, "Mechanical Pokemon", Type.GROUND, Type.STEEL, 0.8, 33.0, Abilities.STRONG_JAW, Abilities.SHEER_FORCE, Abilities.BATTLE_ARMOR, 290, 55, 70, 70, 30, 40, 25, 60, 70, 75, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.REPTRILL, 12, false, false, false, "Mechanical Pokemon", Type.GROUND, Type.STEEL, 1.3, 56.0, Abilities.STRONG_JAW, Abilities.SHEER_FORCE, Abilities.BATTLE_ARMOR, 490, 85, 120, 105, 50, 80, 50, 60, 70, 169, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.FEFEION, 12, false, false, false, "Scorpion Pokemon", Type.BUG, Type.GROUND, 0.6, 20.5, Abilities.HEATPROOF, Abilities.SAND_VEIL, Abilities.FLARE_BOOST, 370, 65, 55, 60, 85, 50, 55, 200, 70, 55, GrowthRate.FAST, 25.0, false),
    new PokemonSpecies(Species.FEFERUN, 12, false, false, false, "Scorpion Pokemon", Type.BUG, Type.GROUND, 1.8, 79.2, Abilities.FLASH_FIRE, Abilities.SAND_FORCE, Abilities.FLARE_BOOST, 530, 80, 75, 100, 125, 80, 70, 45, 70, 205, GrowthRate.FAST, 25.0, false),
    new PokemonSpecies(Species.JERKLE, 12, false, false, false, "Dream Pokemon", Type.ROCK, Type.PSYCHIC, 0.7, 75.0, Abilities.AFTERMATH, Abilities.STICKY_HOLD, Abilities.GOOEY, 479, 94, 30, 90, 130, 70, 65, 45, 70, 169, GrowthRate.MEDIUM_SLOW, null, false),
    new PokemonSpecies(Species.FAPTIME, 12, false, false, false, "Session Pokemon", Type.ROCK, Type.PSYCHIC, 1.5, 71.0, Abilities.SPEED_BOOST, Abilities.OWN_TEMPO, Abilities.STICKY_HOLD, 479, 80, 120, 90, 30, 90, 69, 45, 70, 169, GrowthRate.MEDIUM_SLOW, null, false),
    new PokemonSpecies(Species.SHIRIMAN, 12, false, false, false, "Brown Eye Pokemon", Type.PSYCHIC, Type.FAIRY, 0.9, 31.6, Abilities.PRANKSTER, Abilities.KEEN_EYE, Abilities.INTIMIDATE, 519, 109, 88, 87, 86, 85, 64, 10, 70, 146, GrowthRate.ERRATIC, 50.0, false),
    new PokemonSpecies(Species.FRESRYE, 12, false, false, false, "New Bread Pokemon", Type.GRASS, null, 0.3, 0.9, Abilities.TRUANT, Abilities.CLOUD_NINE, Abilities.FOREWARN, 220, 30, 35, 20, 35, 20, 80, 255, 35, 25, GrowthRate.FLUCTUATING, null, false),
    new PokemonSpecies(Species.DEDWHEAT, 12, false, false, false, "Zombie Pokemon", Type.GRASS, Type.POISON, 1.5, 9.0, Abilities.TRUANT, Abilities.EFFECT_SPORE, Abilities.MOLD_BREAKER, 500, 190, 55, 60, 85, 60, 50, 120, 0, 90, GrowthRate.FLUCTUATING, null, false),
    new PokemonSpecies(Species.NUTJOBBER, 12, false, false, false, "Nuts Pokemon", Type.GHOST, Type.FAIRY, 1.0, 27.2, Abilities.MADMAN, Abilities.STRONG_JAW, Abilities.SHELL_ARMOR, 345, 75, 60, 85, 30, 75, 20, 150, 35, 45, GrowthRate.FAST, 50.0, false),
    new PokemonSpecies(Species.DEISNUTZ, 12, false, false, false, "Goteem Pokemon", Type.GHOST, Type.FAIRY, 1.5, 27.2, Abilities.MADMAN, Abilities.STRONG_JAW, Abilities.SHELL_ARMOR, 500, 80, 90, 110, 90, 90, 40, 45, 35, 102, GrowthRate.FAST, 50.0, false),
    new PokemonSpecies(Species.SPARGLE, 12, false, false, false, "Bear Pokemon", Type.FAIRY, null, 1.0, 40.5, Abilities.VITAL_SPIRIT, Abilities.INSOMNIA, Abilities.UNNERVE, 325, 60, 55, 50, 50, 50, 60, 230, 70, 69, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.SPEDO, 12, false, false, false, "Bear Pokemon", Type.FAIRY, null, 2.1, 156.5, Abilities.ARENA_TRAP, Abilities.SHEER_FORCE, Abilities.UNNERVE, 520, 105, 100, 70, 95, 70, 80, 120, 70, 169, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.HOUSANT, 12, false, false, false, "House Pokemon", Type.BUG, Type.ROCK, 0.2, 1.5, Abilities.MORE_ROOM, Abilities.SHELL_ARMOR, Abilities.UNBURDEN, 330, 60, 70, 80, 30, 40, 50, 150, 70, 65, GrowthRate.ERRATIC, 50.0, false),
    new PokemonSpecies(Species.APARTMANT, 12, false, false, false, "Apartment Pokemon", Type.BUG, Type.ROCK, 0.3, 4.5, Abilities.MORE_ROOM, Abilities.SHELL_ARMOR, Abilities.UNBURDEN, 500, 90, 110, 120, 50, 60, 70, 85, 70, 166, GrowthRate.ERRATIC, 50.0, false),
    new PokemonSpecies(Species.FUERMIGA, 12, false, false, false, "Cheese Bug Pokemon", Type.BUG, Type.FIRE, 0.6, 33.0, Abilities.COMPOUND_EYES, Abilities.GOOEY, Abilities.AROMA_VEIL, 305, 30, 75, 20, 65, 30, 85, 60, 70, 55, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.MARIPYRO, 12, false, false, false, "Cheese Bug Pokemon", Type.BUG, Type.FIRE, 3.2, 92.0, Abilities.MAGIC_GUARD, Abilities.GOOEY, Abilities.AROMA_VEIL, 540, 80, 125, 75, 75, 90, 95, 25, 70, 210, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.CONFIRMABI, 12, false, false, false, "Confirmed Pokemon", Type.GRASS, Type.PSYCHIC, 0.6, 5.0, Abilities.QUICK_FEET, Abilities.DAZZLING, Abilities.CHLOROPHYLL, 510, 80, 60, 70, 95, 70, 135, 120, 70, 251, GrowthRate.FAST, null, false),
    new PokemonSpecies(Species.BULBAPEDO, 12, false, false, false, "Leech Pokemon", Type.GRASS, Type.POISON, 0.7, 25.0, Abilities.RIVALRY, Abilities.ANALYTIC, Abilities.FRISK, 510, 145, 75, 90, 70, 90, 40, 200, 70, 100, GrowthRate.SLOW, 87.5, false),
    new PokemonSpecies(Species.WASTENAUT, 12, false, false, false, "Garbage Pokemon", Type.STEEL, Type.POISON, 1.0, 60.0, Abilities.BATTLE_ARMOR, Abilities.IRON_BARBS, Abilities.STENCH, 320, 70, 80, 50, 20, 80, 20, 180, 70, 72, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.WANTNAUT, 12, false, false, false, "Trash Pokemon", Type.STEEL, Type.POISON, 1.9, 392.0, Abilities.BATTLE_ARMOR, Abilities.IRON_BARBS, Abilities.STENCH, 515, 100, 125, 90, 30, 120, 50, 100, 70, 196, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.CANSUMOR, 12, false, false, false, "Cancer Pokemon", Type.POISON, null, 1.0, 27.2, Abilities.LIQUID_OOZE, Abilities.CORROSION, Abilities.SHED_SKIN, 495, 135, 80, 90, 65, 90, 35, 45, 35, 140, GrowthRate.ERRATIC, 50.0, false),
    new PokemonSpecies(Species.SNUFFANT, 12, false, false, false, "Powder Pokemon", Type.ICE, null, 1.0, 58.5, Abilities.SNOW_CLOAK, Abilities.SLUSH_RUSH, Abilities.OVERCOAT, 310, 70, 85, 35, 60, 40, 20, 150, 70, 65, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.COKEMMOTH, 12, false, false, false, "Addict Pokemon", Type.ICE, null, 2.0, 120.0, Abilities.SPEED_BOOST, Abilities.SLUSH_RUSH, Abilities.OVERCOAT, 530, 105, 110, 75, 115, 80, 45, 60, 70, 162, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.GRIMDAK, 12, false, false, false, "Emo Pokemon", Type.DARK, Type.STEEL, 1.7, 90.7, Abilities.MOODY, Abilities.CURSED_BODY, Abilities.SOUL_HEART, 525, 70, 115, 70, 110, 70, 90, 85, 35, 174, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.SHROOFLE, 12, false, false, false, "Truffle Pokemon", Type.DARK, null, 0.6, 0.9, Abilities.IMMUNITY, Abilities.POISON_HEAL, Abilities.TOXIC_BOOST, 476, 101, 76, 101, 56, 92, 50, 85, 35, 185, GrowthRate.FAST, 50.0, false),
    new PokemonSpecies(Species.BETACLUCK, 12, false, false, false, "Beta Pokemon", Type.ELECTRIC, Type.FLYING, 0.3, 1.7, Abilities.TECHNICIAN, Abilities.RATTLED, Abilities.RUN_AWAY, 285, 50, 20, 50, 75, 50, 40, 200, 35, 55, GrowthRate.MEDIUM_FAST, 100.0, false),
    new PokemonSpecies(Species.THUNDACOCK, 12, false, false, false, "Chad Pokemon", Type.ELECTRIC, Type.FLYING, 1.9, 97.5, Abilities.ADAPTABILITY, Abilities.GUTS, Abilities.MOLD_BREAKER, 530, 70, 115, 80, 80, 70, 115, 70, 35, 180, GrowthRate.MEDIUM_FAST, 100.0, false),
    new PokemonSpecies(Species.TWINFOWL, 12, false, false, false, "Twin Birds Pokemon", Type.STEEL, Type.FLYING, 3.0, 413.2, Abilities.BIG_PECKS, Abilities.FLARE_HEAL, Abilities.WEAK_ARMOR, 285, 40, 75, 40, 20, 40, 70, 200, 35, 55, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.AVIANJOIN, 12, false, false, false, "Twin Birds Pokemon", Type.STEEL, Type.FLYING, 9.1, 911.0, Abilities.HEATPROOF, Abilities.FLARE_HEAL, Abilities.WEAK_ARMOR, 530, 100, 135, 70, 80, 70, 75, 70, 35, 180, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.ILLUMINOWL, 12, false, false, false, "Triforce Pokemon", Type.PSYCHIC, Type.FLYING, 1.8, 15.0, Abilities.ILLUMINATE, Abilities.FOREWARN, Abilities.ANALYTIC, 378, 62, 30, 65, 93, 70, 58, 45, 35, 72, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.ILLUMATRIX, 12, false, false, false, "Triforce Pokemon", Type.PSYCHIC, Type.FLYING, 2.8, 28.0, Abilities.ILLUMINATE, Abilities.FOREWARN, Abilities.ANALYTIC, 555, 90, 43, 90, 133, 95, 104, 25, 35, 222, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.TYPOBOP, 12, false, false, false, "Bop Pokemon", Type.ROCK, Type.DARK, 0.3, 4.5, Abilities.SHEER_FORCE, Abilities.RUN_AWAY, Abilities.RATTLED, 345, 50, 81, 74, 40, 40, 60, 45, 70, 74, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.YEEREX, 12, false, false, false, "Yee Pokemon", Type.ROCK, Type.DARK, 1.5, 190.0, Abilities.SHEER_FORCE, Abilities.INTIMIDATE, Abilities.MOXIE, 521, 81, 130, 90, 60, 70, 90, 45, 70, 182, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.RANDOMIX, 12, false, false, false, "Twitch Pokemon", Type.ROCK, Type.WATER, 0.4, 7.5, Abilities.REGENERATOR, Abilities.SHELL_ARMOR, Abilities.RATTLED, 345, 51, 52, 95, 64, 58, 25, 45, 0, 64, GrowthRate.MEDIUM_FAST, 75.0, false),
    new PokemonSpecies(Species.CTHULLORD, 12, false, false, false, "Dark Lord Pokemon", Type.ROCK, Type.WATER, 2.1, 226.8, Abilities.REGENERATOR, Abilities.SHELL_ARMOR, Abilities.PRESSURE, 521, 110, 101, 90, 95, 70, 55, 45, 0, 192, GrowthRate.MEDIUM_FAST, 75.0, false),
    new PokemonSpecies(Species.QUIBOOM, 12, false, false, false, "Pussy Bomb Pokemon", Type.WATER, null, 0.7, 10.9, Abilities.AFTERMATH, Abilities.STORM_DRAIN, Abilities.DAMP, 321, 49, 54, 45, 54, 45, 74, 200, 70, 60, GrowthRate.FAST, 50.0, false),
    new PokemonSpecies(Species.GYNUKE, 12, false, false, false, "Nuke Cooch Pokemon", Type.WATER, Type.FIRE, 2.3, 84.3, Abilities.AFTERMATH, Abilities.STORM_DRAIN, Abilities.DAMP, 521, 79, 94, 65, 94, 65, 124, 45, 70, 190, GrowthRate.FAST, 50.0, false),
    new PokemonSpecies(Species.RAINGLOCK, 12, false, false, false, "Water Gun Pokemon", Type.WATER, null, 0.5, 0.7, Abilities.RAIN_DISH, Abilities.MEGA_LAUNCHER, Abilities.SNIPER, 490, 70, 70, 70, 140, 70, 70, 60, 35, 171, GrowthRate.MEDIUM_SLOW, null, false),
    new PokemonSpecies(Species.BEATMARINE, 12, false, false, false, "Submarine Pokemon", Type.WATER, Type.ELECTRIC, 0.5, 32.5, Abilities.LIQUID_VOICE, Abilities.STORM_DRAIN, Abilities.GALVANIZE, 310, 80, 40, 70, 30, 40, 50, 80, 70, 54, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.SUBSTARR, 12, false, false, false, "Submarine Pokemon", Type.WATER, Type.ELECTRIC, 1.7, 81.5, Abilities.LIQUID_VOICE, Abilities.STORM_DRAIN, Abilities.GALVANIZE, 485, 120, 60, 90, 65, 70, 80, 60, 70, 170, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.HOFUCNO, 12, false, false, false, "Obnoxious Pokemon", Type.WATER, Type.FLYING, 0.4, 1.8, Abilities.SHADOW_TAG, Abilities.SOUNDPROOF, Abilities.AFTERMATH, 500, 50, 40, 95, 90, 110, 115, 15, 0, 5, GrowthRate.FLUCTUATING, 50.0, false),
    new PokemonSpecies(Species.HORNIGIRI, 12, false, false, false, "Lewd Pokemon", Type.ICE, null, 0.6, 12.0, Abilities.ICE_BODY, Abilities.CLEAR_BODY, Abilities.INFILTRATOR, 335, 50, 65, 75, 30, 50, 65, 169, 70, 69, GrowthRate.MEDIUM_FAST, 25.0, false),
    new PokemonSpecies(Species.HORNICIER, 12, false, false, false, "Lust Pokemon", Type.ICE, null, 1.1, 31.7, Abilities.ICE_BODY, Abilities.CLEAR_BODY, Abilities.INFILTRATOR, 435, 70, 90, 100, 40, 75, 60, 69, 70, 126, GrowthRate.MEDIUM_FAST, 25.0, false),
    new PokemonSpecies(Species.HORNITITAN, 12, false, false, false, "Horny Pokemon", Type.ICE, Type.GROUND, 2.4, 250.5, Abilities.REFRIGERATE, Abilities.FILTER, Abilities.INFILTRATOR, 535, 90, 115, 130, 45, 100, 55, 30, 70, 209, GrowthRate.MEDIUM_FAST, 25.0, false),
    new PokemonSpecies(Species.PREASU, 12, false, false, false, "Excuse Pokemon", Type.ELECTRIC, null, 1.0, 29.5, Abilities.STATIC, Abilities.CURSED_BODY, Abilities.ANALYTIC, 327, 65, 50, 55, 50, 60, 47, 90, 35, 97, GrowthRate.FLUCTUATING, 50.0, false),
    new PokemonSpecies(Species.UNDASTAND, 12, false, false, false, "Excuse Pokemon", Type.ELECTRIC, null, 1.7, 80.0, Abilities.STATIC, Abilities.CURSED_BODY, Abilities.ANALYTIC, 548, 95, 100, 90, 110, 79, 74, 60, 35, 176, GrowthRate.FLUCTUATING, 50.0, false),
    new PokemonSpecies(Species.WARNEY, 12, false, false, false, "Janitor Pokemon", Type.NORMAL, null, 0.6, 25.5, Abilities.DAMP, Abilities.INTIMIDATE, Abilities.RATTLED, 345, 75, 50, 60, 60, 60, 40, 125, 70, 99, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.BANAGEDDON, 12, false, false, false, "Moderator Pokemon", Type.NORMAL, null, 2.0, 300.0, Abilities.ADMIN_ABUSE, Abilities.INTIMIDATE, Abilities.MOLD_BREAKER, 530, 90, 150, 80, 70, 80, 60, 60, 35, 200, GrowthRate.MEDIUM_SLOW, 50.0, false),
    //#ACUFRONT MISSING
    new PokemonSpecies(Species.MILITANT, 12, false, false, false, "Bullet Ant Pokemon", Type.BUG, Type.POISON, 0.0, 0.0, Abilities.STEELWORKER, Abilities.STRONG_JAW, Abilities.INFILTRATOR, 345, 20, 155, 15, 10, 15, 130, 10, 70, 128, GrowthRate.ERRATIC, 50.0, false),
    new PokemonSpecies(Species.SHIGGYDIG, 12, false, false, false, "Condescend Pokemon", Type.NORMAL, Type.GROUND, 1.0, 50.0, Abilities.DAMP, Abilities.LIMBER, Abilities.DEFIANT, 515, 95, 95, 130, 50, 85, 60, 45, 70, 140, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.SIGNOT, 12, false, false, false, "Signpost Pokemon", Type.GROUND, Type.DARK, 2.0, 6.9, Abilities.DRY_SKIN, Abilities.SAND_RUSH, Abilities.ARENA_TRAP, 305, 65, 35, 80, 40, 60, 25, 150, 35, 50, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.REAGAIN, 12, false, false, false, "Signpost Pokemon", Type.GROUND, Type.DARK, 3.5, 65.0, Abilities.DRY_SKIN, Abilities.SAND_RUSH, Abilities.ARENA_TRAP, 495, 100, 70, 110, 80, 90, 45, 60, 35, 175, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.ORMITE, 12, false, false, false, "Lightbulb Pokemon", Type.ROCK, Type.ELECTRIC, 0.3, 6.9, Abilities.JEWELRY, Abilities.LIGHTNING_ROD, Abilities.PROTEAN, 325, 70, 35, 45, 85, 70, 20, 45, 70, 54, GrowthRate.ERRATIC, null, false),
    new PokemonSpecies(Species.VIRISTAL, 12, false, false, false, "Lightbulb Pokemon", Type.ROCK, Type.ELECTRIC, 1.6, 102.0, Abilities.JEWELRY, Abilities.LIGHTNING_ROD, Abilities.PROTEAN, 501, 100, 50, 75, 136, 100, 40, 45, 70, 162, GrowthRate.ERRATIC, null, false),
    new PokemonSpecies(Species.ROLANGO, 12, false, false, false, "Dream Pokemon", Type.DRAGON, Type.FAIRY, 0.3, 5.5, Abilities.TRACE, Abilities.MULTISCALE, Abilities.NATURAL_CURE, 317, 72, 35, 72, 40, 80, 18, 75, 70, 89, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.DREAMEME, 12, false, false, false, "Dream Pokemon", Type.DRAGON, Type.FAIRY, 1.2, 65.5, Abilities.TRACE, Abilities.MULTISCALE, Abilities.NATURAL_CURE, 499, 102, 85, 90, 90, 100, 32, 45, 70, 189, GrowthRate.MEDIUM_FAST, 50.0, false),
    new PokemonSpecies(Species.PEARCHIE, 12, false, false, false, "LOLWUT Pokemon", Type.GRASS, Type.NORMAL, 2.1, 145.0, Abilities.MOODY, Abilities.RECKLESS, Abilities.OBLIVIOUS, 530, 111, 91, 79, 66, 81, 102, 55, 70, 152, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.TARDITANK, 12, false, false, false, "Water Bear Pokemon", Type.BUG, Type.WATER, 0.2, 0.2, Abilities.STURDY, Abilities.FRIEND_GUARD, Abilities.ANTICIPATION, 530, 110, 10, 200, 5, 200, 5, 60, 70, 80, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.IPLORA, 12, false, false, false, "Explorer Pokemon", Type.BUG, Type.STEEL, 0.6, 17.5, Abilities.SLOW_START, Abilities.TRUANT, Abilities.STALL, 255, 60, 45, 45, 55, 45, 5, 255, 35, 11, GrowthRate.SLOW, null, false),
    new PokemonSpecies(Species.CHROMOX, 12, false, false, false, "Googol Pokemon", Type.FIRE, Type.STEEL, 1.6, 102.0, Abilities.SPEED_BOOST, Abilities.SURGE_SURFER, Abilities.DOWNLOAD, 525, 85, 80, 60, 95, 60, 145, 45, 70, 180, GrowthRate.SLOW, null, false),
    new PokemonSpecies(Species.PITAYEN, 12, false, false, false, "Pitaya Pokemon", Type.GRASS, Type.DRAGON, 0.7, 6.9, Abilities.TOUGH_CLAWS, Abilities.ROUGH_SKIN, Abilities.CHLOROPHYLL, 280, 50, 60, 50, 40, 50, 30, 45, 35, 59, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.DRAGAYA, 12, false, false, false, "Pitaya Pokemon", Type.GRASS, Type.DRAGON, 1.5, 95.0, Abilities.TOUGH_CLAWS, Abilities.ROUGH_SKIN, Abilities.CHLOROPHYLL, 400, 70, 80, 70, 60, 70, 50, 45, 35, 114, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.FRUTAGON, 12, false, false, false, "Pitaya Pokemon", Type.GRASS, Type.DRAGON, 2.0, 118.0, Abilities.TOUGH_CLAWS, Abilities.ROUGH_SKIN, Abilities.CHLOROPHYLL, 550, 80, 120, 80, 100, 80, 90, 45, 35, 208, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.BITEKI, 12, false, false, false, "Aesthetic Pokemon", Type.ICE, Type.PSYCHIC, 1.3, 25.2, Abilities.CACOPHONY, Abilities.FILTER, Abilities.SNOW_CLOAK, 495, 70, 30, 50, 125, 125, 95, 15, 70, 145, GrowthRate.MEDIUM_FAST, null, false),
    new PokemonSpecies(Species.SESQUATCH, 12, false, false, false, "Ses Pokemon", Type.NORMAL, Type.GHOST, 2.4, 80.0, Abilities.SUDDENLY, Abilities.MUMMY, Abilities.SNOW_CLOAK, 510, 95, 90, 105, 55, 95, 70, 15, 35, 155, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.FIRESHI, 12, false, false, false, "Flame Pokemon", Type.FIRE, Type.POISON, 0.3, 0.1, Abilities.FLAME_BODY, Abilities.LEVITATE, Abilities.WHITE_SMOKE, 280, 30, 30, 50, 80, 60, 30, 45, 70, 51, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.FIRESHITWI, 12, false, false, false, "Duo Fire Pokemon", Type.FIRE, Type.POISON, 0.6, 0.2, Abilities.FLAME_BODY, Abilities.LEVITATE, Abilities.WHITE_SMOKE, 400, 50, 40, 70, 100, 80, 60, 45, 70, 102, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.FIRESHITRE, 12, false, false, false, "Hot Shit Pokemon", Type.FIRE, Type.POISON, 0.9, 0.3, Abilities.FLAME_BODY, Abilities.LEVITATE, Abilities.WHITE_SMOKE, 550, 80, 50, 95, 120, 105, 100, 45, 70, 183, GrowthRate.SLOW, 50.0, false),
    new PokemonSpecies(Species.SLUGBUD, 12, false, false, false, "Buddy Pokemon", Type.WATER, Type.POISON, 0.4, 6.0, Abilities.HYDRATION, Abilities.SAP_SIPPER, Abilities.RAIN_DISH, 280, 55, 60, 65, 35, 45, 20, 45, 120, 59, GrowthRate.SLOW, 100.0, false),
    new PokemonSpecies(Species.SLUGHUG, 12, false, false, false, "Hug Pokemon", Type.WATER, Type.POISON, 0.9, 18.0, Abilities.HYDRATION, Abilities.SAP_SIPPER, Abilities.RAIN_DISH, 400, 75, 85, 95, 50, 60, 35, 45, 120, 114, GrowthRate.SLOW, 100.0, false),
    new PokemonSpecies(Species.SLUGFUGG, 12, false, false, false, "Fug Pokemon", Type.WATER, Type.POISON, 2.0, 150.5, Abilities.HYDRATION, Abilities.SAP_SIPPER, Abilities.RAIN_DISH, 550, 105, 100, 135, 75, 95, 40, 45, 0, 208, GrowthRate.SLOW, 100.0, false),
    new PokemonSpecies(Species.SKELETROLL, 12, false, false, false, "Skeleton Pokemon", Type.GROUND, Type.GHOST, 0.7, 7.7, Abilities.BATTLE_ARMOR, Abilities.STURDY, Abilities.SHELL_ARMOR, 360, 50, 60, 80, 60, 80, 30, 45, 35, 89, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.SPOOKSCARE, 12, false, false, false, "Graveyard Pokemon", Type.GROUND, Type.GHOST, 1.4, 15.3, Abilities.PRESSURE, Abilities.MAGICIAN, Abilities.CURSED_BODY, 530, 105, 35, 120, 90, 130, 50, 45, 35, 217, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.GORYANNUS, 12, false, false, false, ">Gory Anus Pokemon", Type.GROUND, Type.GHOST, 1.8, 30.0, Abilities.SHEER_FORCE, Abilities.UNNERVE, Abilities.MUMMY, 530, 90, 130, 85, 35, 85, 105, 45, 35, 217, GrowthRate.MEDIUM_SLOW, 50.0, false),
    new PokemonSpecies(Species.LANKONG, 12, false, false, false, "Kong Pokemon", Type.NORMAL, null, 0.9, 19.0, Abilities.LONG_REACH, Abilities.OWN_TEMPO, Abilities.FRISK, 300, 50, 75, 40, 35, 40, 60, 45, 70, 89, GrowthRate.SLOW, 100.0, false),
    new PokemonSpecies(Species.BALLANKEY, 12, false, false, false, "Expand Pokemon", Type.NORMAL, Type.FLYING, 1.2, 32.5, Abilities.LONG_REACH, Abilities.OWN_TEMPO, Abilities.FRISK, 420, 85, 85, 60, 60, 60, 70, 45, 70, 144, GrowthRate.SLOW, 100.0, false),
    new PokemonSpecies(Species.FUNNEDONG, 12, false, false, false, "Lord HE Pokemon", Type.NORMAL, Type.FIGHTING, 1.7, 90.5, Abilities.LONG_REACH, Abilities.OWN_TEMPO, Abilities.FRISK, 600, 100, 130, 90, 70, 90, 120, 45, 70, 218, GrowthRate.SLOW, 100.0, false),
    new PokemonSpecies(Species.NARWHIZ, 12, false, true, false, "Magic Pokemon", Type.WATER, Type.FAIRY, 6.0, 132.0, Abilities.MAGICIAN, Abilities.MAGIC_BOUNCE, Abilities.HEALER, 620, 101, 70, 121, 86, 121, 121, 3, 35, 255, GrowthRate.SLOW, null, false),
    new PokemonSpecies(Species.NITERPENT, 12, false, true, false, "Experiment Pokemon", Type.ELECTRIC, Type.FIRE, 5.8, 180.0, Abilities.TECHNICIAN, Abilities.TERAVOLT, Abilities.TURBOBLAZE, 620, 81, 141, 85, 141, 71, 101, 3, 0, 255, GrowthRate.SLOW, null, false),
    new PokemonSpecies(Species.GRIFFAWORK, 12, false, true, false, "Purity Pokemon", Type.PSYCHIC, Type.FLYING, 3.4, 216.0, Abilities.NATURAL_CURE, Abilities.BEAST_BOOST, Abilities.MARVEL_SCALE, 700, 130, 85, 95, 160, 125, 105, 3, 35, 255, GrowthRate.SLOW, null, false),
    new PokemonSpecies(Species.BOARNOGRAF, 12, false, true, false, "Corruption Pokemon", Type.DARK, Type.GROUND, 3.5, 454.0, Abilities.GUTS, Abilities.BEAST_BOOST, Abilities.MOLD_BREAKER, 700, 130, 160, 125, 85, 95, 105, 3, 0, 255, GrowthRate.SLOW, null, false),
    new PokemonSpecies(Species.ADMOOT, 12, true, true, false, "Olev Pokemon", Type.FAIRY, null, 1.1, 6.0, Abilities.ADMIN_ABUSE, Abilities.SERENE_GRACE, Abilities.BERSERK, 600, 100, 100, 100, 100, 100, 100, 3, 70, 255, GrowthRate.MEDIUM_SLOW, 100.0, false),
    new PokemonSpecies(Species.TENTAQUIL, 12, false, false, false, "Troll Frog Pokemon", Type.BUG, Type.PSYCHIC, 0.7, 51.9, Abilities.IMMUNITY, Abilities.NONE, Abilities.NONE, 600, 100, 100, 100, 100, 100, 100, 255, 100, 255, GrowthRate.MEDIUM_SLOW, null, false),
...
export const speciesStarters = {
  ...
  [Species.KEKROACH]: 2,
  [Species.RICOSHEEP]: 3,
  [Species.SPAGHEFANT]: 3,
  [Species.CRYSTAQUIL]: 5,
  [Species.FONTABA]: 2,
  [Species.FLOCONUT]: 4,
  [Species.MANATEET]: 5,
  [Species.ANONYMOUSE]: 1,
  [Species.MOTHERFUCK]: 2,
  [Species.NINOOP]: 5,
  [Species.TICKTAC]: 4,
  [Species.COZLOAD]: 4,
  [Species.HONRADE]: 4,
  ...
  [Species.BETACLUCK]: 3,
  [Species.TWINFOWL]: 4,
  [Species.ILLUMINOWL]: 5,
  [Species.TYPOBOP]: 3,
  [Species.RANDOMIX]: 3,
  [Species.QUIBOOM]: 3,
  [Species.RAINGLOCK]: 3,
  [Species.BEATMARINE]: 2,
  [Species.HOFUCNO]: 4,
  [Species.HORNIGIRI]: 4,
  [Species.PREASU]: 4,
  [Species.WARNEY]: 4,
  ...
  [Species.FIRESHI]: 4,
  [Species.SLUGBUD]: 5,
  [Species.SKELETROLL]: 4,
  [Species.LANKONG]: 5,
  [Species.NARWHIZ]: 7,
  [Species.NITERPENT]: 6,
  [Species.GRIFFAWORK]: 8,
  [Species.BOARNOGRAF]: 8,
  [Species.ADMOOT]: 7,
  [Species.TENTAQUIL]: 7,
};
...
export const starterPassiveAbilities = {
  ...
  [Species.ARABOMB]: Abilities.BLAZE,
  [Species.EJACASM]: Abilities.TORRENT,
  [Species.REPTYKE]: Abilities.REGENERATOR,
  [Species.FAERIOCK]: Abilities.SOLID_ROCK,
  [Species.CLOUCAT]: Abilities.TOUGH_CLAWS,
  [Species.SADROG]: Abilities.OVERGROW,
  [Species.HODTOG]: Abilities.BLAZE,
  [Species.GNARRK]: Abilities.TORRENT,
};
