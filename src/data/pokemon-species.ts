...
export function initSpecies() {
  allSpecies.push(
    ...
    new PokemonSpecies(Species.DELORIS, 11, false, false, false, "Mindfuck Pokemon", Type.GRASS, Type.GROUND, 2.4, 122.4, Abilities.OWN_TEMPO, Abilities.WONDER_SKIN, Abilities.TANGLING_HAIR, 515, 90, 90, 75, 90, 90, 80, 45, 70, 200, GrowthRate.MEDIUM_SLOW, 50.0, false),
...
export const starterPassiveAbilities = {
  ...
  [Species.GRASSHOLE]: Abilities.ANALYTIC,
  [Species.ARABOMB]: Abilities.SAND_RUSH,
  [Species.EJACASM]: Abilities.UNAWARE,

  [Species.REPTYKE]: Abilities.REGENERATOR,
  [Species.SADROG]: Abilities.OBLIVIOUS,
};
