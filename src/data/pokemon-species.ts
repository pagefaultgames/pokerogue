...
export const starterPassiveAbilities = {
  ...
  [Species.SQUIRRAP]: Abilities.SOUNDPROOF,
  [Species.KENGEON]: Abilities.EARLY_BIRD,
  [Species.CURICRAWL]: Abilities.PRANKSTER,
  [Species.LARVADES]: Abilities.COMPOUND_EYES,
  [Species.CLOVOUR]: Abilities.NATURAL_CURE,
  [Species.NAUSEON]: Abilities.POISON_POINT,
  [Species.PIKOTTON]: Abilities.STATIC,
  [Species.BIRDHOUSE]: Abilities.STURDY,
  [Species.LANSHIL]: Abilities.ROCK_HEAD,
  [Species.MAYMAY]: Abilities.HUSTLE,
  [Species.VANDASH]: Abilities.GUTS,
  [Species.PIGUSON]: Abilities.GUTS,
  [Species.ARMANDO]: Abilities.INNER_FOCUS,
  [Species.SEMDROP]: Abilities.INSOMNIA,
  [Species.FURNAZI]: Abilities.FLAME_BODY,
  [Species.TULURE]: Abilities.WATER_VEIL,
  [Species.PIXILA]: Abilities.NATURAL_CURE,
  [Species.WEDGARD]: Abilities.ARENA_TRAP,
  [Species.RIBBIZAP]: Abilities.LIGHTNING_ROD,
  [Species.ELEPHAS]: Abilities.TELEPATHY,
  [Species.SEAMAPAN]: Abilities.THICK_FAT,
  [Species.CAROLINE]: Abilities.SUPER_LUCK,
  [Species.CHOMPEST]: Abilities.INTIMIDATE,
  [Species.MASDAWG]: Abilities.BALL_FETCH,
  [Species.SPANKE]: Abilities.SHED_SKIN,
  [Species.FISHNISM]: Abilities.RIVALRY,
  [Species.CHEZETTA]: Abilities.GOOEY,
  [Species.KROKLING]: Abilities.ROCK_HEAD,
  [Species.CONCHILLA]: Abilities.CUTE_CHARM,
  [Species.COOLCUBE]: Abilities.SNOW_CLOAK,
  [Species.SMOGAROBEN]: Abilities.POISON_POINT,
  [Species.MACHMONA]: Abilities.PRESSURE,
  [Species.BACUB]: Abilities.THICK_FAT,
  [Species.MOOSTATIC]: Abilities.STATIC,
  [Species.PRETZELY]: Abilities.SOUNDPROOF,
  [Species.DEEMDOW]: Abilities.SHADOW_TAG,
  [Species.CHEERLY]: Abilities.CUTE_CHARM,
  [Species.CARACOLD]: Abilities.PICKUP,
  [Species.PENGAS]: Abilities.BERSERK,
  [Species.PRAETEUR]: Abilities.INTIMIDATE,
  [Species.FLOWRE]: Abilities.LEVITATE,
  [Species.JUARECITO]: Abilities.KEEN_EYE,
  [Species.PUPPACTI]: Abilities.ROUGH_SKIN,
  [Species.TITTAI]: Abilities.SUCTION_CUPS,
  [Species.CHARAGON]: Abilities.SPEED_BOOST,
  [Species.EUPHOREAL]: Abilities.OBLIVIOUS,
  [Species.PRAUNCH]: Abilities.TECHNICIAN,
  [Species.TRICIENT]: Abilities.GUTS,
  [Species.POIZOOKIE]: Abilities.POISON_POINT,
  [Species.SABRECK]: Abilities.SUPER_LUCK,
  [Species.PYRALINK]: Abilities.MAGMA_ARMOR,
  [Species.SINGLETS]: Abilities.SKILL_LINK,
  [Species.MIASMER]: Abilities.LEVITATE,
  [Species.CACADEMON]: Abilities.STENCH,
  [Species.HANGINY]: Abilities.AFTERMATH,
  [Species.FROSOWL]: Abilities.INSOMNIA,
  [Species.DRAPILLAR]: Abilities.SHIELD_DUST,
  [Species.OGRELORD]: Abilities.VICTORY_STAR,
  [Species.CHANTRUTH]: Abilities.JEWELRY,
  [Species.INBITWEEN]: Abilities.MOODY,
  [Species.JARAPE]: Abilities.CURSED_BODY,
  [Species.BONGECKO]: Abilities.BLAZE,
  [Species.BLOBBOS]: Abilities.PURE_POWER,
  [Species.AYYLAMO]: Abilities.COMPOUND_EYES,
  [Species.SMELLOX]: Abilities.STENCH,
  [Species.CHASUMO]: Abilities.DEFIANT,
  [Species.OILSLAM]: Abilities.LIQUID_OOZE,
  [Species.STUFFOWL]: Abilities.EARLY_BIRD,
  [Species.DRAGUN]: Abilities.SNIPER,
  [Species.EVACYCLE]: Abilities.FLAME_BODY,
  [Species.FORYU]: Abilities.MAGNET_PULL,
  [Species.SCYTILL]: Abilities.LEVITATE,
  [Species.BADDON]: Abilities.ROUGH_SKIN,
  [Species.ENDRANTHER]: Abilities.POISON_POINT,
  [Species.NOTRIDLEY]: Abilities.PRESSURE,
  [Species.DEMIWAIFU]: Abilities.SERENE_GRACE,
  [Species.CLOVENIX]: Abilities.REGENERATOR,

  [Species.KNOGOAT]: Abilities.OWN_TEMPO,
  [Species.GLASSHOT]: Abilities.KEEN_EYE,
  [Species.FLUFFYETI]: Abilities.SNOW_CLOAK,
  [Species.MIRROSTINE]: Abilities.LIGHTNING_ROD,
  [Species.MUDPANTS]: Abilities.SAND_RUSH,
  [Species.BUKITLEE]: Abilities.OWN_TEMPO,
  [Species.MIMIMIE]: Abilities.SUCTION_CUPS,
  [Species.SPRUCIFIX]: Abilities.WONDER_GUARD,
  [Species.HULKAN]: Abilities.GUTS,
  [Species.NONITE]: Abilities.CACOPHONY,
  [Species.DUNKYPEA]: Abilities.BIG_PECKS,
  [Species.KUKLUX]: Abilities.FLASH_FIRE,
  [Species.FLAMEBOYAN]: Abilities.RIVALRY,
  [Species.PIICEE]: Abilities.SYNCHRONIZE,
  [Species.SONNANOS]: Abilities.SHEER_FORCE,
  [Species.PLEBBLES]: Abilities.STURDY,
  [Species.SAPLEAF]: Abilities.SOLAR_POWER,
  [Species.POLOSSUS]: Abilities.POLLUTION,
  [Species.HITMONANA]: Abilities.SHED_SKIN,
  [Species.BALLACLE]: Abilities.PICKUP,
  [Species.KEKROACH]: Abilities.SWARM,
  [Species.RICOSHEEP]: Abilities.SPEED_BOOST,
  [Species.SPAGHEFANT]: Abilities.WATER_ABSORB,
  [Species.CRYSTAQUIL]: Abilities.ROUGH_SKIN,
  [Species.FONTABA]: Abilities.TELEPATHY,
  [Species.FLOCONUT]: Abilities.CHLOROPHYLL,
  [Species.MANATEET]: Abilities.WATER_VEIL,
  [Species.ANONYMOUSE]: Abilities.INFILTRATOR,
  [Species.MOTHERFUCK]: Abilities.SHADOW_TAG,
  [Species.NINOOP]: Abilities.HUGE_POWER,
  [Species.TICKTAC]: Abilities.COMPOUND_EYES,
  [Species.COZLOAD]: Abilities.DOWNLOAD,
  [Species.HONRADE]: Abilities.BLADEMASTER,
  [Species.EMBORTION]: Abilities.PRESSURE,
  [Species.GALAVIK]: Abilities.LIQUID_OOZE,
  [Species.POLLEFIN]: Abilities.EFFECT_SPORE,
  [Species.LASSLEE]: Abilities.SYNCHRONIZE,
  [Species.SPOOKSTER]: Abilities.CURSED_BODY,
  [Species.DERPATO]: Abilities.OBLIVIOUS,
  [Species.SADFISH]: Abilities.DRIZZLE,
  [Species.DELORIS]: Abilities.OWN_TEMPO,
  [Species.OREON]: Abilities.SUPER_LUCK,
  [Species.FARFIGTRON]: Abilities.NO_GUARD,
  [Species.REGIRODE]: Abilities.WEAK_ARMOR,
  [Species.REGIMELT]: Abilities.WEAK_ARMOR,
  [Species.REGIRUST]: Abilities.WEAK_ARMOR,
  [Species.JEWIPEDE]: Abilities.PRESSURE,
  [Species.VIVAIGER]: Abilities.FLAME_BODY,
  [Species.HELIOFUG]: Abilities.DROUGHT,
  [Species.ADESIGN]: Abilities.AN_ABILITY,

  [Species.HUMPUNNY]: Abilities.RUN_AWAY,
  [Species.EMELGY]: Abilities.SNIPER,
  [Species.CATIKILLAR]: Abilities.SHIELD_DUST,
  [Species.EBINING]: Abilities.PRANKSTER,
  [Species.UPBOTE]: Abilities.PLUS,
  [Species.FLIPBIRD]: Abilities.DEFEATIST,
  [Species.GANGNOME]: Abilities.SOUNDPROOF,
  [Species.PYONGNOME]: Abilities.INTIMIDATE,
  [Species.BRUHKID]: Abilities.STAMINA,
  [Species.WALRUSE]: Abilities.HYDRATION,
  [Species.DIOBAT]: Abilities.REGENERATOR,
  [Species.DOCEE]: Abilities.TRACE,
  [Species.CAKUPPLE]: Abilities.SWEET_VEIL,
  [Species.BALOOFANG]: Abilities.AFTERMATH,
  [Species.SOCCKAT]: Abilities.QUICK_FEET,
  [Species.EGYLAMP]: Abilities.FLAME_BODY,
  [Species.MEHNDIOR]: Abilities.SPEED_BOOST,
  [Species.MISSLETOE]: Abilities.LEVITATE,
  [Species.FLAA]: Abilities.RUN_AWAY,
  [Species.ARAKETSU]: Abilities.HYPER_CUTTER,
  [Species.FALCAPTAIN]: Abilities.BIG_PECKS,
  [Species.CIRPENT]: Abilities.PRANKSTER,
  [Species.LIZASCOOP]: Abilities.STRONG_JAW,
  [Species.FEFEION]: Abilities.HEATPROOF,
  [Species.JERKLE]: Abilities.AFTERMATH,
  [Species.FAPTIME]: Abilities.SPEED_BOOST,
  [Species.SHIRIMAN]: Abilities.PRANKSTER,
  [Species.FRESRYE]: Abilities.TRUANT,
  [Species.NUTJOBBER]: Abilities.MADMAN,
  [Species.SPARGLE]: Abilities.VITAL_SPIRIT,
  [Species.HOUSANT]: Abilities.MORE_ROOM,
  [Species.FUERMIGA]: Abilities.COMPOUND_EYES,
  [Species.CONFIRMABI]: Abilities.QUICK_FEET,
  [Species.BULBAPEDO]: Abilities.RIVALRY,
  [Species.WASTENAUT]: Abilities.BATTLE_ARMOR,
  [Species.CANSUMOR]: Abilities.LIQUID_OOZE,
  [Species.SNUFFANT]: Abilities.SNOW_CLOAK,
  [Species.GRIMDAK]: Abilities.MOODY,
  [Species.SHROOFLE]: Abilities.IMMUNITY,
  [Species.BETACLUCK]: Abilities.TECHNICIAN,
  [Species.TWINFOWL]: Abilities.BIG_PECKS,
  [Species.ILLUMINOWL]: Abilities.ILLUMINATE,
  [Species.TYPOBOP]: Abilities.SHEER_FORCE,
  [Species.RANDOMIX]: Abilities.REGENERATOR,
  [Species.QUIBOOM]: Abilities.AFTERMATH,
  [Species.RAINGLOCK]: Abilities.RAIN_DISH,
  [Species.BEATMARINE]: Abilities.LIQUID_VOICE,
  [Species.HOFUCNO]: Abilities.SHADOW_TAG,
  [Species.HORNIGIRI]: Abilities.ICE_BODY,
  [Species.PREASU]: Abilities.STATIC,
  [Species.WARNEY]: Abilities.DAMP,
  [Species.ACUFRONT]: Abilities.FORECAST,
  [Species.MILITANT]: Abilities.STEELWORKER,
  [Species.SHIGGYDIG]: Abilities.DAMP,
  [Species.SIGNOT]: Abilities.DRY_SKIN,
  [Species.ORMITE]: Abilities.JEWELRY,
  [Species.ROLANGO]: Abilities.TRACE,
  [Species.PEARCHIE]: Abilities.MOODY,
  [Species.TARDITANK]: Abilities.STURDY,
  [Species.IPLORA]: Abilities.SLOW_START,
  [Species.PITAYEN]: Abilities.TOUGH_CLAWS,
  [Species.BITEKI]: Abilities.CACOPHONY,
  [Species.SESQUATCH]: Abilities.SUDDENLY,
  [Species.FIRESHI]: Abilities.FLAME_BODY,
  [Species.SLUGBUD]: Abilities.HYDRATION,
  [Species.SKELETROLL]: Abilities.BATTLE_ARMOR,
  [Species.LANKONG]: Abilities.LONG_REACH,
  [Species.NARWHIZ]: Abilities.MAGICIAN,
  [Species.NITERPENT]: Abilities.TECHNICIAN,
  [Species.GRIFFAWORK]: Abilities.NATURAL_CURE,
  [Species.BOARNOGRAF]: Abilities.GUTS,
  [Species.ADMOOT]: Abilities.ADMIN_ABUSE,
  [Species.TENTAQUIL]: Abilities.IMMUNITY,
};
