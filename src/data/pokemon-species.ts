...
export abstract class PokemonSpeciesForm {
  ...
  getBaseExp(): integer {
    ...
    case SpeciesFormKey.DELTA_MEGA:
      ret *= 1.5;
      break;
    }
    return ret;
...
export function initSpecies() {
  ...
  allSpecies.push(
    new PokemonSpecies(Species.BULBASAUR, 1, false, false, false, "Seed Pokémon", Type.GRASS, Type.POISON, 0.7, 6.9, Abilities.OVERGROW, Abilities.NONE, Abilities.CHLOROPHYLL, 318, 45, 49, 49, 65, 65, 45, 45, 50, 64, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
      new PokemonForm("Normal", "", Type.GRASS, Type.POISON, 0.7, 6.9, Abilities.OVERGROW, Abilities.NONE, Abilities.CHLOROPHYLL, 318, 45, 49, 49, 65, 65, 45, 45, 50, 64),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FAIRY, Type.PSYCHIC, 0.7, 6.9, Abilities.PSYCHO_CALL, Abilities.NONE, Abilities.REGENERATOR, 318, 45, 49, 49, 65, 65, 45, 45, 50, 106, true, null, true),
	),
    new PokemonSpecies(Species.IVYSAUR, 1, false, false, false, "Seed Pokémon", Type.GRASS, Type.POISON, 1, 13, Abilities.OVERGROW, Abilities.NONE, Abilities.CHLOROPHYLL, 405, 60, 62, 63, 80, 80, 60, 45, 50, 142, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
      new PokemonForm("Normal", "", Type.GRASS, Type.POISON, 1, 13, Abilities.OVERGROW, Abilities.NONE, Abilities.CHLOROPHYLL, 405, 60, 62, 63, 80, 80, 60, 45, 50, 142),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FAIRY, Type.PSYCHIC, 1.0, 13.0, Abilities.PSYCHO_CALL, Abilities.NONE, Abilities.REGENERATOR, 405, 60, 62, 63, 80, 80, 60, 45, 50, 135, true, null, false),
	),
    new PokemonSpecies(Species.VENUSAUR, 1, false, false, false, "Seed Pokémon", Type.GRASS, Type.POISON, 2, 100, Abilities.OVERGROW, Abilities.NONE, Abilities.CHLOROPHYLL, 525, 80, 82, 83, 100, 100, 80, 45, 50, 263, GrowthRate.MEDIUM_SLOW, 87.5, true, true,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FAIRY, Type.PSYCHIC, 2.0, 100.0, Abilities.PSYCHO_CALL, Abilities.NONE, Abilities.REGENERATOR, 525, 80, 82, 83, 100, 100, 80, 45, 50, 175, true, null, true),
			new PokemonForm("Delta-mega", SpeciesFormKey.DELTA_MEGA, Type.FAIRY, Type.PSYCHIC, 2.0, 100.0, Abilities.HUBRIS, Abilities.HUBRIS, Abilities.HUBRIS, 625, 80, 100, 123, 122, 120, 80, 22.5, 50, 350, true, null, false),
    ...
    new PokemonSpecies(Species.CHARMANDER, 1, false, false, false, "Lizard Pokémon", Type.FIRE, null, 0.6, 8.5, Abilities.BLAZE, Abilities.NONE, Abilities.SOLAR_POWER, 309, 39, 52, 43, 60, 50, 65, 45, 50, 62, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
      new PokemonForm("Normal", "", Type.FIRE, null, 0.6, 8.5, Abilities.BLAZE, Abilities.NONE, Abilities.SOLAR_POWER, 309, 39, 52, 43, 60, 50, 65, 45, 50, 62),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GHOST, Type.DRAGON, 0.6, 8.5, Abilities.SPIRIT_CALL, Abilities.NONE, Abilities.DARK_AURA, 309, 39, 52, 43, 60, 50, 65, 45, 50, 103, false, null, true),
	),
    new PokemonSpecies(Species.CHARMELEON, 1, false, false, false, "Flame Pokémon", Type.FIRE, null, 1.1, 19, Abilities.BLAZE, Abilities.NONE, Abilities.SOLAR_POWER, 405, 58, 64, 58, 80, 65, 80, 45, 50, 142, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
      new PokemonForm("Normal", "", Type.FIRE, null, 1.1, 19, Abilities.BLAZE, Abilities.NONE, Abilities.SOLAR_POWER, 405, 58, 64, 58, 80, 65, 80, 45, 50, 142),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GHOST, Type.DRAGON, 1.1, 19.0, Abilities.SPIRIT_CALL, Abilities.NONE, Abilities.DARK_AURA, 405, 58, 64, 58, 80, 65, 80, 45, 50, 135, false, null, true),
	),
    new PokemonSpecies(Species.CHARIZARD, 1, false, false, false, "Flame Pokémon", Type.FIRE, Type.FLYING, 1.7, 90.5, Abilities.BLAZE, Abilities.NONE, Abilities.SOLAR_POWER, 534, 78, 84, 78, 109, 85, 100, 45, 50, 267, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GHOST, Type.DRAGON, 1.7, 90.5, Abilities.SPIRIT_CALL, Abilities.NONE, Abilities.DARK_AURA, 534, 78, 84, 78, 109, 85, 100, 45, 50, 178, false, null, true),
			new PokemonForm("Delta-mega", SpeciesFormKey.DELTA_MEGA, Type.GHOST, Type.DRAGON, 1.7, 90.5, Abilities.NOCTEM, Abilities.NOCTEM, Abilities.NOCTEM, 634, 78, 104, 78, 159, 115, 100, 22.5, 50, 356, false, null, false),
    ...
    new PokemonSpecies(Species.SQUIRTLE, 1, false, false, false, "Tiny Turtle Pokémon", Type.WATER, null, 0.5, 9, Abilities.TORRENT, Abilities.NONE, Abilities.RAIN_DISH, 314, 44, 48, 65, 50, 64, 43, 45, 50, 63, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
      new PokemonForm("Normal", "", Type.WATER, null, 0.5, 9, Abilities.TORRENT, Abilities.NONE, Abilities.RAIN_DISH, 314, 44, 48, 65, 50, 64, 43, 45, 50, 63),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.DARK, Type.FIGHTING, 0.5, 9.0, Abilities.SHADOW_CALL, Abilities.NONE, Abilities.SHADOW_DANCE, 314, 44, 48, 65, 50, 64, 43, 45, 50, 104, false, null, true),
	),
    new PokemonSpecies(Species.WARTORTLE, 1, false, false, false, "Turtle Pokémon", Type.WATER, null, 1, 22.5, Abilities.TORRENT, Abilities.NONE, Abilities.RAIN_DISH, 405, 59, 63, 80, 65, 80, 58, 45, 50, 142, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
      new PokemonForm("Normal", "", Type.WATER, null, 1, 22.5, Abilities.TORRENT, Abilities.NONE, Abilities.RAIN_DISH, 405, 59, 63, 80, 65, 80, 58, 45, 50, 142),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.DARK, Type.FIGHTING, 1.0, 22.5, Abilities.SHADOW_CALL, Abilities.NONE, Abilities.SHADOW_DANCE, 405, 59, 63, 80, 65, 80, 58, 45, 50, 135, false, null, true),
	),
    new PokemonSpecies(Species.BLASTOISE, 1, false, false, false, "Shellfish Pokémon", Type.WATER, null, 1.6, 85.5, Abilities.TORRENT, Abilities.NONE, Abilities.RAIN_DISH, 530, 79, 83, 100, 85, 105, 78, 45, 50, 265, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.DARK, Type.FIGHTING, 1.6, 85.5, Abilities.SHADOW_CALL, Abilities.NONE, Abilities.SHADOW_DANCE, 530, 79, 83, 100, 85, 105, 78, 45, 50, 176, false, null, true),
			new PokemonForm("Delta-mega", SpeciesFormKey.DELTA_MEGA, Type.DARK, Type.FIGHTING, 1.6, 85.5, Abilities.MEGA_LAUNCHER, Abilities.MEGA_LAUNCHER, Abilities.MEGA_LAUNCHER, 630, 79, 103, 120, 135, 115, 78, 22.5, 50, 352, false, null, false),
    ...
    new PokemonSpecies(Species.PIDGEY, 1, false, false, false, "Tiny Bird Pokémon", Type.NORMAL, Type.FLYING, 0.3, 1.8, Abilities.KEEN_EYE, Abilities.TANGLED_FEET, Abilities.BIG_PECKS, 251, 40, 45, 40, 35, 35, 56, 255, 70, 50, GrowthRate.MEDIUM_SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.NORMAL, Type.FLYING, 0.3, 1.8, Abilities.KEEN_EYE, Abilities.TANGLED_FEET, Abilities.BIG_PECKS, 251, 40, 45, 40, 35, 35, 56, 255, 70, 50),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.DARK, Type.DRAGON, 0.3, 1.8, Abilities.INTIMIDATE, Abilities.EARLY_BIRD, Abilities.MARVEL_SCALE, 251, 40, 45, 40, 35, 35, 56, 255, 50, 83, false, null, true),
	),
    new PokemonSpecies(Species.PIDGEOTTO, 1, false, false, false, "Bird Pokémon", Type.NORMAL, Type.FLYING, 1.1, 30, Abilities.KEEN_EYE, Abilities.TANGLED_FEET, Abilities.BIG_PECKS, 349, 63, 60, 55, 50, 50, 71, 120, 70, 122, GrowthRate.MEDIUM_SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.NORMAL, Type.FLYING, 1.1, 30, Abilities.KEEN_EYE, Abilities.TANGLED_FEET, Abilities.BIG_PECKS, 349, 63, 60, 55, 50, 50, 71, 120, 70, 122),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.DARK, Type.DRAGON, 1.1, 30.0, Abilities.INTIMIDATE, Abilities.EARLY_BIRD, Abilities.MARVEL_SCALE, 349, 63, 60, 55, 50, 50, 71, 120, 50, 116, false, null, true),
	),
    new PokemonSpecies(Species.PIDGEOT, 1, false, false, false, "Bird Pokémon", Type.NORMAL, Type.FLYING, 1.5, 39.5, Abilities.KEEN_EYE, Abilities.TANGLED_FEET, Abilities.BIG_PECKS, 479, 83, 80, 75, 70, 70, 101, 45, 70, 216, GrowthRate.MEDIUM_SLOW, 50, false, true,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.DARK, Type.DRAGON, 1.5, 39.5, Abilities.INTIMIDATE, Abilities.EARLY_BIRD, Abilities.MARVEL_SCALE, 479, 83, 80, 75, 70, 70, 101, 45, 50, 159, false, null, true),
			new PokemonForm("Delta-mega", SpeciesFormKey.DELTA_MEGA, Type.DARK, Type.DRAGON, 1.5, 39.5, Abilities.INTIMIDATE, Abilities.INTIMIDATE, Abilities.INTIMIDATE, 579, 83, 80, 80, 135, 80, 121, 22.5, 50, 318, false, null, false),
    ...
    new PokemonSpecies(Species.PIKACHU, 1, false, false, false, "Mouse Pokémon", Type.ELECTRIC, null, 0.4, 6, Abilities.STATIC, Abilities.NONE, Abilities.LIGHTNING_ROD, 320, 35, 55, 40, 50, 50, 90, 190, 50, 112, GrowthRate.MEDIUM_FAST, 50, true, true,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FLYING, Type.FAIRY, 0.4, 6.0, Abilities.CUTE_CHARM, Abilities.CLOUD_NINE, Abilities.GALE_WINGS, 320, 35, 55, 40, 50, 50, 90, 190, 50, 106, false, null, true),
    ...
    new PokemonSpecies(Species.RAICHU, 1, false, false, false, "Mouse Pokémon", Type.ELECTRIC, null, 0.8, 30, Abilities.STATIC, Abilities.NONE, Abilities.LIGHTNING_ROD, 485, 60, 90, 55, 90, 80, 110, 75, 50, 243, GrowthRate.MEDIUM_FAST, 50, true, true,
      new PokemonForm("Normal", "", Type.ELECTRIC, null, 0.8, 30, Abilities.STATIC, Abilities.NONE, Abilities.LIGHTNING_ROD, 485, 60, 90, 55, 90, 80, 110, 75, 50, 243),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FLYING, Type.FAIRY, 0.8, 30.0, Abilities.CUTE_CHARM, Abilities.CLOUD_NINE, Abilities.GALE_WINGS, 485, 60, 90, 55, 90, 80, 110, 75, 50, 161, false, null, true),
	),
    ...
    new PokemonSpecies(Species.DIGLETT, 1, false, false, false, "Mole Pokémon", Type.GROUND, null, 0.2, 0.8, Abilities.SAND_VEIL, Abilities.ARENA_TRAP, Abilities.SAND_FORCE, 265, 10, 55, 25, 35, 45, 95, 255, 50, 53, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.GROUND, null, 0.2, 0.8, Abilities.SAND_VEIL, Abilities.ARENA_TRAP, Abilities.SAND_FORCE, 265, 10, 55, 25, 35, 45, 95, 255, 50, 53),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ICE, Type.NORMAL, 0.2, 0.8, Abilities.SNOW_CLOAK, Abilities.FUR_COAT, Abilities.OBLIVIOUS, 265, 10, 55, 25, 35, 45, 95, 255, 50, 88, false, null, true),
	),
    new PokemonSpecies(Species.DUGTRIO, 1, false, false, false, "Mole Pokémon", Type.GROUND, null, 0.7, 33.3, Abilities.SAND_VEIL, Abilities.ARENA_TRAP, Abilities.SAND_FORCE, 425, 35, 100, 50, 50, 70, 120, 50, 50, 149, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.GROUND, null, 0.7, 33.3, Abilities.SAND_VEIL, Abilities.ARENA_TRAP, Abilities.SAND_FORCE, 425, 35, 100, 50, 50, 70, 120, 50, 50, 149),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ICE, Type.NORMAL, 0.7, 33.3, Abilities.SNOW_CLOAK, Abilities.FUR_COAT, Abilities.OBLIVIOUS, 405, 35, 80, 50, 50, 70, 120, 50, 50, 135, false, null, true),
	),
    ...
    new PokemonSpecies(Species.GROWLITHE, 1, false, false, false, "Puppy Pokémon", Type.FIRE, null, 0.7, 19, Abilities.INTIMIDATE, Abilities.FLASH_FIRE, Abilities.JUSTIFIED, 350, 55, 70, 45, 70, 50, 60, 190, 50, 70, GrowthRate.SLOW, 75, false, true,
      new PokemonForm("Normal", "", Type.FIRE, null, 0.7, 19, Abilities.INTIMIDATE, Abilities.FLASH_FIRE, Abilities.JUSTIFIED, 350, 55, 70, 45, 70, 50, 60, 190, 50, 70),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.NORMAL, Type.DRAGON, 0.7, 19.0, Abilities.INNER_FOCUS, Abilities.INTIMIDATE, Abilities.MULTISCALE, 350, 55, 70, 45, 70, 50, 60, 190, 50, 116, false, null, true),
	),
    new PokemonSpecies(Species.ARCANINE, 1, false, false, false, "Legendary Pokémon", Type.FIRE, null, 1.9, 155, Abilities.INTIMIDATE, Abilities.FLASH_FIRE, Abilities.JUSTIFIED, 555, 90, 110, 80, 100, 80, 95, 75, 50, 194, GrowthRate.SLOW, 75, false, true,
      new PokemonForm("Normal", "", Type.FIRE, null, 1.9, 155, Abilities.INTIMIDATE, Abilities.FLASH_FIRE, Abilities.JUSTIFIED, 555, 90, 110, 80, 100, 80, 95, 75, 50, 194),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.NORMAL, Type.DRAGON, 1.9, 155.0, Abilities.INNER_FOCUS, Abilities.INTIMIDATE, Abilities.MULTISCALE, 555, 90, 110, 80, 100, 80, 95, 75, 50, 185, false, null, true),
	),
    ...
    new PokemonSpecies(Species.TENTACOOL, 1, false, false, false, "Jellyfish Pokémon", Type.WATER, Type.POISON, 0.9, 45.5, Abilities.CLEAR_BODY, Abilities.LIQUID_OOZE, Abilities.RAIN_DISH, 335, 40, 40, 35, 50, 100, 70, 190, 50, 67, GrowthRate.SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.WATER, Type.POISON, 0.9, 45.5, Abilities.CLEAR_BODY, Abilities.LIQUID_OOZE, Abilities.RAIN_DISH, 335, 40, 40, 35, 50, 100, 70, 190, 50, 67),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GRASS, Type.POISON, 0.9, 45.5, Abilities.STORM_DRAIN, Abilities.POISON_TOUCH, Abilities.OVERGROW, 335, 40, 40, 35, 50, 100, 70, 190, 50, 111, false, null, true),
	),
    new PokemonSpecies(Species.TENTACRUEL, 1, false, false, false, "Jellyfish Pokémon", Type.WATER, Type.POISON, 1.6, 55, Abilities.CLEAR_BODY, Abilities.LIQUID_OOZE, Abilities.RAIN_DISH, 515, 80, 70, 65, 80, 120, 100, 60, 50, 180, GrowthRate.SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.WATER, Type.POISON, 1.6, 55, Abilities.CLEAR_BODY, Abilities.LIQUID_OOZE, Abilities.RAIN_DISH, 515, 80, 70, 65, 80, 120, 100, 60, 50, 180),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GRASS, Type.POISON, 1.6, 55.0, Abilities.STORM_DRAIN, Abilities.POISON_TOUCH, Abilities.OVERGROW, 515, 80, 70, 65, 80, 120, 100, 60, 50, 171, false, null, true),
	),
    new PokemonSpecies(Species.GEODUDE, 1, false, false, false, "Rock Pokémon", Type.ROCK, Type.GROUND, 0.4, 20, Abilities.ROCK_HEAD, Abilities.STURDY, Abilities.SAND_VEIL, 300, 40, 80, 100, 30, 30, 20, 255, 70, 60, GrowthRate.MEDIUM_SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.ROCK, Type.GROUND, 0.4, 20, Abilities.ROCK_HEAD, Abilities.STURDY, Abilities.SAND_VEIL, 300, 40, 80, 100, 30, 30, 20, 255, 70, 60),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.PSYCHIC, Type.ROCK, 0.4, 20.0, Abilities.REGENERATOR, Abilities.SAP_SIPPER, Abilities.MAGIC_BOUNCE, 300, 40, 80, 100, 30, 30, 20, 120, 50, 100, false, null, true),
	),
    new PokemonSpecies(Species.GRAVELER, 1, false, false, false, "Rock Pokémon", Type.ROCK, Type.GROUND, 1, 105, Abilities.ROCK_HEAD, Abilities.STURDY, Abilities.SAND_VEIL, 390, 55, 95, 115, 45, 45, 35, 120, 70, 137, GrowthRate.MEDIUM_SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.ROCK, Type.GROUND, 1, 105, Abilities.ROCK_HEAD, Abilities.STURDY, Abilities.SAND_VEIL, 390, 55, 95, 115, 45, 45, 35, 120, 70, 137),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.PSYCHIC, Type.ROCK, 1.0, 105.0, Abilities.REGENERATOR, Abilities.SAP_SIPPER, Abilities.MAGIC_BOUNCE, 390, 55, 95, 115, 45, 45, 35, 120, 50, 130, false, null, true),
	),
    new PokemonSpecies(Species.GOLEM, 1, false, false, false, "Megaton Pokémon", Type.ROCK, Type.GROUND, 1.4, 300, Abilities.ROCK_HEAD, Abilities.STURDY, Abilities.SAND_VEIL, 495, 80, 120, 130, 55, 65, 45, 45, 70, 223, GrowthRate.MEDIUM_SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.ROCK, Type.GROUND, 1.4, 300, Abilities.ROCK_HEAD, Abilities.STURDY, Abilities.SAND_VEIL, 495, 80, 120, 130, 55, 65, 45, 45, 70, 223),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.PSYCHIC, Type.ROCK, 1.4, 300.0, Abilities.REGENERATOR, Abilities.SAP_SIPPER, Abilities.MAGIC_BOUNCE, 495, 80, 120, 130, 55, 65, 45, 45, 50, 165, false, null, true),
	),
    ...
    new PokemonSpecies(Species.DODUO, 1, false, false, false, "Twin Bird Pokémon", Type.NORMAL, Type.FLYING, 1.4, 39.2, Abilities.RUN_AWAY, Abilities.EARLY_BIRD, Abilities.TANGLED_FEET, 310, 35, 85, 45, 35, 35, 75, 190, 70, 62, GrowthRate.MEDIUM_FAST, 50, true, true,
      new PokemonForm("Normal", "", Type.NORMAL, Type.FLYING, 1.4, 39.2, Abilities.RUN_AWAY, Abilities.EARLY_BIRD, Abilities.TANGLED_FEET, 310, 35, 85, 45, 35, 35, 75, 190, 70, 62),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.PSYCHIC, null, 1.4, 39.2, Abilities.COMPOUND_EYES, Abilities.TRACE, Abilities.PSYCHO_CALL, 310, 35, 85, 45, 35, 35, 75, 190, 50, 103, false, null, true),
	),
    new PokemonSpecies(Species.DODRIO, 1, false, false, false, "Triple Bird Pokémon", Type.NORMAL, Type.FLYING, 1.8, 85.2, Abilities.RUN_AWAY, Abilities.EARLY_BIRD, Abilities.TANGLED_FEET, 470, 60, 110, 70, 60, 60, 110, 45, 70, 165, GrowthRate.MEDIUM_FAST, 50, true, true,
      new PokemonForm("Normal", "", Type.NORMAL, Type.FLYING, 1.8, 85.2, Abilities.RUN_AWAY, Abilities.EARLY_BIRD, Abilities.TANGLED_FEET, 470, 60, 110, 70, 60, 60, 110, 45, 70, 165),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.PSYCHIC, null, 1.8, 85.2, Abilities.COMPOUND_EYES, Abilities.TRACE, Abilities.PSYCHO_CALL, 460, 60, 110, 70, 60, 60, 100, 45, 50, 153, false, null, true),
	),
    ...
    new PokemonSpecies(Species.GRIMER, 1, false, false, false, "Sludge Pokémon", Type.POISON, null, 0.9, 30, Abilities.STENCH, Abilities.STICKY_HOLD, Abilities.POISON_TOUCH, 325, 80, 80, 50, 40, 50, 25, 190, 70, 65, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.POISON, null, 0.9, 30, Abilities.STENCH, Abilities.STICKY_HOLD, Abilities.POISON_TOUCH, 325, 80, 80, 50, 40, 50, 25, 190, 70, 65),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GROUND, null, 0.9, 30.0, Abilities.SAP_SIPPER, Abilities.NONE, Abilities.WATER_ABSORB, 325, 80, 80, 50, 40, 50, 25, 190, 50, 108, false, null, true),
	),
    new PokemonSpecies(Species.MUK, 1, false, false, false, "Sludge Pokémon", Type.POISON, null, 1.2, 30, Abilities.STENCH, Abilities.STICKY_HOLD, Abilities.POISON_TOUCH, 500, 105, 105, 75, 65, 100, 50, 75, 70, 175, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.POISON, null, 1.2, 30, Abilities.STENCH, Abilities.STICKY_HOLD, Abilities.POISON_TOUCH, 500, 105, 105, 75, 65, 100, 50, 75, 70, 175),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GROUND, null, 1.2, 30.0, Abilities.SAP_SIPPER, Abilities.REGURGITATION, Abilities.WATER_ABSORB, 500, 105, 105, 75, 65, 100, 50, 75, 50, 166, false, null, true),
	),
    ...
    new PokemonSpecies(Species.KOFFING, 1, false, false, false, "Poison Gas Pokémon", Type.POISON, null, 0.6, 1, Abilities.LEVITATE, Abilities.NEUTRALIZING_GAS, Abilities.STENCH, 340, 40, 65, 95, 60, 45, 35, 190, 50, 68, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.POISON, null, 0.6, 1, Abilities.LEVITATE, Abilities.NEUTRALIZING_GAS, Abilities.STENCH, 340, 40, 65, 95, 60, 45, 35, 190, 50, 68),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ELECTRIC, Type.FLYING, 0.6, 1.0, Abilities.CLOUD_NINE, Abilities.AMPLIFIER, Abilities.VOLT_ABSORB, 340, 40, 65, 95, 60, 45, 35, 190, 50, 113, false, null, true),
	),
    new PokemonSpecies(Species.WEEZING, 1, false, false, false, "Poison Gas Pokémon", Type.POISON, null, 1.2, 9.5, Abilities.LEVITATE, Abilities.NEUTRALIZING_GAS, Abilities.STENCH, 490, 65, 90, 120, 85, 70, 60, 60, 50, 172, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.POISON, null, 1.2, 9.5, Abilities.LEVITATE, Abilities.NEUTRALIZING_GAS, Abilities.STENCH, 490, 65, 90, 120, 85, 70, 60, 60, 50, 172),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ELECTRIC, Type.FLYING, 1.2, 9.5, Abilities.CLOUD_NINE, Abilities.AMPLIFIER, Abilities.VOLT_ABSORB, 490, 65, 90, 120, 85, 70, 60, 60, 50, 163, false, null, true),
	),
    ...
    new PokemonSpecies(Species.TANGELA, 1, false, false, false, "Vine Pokémon", Type.GRASS, null, 1, 35, Abilities.CHLOROPHYLL, Abilities.LEAF_GUARD, Abilities.REGENERATOR, 435, 65, 55, 115, 100, 40, 60, 45, 50, 87, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.GRASS, null, 1, 35, Abilities.CHLOROPHYLL, Abilities.LEAF_GUARD, Abilities.REGENERATOR, 435, 65, 55, 115, 100, 40, 60, 45, 50, 87),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GROUND, null, 1.0, 35.0, Abilities.DRY_SKIN, Abilities.SAND_FORCE, Abilities.ROUGH_SKIN, 435, 65, 55, 115, 100, 40, 60, 45, 50, 145, false, null, true),
	),
    ...
    new PokemonSpecies(Species.SCYTHER, 1, false, false, false, "Mantis Pokémon", Type.BUG, Type.FLYING, 1.5, 56, Abilities.SWARM, Abilities.TECHNICIAN, Abilities.STEADFAST, 500, 70, 110, 80, 55, 80, 105, 45, 50, 100, GrowthRate.MEDIUM_FAST, 50, true, true,
      new PokemonForm("Normal", "", Type.BUG, Type.FLYING, 1.5, 56, Abilities.SWARM, Abilities.TECHNICIAN, Abilities.STEADFAST, 500, 70, 110, 80, 55, 80, 105, 45, 50, 100),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ICE, Type.FIGHTING, 1.5, 56.0, Abilities.HUSTLE, Abilities.ICE_CLEATS, Abilities.SUPER_LUCK, 500, 70, 110, 80, 55, 80, 105, 45, 50, 166, false, null, true),
	),
    ...
    new PokemonSpecies(Species.ELECTABUZZ, 1, false, false, false, "Electric Pokémon", Type.ELECTRIC, null, 1.1, 30, Abilities.STATIC, Abilities.NONE, Abilities.VITAL_SPIRIT, 490, 65, 83, 57, 95, 85, 105, 45, 50, 172, GrowthRate.MEDIUM_FAST, 75, false, true,
      new PokemonForm("Normal", "", Type.ELECTRIC, null, 1.1, 30, Abilities.STATIC, Abilities.NONE, Abilities.VITAL_SPIRIT, 490, 65, 83, 57, 95, 85, 105, 45, 50, 172),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ROCK, null, 1.1, 45.0, Abilities.INNER_FOCUS, Abilities.NONE, Abilities.BATTLE_ARMOR, 490, 65, 83, 57, 95, 85, 105, 45, 50, 163, false, null, true),
	),
    new PokemonSpecies(Species.MAGMAR, 1, false, false, false, "Spitfire Pokémon", Type.FIRE, null, 1.3, 44.5, Abilities.FLAME_BODY, Abilities.NONE, Abilities.VITAL_SPIRIT, 495, 65, 95, 57, 100, 85, 93, 45, 50, 173, GrowthRate.MEDIUM_FAST, 75, false, true,
      new PokemonForm("Normal", "", Type.FIRE, null, 1.3, 44.5, Abilities.FLAME_BODY, Abilities.NONE, Abilities.VITAL_SPIRIT, 495, 65, 95, 57, 100, 85, 93, 45, 50, 173),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.WATER, null, 1.3, 44.5, Abilities.SWIFT_SWIM, Abilities.NONE, Abilities.RAIN_DISH, 495, 65, 95, 57, 100, 85, 93, 45, 50, 165, false, null, true),
	),
    ...
    new PokemonSpecies(Species.DITTO, 1, false, false, false, "Transform Pokémon", Type.NORMAL, null, 0.3, 4, Abilities.LIMBER, Abilities.NONE, Abilities.IMPOSTER, 288, 48, 48, 48, 48, 48, 48, 35, 50, 101, GrowthRate.MEDIUM_FAST, null, false, true,
      new PokemonForm("Normal", "", Type.NORMAL, null, 0.3, 4, Abilities.LIMBER, Abilities.NONE, Abilities.IMPOSTER, 288, 48, 48, 48, 48, 48, 48, 35, 50, 101),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.WATER, null, 0.3, 4.0, Abilities.PROTEAN, Abilities.NONE, Abilities.NONE, 288, 48, 48, 48, 48, 48, 48, 35, 50, 96, false, null, true),
	),
    ...
    new PokemonSpecies(Species.KABUTO, 1, false, false, false, "Shellfish Pokémon", Type.ROCK, Type.WATER, 0.5, 11.5, Abilities.SWIFT_SWIM, Abilities.BATTLE_ARMOR, Abilities.WEAK_ARMOR, 355, 30, 80, 90, 55, 45, 55, 45, 50, 71, GrowthRate.MEDIUM_FAST, 87.5, false, true,
      new PokemonForm("Normal", "", Type.ROCK, Type.WATER, 0.5, 11.5, Abilities.SWIFT_SWIM, Abilities.BATTLE_ARMOR, Abilities.WEAK_ARMOR, 355, 30, 80, 90, 55, 45, 55, 45, 50, 71),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.BUG, Type.DARK, 0.5, 11.5, Abilities.SWARM, Abilities.UNNERVE, Abilities.TOUGH_CLAWS, 360, 30, 80, 95, 55, 45, 55, 45, 50, 120, false, null, true),
	),
    new PokemonSpecies(Species.KABUTOPS, 1, false, false, false, "Shellfish Pokémon", Type.ROCK, Type.WATER, 1.3, 40.5, Abilities.SWIFT_SWIM, Abilities.BATTLE_ARMOR, Abilities.WEAK_ARMOR, 495, 60, 115, 105, 65, 70, 80, 45, 50, 173, GrowthRate.MEDIUM_FAST, 87.5, false, true,
      new PokemonForm("Normal", "", Type.ROCK, Type.WATER, 1.3, 40.5, Abilities.SWIFT_SWIM, Abilities.BATTLE_ARMOR, Abilities.WEAK_ARMOR, 495, 60, 115, 105, 65, 70, 80, 45, 50, 173),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.BUG, Type.DARK, 1.3, 40.5, Abilities.SWARM, Abilities.UNNERVE, Abilities.TOUGH_CLAWS, 495, 60, 115, 105, 65, 70, 80, 45, 50, 165, false, null, true),
	),
    ...
    new PokemonSpecies(Species.SNORLAX, 1, false, false, false, "Sleeping Pokémon", Type.NORMAL, null, 2.1, 460, Abilities.IMMUNITY, Abilities.THICK_FAT, Abilities.GLUTTONY, 540, 160, 110, 65, 65, 110, 30, 25, 50, 189, GrowthRate.SLOW, 87.5, false, true,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GRASS, Type.GRASS, 2.1, 460.0, Abilities.OVERCOAT, Abilities.THICK_FAT, Abilities.ADAPTABILITY, 540, 160, 110, 65, 65, 110, 30, 25, 50, 180, false, null, true),
    ...
    new PokemonSpecies(Species.DRATINI, 1, false, false, false, "Dragon Pokémon", Type.DRAGON, null, 1.8, 3.3, Abilities.SHED_SKIN, Abilities.NONE, Abilities.MARVEL_SCALE, 300, 41, 64, 45, 50, 50, 50, 45, 35, 60, GrowthRate.SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.DRAGON, null, 1.8, 3.3, Abilities.SHED_SKIN, Abilities.NONE, Abilities.MARVEL_SCALE, 300, 41, 64, 45, 50, 50, 50, 45, 35, 60),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.WATER, Type.ELECTRIC, 1.8, 3.3, Abilities.SWIFT_SWIM, Abilities.NONE, Abilities.VOLT_ABSORB, 300, 41, 64, 45, 50, 50, 50, 45, 50, 100, false, null, true),
	),
    new PokemonSpecies(Species.DRAGONAIR, 1, false, false, false, "Dragon Pokémon", Type.DRAGON, null, 4, 16.5, Abilities.SHED_SKIN, Abilities.NONE, Abilities.MARVEL_SCALE, 420, 61, 84, 65, 70, 70, 70, 45, 35, 147, GrowthRate.SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.DRAGON, null, 4, 16.5, Abilities.SHED_SKIN, Abilities.NONE, Abilities.MARVEL_SCALE, 420, 61, 84, 65, 70, 70, 70, 45, 35, 147),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.WATER, Type.ELECTRIC, 4.0, 16.5, Abilities.SWIFT_SWIM, Abilities.NONE, Abilities.VOLT_ABSORB, 420, 61, 84, 65, 70, 70, 70, 45, 50, 140, false, null, true),
	),
    new PokemonSpecies(Species.DRAGONITE, 1, false, false, false, "Dragon Pokémon", Type.DRAGON, Type.FLYING, 2.2, 210, Abilities.INNER_FOCUS, Abilities.NONE, Abilities.MULTISCALE, 600, 91, 134, 95, 100, 100, 80, 45, 35, 300, GrowthRate.SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.DRAGON, Type.FLYING, 2.2, 210, Abilities.INNER_FOCUS, Abilities.NONE, Abilities.MULTISCALE, 600, 91, 134, 95, 100, 100, 80, 45, 35, 300),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.WATER, Type.ELECTRIC, 2.2, 210.0, Abilities.SWIFT_SWIM, Abilities.NONE, Abilities.VOLT_ABSORB, 600, 91, 134, 95, 100, 100, 80, 45, 50, 200, false, null, true),
	),
    ...
    new PokemonSpecies(Species.CYNDAQUIL, 2, false, false, false, "Fire Mouse Pokémon", Type.FIRE, null, 0.5, 7.9, Abilities.BLAZE, Abilities.NONE, Abilities.FLASH_FIRE, 309, 39, 52, 43, 60, 50, 65, 45, 70, 62, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
      new PokemonForm("Normal", "", Type.FIRE, null, 0.5, 7.9, Abilities.BLAZE, Abilities.NONE, Abilities.FLASH_FIRE, 309, 39, 52, 43, 60, 50, 65, 45, 70, 62),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ELECTRIC, null, 0.5, 7.9, Abilities.STATIC, Abilities.NONE, Abilities.LIGHTNING_ROD, 309, 39, 52, 43, 60, 50, 65, 45, 50, 103, false, null, true),
	),
    new PokemonSpecies(Species.QUILAVA, 2, false, false, false, "Volcano Pokémon", Type.FIRE, null, 0.9, 19, Abilities.BLAZE, Abilities.NONE, Abilities.FLASH_FIRE, 405, 58, 64, 58, 80, 65, 80, 45, 70, 142, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
      new PokemonForm("Normal", "", Type.FIRE, null, 0.9, 19, Abilities.BLAZE, Abilities.NONE, Abilities.FLASH_FIRE, 405, 58, 64, 58, 80, 65, 80, 45, 70, 142),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ELECTRIC, Type.STEEL, 0.9, 28.5, Abilities.STATIC, Abilities.NONE, Abilities.LIGHTNING_ROD, 405, 58, 64, 58, 80, 65, 80, 45, 50, 135, false, null, true),
	),
    new PokemonSpecies(Species.TYPHLOSION, 2, false, false, false, "Volcano Pokémon", Type.FIRE, null, 1.7, 79.5, Abilities.BLAZE, Abilities.NONE, Abilities.FLASH_FIRE, 534, 78, 84, 78, 109, 85, 100, 45, 70, 240, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
      new PokemonForm("Normal", "", Type.FIRE, null, 1.7, 79.5, Abilities.BLAZE, Abilities.NONE, Abilities.FLASH_FIRE, 534, 78, 84, 78, 109, 85, 100, 45, 70, 240),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ELECTRIC, Type.STEEL, 1.7, 159.0, Abilities.MOTOR_DRIVE, Abilities.NONE, Abilities.LIGHTNING_ROD, 534, 78, 84, 78, 109, 85, 100, 45, 50, 178, false, null, true),
			new PokemonForm("Delta-mega", SpeciesFormKey.DELTA_MEGA, Type.ELECTRIC, Type.STEEL, 1.7, 159.0, Abilities.SUPERCELL, Abilities.SUPERCELL, Abilities.SUPERCELL, 634, 78, 89, 88, 159, 110, 110, 22.5, 50, 356, false, null, false),
	),
    ...
    new PokemonSpecies(Species.HOOTHOOT, 2, false, false, false, "Owl Pokémon", Type.NORMAL, Type.FLYING, 0.7, 21.2, Abilities.INSOMNIA, Abilities.KEEN_EYE, Abilities.TINTED_LENS, 262, 60, 30, 30, 36, 56, 50, 255, 50, 52, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.NORMAL, Type.FLYING, 0.7, 21.2, Abilities.INSOMNIA, Abilities.KEEN_EYE, Abilities.TINTED_LENS, 262, 60, 30, 30, 36, 56, 50, 255, 50, 52),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ICE, Type.FLYING, 0.7, 21.2, Abilities.NO_GUARD, Abilities.KEEN_EYE, Abilities.SNOW_CLOAK, 262, 60, 30, 30, 36, 56, 50, 255, 50, 87, false, null, true),
	),
    new PokemonSpecies(Species.NOCTOWL, 2, false, false, false, "Owl Pokémon", Type.NORMAL, Type.FLYING, 1.6, 40.8, Abilities.INSOMNIA, Abilities.KEEN_EYE, Abilities.TINTED_LENS, 452, 100, 50, 50, 86, 96, 70, 90, 50, 158, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.NORMAL, Type.FLYING, 1.6, 40.8, Abilities.INSOMNIA, Abilities.KEEN_EYE, Abilities.TINTED_LENS, 452, 100, 50, 50, 86, 96, 70, 90, 50, 158),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ICE, Type.FLYING, 1.6, 40.8, Abilities.NO_GUARD, Abilities.KEEN_EYE, Abilities.SNOW_CLOAK, 442, 100, 50, 50, 76, 96, 70, 90, 50, 147, false, null, true),
	),
    ...
    new PokemonSpecies(Species.CHINCHOU, 2, false, false, false, "Angler Pokémon", Type.WATER, Type.ELECTRIC, 0.5, 12, Abilities.VOLT_ABSORB, Abilities.ILLUMINATE, Abilities.WATER_ABSORB, 330, 75, 38, 38, 56, 56, 67, 190, 50, 66, GrowthRate.SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.WATER, Type.ELECTRIC, 0.5, 12, Abilities.VOLT_ABSORB, Abilities.ILLUMINATE, Abilities.WATER_ABSORB, 330, 75, 38, 38, 56, 56, 67, 190, 50, 66),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GHOST, Type.FIRE, 0.5, 12.0, Abilities.FLASH_FIRE, Abilities.UNNERVE, Abilities.LEVITATE, 330, 75, 38, 38, 56, 56, 67, 190, 50, 110, false, null, true),
	),
    new PokemonSpecies(Species.LANTURN, 2, false, false, false, "Light Pokémon", Type.WATER, Type.ELECTRIC, 1.2, 22.5, Abilities.VOLT_ABSORB, Abilities.ILLUMINATE, Abilities.WATER_ABSORB, 460, 125, 58, 58, 76, 76, 67, 75, 50, 161, GrowthRate.SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.WATER, Type.ELECTRIC, 1.2, 22.5, Abilities.VOLT_ABSORB, Abilities.ILLUMINATE, Abilities.WATER_ABSORB, 460, 125, 58, 58, 76, 76, 67, 75, 50, 161),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GHOST, Type.FIRE, 1.2, 22.5, Abilities.FLASH_FIRE, Abilities.UNNERVE, Abilities.LEVITATE, 460, 125, 58, 58, 76, 76, 67, 75, 50, 153, false, null, true),
	),
    new PokemonSpecies(Species.PICHU, 2, false, false, false, "Tiny Mouse Pokémon", Type.ELECTRIC, null, 0.3, 2, Abilities.STATIC, Abilities.NONE, Abilities.LIGHTNING_ROD, 205, 20, 40, 15, 35, 35, 60, 190, 70, 41, GrowthRate.MEDIUM_FAST, 50, false, false,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FLYING, Type.FAIRY, 0.3, 2.0, Abilities.CUTE_CHARM, Abilities.CLOUD_NINE, Abilities.GALE_WINGS, 205, 20, 40, 15, 35, 35, 60, 190, 50, 68, false, null, true),
    ...
    new PokemonSpecies(Species.AIPOM, 2, false, false, false, "Long Tail Pokémon", Type.NORMAL, null, 0.8, 11.5, Abilities.RUN_AWAY, Abilities.PICKUP, Abilities.SKILL_LINK, 360, 55, 70, 55, 40, 55, 85, 45, 70, 72, GrowthRate.FAST, 50, true, true,
      new PokemonForm("Normal", "", Type.NORMAL, null, 0.8, 11.5, Abilities.RUN_AWAY, Abilities.PICKUP, Abilities.SKILL_LINK, 360, 55, 70, 55, 40, 55, 85, 45, 70, 72),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GHOST, Type.NORMAL, 0.8, 11.5, Abilities.CURSED_BODY, Abilities.RATTLED, Abilities.TECHNICIAN, 360, 55, 70, 55, 40, 55, 85, 45, 50, 120, false, null, true),
	),
    new PokemonSpecies(Species.SUNKERN, 2, false, false, false, "Seed Pokémon", Type.GRASS, null, 0.3, 1.8, Abilities.CHLOROPHYLL, Abilities.SOLAR_POWER, Abilities.EARLY_BIRD, 180, 30, 30, 30, 30, 30, 30, 235, 70, 36, GrowthRate.MEDIUM_SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.GRASS, null, 0.3, 1.8, Abilities.CHLOROPHYLL, Abilities.SOLAR_POWER, Abilities.EARLY_BIRD, 180, 30, 30, 30, 30, 30, 30, 235, 70, 36),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FIRE, Type.POISON, 0.3, 1.8, Abilities.FLAME_BODY, Abilities.ANALYTIC, Abilities.POISON_POINT, 180, 30, 30, 30, 30, 30, 30, 235, 50, 60, false, null, true),
	),
    new PokemonSpecies(Species.SUNFLORA, 2, false, false, false, "Sun Pokémon", Type.GRASS, null, 0.8, 8.5, Abilities.CHLOROPHYLL, Abilities.SOLAR_POWER, Abilities.EARLY_BIRD, 425, 75, 75, 55, 105, 85, 30, 120, 70, 149, GrowthRate.MEDIUM_SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.GRASS, null, 0.8, 8.5, Abilities.CHLOROPHYLL, Abilities.SOLAR_POWER, Abilities.EARLY_BIRD, 425, 75, 75, 55, 105, 85, 30, 120, 70, 149),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FIRE, Type.POISON, 0.8, 8.5, Abilities.FLAME_BODY, Abilities.ANALYTIC, Abilities.POISON_POINT, 425, 75, 75, 55, 105, 85, 30, 120, 50, 141, false, null, true),
			new PokemonForm("Delta-mega", SpeciesFormKey.DELTA_MEGA, Type.FIRE, Type.POISON, 0.8, 8.5, Abilities.CHLOROFURY, Abilities.CHLOROFURY, Abilities.CHLOROFURY, 525, 75, 85, 80, 135, 105, 45, 60.0, 50, 282, false, null, false),
	),
    new PokemonSpecies(Species.YANMA, 2, false, false, false, "Clear Wing Pokémon", Type.BUG, Type.FLYING, 1.2, 38, Abilities.SPEED_BOOST, Abilities.COMPOUND_EYES, Abilities.FRISK, 390, 65, 65, 45, 75, 45, 95, 75, 70, 78, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.BUG, Type.FLYING, 1.2, 38, Abilities.SPEED_BOOST, Abilities.COMPOUND_EYES, Abilities.FRISK, 390, 65, 65, 45, 75, 45, 95, 75, 70, 78),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GRASS, Type.FLYING, 1.2, 38.0, Abilities.ADAPTABILITY, Abilities.LEAF_GUARD, Abilities.NATURAL_CURE, 390, 65, 65, 45, 75, 45, 95, 75, 50, 130, false, null, true),
	),
    new PokemonSpecies(Species.WOOPER, 2, false, false, false, "Water Fish Pokémon", Type.WATER, Type.GROUND, 0.4, 8.5, Abilities.DAMP, Abilities.WATER_ABSORB, Abilities.UNAWARE, 210, 55, 45, 45, 25, 25, 15, 255, 50, 42, GrowthRate.MEDIUM_FAST, 50, true, true,
      new PokemonForm("Normal", "", Type.WATER, Type.GROUND, 0.4, 8.5, Abilities.DAMP, Abilities.WATER_ABSORB, Abilities.UNAWARE, 210, 55, 45, 45, 25, 25, 15, 255, 50, 42),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GRASS, Type.FIRE, 0.4, 8.5, Abilities.PICKUP, Abilities.FLASH_FIRE, Abilities.HARVEST, 210, 55, 45, 45, 25, 25, 15, 255, 50, 70, false, null, true),
	),
    new PokemonSpecies(Species.QUAGSIRE, 2, false, false, false, "Water Fish Pokémon", Type.WATER, Type.GROUND, 1.4, 75, Abilities.DAMP, Abilities.WATER_ABSORB, Abilities.UNAWARE, 430, 95, 85, 85, 65, 65, 35, 90, 50, 151, GrowthRate.MEDIUM_FAST, 50, true, true,
      new PokemonForm("Normal", "", Type.WATER, Type.GROUND, 1.4, 75, Abilities.DAMP, Abilities.WATER_ABSORB, Abilities.UNAWARE, 430, 95, 85, 85, 65, 65, 35, 90, 50, 151),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GRASS, Type.FIRE, 1.4, 75.0, Abilities.PICKUP, Abilities.FLASH_FIRE, Abilities.HARVEST, 430, 95, 85, 85, 65, 65, 35, 90, 50, 143, false, null, true),
	),
    ...
    new PokemonSpecies(Species.MISDREAVUS, 2, false, false, false, "Screech Pokémon", Type.GHOST, null, 0.7, 1, Abilities.LEVITATE, Abilities.NONE, Abilities.NONE, 435, 60, 60, 60, 85, 85, 85, 45, 35, 87, GrowthRate.FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.GHOST, null, 0.7, 1, Abilities.LEVITATE, Abilities.NONE, Abilities.NONE, 435, 60, 60, 60, 85, 85, 85, 45, 35, 87),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ICE, Type.FAIRY, 0.7, 1.0, Abilities.MAGIC_GUARD, Abilities.NONE, Abilities.WINTER_JOY, 435, 60, 60, 60, 85, 85, 85, 45, 50, 145, false, null, true),
	),
    ...
    new PokemonSpecies(Species.GIRAFARIG, 2, false, false, false, "Long Neck Pokémon", Type.NORMAL, Type.PSYCHIC, 1.5, 41.5, Abilities.INNER_FOCUS, Abilities.EARLY_BIRD, Abilities.SAP_SIPPER, 455, 70, 80, 65, 90, 65, 85, 60, 70, 159, GrowthRate.MEDIUM_FAST, 50, true, true,
      new PokemonForm("Normal", "", Type.NORMAL, Type.PSYCHIC, 1.5, 41.5, Abilities.INNER_FOCUS, Abilities.EARLY_BIRD, Abilities.SAP_SIPPER, 455, 70, 80, 65, 90, 65, 85, 60, 70, 159),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.STEEL, Type.POISON, 1.5, 83.0, Abilities.ANGER_POINT, Abilities.STENCH, Abilities.INTIMIDATE, 455, 70, 80, 65, 90, 65, 85, 60, 50, 151, false, null, true),
			new PokemonForm("Delta-mega", SpeciesFormKey.DELTA_MEGA, Type.STEEL, Type.POISON, 1.5, 83.0, Abilities.INTIMIDATE, Abilities.INTIMIDATE, Abilities.INTIMIDATE, 555, 70, 80, 95, 130, 95, 85, 30.0, 50, 302, false, null, false),
	),
    ...
    new PokemonSpecies(Species.DUNSPARCE, 2, false, false, false, "Land Snake Pokémon", Type.NORMAL, null, 1.5, 14, Abilities.SERENE_GRACE, Abilities.RUN_AWAY, Abilities.RATTLED, 415, 100, 70, 70, 65, 65, 45, 190, 50, 145, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.NORMAL, null, 1.5, 14, Abilities.SERENE_GRACE, Abilities.RUN_AWAY, Abilities.RATTLED, 415, 100, 70, 70, 65, 65, 45, 190, 50, 145),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.BUG, Type.WATER, 1.5, 14.0, Abilities.HYPER_CUTTER, Abilities.SWIFT_SWIM, Abilities.SKILL_LINK, 415, 100, 70, 70, 65, 65, 45, 190, 50, 138, false, null, true),
	),
    ...
    new PokemonSpecies(Species.SCIZOR, 2, false, false, false, "Pincer Pokémon", Type.BUG, Type.STEEL, 1.8, 118, Abilities.SWARM, Abilities.TECHNICIAN, Abilities.LIGHT_METAL, 500, 70, 130, 100, 55, 80, 65, 25, 50, 175, GrowthRate.MEDIUM_FAST, 50, true, true,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ICE, Type.FIGHTING, 1.8, 118.0, Abilities.TOUGH_CLAWS, Abilities.ICE_CLEATS, Abilities.SUPER_LUCK, 500, 70, 130, 100, 55, 80, 65, 45, 50, 166, false, null, true),
			new PokemonForm("Delta-mega", SpeciesFormKey.DELTA_MEGA, Type.ICE, Type.FIGHTING, 1.8, 118.0, Abilities.ADAPTABILITY, Abilities.ADAPTABILITY, Abilities.ADAPTABILITY, 600, 70, 150, 140, 65, 100, 75, 22.5, 50, 332, false, null, false),
    ...
    new PokemonSpecies(Species.SHUCKLE, 2, false, false, false, "Mold Pokémon", Type.BUG, Type.ROCK, 0.6, 20.5, Abilities.STURDY, Abilities.GLUTTONY, Abilities.CONTRARY, 505, 20, 10, 230, 10, 230, 5, 190, 50, 177, GrowthRate.MEDIUM_SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.BUG, Type.ROCK, 0.6, 20.5, Abilities.STURDY, Abilities.GLUTTONY, Abilities.CONTRARY, 505, 20, 10, 230, 10, 230, 5, 190, 50, 177),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FIGHTING, Type.STEEL, 0.6, 41.0, Abilities.STURDY, Abilities.NO_GUARD, Abilities.IRON_BARBS, 505, 20, 10, 230, 10, 230, 5, 190, 50, 168, false, null, true),
	),
    ...
    new PokemonSpecies(Species.REMORAID, 2, false, false, false, "Jet Pokémon", Type.WATER, null, 0.6, 12, Abilities.HUSTLE, Abilities.SNIPER, Abilities.MOODY, 300, 35, 65, 35, 65, 35, 65, 190, 50, 60, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.WATER, null, 0.6, 12, Abilities.HUSTLE, Abilities.SNIPER, Abilities.MOODY, 300, 35, 65, 35, 65, 35, 65, 190, 50, 60),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FIRE, null, 0.6, 12.0, Abilities.HEATPROOF, Abilities.WHITE_SMOKE, Abilities.CONTRARY, 300, 35, 65, 35, 65, 35, 65, 190, 50, 100, false, null, true),
	),
    new PokemonSpecies(Species.OCTILLERY, 2, false, false, false, "Jet Pokémon", Type.WATER, null, 0.9, 28.5, Abilities.SUCTION_CUPS, Abilities.SNIPER, Abilities.MOODY, 480, 75, 105, 75, 105, 75, 45, 75, 50, 168, GrowthRate.MEDIUM_FAST, 50, true, true,
      new PokemonForm("Normal", "", Type.WATER, null, 0.9, 28.5, Abilities.SUCTION_CUPS, Abilities.SNIPER, Abilities.MOODY, 480, 75, 105, 75, 105, 75, 45, 75, 50, 168),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FIRE, null, 0.9, 28.5, Abilities.HEATPROOF, Abilities.WHITE_SMOKE, Abilities.CONTRARY, 480, 75, 105, 75, 105, 75, 45, 75, 50, 160, false, null, true),
	),
    ...
    new PokemonSpecies(Species.ELEKID, 2, false, false, false, "Electric Pokémon", Type.ELECTRIC, null, 0.6, 23.5, Abilities.STATIC, Abilities.NONE, Abilities.VITAL_SPIRIT, 360, 45, 63, 37, 65, 55, 95, 45, 50, 72, GrowthRate.MEDIUM_FAST, 75, false, true,
      new PokemonForm("Normal", "", Type.ELECTRIC, null, 0.6, 23.5, Abilities.STATIC, Abilities.NONE, Abilities.VITAL_SPIRIT, 360, 45, 63, 37, 65, 55, 95, 45, 50, 72),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ROCK, null, 0.6, 35.5, Abilities.INNER_FOCUS, Abilities.NONE, Abilities.BATTLE_ARMOR, 360, 45, 63, 37, 65, 55, 95, 45, 50, 120, false, null, true),
	),
    new PokemonSpecies(Species.MAGBY, 2, false, false, false, "Live Coal Pokémon", Type.FIRE, null, 0.7, 21.4, Abilities.FLAME_BODY, Abilities.NONE, Abilities.VITAL_SPIRIT, 365, 45, 75, 37, 70, 55, 83, 45, 50, 73, GrowthRate.MEDIUM_FAST, 75, false, true,
      new PokemonForm("Normal", "", Type.FIRE, null, 0.7, 21.4, Abilities.FLAME_BODY, Abilities.NONE, Abilities.VITAL_SPIRIT, 365, 45, 75, 37, 70, 55, 83, 45, 50, 73),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.WATER, null, 0.7, 21.4, Abilities.SWIFT_SWIM, Abilities.NONE, Abilities.RAIN_DISH, 365, 45, 75, 37, 70, 55, 83, 45, 50, 121, false, null, true),
	),
    ...
    new PokemonSpecies(Species.TREECKO, 3, false, false, false, "Wood Gecko Pokémon", Type.GRASS, null, 0.5, 5, Abilities.OVERGROW, Abilities.NONE, Abilities.UNBURDEN, 310, 40, 45, 35, 65, 55, 70, 45, 50, 62, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
      new PokemonForm("Normal", "", Type.GRASS, null, 0.5, 5, Abilities.OVERGROW, Abilities.NONE, Abilities.UNBURDEN, 310, 40, 45, 35, 65, 55, 70, 45, 50, 62),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.NORMAL, Type.FIGHTING, 0.5, 5.0, Abilities.INNER_FOCUS, Abilities.NONE, Abilities.GUTS, 310, 40, 45, 35, 65, 55, 70, 45, 50, 103, false, null, true),
	),
    new PokemonSpecies(Species.GROVYLE, 3, false, false, false, "Wood Gecko Pokémon", Type.GRASS, null, 0.9, 21.6, Abilities.OVERGROW, Abilities.NONE, Abilities.UNBURDEN, 405, 50, 65, 45, 85, 65, 95, 45, 50, 142, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
      new PokemonForm("Normal", "", Type.GRASS, null, 0.9, 21.6, Abilities.OVERGROW, Abilities.NONE, Abilities.UNBURDEN, 405, 50, 65, 45, 85, 65, 95, 45, 50, 142),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.NORMAL, Type.FIGHTING, 0.9, 21.6, Abilities.INNER_FOCUS, Abilities.NONE, Abilities.GUTS, 405, 50, 65, 45, 85, 65, 95, 45, 50, 135, false, null, true),
	),
    new PokemonSpecies(Species.SCEPTILE, 3, false, false, false, "Forest Pokémon", Type.GRASS, null, 1.7, 52.2, Abilities.OVERGROW, Abilities.NONE, Abilities.UNBURDEN, 530, 70, 85, 65, 105, 85, 120, 45, 50, 265, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.DRAGON, Type.FIGHTING, 1.7, 52.2, Abilities.INNER_FOCUS, Abilities.NONE, Abilities.GUTS, 530, 70, 85, 65, 105, 85, 120, 45, 50, 176, false, null, true),
    ...
    new PokemonSpecies(Species.TORCHIC, 3, false, false, false, "Chick Pokémon", Type.FIRE, null, 0.4, 2.5, Abilities.BLAZE, Abilities.NONE, Abilities.SPEED_BOOST, 310, 45, 60, 40, 70, 50, 45, 45, 50, 62, GrowthRate.MEDIUM_SLOW, 87.5, true, true,
      new PokemonForm("Normal", "", Type.FIRE, null, 0.4, 2.5, Abilities.BLAZE, Abilities.NONE, Abilities.SPEED_BOOST, 310, 45, 60, 40, 70, 50, 45, 45, 50, 62),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.PSYCHIC, null, 0.4, 2.5, Abilities.KEEN_EYE, Abilities.NONE, Abilities.RIVALRY, 310, 45, 60, 40, 70, 50, 45, 45, 50, 103, false, null, true),
	),
    new PokemonSpecies(Species.COMBUSKEN, 3, false, false, false, "Young Fowl Pokémon", Type.FIRE, Type.FIGHTING, 0.9, 19.5, Abilities.BLAZE, Abilities.NONE, Abilities.SPEED_BOOST, 405, 60, 85, 60, 85, 60, 55, 45, 50, 142, GrowthRate.MEDIUM_SLOW, 87.5, true, true,
      new PokemonForm("Normal", "", Type.FIRE, Type.FIGHTING, 0.9, 19.5, Abilities.BLAZE, Abilities.NONE, Abilities.SPEED_BOOST, 405, 60, 85, 60, 85, 60, 55, 45, 50, 142),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.PSYCHIC, null, 0.9, 19.5, Abilities.KEEN_EYE, Abilities.NONE, Abilities.RIVALRY, 405, 60, 85, 60, 85, 60, 55, 45, 50, 135, false, null, true),
	),
    new PokemonSpecies(Species.BLAZIKEN, 3, false, false, false, "Blaze Pokémon", Type.FIRE, Type.FIGHTING, 1.9, 52, Abilities.BLAZE, Abilities.NONE, Abilities.SPEED_BOOST, 530, 80, 120, 70, 110, 70, 80, 45, 50, 265, GrowthRate.MEDIUM_SLOW, 87.5, true, true,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.PSYCHIC, Type.FLYING, 1.9, 52.0, Abilities.KEEN_EYE, Abilities.NONE, Abilities.GALE_WINGS, 530, 80, 120, 70, 110, 70, 80, 45, 50, 176, false, null, true),
    ...
    new PokemonSpecies(Species.LOTAD, 3, false, false, false, "Water Weed Pokémon", Type.WATER, Type.GRASS, 0.5, 2.6, Abilities.SWIFT_SWIM, Abilities.RAIN_DISH, Abilities.OWN_TEMPO, 220, 40, 30, 30, 40, 50, 30, 255, 50, 44, GrowthRate.MEDIUM_SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.WATER, Type.GRASS, 0.5, 2.6, Abilities.SWIFT_SWIM, Abilities.RAIN_DISH, Abilities.OWN_TEMPO, 220, 40, 30, 30, 40, 50, 30, 255, 50, 44),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.PSYCHIC, Type.WATER, 0.5, 2.6, Abilities.MAGIC_BOUNCE, Abilities.SYNCHRONIZE, Abilities.UNAWARE, 220, 40, 30, 30, 40, 50, 30, 255, 50, 73, false, null, true),
	),
    new PokemonSpecies(Species.LOMBRE, 3, false, false, false, "Jolly Pokémon", Type.WATER, Type.GRASS, 1.2, 32.5, Abilities.SWIFT_SWIM, Abilities.RAIN_DISH, Abilities.OWN_TEMPO, 340, 60, 50, 50, 60, 70, 50, 120, 50, 119, GrowthRate.MEDIUM_SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.WATER, Type.GRASS, 1.2, 32.5, Abilities.SWIFT_SWIM, Abilities.RAIN_DISH, Abilities.OWN_TEMPO, 340, 60, 50, 50, 60, 70, 50, 120, 50, 119),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.PSYCHIC, Type.WATER, 1.2, 32.5, Abilities.MAGIC_BOUNCE, Abilities.SYNCHRONIZE, Abilities.UNAWARE, 340, 60, 50, 50, 60, 70, 50, 120, 50, 113, false, null, true),
	),
    new PokemonSpecies(Species.LUDICOLO, 3, false, false, false, "Carefree Pokémon", Type.WATER, Type.GRASS, 1.5, 55, Abilities.SWIFT_SWIM, Abilities.RAIN_DISH, Abilities.OWN_TEMPO, 480, 80, 70, 70, 90, 100, 70, 45, 50, 240, GrowthRate.MEDIUM_SLOW, 50, true, true,
      new PokemonForm("Normal", "", Type.WATER, Type.GRASS, 1.5, 55, Abilities.SWIFT_SWIM, Abilities.RAIN_DISH, Abilities.OWN_TEMPO, 480, 80, 70, 70, 90, 100, 70, 45, 50, 240),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.PSYCHIC, Type.WATER, 1.5, 55.0, Abilities.MAGIC_BOUNCE, Abilities.SYNCHRONIZE, Abilities.UNAWARE, 480, 80, 70, 70, 90, 100, 70, 45, 50, 160, false, null, true),
	),
    new PokemonSpecies(Species.SEEDOT, 3, false, false, false, "Acorn Pokémon", Type.GRASS, null, 0.5, 4, Abilities.CHLOROPHYLL, Abilities.EARLY_BIRD, Abilities.PICKPOCKET, 220, 40, 40, 50, 30, 30, 30, 255, 50, 44, GrowthRate.MEDIUM_SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.GRASS, null, 0.5, 4, Abilities.CHLOROPHYLL, Abilities.EARLY_BIRD, Abilities.PICKPOCKET, 220, 40, 40, 50, 30, 30, 30, 255, 50, 44),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ELECTRIC, null, 0.5, 4.0, Abilities.VOLT_ABSORB, Abilities.MINUS, Abilities.STATIC, 220, 40, 40, 50, 30, 30, 30, 255, 50, 73, false, null, true),
	),
    new PokemonSpecies(Species.NUZLEAF, 3, false, false, false, "Wily Pokémon", Type.GRASS, Type.DARK, 1, 28, Abilities.CHLOROPHYLL, Abilities.EARLY_BIRD, Abilities.PICKPOCKET, 340, 70, 70, 40, 60, 40, 60, 120, 50, 119, GrowthRate.MEDIUM_SLOW, 50, true, true,
      new PokemonForm("Normal", "", Type.GRASS, Type.DARK, 1, 28, Abilities.CHLOROPHYLL, Abilities.EARLY_BIRD, Abilities.PICKPOCKET, 340, 70, 70, 40, 60, 40, 60, 120, 50, 119),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ELECTRIC, null, 1.0, 28.0, Abilities.VOLT_ABSORB, Abilities.MINUS, Abilities.HUBRIS, 340, 70, 70, 40, 60, 40, 60, 120, 50, 113, false, null, true),
	),
    new PokemonSpecies(Species.SHIFTRY, 3, false, false, false, "Wicked Pokémon", Type.GRASS, Type.DARK, 1.3, 59.6, Abilities.CHLOROPHYLL, Abilities.WIND_RIDER, Abilities.PICKPOCKET, 480, 90, 100, 60, 90, 60, 80, 45, 50, 240, GrowthRate.MEDIUM_SLOW, 50, true, true,
      new PokemonForm("Normal", "", Type.GRASS, Type.DARK, 1.3, 59.6, Abilities.CHLOROPHYLL, Abilities.WIND_RIDER, Abilities.PICKPOCKET, 480, 90, 100, 60, 90, 60, 80, 45, 50, 240),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ELECTRIC, null, 1.3, 59.6, Abilities.VOLT_ABSORB, Abilities.MINUS, Abilities.HUBRIS, 480, 90, 100, 60, 90, 60, 80, 45, 50, 160, false, null, true),
	),
    ...
    new PokemonSpecies(Species.RALTS, 3, false, false, false, "Feeling Pokémon", Type.PSYCHIC, Type.FAIRY, 0.4, 6.6, Abilities.SYNCHRONIZE, Abilities.TRACE, Abilities.TELEPATHY, 198, 28, 25, 25, 45, 35, 40, 235, 35, 40, GrowthRate.SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.PSYCHIC, Type.FAIRY, 0.4, 6.6, Abilities.SYNCHRONIZE, Abilities.TRACE, Abilities.TELEPATHY, 198, 28, 25, 25, 45, 35, 40, 235, 35, 40),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ELECTRIC, Type.ICE, 0.4, 6.6, Abilities.LIGHTNING_ROD, Abilities.CLEAR_BODY, Abilities.SNOW_CLOAK, 198, 28, 25, 25, 45, 35, 40, 235, 50, 66, false, null, true),
	),
    new PokemonSpecies(Species.KIRLIA, 3, false, false, false, "Emotion Pokémon", Type.PSYCHIC, Type.FAIRY, 0.8, 20.2, Abilities.SYNCHRONIZE, Abilities.TRACE, Abilities.TELEPATHY, 278, 38, 35, 35, 65, 55, 50, 120, 35, 97, GrowthRate.SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.PSYCHIC, Type.FAIRY, 0.8, 20.2, Abilities.SYNCHRONIZE, Abilities.TRACE, Abilities.TELEPATHY, 278, 38, 35, 35, 65, 55, 50, 120, 35, 97),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ELECTRIC, Type.ICE, 0.8, 20.2, Abilities.LIGHTNING_ROD, Abilities.CLEAR_BODY, Abilities.SNOW_CLOAK, 278, 38, 35, 35, 65, 55, 50, 120, 50, 92, false, null, true),
	),
    new PokemonSpecies(Species.GARDEVOIR, 3, false, false, false, "Embrace Pokémon", Type.PSYCHIC, Type.FAIRY, 1.6, 48.4, Abilities.SYNCHRONIZE, Abilities.TRACE, Abilities.TELEPATHY, 518, 68, 65, 65, 125, 115, 80, 45, 35, 259, GrowthRate.SLOW, 0, false, true,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ELECTRIC, Type.ICE, 1.6, 48.4, Abilities.LIGHTNING_ROD, Abilities.CLEAR_BODY, Abilities.SNOW_CLOAK, 518, 68, 65, 65, 125, 115, 80, 45, 50, 172, true, null, true),
			new PokemonForm("Delta-mega", SpeciesFormKey.DELTA_MEGA, Type.ELECTRIC, Type.ICE, 1.6, 48.4, Abilities.LIGHTNING_ROD, Abilities.LIGHTNING_ROD, Abilities.LIGHTNING_ROD, 618, 68, 85, 65, 165, 135, 100, 22.5, 50, 344, true, null, false),
    ...
    new PokemonSpecies(Species.SABLEYE, 3, false, false, false, "Darkness Pokémon", Type.DARK, Type.GHOST, 0.5, 11, Abilities.KEEN_EYE, Abilities.STALL, Abilities.PRANKSTER, 380, 50, 75, 75, 65, 65, 50, 45, 35, 133, GrowthRate.MEDIUM_SLOW, 50, false, true,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FIRE, Type.ROCK, 0.5, 11.0, Abilities.SOLID_ROCK, Abilities.WEAK_ARMOR, Abilities.UNBURDEN, 380, 50, 75, 75, 65, 65, 50, 45, 50, 126, false, null, true),
			new PokemonForm("Delta-mega", SpeciesFormKey.DELTA_MEGA, Type.FIRE, Type.ROCK, 0.5, 11.0, Abilities.DRY_SKIN, Abilities.DRY_SKIN, Abilities.DRY_SKIN, 480, 50, 85, 125, 85, 115, 20, 22.5, 50, 252, false, null, false),
    ...
    new PokemonSpecies(Species.MAWILE, 3, false, false, false, "Deceiver Pokémon", Type.STEEL, Type.FAIRY, 0.6, 11.5, Abilities.HYPER_CUTTER, Abilities.INTIMIDATE, Abilities.SHEER_FORCE, 380, 50, 85, 85, 55, 55, 50, 45, 50, 133, GrowthRate.FAST, 50, false, true,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GRASS, Type.DARK, 0.6, 11.5, Abilities.SERENE_GRACE, Abilities.FLOWER_VEIL, Abilities.IMMUNITY, 380, 50, 85, 85, 55, 55, 50, 45, 50, 126, false, null, true),
			new PokemonForm("Delta-mega", SpeciesFormKey.DELTA_MEGA, Type.GRASS, Type.DARK, 0.6, 11.5, Abilities.ARENA_TRAP, Abilities.ARENA_TRAP, Abilities.ARENA_TRAP, 480, 50, 105, 125, 55, 95, 50, 22.5, 50, 252, false, null, false),
    ...
    new PokemonSpecies(Species.ARON, 3, false, false, false, "Iron Armor Pokémon", Type.STEEL, Type.ROCK, 0.4, 60, Abilities.STURDY, Abilities.ROCK_HEAD, Abilities.HEAVY_METAL, 330, 50, 70, 100, 40, 40, 30, 180, 35, 66, GrowthRate.SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.STEEL, Type.ROCK, 0.4, 60, Abilities.STURDY, Abilities.ROCK_HEAD, Abilities.HEAVY_METAL, 330, 50, 70, 100, 40, 40, 30, 180, 35, 66),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FIRE, Type.STEEL, 0.4, 60.0, Abilities.FLAME_BODY, Abilities.DROUGHT, Abilities.HEAVY_METAL, 330, 50, 70, 100, 40, 40, 30, 180, 50, 110, false, null, true),
	),
    new PokemonSpecies(Species.LAIRON, 3, false, false, false, "Iron Armor Pokémon", Type.STEEL, Type.ROCK, 0.9, 120, Abilities.STURDY, Abilities.ROCK_HEAD, Abilities.HEAVY_METAL, 430, 60, 90, 140, 50, 50, 40, 90, 35, 151, GrowthRate.SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.STEEL, Type.ROCK, 0.9, 120, Abilities.STURDY, Abilities.ROCK_HEAD, Abilities.HEAVY_METAL, 430, 60, 90, 140, 50, 50, 40, 90, 35, 151),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FIRE, Type.STEEL, 0.9, 120.0, Abilities.FLAME_BODY, Abilities.DROUGHT, Abilities.HEAVY_METAL, 430, 60, 90, 140, 50, 50, 40, 90, 50, 143, false, null, true),
	),
    new PokemonSpecies(Species.AGGRON, 3, false, false, false, "Iron Armor Pokémon", Type.STEEL, Type.ROCK, 2.1, 360, Abilities.STURDY, Abilities.ROCK_HEAD, Abilities.HEAVY_METAL, 530, 70, 110, 180, 60, 60, 50, 45, 35, 265, GrowthRate.SLOW, 50, false, true,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FIRE, Type.STEEL, 2.1, 360.0, Abilities.FLAME_BODY, Abilities.DROUGHT, Abilities.HEAVY_METAL, 530, 70, 110, 180, 60, 60, 50, 45, 50, 176, false, null, true),
    ...
    new PokemonSpecies(Species.MEDITITE, 3, false, false, false, "Meditate Pokémon", Type.FIGHTING, Type.PSYCHIC, 0.6, 11.2, Abilities.PURE_POWER, Abilities.NONE, Abilities.TELEPATHY, 280, 30, 40, 55, 40, 55, 60, 180, 70, 56, GrowthRate.MEDIUM_FAST, 50, true, true,
      new PokemonForm("Normal", "", Type.FIGHTING, Type.PSYCHIC, 0.6, 11.2, Abilities.PURE_POWER, Abilities.NONE, Abilities.TELEPATHY, 280, 30, 40, 55, 40, 55, 60, 180, 70, 56),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FAIRY, null, 0.6, 11.2, Abilities.SAP_SIPPER, Abilities.NONE, Abilities.ATHENIAN, 280, 30, 40, 55, 40, 55, 60, 180, 50, 93, false, null, true),
	),
    new PokemonSpecies(Species.MEDICHAM, 3, false, false, false, "Meditate Pokémon", Type.FIGHTING, Type.PSYCHIC, 1.3, 31.5, Abilities.PURE_POWER, Abilities.NONE, Abilities.TELEPATHY, 410, 60, 60, 75, 60, 75, 80, 90, 70, 144, GrowthRate.MEDIUM_FAST, 50, true, true,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FAIRY, Type.GROUND, 1.3, 31.5, Abilities.SAP_SIPPER, Abilities.NONE, Abilities.ATHENIAN, 410, 60, 60, 75, 60, 75, 80, 90, 50, 136, false, null, true),
			new PokemonForm("Delta-mega", SpeciesFormKey.DELTA_MEGA, Type.FAIRY, Type.GROUND, 1.3, 31.5, Abilities.ATHENIAN, Abilities.ATHENIAN, Abilities.ATHENIAN, 510, 60, 100, 85, 80, 85, 100, 45.0, 50, 272, false, null, false),
    ...
    new PokemonSpecies(Species.PLUSLE, 3, false, false, false, "Cheering Pokémon", Type.ELECTRIC, null, 0.4, 4.2, Abilities.PLUS, Abilities.NONE, Abilities.LIGHTNING_ROD, 405, 60, 50, 40, 85, 75, 95, 200, 70, 142, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.ELECTRIC, null, 0.4, 4.2, Abilities.PLUS, Abilities.NONE, Abilities.LIGHTNING_ROD, 405, 60, 50, 40, 85, 75, 95, 200, 70, 142),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FIRE, Type.FAIRY, 0.4, 4.2, Abilities.CUTE_CHARM, Abilities.NONE, Abilities.PIXILATE, 405, 60, 50, 40, 85, 75, 95, 200, 50, 135, false, null, true),
	),
    new PokemonSpecies(Species.MINUN, 3, false, false, false, "Cheering Pokémon", Type.ELECTRIC, null, 0.4, 4.2, Abilities.MINUS, Abilities.NONE, Abilities.VOLT_ABSORB, 405, 60, 40, 50, 75, 85, 95, 200, 70, 142, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.ELECTRIC, null, 0.4, 4.2, Abilities.MINUS, Abilities.NONE, Abilities.VOLT_ABSORB, 405, 60, 40, 50, 75, 85, 95, 200, 70, 142),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ICE, Type.FAIRY, 0.4, 4.2, Abilities.CUTE_CHARM, Abilities.NONE, Abilities.PIXILATE, 405, 60, 40, 50, 75, 85, 95, 200, 50, 135, false, null, true),
	),
    ...
    new PokemonSpecies(Species.ROSELIA, 3, false, false, false, "Thorn Pokémon", Type.GRASS, Type.POISON, 0.3, 2, Abilities.NATURAL_CURE, Abilities.POISON_POINT, Abilities.LEAF_GUARD, 400, 50, 60, 45, 100, 80, 65, 150, 50, 140, GrowthRate.MEDIUM_SLOW, 50, true, true,
      new PokemonForm("Normal", "", Type.GRASS, Type.POISON, 0.3, 2, Abilities.NATURAL_CURE, Abilities.POISON_POINT, Abilities.LEAF_GUARD, 400, 50, 60, 45, 100, 80, 65, 150, 50, 140),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.DARK, Type.FAIRY, 0.3, 2.0, Abilities.SHADOW_DANCE, Abilities.HELIOPHOBIA, Abilities.LIMBER, 400, 50, 60, 45, 100, 80, 65, 255, 50, 133, false, null, true),
	),
    ...
    new PokemonSpecies(Species.WAILMER, 3, false, false, false, "Ball Whale Pokémon", Type.WATER, null, 2, 130, Abilities.WATER_VEIL, Abilities.OBLIVIOUS, Abilities.PRESSURE, 400, 130, 70, 35, 70, 35, 60, 125, 50, 80, GrowthRate.FLUCTUATING, 50, false, true,
      new PokemonForm("Normal", "", Type.WATER, null, 2, 130, Abilities.WATER_VEIL, Abilities.OBLIVIOUS, Abilities.PRESSURE, 400, 130, 70, 35, 70, 35, 60, 125, 50, 80),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ICE, Type.FLYING, 2.0, 130.0, Abilities.WONDER_SKIN, Abilities.REFRIGERATE, Abilities.SNOW_CLOAK, 400, 130, 70, 35, 70, 35, 60, 125, 50, 133, false, null, true),
	),
    new PokemonSpecies(Species.WAILORD, 3, false, false, false, "Float Whale Pokémon", Type.WATER, null, 14.5, 398, Abilities.WATER_VEIL, Abilities.OBLIVIOUS, Abilities.PRESSURE, 500, 170, 90, 45, 90, 45, 60, 60, 50, 175, GrowthRate.FLUCTUATING, 50, false, true,
      new PokemonForm("Normal", "", Type.WATER, null, 14.5, 398, Abilities.WATER_VEIL, Abilities.OBLIVIOUS, Abilities.PRESSURE, 500, 170, 90, 45, 90, 45, 60, 60, 50, 175),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ICE, Type.FLYING, 14.5, 398.0, Abilities.WONDER_SKIN, Abilities.REFRIGERATE, Abilities.SNOW_WARNING, 500, 170, 90, 45, 90, 45, 60, 60, 50, 166, false, null, true),
	),
    new PokemonSpecies(Species.NUMEL, 3, false, false, false, "Numb Pokémon", Type.FIRE, Type.GROUND, 0.7, 24, Abilities.OBLIVIOUS, Abilities.SIMPLE, Abilities.OWN_TEMPO, 305, 60, 60, 40, 65, 45, 35, 255, 70, 61, GrowthRate.MEDIUM_FAST, 50, true, true,
      new PokemonForm("Normal", "", Type.FIRE, Type.GROUND, 0.7, 24, Abilities.OBLIVIOUS, Abilities.SIMPLE, Abilities.OWN_TEMPO, 305, 60, 60, 40, 65, 45, 35, 255, 70, 61),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.POISON, null, 0.7, 24.0, Abilities.VENOMOUS, Abilities.POISON_POINT, Abilities.LIQUID_OOZE, 305, 60, 60, 40, 65, 45, 35, 255, 50, 101, false, null, true),
	),
    new PokemonSpecies(Species.CAMERUPT, 3, false, false, false, "Eruption Pokémon", Type.FIRE, Type.GROUND, 1.9, 220, Abilities.MAGMA_ARMOR, Abilities.SOLID_ROCK, Abilities.ANGER_POINT, 460, 70, 100, 70, 105, 75, 40, 150, 70, 161, GrowthRate.MEDIUM_FAST, 50, true, true,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.POISON, null, 1.9, 220.0, Abilities.VENOMOUS, Abilities.POISON_POINT, Abilities.LIQUID_OOZE, 460, 70, 100, 70, 105, 75, 40, 150, 50, 153, false, null, true),
			new PokemonForm("Delta-mega", SpeciesFormKey.DELTA_MEGA, Type.POISON, null, 1.9, 220.0, Abilities.VENOMOUS, Abilities.VENOMOUS, Abilities.VENOMOUS, 560, 70, 120, 100, 145, 105, 20, 75.0, 50, 306, false, null, false),
    ...
    new PokemonSpecies(Species.FEEBAS, 3, false, false, false, "Fish Pokémon", Type.WATER, null, 0.6, 7.4, Abilities.SWIFT_SWIM, Abilities.OBLIVIOUS, Abilities.ADAPTABILITY, 200, 20, 15, 20, 10, 55, 80, 255, 50, 40, GrowthRate.ERRATIC, 50, false, true,
      new PokemonForm("Normal", "", Type.WATER, null, 0.6, 7.4, Abilities.SWIFT_SWIM, Abilities.OBLIVIOUS, Abilities.ADAPTABILITY, 200, 20, 15, 20, 10, 55, 80, 255, 50, 40),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GHOST, null, 0.6, 7.4, Abilities.RATTLED, Abilities.RUN_AWAY, Abilities.SPIRIT_CALL, 200, 20, 15, 20, 10, 55, 80, 255, 50, 66, false, null, true),
	),
    new PokemonSpecies(Species.MILOTIC, 3, false, false, false, "Tender Pokémon", Type.WATER, null, 6.2, 162, Abilities.MARVEL_SCALE, Abilities.COMPETITIVE, Abilities.CUTE_CHARM, 540, 95, 60, 79, 100, 125, 81, 60, 50, 189, GrowthRate.ERRATIC, 50, true, true,
      new PokemonForm("Normal", "", Type.WATER, null, 6.2, 162, Abilities.MARVEL_SCALE, Abilities.COMPETITIVE, Abilities.CUTE_CHARM, 540, 95, 60, 79, 100, 125, 81, 60, 50, 189),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GHOST, null, 6.2, 162.0, Abilities.REGENERATOR, Abilities.DEFIANT, Abilities.CURSED_BODY, 540, 95, 60, 79, 100, 125, 81, 60, 50, 180, false, null, true),
			new PokemonForm("Delta-mega", SpeciesFormKey.DELTA_MEGA, Type.GHOST, null, 6.2, 162.0, Abilities.ABSOLUTION, Abilities.ABSOLUTION, Abilities.ABSOLUTION, 640, 95, 70, 109, 130, 155, 81, 30.0, 50, 360, false, null, false),
	),
    ...
    new PokemonSpecies(Species.SNORUNT, 3, false, false, false, "Snow Hat Pokémon", Type.ICE, null, 0.7, 16.8, Abilities.INNER_FOCUS, Abilities.ICE_BODY, Abilities.MOODY, 300, 50, 50, 50, 50, 50, 50, 190, 50, 60, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.ICE, null, 0.7, 16.8, Abilities.INNER_FOCUS, Abilities.ICE_BODY, Abilities.MOODY, 300, 50, 50, 50, 50, 50, 50, 190, 50, 60),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FIRE, null, 0.7, 16.8, Abilities.WHITE_SMOKE, Abilities.NONE, Abilities.FLASH_FIRE, 300, 50, 50, 50, 50, 50, 50, 190, 50, 100, false, null, true),
	),
    new PokemonSpecies(Species.GLALIE, 3, false, false, false, "Face Pokémon", Type.ICE, null, 1.5, 256.5, Abilities.INNER_FOCUS, Abilities.ICE_BODY, Abilities.MOODY, 480, 80, 80, 80, 80, 80, 80, 75, 50, 168, GrowthRate.MEDIUM_FAST, 100, false, true,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FIRE, Type.ROCK, 1.5, 256.5, Abilities.ROCK_HEAD, Abilities.NONE, Abilities.FLASH_FIRE, 480, 80, 80, 80, 80, 80, 80, 75, 50, 160, false, null, true),
			new PokemonForm("Delta-mega", SpeciesFormKey.DELTA_MEGA, Type.FIRE, Type.ROCK, 1.5, 256.5, Abilities.RECKLESS, Abilities.RECKLESS, Abilities.RECKLESS, 580, 80, 120, 80, 120, 80, 100, 37.5, 50, 320, false, null, false),
    ...
    new PokemonSpecies(Species.CLAMPERL, 3, false, false, false, "Bivalve Pokémon", Type.WATER, null, 0.4, 52.5, Abilities.SHELL_ARMOR, Abilities.NONE, Abilities.RATTLED, 345, 35, 64, 85, 74, 55, 32, 255, 70, 69, GrowthRate.ERRATIC, 50, false, true,
      new PokemonForm("Normal", "", Type.WATER, null, 0.4, 52.5, Abilities.SHELL_ARMOR, Abilities.NONE, Abilities.RATTLED, 345, 35, 64, 85, 74, 55, 32, 255, 70, 69),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.DRAGON, null, 0.4, 52.5, Abilities.PRESSURE, Abilities.NONE, Abilities.BATTLE_ARMOR, 346, 35, 65, 85, 74, 55, 32, 255, 50, 115, false, null, true),
	),
    new PokemonSpecies(Species.HUNTAIL, 3, false, false, false, "Deep Sea Pokémon", Type.WATER, null, 1.7, 27, Abilities.SWIFT_SWIM, Abilities.NONE, Abilities.WATER_VEIL, 485, 55, 104, 105, 94, 75, 52, 60, 70, 170, GrowthRate.ERRATIC, 50, false, true,
      new PokemonForm("Normal", "", Type.WATER, null, 1.7, 27, Abilities.SWIFT_SWIM, Abilities.NONE, Abilities.WATER_VEIL, 485, 55, 104, 105, 94, 75, 52, 60, 70, 170),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.DRAGON, Type.DARK, 1.7, 27.0, Abilities.PRESSURE, Abilities.NONE, Abilities.STRONG_JAW, 485, 55, 104, 105, 94, 75, 52, 60, 50, 161, false, null, true),
	),
    new PokemonSpecies(Species.GOREBYSS, 3, false, false, false, "South Sea Pokémon", Type.WATER, null, 1.8, 22.6, Abilities.SWIFT_SWIM, Abilities.NONE, Abilities.HYDRATION, 485, 55, 84, 105, 114, 75, 52, 60, 70, 170, GrowthRate.ERRATIC, 50, false, true,
      new PokemonForm("Normal", "", Type.WATER, null, 1.8, 22.6, Abilities.SWIFT_SWIM, Abilities.NONE, Abilities.HYDRATION, 485, 55, 84, 105, 114, 75, 52, 60, 70, 170),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.DRAGON, Type.FAIRY, 1.8, 22.6, Abilities.PRESSURE, Abilities.NONE, Abilities.MARVEL_SCALE, 485, 55, 84, 105, 114, 75, 52, 60, 50, 161, false, null, true),
	),
    ...
    new PokemonSpecies(Species.BELDUM, 3, false, false, false, "Iron Ball Pokémon", Type.STEEL, Type.PSYCHIC, 0.6, 95.2, Abilities.CLEAR_BODY, Abilities.NONE, Abilities.LIGHT_METAL, 300, 40, 55, 80, 35, 60, 30, 3, 35, 60, GrowthRate.SLOW, null, false, true,
      new PokemonForm("Normal", "", Type.STEEL, Type.PSYCHIC, 0.6, 95.2, Abilities.CLEAR_BODY, Abilities.NONE, Abilities.LIGHT_METAL, 300, 40, 55, 80, 35, 60, 30, 3, 35, 60),
      new PokemonForm("Delta-ruin", "delta-ruin", Type.GRASS, Type.ROCK, 0.6, 95.2, Abilities.STURDY, Abilities.NONE, Abilities.ROCK_HEAD, 300, 40, 55, 80, 35, 60, 30, 3, 50, 100, false, null, true),
			new PokemonForm("Delta-spider", "delta-spider", Type.GROUND, Type.BUG, 0.6, 47.6, Abilities.POISON_TOUCH, Abilities.IMMUNITY, Abilities.POISON_HEAL, 300, 40, 55, 80, 35, 60, 30, 3, 50, 100, false, null, true),
	),
    new PokemonSpecies(Species.METANG, 3, false, false, false, "Iron Claw Pokémon", Type.STEEL, Type.PSYCHIC, 1.2, 202.5, Abilities.CLEAR_BODY, Abilities.NONE, Abilities.LIGHT_METAL, 420, 60, 75, 100, 55, 80, 50, 3, 35, 147, GrowthRate.SLOW, null, false, true,
      new PokemonForm("Normal", "", Type.STEEL, Type.PSYCHIC, 1.2, 202.5, Abilities.CLEAR_BODY, Abilities.NONE, Abilities.LIGHT_METAL, 420, 60, 75, 100, 55, 80, 50, 3, 35, 147),
      new PokemonForm("Delta-ruin", "delta-ruin", Type.GRASS, Type.ROCK, 1.2, 202.5, Abilities.STURDY, Abilities.NONE, Abilities.ROCK_HEAD, 420, 60, 75, 100, 55, 80, 50, 3, 50, 140, false, null, true),
			new PokemonForm("Delta-spider", "delta-spider", Type.GROUND, Type.BUG, 1.2, 101.3, Abilities.POISON_TOUCH, Abilities.IMMUNITY, Abilities.POISON_HEAL, 420, 60, 75, 100, 55, 80, 50, 3, 50, 140, false, null, true),
	),
    new PokemonSpecies(Species.METAGROSS, 3, false, false, false, "Iron Leg Pokémon", Type.STEEL, Type.PSYCHIC, 1.6, 550, Abilities.CLEAR_BODY, Abilities.NONE, Abilities.LIGHT_METAL, 600, 80, 135, 130, 95, 90, 70, 3, 35, 300, GrowthRate.SLOW, null, false, true,
      ...
      new PokemonForm("Delta-ruin", "delta-ruin", Type.GRASS, Type.ROCK, 1.6, 550.0, Abilities.STURDY, Abilities.NONE, Abilities.ROCK_HEAD, 600, 80, 135, 130, 95, 90, 70, 3, 50, 200, false, null, true),
			new PokemonForm("Delta-spider", "delta-spider", Type.GROUND, Type.BUG, 1.5, 225.0, Abilities.POISON_TOUCH, Abilities.IMMUNITY, Abilities.POISON_HEAL, 600, 80, 135, 130, 95, 90, 70, 3, 50, 200, false, null, true),
			new PokemonForm("Delta-ruin-mega", "delta-ruin-mega", Type.GRASS, Type.ROCK, 1.6, 550.0, Abilities.ROCK_HEAD, Abilities.ROCK_HEAD, Abilities.ROCK_HEAD, 700, 80, 145, 150, 105, 110, 110, 1.5, 50, 400, false, null, false),
      new PokemonForm("Delta-spider-mega", "delta-spider-mega", Type.GROUND, Type.BUG, 1.5, 225.0, Abilities.MOLD_BREAKER, Abilities.MOLD_BREAKER, Abilities.MOLD_BREAKER, 700, 80, 145, 150, 105, 110, 110, 1.5, 50, 400, false, null, false),
    ...
    new PokemonSpecies(Species.REGIROCK, 3, true, false, false, "Rock Peak Pokémon", Type.ROCK, null, 1.7, 230, Abilities.CLEAR_BODY, Abilities.NONE, Abilities.STURDY, 580, 80, 100, 200, 50, 100, 50, 3, 35, 290, GrowthRate.SLOW, null, false, true,
      new PokemonForm("Normal", "", Type.ROCK, null, 1.7, 230, Abilities.CLEAR_BODY, Abilities.NONE, Abilities.STURDY, 580, 80, 100, 200, 50, 100, 50, 3, 35, 290),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GROUND, null, 1.7, 230.0, Abilities.SAND_VEIL, Abilities.NONE, Abilities.DRY_SKIN, 580, 80, 100, 200, 50, 100, 50, 3, 50, 193, false, null, true),
	),
    new PokemonSpecies(Species.REGICE, 3, true, false, false, "Iceberg Pokémon", Type.ICE, null, 1.8, 175, Abilities.CLEAR_BODY, Abilities.NONE, Abilities.ICE_BODY, 580, 80, 50, 100, 100, 200, 50, 3, 35, 290, GrowthRate.SLOW, null, false, true,
      new PokemonForm("Normal", "", Type.ICE, null, 1.8, 175, Abilities.CLEAR_BODY, Abilities.NONE, Abilities.ICE_BODY, 580, 80, 50, 100, 100, 200, 50, 3, 35, 290),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.WATER, null, 1.8, 175.0, Abilities.WATER_VEIL, Abilities.NONE, Abilities.STORM_DRAIN, 580, 80, 50, 100, 100, 200, 50, 3, 50, 193, false, null, true),
	),
    new PokemonSpecies(Species.REGISTEEL, 3, true, false, false, "Iron Pokémon", Type.STEEL, null, 1.9, 205, Abilities.CLEAR_BODY, Abilities.NONE, Abilities.LIGHT_METAL, 580, 80, 75, 150, 75, 150, 50, 3, 35, 290, GrowthRate.SLOW, null, false, true,
      new PokemonForm("Normal", "", Type.STEEL, null, 1.9, 205, Abilities.CLEAR_BODY, Abilities.NONE, Abilities.LIGHT_METAL, 580, 80, 75, 150, 75, 150, 50, 3, 35, 290),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FIRE, null, 1.9, 205.0, Abilities.FLAME_BODY, Abilities.NONE, Abilities.FOUNDRY, 580, 80, 75, 150, 75, 150, 50, 3, 50, 193, false, null, true),
	),
    ...
    new PokemonSpecies(Species.TURTWIG, 4, false, false, false, "Tiny Leaf Pokémon", Type.GRASS, null, 0.4, 10.2, Abilities.OVERGROW, Abilities.NONE, Abilities.SHELL_ARMOR, 318, 55, 68, 64, 45, 55, 31, 45, 70, 64, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
      new PokemonForm("Normal", "", Type.GRASS, null, 0.4, 10.2, Abilities.OVERGROW, Abilities.NONE, Abilities.SHELL_ARMOR, 318, 55, 68, 64, 45, 55, 31, 45, 70, 64),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.WATER, Type.GROUND, 0.4, 10.2, Abilities.WATER_ABSORB, Abilities.NONE, Abilities.SWIFT_SWIM, 318, 55, 68, 64, 45, 55, 31, 45, 50, 106, false, null, true),
	),
    new PokemonSpecies(Species.GROTLE, 4, false, false, false, "Grove Pokémon", Type.GRASS, null, 1.1, 97, Abilities.OVERGROW, Abilities.NONE, Abilities.SHELL_ARMOR, 405, 75, 89, 85, 55, 65, 36, 45, 70, 142, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
      new PokemonForm("Normal", "", Type.GRASS, null, 1.1, 97, Abilities.OVERGROW, Abilities.NONE, Abilities.SHELL_ARMOR, 405, 75, 89, 85, 55, 65, 36, 45, 70, 142),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.WATER, Type.GROUND, 1.1, 97.0, Abilities.WATER_ABSORB, Abilities.NONE, Abilities.SWIFT_SWIM, 405, 75, 89, 85, 55, 65, 36, 45, 50, 135, false, null, true),
	),
    new PokemonSpecies(Species.TORTERRA, 4, false, false, false, "Continent Pokémon", Type.GRASS, Type.GROUND, 2.2, 310, Abilities.OVERGROW, Abilities.NONE, Abilities.SHELL_ARMOR, 525, 95, 109, 105, 75, 85, 56, 45, 70, 236, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
      new PokemonForm("Normal", "", Type.GRASS, Type.GROUND, 2.2, 310, Abilities.OVERGROW, Abilities.NONE, Abilities.SHELL_ARMOR, 525, 95, 109, 105, 75, 85, 56, 45, 70, 236),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.WATER, Type.GROUND, 2.2, 310.0, Abilities.WATER_ABSORB, Abilities.NONE, Abilities.SWIFT_SWIM, 525, 95, 109, 105, 75, 85, 56, 45, 50, 175, false, null, true),
	),
    ...
    new PokemonSpecies(Species.SHINX, 4, false, false, false, "Flash Pokémon", Type.ELECTRIC, null, 0.5, 9.5, Abilities.RIVALRY, Abilities.INTIMIDATE, Abilities.GUTS, 263, 45, 65, 34, 40, 34, 45, 235, 50, 53, GrowthRate.MEDIUM_SLOW, 50, true, true,
      new PokemonForm("Normal", "", Type.ELECTRIC, null, 0.5, 9.5, Abilities.RIVALRY, Abilities.INTIMIDATE, Abilities.GUTS, 263, 45, 65, 34, 40, 34, 45, 235, 50, 53),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.STEEL, Type.POISON, 0.5, 19.0, Abilities.POISON_TOUCH, Abilities.VAMPIRIC, Abilities.VENOMOUS, 263, 45, 65, 34, 40, 34, 45, 235, 50, 87, false, null, true),
	),
    new PokemonSpecies(Species.LUXIO, 4, false, false, false, "Spark Pokémon", Type.ELECTRIC, null, 0.9, 30.5, Abilities.RIVALRY, Abilities.INTIMIDATE, Abilities.GUTS, 363, 60, 85, 49, 60, 49, 60, 120, 100, 127, GrowthRate.MEDIUM_SLOW, 50, true, true,
      new PokemonForm("Normal", "", Type.ELECTRIC, null, 0.9, 30.5, Abilities.RIVALRY, Abilities.INTIMIDATE, Abilities.GUTS, 363, 60, 85, 49, 60, 49, 60, 120, 100, 127),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.STEEL, Type.POISON, 0.9, 61.0, Abilities.POISON_TOUCH, Abilities.VAMPIRIC, Abilities.VENOMOUS, 363, 60, 85, 49, 60, 49, 60, 120, 50, 121, false, null, true),
	),
    new PokemonSpecies(Species.LUXRAY, 4, false, false, false, "Gleam Eyes Pokémon", Type.ELECTRIC, null, 1.4, 42, Abilities.RIVALRY, Abilities.INTIMIDATE, Abilities.GUTS, 523, 80, 120, 79, 95, 79, 70, 45, 50, 262, GrowthRate.MEDIUM_SLOW, 50, true, true,
      new PokemonForm("Normal", "", Type.ELECTRIC, null, 1.4, 42, Abilities.RIVALRY, Abilities.INTIMIDATE, Abilities.GUTS, 523, 80, 120, 79, 95, 79, 70, 45, 50, 262),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.STEEL, Type.POISON, 1.4, 84.0, Abilities.POISON_TOUCH, Abilities.VAMPIRIC, Abilities.VENOMOUS, 523, 80, 120, 79, 95, 79, 70, 45, 50, 174, false, null, true),
	),
    new PokemonSpecies(Species.BUDEW, 4, false, false, false, "Bud Pokémon", Type.GRASS, Type.POISON, 0.2, 1.2, Abilities.NATURAL_CURE, Abilities.POISON_POINT, Abilities.LEAF_GUARD, 280, 40, 30, 35, 50, 70, 55, 255, 50, 56, GrowthRate.MEDIUM_SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.GRASS, Type.POISON, 0.2, 1.2, Abilities.NATURAL_CURE, Abilities.POISON_POINT, Abilities.LEAF_GUARD, 280, 40, 30, 35, 50, 70, 55, 255, 50, 56),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.DARK, Type.FAIRY, 0.2, 1.2, Abilities.SHADOW_DANCE, Abilities.HELIOPHOBIA, Abilities.INNER_FOCUS, 280, 40, 30, 35, 50, 70, 55, 255, 50, 93, false, null, true),
	),
    new PokemonSpecies(Species.ROSERADE, 4, false, false, false, "Bouquet Pokémon", Type.GRASS, Type.POISON, 0.9, 14.5, Abilities.NATURAL_CURE, Abilities.POISON_POINT, Abilities.TECHNICIAN, 515, 60, 70, 65, 125, 105, 90, 75, 50, 258, GrowthRate.MEDIUM_SLOW, 50, true, true,
      new PokemonForm("Normal", "", Type.GRASS, Type.POISON, 0.9, 14.5, Abilities.NATURAL_CURE, Abilities.POISON_POINT, Abilities.TECHNICIAN, 515, 60, 70, 65, 125, 105, 90, 75, 50, 258),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.DARK, Type.FAIRY, 0.9, 14.5, Abilities.SHADOW_DANCE, Abilities.HELIOPHOBIA, Abilities.LIMBER, 515, 60, 70, 65, 125, 105, 90, 255, 50, 171, false, null, true),
	),
    ...
    new PokemonSpecies(Species.COMBEE, 4, false, false, false, "Tiny Bee Pokémon", Type.BUG, Type.FLYING, 0.3, 5.5, Abilities.HONEY_GATHER, Abilities.NONE, Abilities.HUSTLE, 244, 30, 30, 42, 30, 42, 70, 120, 50, 49, GrowthRate.MEDIUM_SLOW, 87.5, true, true,
      new PokemonForm("Normal", "", Type.BUG, Type.FLYING, 0.3, 5.5, Abilities.HONEY_GATHER, Abilities.NONE, Abilities.HUSTLE, 244, 30, 30, 42, 30, 42, 70, 120, 50, 49),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.STEEL, Type.FIRE, 0.3, 11.0, Abilities.LEVITATE, Abilities.NONE, Abilities.SPEED_BOOST, 244, 30, 30, 42, 30, 42, 70, 120, 50, 81, false, null, true),
	),
    new PokemonSpecies(Species.VESPIQUEN, 4, false, false, false, "Beehive Pokémon", Type.BUG, Type.FLYING, 1.2, 38.5, Abilities.PRESSURE, Abilities.NONE, Abilities.UNNERVE, 474, 70, 80, 102, 80, 102, 40, 45, 50, 166, GrowthRate.MEDIUM_SLOW, 0, false, true,
      new PokemonForm("Normal", "", Type.BUG, Type.FLYING, 1.2, 38.5, Abilities.PRESSURE, Abilities.NONE, Abilities.UNNERVE, 474, 70, 80, 102, 80, 102, 40, 45, 50, 166),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.STEEL, Type.FIRE, 1.2, 77.0, Abilities.LEVITATE, Abilities.NONE, Abilities.SPEED_BOOST, 474, 70, 80, 102, 80, 102, 40, 45, 50, 158, false, null, true),
	),
    ...
    new PokemonSpecies(Species.AMBIPOM, 4, false, false, false, "Long Tail Pokémon", Type.NORMAL, null, 1.2, 20.3, Abilities.TECHNICIAN, Abilities.PICKUP, Abilities.SKILL_LINK, 482, 75, 100, 66, 60, 66, 115, 45, 100, 169, GrowthRate.FAST, 50, true, true,
      new PokemonForm("Normal", "", Type.NORMAL, null, 1.2, 20.3, Abilities.TECHNICIAN, Abilities.PICKUP, Abilities.SKILL_LINK, 482, 75, 100, 66, 60, 66, 115, 45, 100, 169),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GHOST, Type.NORMAL, 1.2, 20.3, Abilities.CURSED_BODY, Abilities.INFILTRATOR, Abilities.TECHNICIAN, 482, 75, 100, 66, 60, 66, 115, 45, 50, 160, false, null, true),
	),
    new PokemonSpecies(Species.DRIFLOON, 4, false, false, false, "Balloon Pokémon", Type.GHOST, Type.FLYING, 0.4, 1.2, Abilities.AFTERMATH, Abilities.UNBURDEN, Abilities.FLARE_BOOST, 348, 90, 50, 34, 60, 44, 70, 125, 50, 70, GrowthRate.FLUCTUATING, 50, false, true,
      new PokemonForm("Normal", "", Type.GHOST, Type.FLYING, 0.4, 1.2, Abilities.AFTERMATH, Abilities.UNBURDEN, Abilities.FLARE_BOOST, 348, 90, 50, 34, 60, 44, 70, 125, 50, 70),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FIRE, Type.FLYING, 0.4, 1.2, Abilities.FLASH_FIRE, Abilities.VITAL_SPIRIT, Abilities.NO_GUARD, 348, 90, 50, 34, 60, 44, 70, 125, 50, 116, false, null, true),
	),
    new PokemonSpecies(Species.DRIFBLIM, 4, false, false, false, "Blimp Pokémon", Type.GHOST, Type.FLYING, 1.2, 15, Abilities.AFTERMATH, Abilities.UNBURDEN, Abilities.FLARE_BOOST, 498, 150, 80, 44, 90, 54, 80, 60, 50, 174, GrowthRate.FLUCTUATING, 50, false, true,
      new PokemonForm("Normal", "", Type.GHOST, Type.FLYING, 1.2, 15, Abilities.AFTERMATH, Abilities.UNBURDEN, Abilities.FLARE_BOOST, 498, 150, 80, 44, 90, 54, 80, 60, 50, 174),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FIRE, Type.FLYING, 1.2, 15.0, Abilities.FLASH_FIRE, Abilities.VITAL_SPIRIT, Abilities.NO_GUARD, 498, 150, 80, 44, 90, 54, 80, 60, 50, 166, false, null, true),
	),
    new PokemonSpecies(Species.BUNEARY, 4, false, false, false, "Rabbit Pokémon", Type.NORMAL, null, 0.4, 5.5, Abilities.RUN_AWAY, Abilities.KLUTZ, Abilities.LIMBER, 350, 55, 66, 44, 44, 56, 85, 190, 0, 70, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.NORMAL, null, 0.4, 5.5, Abilities.RUN_AWAY, Abilities.KLUTZ, Abilities.LIMBER, 350, 55, 66, 44, 44, 56, 85, 190, 0, 70),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FIGHTING, null, 0.4, 5.5, Abilities.PICKPOCKET, Abilities.FRISK, Abilities.LIMBER, 350, 55, 66, 44, 44, 56, 85, 190, 50, 116, false, null, true),
	),
    new PokemonSpecies(Species.LOPUNNY, 4, false, false, false, "Rabbit Pokémon", Type.NORMAL, null, 1.2, 33.3, Abilities.CUTE_CHARM, Abilities.KLUTZ, Abilities.LIMBER, 480, 65, 76, 84, 54, 96, 105, 60, 140, 168, GrowthRate.MEDIUM_FAST, 50, false, true,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FIGHTING, null, 1.2, 33.3, Abilities.UNBURDEN, Abilities.INNER_FOCUS, Abilities.LIMBER, 480, 65, 76, 84, 54, 96, 105, 60, 50, 160, false, null, true),
			new PokemonForm("Delta-mega", SpeciesFormKey.DELTA_MEGA, Type.FIGHTING, Type.PSYCHIC, 1.2, 33.3, Abilities.INFILTRATOR, Abilities.INFILTRATOR, Abilities.INFILTRATOR, 580, 65, 136, 94, 54, 96, 135, 30.0, 50, 320, false, null, false),
    ...
    new PokemonSpecies(Species.MISMAGIUS, 4, false, false, false, "Magical Pokémon", Type.GHOST, null, 0.9, 4.4, Abilities.LEVITATE, Abilities.NONE, Abilities.NONE, 495, 60, 60, 60, 105, 105, 105, 45, 35, 173, GrowthRate.FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.GHOST, null, 0.9, 4.4, Abilities.LEVITATE, Abilities.NONE, Abilities.NONE, 495, 60, 60, 60, 105, 105, 105, 45, 35, 173),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ICE, Type.FAIRY, 0.9, 4.4, Abilities.MAGIC_GUARD, Abilities.NONE, Abilities.WINTER_JOY, 495, 60, 60, 60, 105, 105, 105, 45, 50, 165, false, null, true),
	),
    ...
    new PokemonSpecies(Species.MUNCHLAX, 4, false, false, false, "Big Eater Pokémon", Type.NORMAL, null, 0.6, 105, Abilities.PICKUP, Abilities.THICK_FAT, Abilities.GLUTTONY, 390, 135, 85, 40, 40, 85, 5, 50, 50, 78, GrowthRate.SLOW, 87.5, false, true,
      new PokemonForm("Normal", "", Type.NORMAL, null, 0.6, 105, Abilities.PICKUP, Abilities.THICK_FAT, Abilities.GLUTTONY, 390, 135, 85, 40, 40, 85, 5, 50, 50, 78),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GRASS, null, 0.6, 105.0, Abilities.OVERCOAT, Abilities.THICK_FAT, Abilities.ADAPTABILITY, 390, 135, 85, 40, 40, 85, 5, 50, 50, 130, false, null, true),
	),
    new PokemonSpecies(Species.RIOLU, 4, false, false, false, "Emanation Pokémon", Type.FIGHTING, null, 0.7, 20.2, Abilities.STEADFAST, Abilities.INNER_FOCUS, Abilities.PRANKSTER, 285, 40, 70, 40, 35, 40, 60, 75, 50, 57, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
      new PokemonForm("Normal", "", Type.FIGHTING, null, 0.7, 20.2, Abilities.STEADFAST, Abilities.INNER_FOCUS, Abilities.PRANKSTER, 285, 40, 70, 40, 35, 40, 60, 75, 50, 57),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.DARK, null, 0.7, 20.2, Abilities.JUSTIFIED, Abilities.PRESSURE, Abilities.MUMMY, 285, 40, 70, 40, 35, 40, 60, 75, 50, 95, false, null, true),
	),
    new PokemonSpecies(Species.LUCARIO, 4, false, false, false, "Aura Pokémon", Type.FIGHTING, Type.STEEL, 1.2, 54, Abilities.STEADFAST, Abilities.INNER_FOCUS, Abilities.JUSTIFIED, 525, 70, 110, 70, 115, 70, 90, 45, 50, 184, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.DARK, Type.GROUND, 1.2, 54.0, Abilities.JUSTIFIED, Abilities.PRESSURE, Abilities.MUMMY, 525, 70, 110, 70, 115, 70, 90, 45, 50, 175, false, null, true),
			new PokemonForm("Delta-mega", SpeciesFormKey.DELTA_MEGA, Type.DARK, Type.GROUND, 1.2, 54.0, Abilities.DEFIANT, Abilities.DEFIANT, Abilities.DEFIANT, 625, 70, 145, 88, 140, 70, 112, 22.5, 50, 350, false, null, false),
    ...
    new PokemonSpecies(Species.CROAGUNK, 4, false, false, false, "Toxic Mouth Pokémon", Type.POISON, Type.FIGHTING, 0.7, 23, Abilities.ANTICIPATION, Abilities.DRY_SKIN, Abilities.POISON_TOUCH, 300, 48, 61, 40, 61, 40, 50, 140, 100, 60, GrowthRate.MEDIUM_FAST, 50, true, true,
      new PokemonForm("Normal", "", Type.POISON, Type.FIGHTING, 0.7, 23, Abilities.ANTICIPATION, Abilities.DRY_SKIN, Abilities.POISON_TOUCH, 300, 48, 61, 40, 61, 40, 50, 140, 100, 60),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FIRE, null, 0.7, 23.0, Abilities.MAGMA_ARMOR, Abilities.BLAZE, Abilities.HUSTLE, 300, 48, 61, 40, 61, 40, 50, 140, 50, 100, false, null, true),
	),
    new PokemonSpecies(Species.TOXICROAK, 4, false, false, false, "Toxic Mouth Pokémon", Type.POISON, Type.FIGHTING, 1.3, 44.4, Abilities.ANTICIPATION, Abilities.DRY_SKIN, Abilities.POISON_TOUCH, 490, 83, 106, 65, 86, 65, 85, 75, 50, 172, GrowthRate.MEDIUM_FAST, 50, true, true,
      new PokemonForm("Normal", "", Type.POISON, Type.FIGHTING, 1.3, 44.4, Abilities.ANTICIPATION, Abilities.DRY_SKIN, Abilities.POISON_TOUCH, 490, 83, 106, 65, 86, 65, 85, 75, 50, 172),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FIRE, null, 1.3, 44.4, Abilities.MAGMA_ARMOR, Abilities.BLAZE, Abilities.HUSTLE, 490, 83, 106, 65, 86, 65, 85, 75, 50, 163, false, null, true),
	),
    ...
    new PokemonSpecies(Species.TANGROWTH, 4, false, false, false, "Vine Pokémon", Type.GRASS, null, 2, 128.6, Abilities.CHLOROPHYLL, Abilities.LEAF_GUARD, Abilities.REGENERATOR, 535, 100, 100, 125, 110, 50, 50, 30, 50, 187, GrowthRate.MEDIUM_FAST, 50, true, true,
      new PokemonForm("Normal", "", Type.GRASS, null, 2, 128.6, Abilities.CHLOROPHYLL, Abilities.LEAF_GUARD, Abilities.REGENERATOR, 535, 100, 100, 125, 110, 50, 50, 30, 50, 187),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GROUND, Type.FIGHTING, 2.0, 128.6, Abilities.DRY_SKIN, Abilities.SAND_FORCE, Abilities.ROUGH_SKIN, 535, 100, 100, 125, 110, 50, 50, 30, 50, 178, false, null, true),
	),
    new PokemonSpecies(Species.ELECTIVIRE, 4, false, false, false, "Thunderbolt Pokémon", Type.ELECTRIC, null, 1.8, 138.6, Abilities.MOTOR_DRIVE, Abilities.NONE, Abilities.VITAL_SPIRIT, 540, 75, 123, 67, 95, 85, 95, 30, 50, 270, GrowthRate.MEDIUM_FAST, 75, false, true,
      new PokemonForm("Normal", "", Type.ELECTRIC, null, 1.8, 138.6, Abilities.MOTOR_DRIVE, Abilities.NONE, Abilities.VITAL_SPIRIT, 540, 75, 123, 67, 95, 85, 95, 30, 50, 270),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ROCK, Type.DRAGON, 1.8, 220.0, Abilities.SHADOW_DANCE, Abilities.NONE, Abilities.STURDY, 540, 75, 123, 67, 95, 85, 95, 30, 50, 180, false, null, true),
	),
    new PokemonSpecies(Species.MAGMORTAR, 4, false, false, false, "Blast Pokémon", Type.FIRE, null, 1.6, 68, Abilities.FLAME_BODY, Abilities.NONE, Abilities.VITAL_SPIRIT, 540, 75, 95, 67, 125, 95, 83, 30, 50, 270, GrowthRate.MEDIUM_FAST, 75, false, true,
      new PokemonForm("Normal", "", Type.FIRE, null, 1.6, 68, Abilities.FLAME_BODY, Abilities.NONE, Abilities.VITAL_SPIRIT, 540, 75, 95, 67, 125, 95, 83, 30, 50, 270),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.WATER, Type.STEEL, 1.6, 102.0, Abilities.MEGA_LAUNCHER, Abilities.NONE, Abilities.FILTER, 540, 75, 95, 67, 125, 95, 83, 30, 50, 180, false, null, true),
	),
    ...
    new PokemonSpecies(Species.YANMEGA, 4, false, false, false, "Ogre Darner Pokémon", Type.BUG, Type.FLYING, 1.9, 51.5, Abilities.SPEED_BOOST, Abilities.TINTED_LENS, Abilities.FRISK, 515, 86, 76, 86, 116, 56, 95, 30, 70, 180, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.BUG, Type.FLYING, 1.9, 51.5, Abilities.SPEED_BOOST, Abilities.TINTED_LENS, Abilities.FRISK, 515, 86, 76, 86, 116, 56, 95, 30, 70, 180),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GRASS, Type.FLYING, 1.9, 51.5, Abilities.ADAPTABILITY, Abilities.CHLOROPHYLL, Abilities.NATURAL_CURE, 515, 86, 76, 86, 116, 56, 95, 30, 50, 171, false, null, true),
	),
    ...
    new PokemonSpecies(Species.GALLADE, 4, false, false, false, "Blade Pokémon", Type.PSYCHIC, Type.FIGHTING, 1.6, 52, Abilities.STEADFAST, Abilities.SHARPNESS, Abilities.JUSTIFIED, 518, 68, 125, 65, 65, 115, 80, 45, 35, 259, GrowthRate.SLOW, 100, false, true,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ELECTRIC, Type.ICE, 1.6, 52.0, Abilities.VOLT_ABSORB, Abilities.NONE, Abilities.ICE_BODY, 518, 68, 125, 65, 65, 115, 80, 45, 50, 172, false, null, true),
			new PokemonForm("Delta-mega", SpeciesFormKey.DELTA_MEGA, Type.ELECTRIC, Type.ICE, 1.6, 52.0, Abilities.VOLT_ABSORB, Abilities.VOLT_ABSORB, Abilities.VOLT_ABSORB, 618, 68, 165, 95, 65, 115, 110, 22.5, 50, 344, false, null, false),
    ...
    new PokemonSpecies(Species.FROSLASS, 4, false, false, false, "Snow Land Pokémon", Type.ICE, Type.GHOST, 1.3, 26.6, Abilities.SNOW_CLOAK, Abilities.NONE, Abilities.CURSED_BODY, 480, 70, 80, 70, 80, 70, 110, 75, 50, 168, GrowthRate.MEDIUM_FAST, 0, false, true,
      new PokemonForm("Normal", "", Type.ICE, Type.GHOST, 1.3, 26.6, Abilities.SNOW_CLOAK, Abilities.NONE, Abilities.CURSED_BODY, 480, 70, 80, 70, 80, 70, 110, 75, 50, 168),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FIRE, null, 1.3, 26.6, Abilities.COMPETITIVE, Abilities.NONE, Abilities.FLASH_FIRE, 480, 70, 80, 70, 80, 70, 110, 75, 50, 160, false, null, true),
			new PokemonForm("Delta-mega", SpeciesFormKey.DELTA_MEGA, Type.FIRE, Type.GHOST, 1.3, 26.6, Abilities.MAGIC_GUARD, Abilities.MAGIC_GUARD, Abilities.MAGIC_GUARD, 580, 70, 80, 85, 120, 105, 120, 37.5, 50, 320, false, null, false),
	),
    ...
    new PokemonSpecies(Species.SNIVY, 5, false, false, false, "Grass Snake Pokémon", Type.GRASS, null, 0.6, 8.1, Abilities.OVERGROW, Abilities.NONE, Abilities.CONTRARY, 308, 45, 45, 55, 45, 55, 63, 45, 70, 62, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
      new PokemonForm("Normal", "", Type.GRASS, null, 0.6, 8.1, Abilities.OVERGROW, Abilities.NONE, Abilities.CONTRARY, 308, 45, 45, 55, 45, 55, 63, 45, 70, 62),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.WATER, null, 0.6, 8.1, Abilities.MULTISCALE, Abilities.NONE, Abilities.HYDRATION, 308, 45, 45, 55, 45, 55, 63, 45, 50, 102, false, null, true),
	),
    new PokemonSpecies(Species.SERVINE, 5, false, false, false, "Grass Snake Pokémon", Type.GRASS, null, 0.8, 16, Abilities.OVERGROW, Abilities.NONE, Abilities.CONTRARY, 413, 60, 60, 75, 60, 75, 83, 45, 70, 145, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
      new PokemonForm("Normal", "", Type.GRASS, null, 0.8, 16, Abilities.OVERGROW, Abilities.NONE, Abilities.CONTRARY, 413, 60, 60, 75, 60, 75, 83, 45, 70, 145),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.WATER, null, 0.8, 16.0, Abilities.MULTISCALE, Abilities.NONE, Abilities.HYDRATION, 413, 60, 60, 75, 60, 75, 83, 45, 50, 137, false, null, true),
	),
    new PokemonSpecies(Species.SERPERIOR, 5, false, false, false, "Regal Pokémon", Type.GRASS, null, 3.3, 63, Abilities.OVERGROW, Abilities.NONE, Abilities.CONTRARY, 528, 75, 75, 95, 75, 95, 113, 45, 70, 238, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
      new PokemonForm("Normal", "", Type.GRASS, null, 3.3, 63, Abilities.OVERGROW, Abilities.NONE, Abilities.CONTRARY, 528, 75, 75, 95, 75, 95, 113, 45, 70, 238),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.WATER, Type.DRAGON, 3.3, 63.0, Abilities.MULTISCALE, Abilities.NONE, Abilities.DRIZZLE, 528, 75, 75, 95, 75, 95, 113, 45, 50, 176, false, null, true),
	),
    ...
    new PokemonSpecies(Species.PURRLOIN, 5, false, false, false, "Devious Pokémon", Type.DARK, null, 0.4, 10.1, Abilities.LIMBER, Abilities.UNBURDEN, Abilities.PRANKSTER, 281, 41, 50, 37, 50, 37, 66, 255, 50, 56, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.DARK, null, 0.4, 10.1, Abilities.LIMBER, Abilities.UNBURDEN, Abilities.PRANKSTER, 281, 41, 50, 37, 50, 37, 66, 255, 50, 56),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GHOST, Type.FAIRY, 0.4, 10.1, Abilities.ILLUSION, Abilities.UNNERVE, Abilities.LIGHTNING_ROD, 281, 41, 50, 37, 50, 37, 66, 255, 50, 93, false, null, true),
	),
    new PokemonSpecies(Species.LIEPARD, 5, false, false, false, "Cruel Pokémon", Type.DARK, null, 1.1, 37.5, Abilities.LIMBER, Abilities.UNBURDEN, Abilities.PRANKSTER, 446, 64, 88, 50, 88, 50, 106, 90, 50, 156, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.DARK, null, 1.1, 37.5, Abilities.LIMBER, Abilities.UNBURDEN, Abilities.PRANKSTER, 446, 64, 88, 50, 88, 50, 106, 90, 50, 156),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GHOST, Type.FAIRY, 1.1, 37.5, Abilities.ILLUSION, Abilities.UNNERVE, Abilities.BULLETPROOF, 446, 64, 88, 50, 88, 50, 106, 90, 50, 148, false, null, true),
	),
    ...
    new PokemonSpecies(Species.VENIPEDE, 5, false, false, false, "Centipede Pokémon", Type.BUG, Type.POISON, 0.4, 5.3, Abilities.POISON_POINT, Abilities.SWARM, Abilities.SPEED_BOOST, 260, 30, 45, 59, 30, 39, 57, 255, 50, 52, GrowthRate.MEDIUM_SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.BUG, Type.POISON, 0.4, 5.3, Abilities.POISON_POINT, Abilities.SWARM, Abilities.SPEED_BOOST, 260, 30, 45, 59, 30, 39, 57, 255, 50, 52),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ROCK, Type.FIRE, 0.4, 8.0, Abilities.WEAK_ARMOR, Abilities.MAGMA_ARMOR, Abilities.MOLD_BREAKER, 260, 30, 45, 59, 30, 39, 57, 255, 50, 86, false, null, true),
	),
    new PokemonSpecies(Species.WHIRLIPEDE, 5, false, false, false, "Curlipede Pokémon", Type.BUG, Type.POISON, 1.2, 58.5, Abilities.POISON_POINT, Abilities.SWARM, Abilities.SPEED_BOOST, 360, 40, 55, 99, 40, 79, 47, 120, 50, 126, GrowthRate.MEDIUM_SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.BUG, Type.POISON, 1.2, 58.5, Abilities.POISON_POINT, Abilities.SWARM, Abilities.SPEED_BOOST, 360, 40, 55, 99, 40, 79, 47, 120, 50, 126),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ROCK, Type.FIRE, 1.2, 87.8, Abilities.WEAK_ARMOR, Abilities.MAGMA_ARMOR, Abilities.MOLD_BREAKER, 360, 40, 55, 99, 40, 79, 47, 120, 50, 120, false, null, true),
	),
    new PokemonSpecies(Species.SCOLIPEDE, 5, false, false, false, "Megapede Pokémon", Type.BUG, Type.POISON, 2.5, 200.5, Abilities.POISON_POINT, Abilities.SWARM, Abilities.SPEED_BOOST, 485, 60, 100, 89, 55, 69, 112, 45, 50, 243, GrowthRate.MEDIUM_SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.BUG, Type.POISON, 2.5, 200.5, Abilities.POISON_POINT, Abilities.SWARM, Abilities.SPEED_BOOST, 485, 60, 100, 89, 55, 69, 112, 45, 50, 243),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ROCK, Type.FIRE, 2.5, 300.8, Abilities.WEAK_ARMOR, Abilities.MAGMA_ARMOR, Abilities.MOLD_BREAKER, 485, 60, 100, 89, 55, 69, 112, 45, 50, 161, false, null, true),
	),
    ...
    new PokemonSpecies(Species.PETILIL, 5, false, false, false, "Bulb Pokémon", Type.GRASS, null, 0.5, 6.6, Abilities.CHLOROPHYLL, Abilities.OWN_TEMPO, Abilities.LEAF_GUARD, 280, 45, 35, 50, 70, 50, 30, 190, 50, 56, GrowthRate.MEDIUM_FAST, 0, false, true,
      new PokemonForm("Normal", "", Type.GRASS, null, 0.5, 6.6, Abilities.CHLOROPHYLL, Abilities.OWN_TEMPO, Abilities.LEAF_GUARD, 280, 45, 35, 50, 70, 50, 30, 190, 50, 56),
      new PokemonForm("Delta-fairy", "delta-fairy", Type.FAIRY, Type.FLYING, 0.508, 6.62, Abilities.SERENE_GRACE, Abilities.SYNCHRONIZE, Abilities.HEALER, 280, 45, 35, 50, 70, 50, 30, 190, 50, 93, false, null, true),
			new PokemonForm("Delta-water", "delta-water", Type.WATER, Type.FIRE, 0.5, 6.6, Abilities.STORM_DRAIN, Abilities.FLASH_FIRE, Abilities.REGENERATOR, 280, 45, 35, 50, 70, 50, 30, 190, 50, 93, false, null, true),
	),
    new PokemonSpecies(Species.LILLIGANT, 5, false, false, false, "Flowering Pokémon", Type.GRASS, null, 1.1, 16.3, Abilities.CHLOROPHYLL, Abilities.OWN_TEMPO, Abilities.LEAF_GUARD, 480, 70, 60, 75, 110, 75, 90, 75, 50, 168, GrowthRate.MEDIUM_FAST, 0, false, true,
      new PokemonForm("Normal", "", Type.GRASS, null, 1.1, 16.3, Abilities.CHLOROPHYLL, Abilities.OWN_TEMPO, Abilities.LEAF_GUARD, 480, 70, 60, 75, 110, 75, 90, 75, 50, 168),
      new PokemonForm("Delta-fairy", "delta-fairy", Type.FAIRY, Type.FLYING, 1.1, 16.3, Abilities.SERENE_GRACE, Abilities.SYNCHRONIZE, Abilities.HEALER, 480, 70, 60, 75, 110, 75, 90, 75, 50, 160, false, null, true),
			new PokemonForm("Delta-water", "delta-water", Type.WATER, Type.FIRE, 1.1, 16.3, Abilities.STORM_DRAIN, Abilities.FLASH_FIRE, Abilities.REGENERATOR, 480, 70, 60, 75, 110, 75, 90, 75, 50, 160, false, null, true),
	),
    ...
    new PokemonSpecies(Species.DARUMAKA, 5, false, false, false, "Zen Charm Pokémon", Type.FIRE, null, 0.6, 37.5, Abilities.HUSTLE, Abilities.NONE, Abilities.INNER_FOCUS, 315, 70, 90, 45, 15, 45, 50, 120, 50, 63, GrowthRate.MEDIUM_SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.FIRE, null, 0.6, 37.5, Abilities.HUSTLE, Abilities.NONE, Abilities.INNER_FOCUS, 315, 70, 90, 45, 15, 45, 50, 120, 50, 63),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.DARK, Type.GHOST, 0.6, 37.5, Abilities.UNNERVE, Abilities.NONE, Abilities.WONDER_SKIN, 315, 70, 90, 45, 15, 45, 50, 120, 50, 105, false, null, true),
	),
    new PokemonSpecies(Species.DARMANITAN, 5, false, false, false, "Blazing Pokémon", Type.FIRE, null, 1.3, 92.9, Abilities.SHEER_FORCE, Abilities.NONE, Abilities.ZEN_MODE, 480, 105, 140, 55, 30, 55, 95, 60, 50, 168, GrowthRate.MEDIUM_SLOW, 50, false, true,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.DARK, Type.GHOST, 1.3, 92.9, Abilities.UNNERVE, Abilities.NONE, Abilities.WONDER_SKIN, 480, 105, 140, 55, 30, 55, 95, 60, 50, 160, false, null, true),
    ...
    new PokemonSpecies(Species.MARACTUS, 5, false, false, false, "Cactus Pokémon", Type.GRASS, null, 1, 28, Abilities.WATER_ABSORB, Abilities.CHLOROPHYLL, Abilities.STORM_DRAIN, 461, 75, 86, 67, 106, 67, 60, 255, 50, 161, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.GRASS, null, 1, 28, Abilities.WATER_ABSORB, Abilities.CHLOROPHYLL, Abilities.STORM_DRAIN, 461, 75, 86, 67, 106, 67, 60, 255, 50, 161),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.STEEL, null, 1.0, 56.0, Abilities.MOTOR_DRIVE, Abilities.CLEAR_BODY, Abilities.TRACE, 461, 75, 86, 67, 106, 67, 60, 255, 50, 153, false, null, true),
	),
    new PokemonSpecies(Species.DWEBBLE, 5, false, false, false, "Rock Inn Pokémon", Type.BUG, Type.ROCK, 0.3, 14.5, Abilities.STURDY, Abilities.SHELL_ARMOR, Abilities.WEAK_ARMOR, 325, 50, 65, 85, 35, 35, 55, 190, 50, 65, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.BUG, Type.ROCK, 0.3, 14.5, Abilities.STURDY, Abilities.SHELL_ARMOR, Abilities.WEAK_ARMOR, 325, 50, 65, 85, 35, 35, 55, 190, 50, 65),
      new PokemonForm("Delta-berry", "delta-berry", Type.GRASS, Type.POISON, 0.3, 10.6, Abilities.HARVEST, Abilities.LEAF_GUARD, Abilities.CHLOROPHYLL, 325, 50, 65, 85, 35, 35, 55, 190, 50, 108, false, null, true),
			new PokemonForm("Delta-cake", "delta-cake", Type.FAIRY, Type.NORMAL, 0.3, 7.8, Abilities.OWN_TEMPO, Abilities.SCRAPPY, Abilities.SIMPLE, 325, 50, 65, 85, 35, 35, 55, 190, 50, 108, false, null, true),
	),
    new PokemonSpecies(Species.CRUSTLE, 5, false, false, false, "Stone Home Pokémon", Type.BUG, Type.ROCK, 1.4, 200, Abilities.STURDY, Abilities.SHELL_ARMOR, Abilities.WEAK_ARMOR, 485, 70, 105, 125, 65, 75, 45, 75, 50, 170, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.BUG, Type.ROCK, 1.4, 200, Abilities.STURDY, Abilities.SHELL_ARMOR, Abilities.WEAK_ARMOR, 485, 70, 105, 125, 65, 75, 45, 75, 50, 170),
      new PokemonForm("Delta-berry", "delta-berry", Type.GRASS, Type.POISON, 1.4, 150.0, Abilities.HARVEST, Abilities.LEAF_GUARD, Abilities.CHLOROPHYLL, 475, 70, 95, 125, 65, 75, 45, 75, 50, 158, false, null, true),
			new PokemonForm("Delta-cake", "delta-cake", Type.FAIRY, Type.NORMAL, 1.4, 100.0, Abilities.OWN_TEMPO, Abilities.SCRAPPY, Abilities.SIMPLE, 475, 70, 95, 125, 65, 75, 45, 75, 50, 158, false, null, true),
	),
    new PokemonSpecies(Species.SCRAGGY, 5, false, false, false, "Shedding Pokémon", Type.DARK, Type.FIGHTING, 0.6, 11.8, Abilities.SHED_SKIN, Abilities.MOXIE, Abilities.INTIMIDATE, 348, 50, 75, 70, 35, 70, 48, 180, 35, 70, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.DARK, Type.FIGHTING, 0.6, 11.8, Abilities.SHED_SKIN, Abilities.MOXIE, Abilities.INTIMIDATE, 348, 50, 75, 70, 35, 70, 48, 180, 35, 70),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GRASS, null, 0.6, 11.8, Abilities.ROUGH_SKIN, Abilities.RIVALRY, Abilities.ANGER_POINT, 348, 50, 75, 70, 35, 70, 48, 180, 50, 116, false, null, true),
	),
    new PokemonSpecies(Species.SCRAFTY, 5, false, false, false, "Hoodlum Pokémon", Type.DARK, Type.FIGHTING, 1.1, 30, Abilities.SHED_SKIN, Abilities.MOXIE, Abilities.INTIMIDATE, 488, 65, 90, 115, 45, 115, 58, 90, 50, 171, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.DARK, Type.FIGHTING, 1.1, 30, Abilities.SHED_SKIN, Abilities.MOXIE, Abilities.INTIMIDATE, 488, 65, 90, 115, 45, 115, 58, 90, 50, 171),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GRASS, null, 1.1, 30.0, Abilities.ROUGH_SKIN, Abilities.RIVALRY, Abilities.ANGER_POINT, 488, 65, 90, 115, 45, 115, 58, 90, 50, 162, false, null, true),
	),
    ...
    new PokemonSpecies(Species.YAMASK, 5, false, false, false, "Spirit Pokémon", Type.GHOST, null, 0.5, 1.5, Abilities.MUMMY, Abilities.NONE, Abilities.NONE, 303, 38, 30, 85, 55, 65, 30, 190, 50, 61, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.GHOST, null, 0.5, 1.5, Abilities.MUMMY, Abilities.NONE, Abilities.NONE, 303, 38, 30, 85, 55, 65, 30, 190, 50, 61),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.STEEL, Type.POISON, 0.5, 3.0, Abilities.AFTERMATH, Abilities.INFILTRATOR, Abilities.WONDER_SKIN, 303, 38, 30, 85, 55, 65, 30, 190, 50, 101, false, null, true),
	),
    new PokemonSpecies(Species.COFAGRIGUS, 5, false, false, false, "Coffin Pokémon", Type.GHOST, null, 1.7, 76.5, Abilities.MUMMY, Abilities.NONE, Abilities.NONE, 483, 58, 50, 145, 95, 105, 30, 90, 50, 169, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.GHOST, null, 1.7, 76.5, Abilities.MUMMY, Abilities.NONE, Abilities.NONE, 483, 58, 50, 145, 95, 105, 30, 90, 50, 169),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.STEEL, Type.POISON, 1.7, 153.0, Abilities.AFTERMATH, Abilities.INFILTRATOR, Abilities.WONDER_SKIN, 503, 78, 50, 145, 95, 105, 30, 90, 50, 167, false, null, true),
	),
    ...
    new PokemonSpecies(Species.SOLOSIS, 5, false, false, false, "Cell Pokémon", Type.PSYCHIC, null, 0.3, 1, Abilities.OVERCOAT, Abilities.MAGIC_GUARD, Abilities.REGENERATOR, 290, 45, 30, 40, 105, 50, 20, 200, 50, 58, GrowthRate.MEDIUM_SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.PSYCHIC, null, 0.3, 1, Abilities.OVERCOAT, Abilities.MAGIC_GUARD, Abilities.REGENERATOR, 290, 45, 30, 40, 105, 50, 20, 200, 50, 58),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GHOST, Type.ROCK, 0.3, 2.0, Abilities.LEVITATE, Abilities.CURSED_BODY, Abilities.INTIMIDATE, 290, 45, 30, 40, 105, 50, 20, 200, 50, 96, false, null, true),
	),
    new PokemonSpecies(Species.DUOSION, 5, false, false, false, "Mitosis Pokémon", Type.PSYCHIC, null, 0.6, 8, Abilities.OVERCOAT, Abilities.MAGIC_GUARD, Abilities.REGENERATOR, 370, 65, 40, 50, 125, 60, 30, 100, 50, 130, GrowthRate.MEDIUM_SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.PSYCHIC, null, 0.6, 8, Abilities.OVERCOAT, Abilities.MAGIC_GUARD, Abilities.REGENERATOR, 370, 65, 40, 50, 125, 60, 30, 100, 50, 130),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GHOST, Type.ROCK, 0.6, 16.0, Abilities.LEVITATE, Abilities.CURSED_BODY, Abilities.INTIMIDATE, 370, 65, 40, 50, 125, 60, 30, 100, 50, 123, false, null, true),
	),
    new PokemonSpecies(Species.REUNICLUS, 5, false, false, false, "Multiplying Pokémon", Type.PSYCHIC, null, 1, 20.1, Abilities.OVERCOAT, Abilities.MAGIC_GUARD, Abilities.REGENERATOR, 490, 110, 65, 75, 125, 85, 30, 50, 50, 245, GrowthRate.MEDIUM_SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.PSYCHIC, null, 1, 20.1, Abilities.OVERCOAT, Abilities.MAGIC_GUARD, Abilities.REGENERATOR, 490, 110, 65, 75, 125, 85, 30, 50, 50, 245),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GHOST, Type.ROCK, 1.0, 40.2, Abilities.LEVITATE, Abilities.CURSED_BODY, Abilities.INTIMIDATE, 490, 110, 65, 75, 125, 85, 30, 50, 50, 163, false, null, true),
	),
    ...
    new PokemonSpecies(Species.EMOLGA, 5, false, false, false, "Sky Squirrel Pokémon", Type.ELECTRIC, Type.FLYING, 0.4, 5, Abilities.STATIC, Abilities.NONE, Abilities.MOTOR_DRIVE, 428, 55, 75, 60, 75, 60, 103, 200, 50, 150, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.ELECTRIC, Type.FLYING, 0.4, 5, Abilities.STATIC, Abilities.NONE, Abilities.MOTOR_DRIVE, 428, 55, 75, 60, 75, 60, 103, 200, 50, 150),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FIRE, Type.DARK, 0.4, 5.0, Abilities.FLASH_FIRE, Abilities.NONE, Abilities.BLAZE_BOOST, 428, 55, 75, 60, 75, 60, 103, 200, 50, 142, false, null, true),
	),
    new PokemonSpecies(Species.KARRABLAST, 5, false, false, false, "Clamping Pokémon", Type.BUG, null, 0.5, 5.9, Abilities.SWARM, Abilities.SHED_SKIN, Abilities.NO_GUARD, 315, 50, 75, 45, 40, 45, 60, 200, 50, 63, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.BUG, null, 0.5, 5.9, Abilities.SWARM, Abilities.SHED_SKIN, Abilities.NO_GUARD, 315, 50, 75, 45, 40, 45, 60, 200, 50, 63),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FAIRY, null, 0.5, 5.9, Abilities.HEATPROOF, Abilities.SWEET_VEIL, Abilities.SIMPLE, 315, 50, 75, 45, 40, 45, 60, 200, 50, 105, false, null, true),
	),
    new PokemonSpecies(Species.ESCAVALIER, 5, false, false, false, "Cavalry Pokémon", Type.BUG, Type.STEEL, 1, 33, Abilities.SWARM, Abilities.SHELL_ARMOR, Abilities.OVERCOAT, 495, 70, 135, 105, 60, 105, 20, 75, 50, 173, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.BUG, Type.STEEL, 1, 33, Abilities.SWARM, Abilities.SHELL_ARMOR, Abilities.OVERCOAT, 495, 70, 135, 105, 60, 105, 20, 75, 50, 173),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FAIRY, null, 1.0, 33.0, Abilities.HEATPROOF, Abilities.SWEET_VEIL, Abilities.SIMPLE, 495, 70, 135, 105, 60, 105, 20, 75, 50, 165, false, null, true),
	),
    new PokemonSpecies(Species.FOONGUS, 5, false, false, false, "Mushroom Pokémon", Type.GRASS, Type.POISON, 0.2, 1, Abilities.EFFECT_SPORE, Abilities.NONE, Abilities.REGENERATOR, 294, 69, 55, 45, 55, 55, 15, 190, 50, 59, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.GRASS, Type.POISON, 0.2, 1, Abilities.EFFECT_SPORE, Abilities.NONE, Abilities.REGENERATOR, 294, 69, 55, 45, 55, 55, 15, 190, 50, 59),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GHOST, Type.DARK, 0.2, 1.0, Abilities.PRANKSTER, Abilities.NONE, Abilities.INTIMIDATE, 294, 69, 55, 45, 55, 55, 15, 190, 50, 98, false, null, true),
	),
    new PokemonSpecies(Species.AMOONGUSS, 5, false, false, false, "Mushroom Pokémon", Type.GRASS, Type.POISON, 0.6, 10.5, Abilities.EFFECT_SPORE, Abilities.NONE, Abilities.REGENERATOR, 464, 114, 85, 70, 85, 80, 30, 75, 50, 162, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.GRASS, Type.POISON, 0.6, 10.5, Abilities.EFFECT_SPORE, Abilities.NONE, Abilities.REGENERATOR, 464, 114, 85, 70, 85, 80, 30, 75, 50, 162),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GHOST, Type.DARK, 0.6, 10.5, Abilities.PRANKSTER, Abilities.NONE, Abilities.INTIMIDATE, 464, 114, 85, 70, 85, 80, 30, 75, 50, 154, false, null, true),
	),
    ...
    new PokemonSpecies(Species.LITWICK, 5, false, false, false, "Candle Pokémon", Type.GHOST, Type.FIRE, 0.3, 3.1, Abilities.FLASH_FIRE, Abilities.FLAME_BODY, Abilities.INFILTRATOR, 275, 50, 30, 55, 65, 55, 20, 190, 50, 55, GrowthRate.MEDIUM_SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.GHOST, Type.FIRE, 0.3, 3.1, Abilities.FLASH_FIRE, Abilities.FLAME_BODY, Abilities.INFILTRATOR, 275, 50, 30, 55, 65, 55, 20, 190, 50, 55),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FAIRY, Type.FIRE, 0.3, 3.1, Abilities.FLASH_FIRE, Abilities.WEAK_ARMOR, Abilities.FAIRY_AURA, 275, 50, 30, 55, 65, 55, 20, 190, 50, 91, false, null, true),
	),
    new PokemonSpecies(Species.LAMPENT, 5, false, false, false, "Lamp Pokémon", Type.GHOST, Type.FIRE, 0.6, 13, Abilities.FLASH_FIRE, Abilities.FLAME_BODY, Abilities.INFILTRATOR, 370, 60, 40, 60, 95, 60, 55, 90, 50, 130, GrowthRate.MEDIUM_SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.GHOST, Type.FIRE, 0.6, 13, Abilities.FLASH_FIRE, Abilities.FLAME_BODY, Abilities.INFILTRATOR, 370, 60, 40, 60, 95, 60, 55, 90, 50, 130),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FAIRY, Type.FIRE, 0.6, 13.0, Abilities.FLASH_FIRE, Abilities.WEAK_ARMOR, Abilities.FAIRY_AURA, 370, 60, 40, 60, 95, 60, 55, 90, 50, 123, false, null, true),
	),
    new PokemonSpecies(Species.CHANDELURE, 5, false, false, false, "Luring Pokémon", Type.GHOST, Type.FIRE, 1, 34.3, Abilities.FLASH_FIRE, Abilities.FLAME_BODY, Abilities.INFILTRATOR, 520, 60, 55, 90, 145, 90, 80, 45, 50, 260, GrowthRate.MEDIUM_SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.GHOST, Type.FIRE, 1, 34.3, Abilities.FLASH_FIRE, Abilities.FLAME_BODY, Abilities.INFILTRATOR, 520, 60, 55, 90, 145, 90, 80, 45, 50, 260),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FAIRY, Type.FIRE, 1.0, 34.3, Abilities.FLASH_FIRE, Abilities.WEAK_ARMOR, Abilities.FAIRY_AURA, 520, 60, 55, 90, 145, 90, 80, 45, 50, 173, false, null, true),
	),
    new PokemonSpecies(Species.AXEW, 5, false, false, false, "Tusk Pokémon", Type.DRAGON, null, 0.6, 18, Abilities.RIVALRY, Abilities.MOLD_BREAKER, Abilities.UNNERVE, 320, 46, 87, 60, 30, 40, 57, 75, 35, 64, GrowthRate.SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.DRAGON, null, 0.6, 18, Abilities.RIVALRY, Abilities.MOLD_BREAKER, Abilities.UNNERVE, 320, 46, 87, 60, 30, 40, 57, 75, 35, 64),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.WATER, null, 0.6, 18.0, Abilities.STRONG_JAW, Abilities.WATER_VEIL, Abilities.SWIFT_SWIM, 320, 46, 87, 60, 30, 40, 57, 75, 50, 106, false, null, true),
	),
    new PokemonSpecies(Species.FRAXURE, 5, false, false, false, "Axe Jaw Pokémon", Type.DRAGON, null, 1, 36, Abilities.RIVALRY, Abilities.MOLD_BREAKER, Abilities.UNNERVE, 410, 66, 117, 70, 40, 50, 67, 60, 35, 144, GrowthRate.SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.DRAGON, null, 1, 36, Abilities.RIVALRY, Abilities.MOLD_BREAKER, Abilities.UNNERVE, 410, 66, 117, 70, 40, 50, 67, 60, 35, 144),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.WATER, null, 1.0, 36.0, Abilities.STRONG_JAW, Abilities.WATER_VEIL, Abilities.SWIFT_SWIM, 410, 66, 117, 70, 40, 50, 67, 60, 50, 136, false, null, true),
	),
    new PokemonSpecies(Species.HAXORUS, 5, false, false, false, "Axe Jaw Pokémon", Type.DRAGON, null, 1.8, 105.5, Abilities.RIVALRY, Abilities.MOLD_BREAKER, Abilities.UNNERVE, 540, 76, 147, 90, 60, 70, 97, 45, 35, 270, GrowthRate.SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.DRAGON, null, 1.8, 105.5, Abilities.RIVALRY, Abilities.MOLD_BREAKER, Abilities.UNNERVE, 540, 76, 147, 90, 60, 70, 97, 45, 35, 270),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.WATER, Type.STEEL, 1.8, 211.0, Abilities.STRONG_JAW, Abilities.WATER_VEIL, Abilities.HEAVY_METAL, 540, 76, 147, 90, 60, 70, 97, 45, 50, 180, false, null, true),
	),
    ...
    new PokemonSpecies(Species.GOLETT, 5, false, false, false, "Automaton Pokémon", Type.GROUND, Type.GHOST, 1, 92, Abilities.IRON_FIST, Abilities.KLUTZ, Abilities.NO_GUARD, 303, 59, 74, 50, 35, 50, 35, 190, 50, 61, GrowthRate.MEDIUM_FAST, null, false, true,
      new PokemonForm("Normal", "", Type.GROUND, Type.GHOST, 1, 92, Abilities.IRON_FIST, Abilities.KLUTZ, Abilities.NO_GUARD, 303, 59, 74, 50, 35, 50, 35, 190, 50, 61),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FIGHTING, Type.STEEL, 1.0, 92.0, Abilities.IRON_FIST, Abilities.BATTLE_ARMOR, Abilities.GUTS, 303, 59, 74, 50, 35, 50, 35, 190, 50, 101, false, null, true),
	),
    new PokemonSpecies(Species.GOLURK, 5, false, false, false, "Automaton Pokémon", Type.GROUND, Type.GHOST, 2.8, 330, Abilities.IRON_FIST, Abilities.KLUTZ, Abilities.NO_GUARD, 483, 89, 124, 80, 55, 80, 55, 90, 50, 169, GrowthRate.MEDIUM_FAST, null, false, true,
      new PokemonForm("Normal", "", Type.GROUND, Type.GHOST, 2.8, 330, Abilities.IRON_FIST, Abilities.KLUTZ, Abilities.NO_GUARD, 483, 89, 124, 80, 55, 80, 55, 90, 50, 169),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FIGHTING, Type.STEEL, 2.8, 330.0, Abilities.IRON_FIST, Abilities.BATTLE_ARMOR, Abilities.GUTS, 483, 89, 124, 80, 55, 80, 55, 90, 50, 161, false, null, true),
	),
    new PokemonSpecies(Species.PAWNIARD, 5, false, false, false, "Sharp Blade Pokémon", Type.DARK, Type.STEEL, 0.5, 10.2, Abilities.DEFIANT, Abilities.INNER_FOCUS, Abilities.PRESSURE, 340, 45, 85, 70, 40, 40, 60, 120, 35, 68, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.DARK, Type.STEEL, 0.5, 10.2, Abilities.DEFIANT, Abilities.INNER_FOCUS, Abilities.PRESSURE, 340, 45, 85, 70, 40, 40, 60, 120, 35, 68),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FLYING, Type.FIGHTING, 0.5, 10.2, Abilities.DEFIANT, Abilities.FRISK, Abilities.WIND_FORCE, 340, 45, 85, 70, 40, 40, 60, 120, 50, 113, false, null, true),
	),
    new PokemonSpecies(Species.BISHARP, 5, false, false, false, "Sword Blade Pokémon", Type.DARK, Type.STEEL, 1.6, 70, Abilities.DEFIANT, Abilities.INNER_FOCUS, Abilities.PRESSURE, 490, 65, 125, 100, 60, 70, 70, 45, 35, 172, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.DARK, Type.STEEL, 1.6, 70, Abilities.DEFIANT, Abilities.INNER_FOCUS, Abilities.PRESSURE, 490, 65, 125, 100, 60, 70, 70, 45, 35, 172),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FLYING, Type.FIGHTING, 1.6, 70.0, Abilities.FRISK, Abilities.DEFIANT, Abilities.WIND_FORCE, 490, 65, 125, 100, 60, 70, 70, 45, 50, 163, false, null, true),
			new PokemonForm("Delta-mega", SpeciesFormKey.DELTA_MEGA, Type.FLYING, Type.FIGHTING, 1.6, 70.0, Abilities.TECHNICIAN, Abilities.TECHNICIAN, Abilities.TECHNICIAN, 590, 65, 145, 130, 60, 85, 105, 22.5, 50, 326, false, null, false),
	),
    ...
    new PokemonSpecies(Species.HEATMOR, 5, false, false, false, "Anteater Pokémon", Type.FIRE, null, 1.4, 58, Abilities.GLUTTONY, Abilities.FLASH_FIRE, Abilities.WHITE_SMOKE, 484, 85, 97, 66, 105, 66, 65, 90, 50, 169, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.FIRE, null, 1.4, 58, Abilities.GLUTTONY, Abilities.FLASH_FIRE, Abilities.WHITE_SMOKE, 484, 85, 97, 66, 105, 66, 65, 90, 50, 169),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.POISON, Type.STEEL, 1.4, 116.0, Abilities.LIQUID_OOZE, Abilities.SHEER_FORCE, Abilities.MEGA_LAUNCHER, 484, 85, 97, 66, 105, 66, 65, 90, 50, 161, false, null, true),
	),
    ...
    new PokemonSpecies(Species.DEINO, 5, false, false, false, "Irate Pokémon", Type.DARK, Type.DRAGON, 0.8, 17.3, Abilities.HUSTLE, Abilities.NONE, Abilities.NONE, 300, 52, 65, 50, 45, 50, 38, 45, 35, 60, GrowthRate.SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.DARK, Type.DRAGON, 0.8, 17.3, Abilities.HUSTLE, Abilities.NONE, Abilities.NONE, 300, 52, 65, 50, 45, 50, 38, 45, 35, 60),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GROUND, Type.POISON, 0.8, 17.3, Abilities.VENOMOUS, Abilities.NONE, Abilities.NONE, 300, 52, 65, 50, 45, 50, 38, 45, 50, 100, true, null, true),
	),
    new PokemonSpecies(Species.ZWEILOUS, 5, false, false, false, "Hostile Pokémon", Type.DARK, Type.DRAGON, 1.4, 50, Abilities.HUSTLE, Abilities.NONE, Abilities.NONE, 420, 72, 85, 70, 65, 70, 58, 45, 35, 147, GrowthRate.SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.DARK, Type.DRAGON, 1.4, 50, Abilities.HUSTLE, Abilities.NONE, Abilities.NONE, 420, 72, 85, 70, 65, 70, 58, 45, 35, 147),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GROUND, Type.POISON, 1.4, 50.0, Abilities.VENOMOUS, Abilities.NONE, Abilities.NONE, 420, 72, 85, 70, 65, 70, 58, 45, 50, 140, true, null, true),
	),
    new PokemonSpecies(Species.HYDREIGON, 5, false, false, false, "Brutal Pokémon", Type.DARK, Type.DRAGON, 1.8, 160, Abilities.LEVITATE, Abilities.NONE, Abilities.NONE, 600, 92, 105, 90, 125, 90, 98, 45, 35, 300, GrowthRate.SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.DARK, Type.DRAGON, 1.8, 160, Abilities.LEVITATE, Abilities.NONE, Abilities.NONE, 600, 92, 105, 90, 125, 90, 98, 45, 35, 300),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GROUND, Type.POISON, 1.8, 160.0, Abilities.INTOXICATE, Abilities.NONE, Abilities.NONE, 600, 92, 105, 90, 125, 90, 98, 45, 50, 200, true, null, true),
	),
    new PokemonSpecies(Species.LARVESTA, 5, false, false, false, "Torch Pokémon", Type.BUG, Type.FIRE, 1.1, 28.8, Abilities.FLAME_BODY, Abilities.NONE, Abilities.SWARM, 360, 55, 85, 55, 50, 55, 60, 45, 50, 72, GrowthRate.SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.BUG, Type.FIRE, 1.1, 28.8, Abilities.FLAME_BODY, Abilities.NONE, Abilities.SWARM, 360, 55, 85, 55, 50, 55, 60, 45, 50, 72),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.DARK, Type.POISON, 1.1, 28.8, Abilities.DEFIANT, Abilities.NONE, Abilities.ABSOLUTION, 360, 55, 85, 55, 50, 55, 60, 45, 50, 120, false, null, true),
	),
    new PokemonSpecies(Species.VOLCARONA, 5, false, false, false, "Sun Pokémon", Type.BUG, Type.FIRE, 1.6, 46, Abilities.FLAME_BODY, Abilities.NONE, Abilities.SWARM, 550, 85, 60, 65, 135, 105, 100, 15, 50, 275, GrowthRate.SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.BUG, Type.FIRE, 1.6, 46, Abilities.FLAME_BODY, Abilities.NONE, Abilities.SWARM, 550, 85, 60, 65, 135, 105, 100, 15, 50, 275),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.DARK, Type.POISON, 1.6, 46.0, Abilities.LEVITATE, Abilities.NONE, Abilities.ABSOLUTION, 550, 85, 60, 65, 135, 105, 100, 15, 50, 183, false, null, true),
	),
    ...
    new PokemonSpecies(Species.MELOETTA, 5, false, false, true, "Melody Pokémon", Type.NORMAL, Type.PSYCHIC, 0.6, 6.5, Abilities.SERENE_GRACE, Abilities.NONE, Abilities.NONE, 600, 100, 77, 77, 128, 128, 90, 3, 100, 270, GrowthRate.SLOW, 0, false, true,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA+"-mime", Type.DARK, Type.FAIRY, 0.6, 6.5, Abilities.FILTER, Abilities.NONE, Abilities.NONE, 600, 100, 128, 90, 77, 77, 128, 3, 50, 200, false, null, true),
      new PokemonForm("Delta", SpeciesFormKey.DELTA+"-magician", Type.DARK, Type.PSYCHIC, 0.6, 6.5, Abilities.FILTER, Abilities.NONE, Abilities.NONE, 600, 100, 77, 77, 128, 128, 90, 3, 50, 200, false, null, true),
    ...
    new PokemonSpecies(Species.FROAKIE, 6, false, false, false, "Bubble Frog Pokémon", Type.WATER, null, 0.3, 7, Abilities.TORRENT, Abilities.NONE, Abilities.PROTEAN, 314, 41, 56, 40, 62, 44, 71, 45, 70, 63, GrowthRate.MEDIUM_SLOW, 87.5, false, false,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GRASS, null, 0.3, 7.0, Abilities.STEADFAST, Abilities.NONE, Abilities.PRANKSTER, 314, 41, 56, 40, 62, 44, 71, 45, 50, 104, false, null, true),
    ...
    new PokemonSpecies(Species.FROGADIER, 6, false, false, false, "Bubble Frog Pokémon", Type.WATER, null, 0.6, 10.9, Abilities.TORRENT, Abilities.NONE, Abilities.PROTEAN, 405, 54, 63, 52, 83, 56, 97, 45, 70, 142, GrowthRate.MEDIUM_SLOW, 87.5, false, false,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GRASS, Type.GRASS, 0.6, 10.9, Abilities.STEADFAST, Abilities.NONE, Abilities.PRANKSTER, 405, 54, 63, 52, 83, 56, 97, 45, 50, 135, false, null, true),
    ...
    new PokemonSpecies(Species.GRENINJA, 6, false, false, false, "Ninja Pokémon", Type.WATER, Type.DARK, 1.5, 40, Abilities.TORRENT, Abilities.NONE, Abilities.PROTEAN, 530, 72, 95, 67, 103, 71, 122, 45, 70, 239, GrowthRate.MEDIUM_SLOW, 87.5, false, false,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GRASS, Type.FIRE, 1.5, 40.0, Abilities.STEADFAST, Abilities.NONE, Abilities.PRANKSTER, 530, 72, 95, 67, 103, 71, 122, 45, 50, 176, false, null, true),
    ...
    new PokemonSpecies(Species.AMAURA, 6, false, false, false, "Tundra Pokémon", Type.ROCK, Type.ICE, 1.3, 25.2, Abilities.REFRIGERATE, Abilities.NONE, Abilities.SNOW_WARNING, 362, 77, 59, 50, 67, 63, 46, 45, 50, 72, GrowthRate.MEDIUM_FAST, 87.5, false, true,
      new PokemonForm("Normal", "", Type.ROCK, Type.ICE, 1.3, 25.2, Abilities.REFRIGERATE, Abilities.NONE, Abilities.SNOW_WARNING, 362, 77, 59, 50, 67, 63, 46, 45, 50, 72),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GRASS, Type.WATER, 1.3, 25.2, Abilities.FRIEND_GUARD, Abilities.NONE, Abilities.PHOTOTROPH, 362, 77, 59, 50, 67, 63, 46, 45, 50, 120, false, null, true),
	),
    new PokemonSpecies(Species.AURORUS, 6, false, false, false, "Tundra Pokémon", Type.ROCK, Type.ICE, 2.7, 225, Abilities.REFRIGERATE, Abilities.NONE, Abilities.SNOW_WARNING, 521, 123, 77, 72, 99, 92, 58, 45, 50, 104, GrowthRate.MEDIUM_FAST, 87.5, false, true,
      new PokemonForm("Normal", "", Type.ROCK, Type.ICE, 2.7, 225, Abilities.REFRIGERATE, Abilities.NONE, Abilities.SNOW_WARNING, 521, 123, 77, 72, 99, 92, 58, 45, 50, 104),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GRASS, Type.WATER, 2.7, 225.0, Abilities.FRIEND_GUARD, Abilities.NONE, Abilities.PHOTOTROPH, 521, 123, 77, 72, 99, 92, 58, 45, 50, 173, false, null, true),
	),
    ...
    new PokemonSpecies(Species.GOOMY, 6, false, false, false, "Soft Tissue Pokémon", Type.DRAGON, null, 0.3, 2.8, Abilities.SAP_SIPPER, Abilities.HYDRATION, Abilities.GOOEY, 300, 45, 50, 35, 55, 75, 40, 45, 35, 60, GrowthRate.SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.DRAGON, null, 0.3, 2.8, Abilities.SAP_SIPPER, Abilities.HYDRATION, Abilities.GOOEY, 300, 45, 50, 35, 55, 75, 40, 45, 35, 60),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GROUND, Type.WATER, 0.3, 2.8, Abilities.OVERCOAT, Abilities.WATER_ABSORB, Abilities.GOOEY, 300, 45, 50, 35, 55, 75, 40, 45, 50, 100, false, null, true),
	),
    new PokemonSpecies(Species.SLIGGOO, 6, false, false, false, "Soft Tissue Pokémon", Type.DRAGON, null, 0.8, 17.5, Abilities.SAP_SIPPER, Abilities.HYDRATION, Abilities.GOOEY, 452, 68, 75, 53, 83, 113, 60, 45, 35, 158, GrowthRate.SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.DRAGON, null, 0.8, 17.5, Abilities.SAP_SIPPER, Abilities.HYDRATION, Abilities.GOOEY, 452, 68, 75, 53, 83, 113, 60, 45, 35, 158),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GROUND, Type.WATER, 0.8, 17.5, Abilities.OVERCOAT, Abilities.WATER_ABSORB, Abilities.GOOEY, 452, 68, 75, 53, 83, 113, 60, 45, 50, 150, false, null, true),
	),
    new PokemonSpecies(Species.GOODRA, 6, false, false, false, "Dragon Pokémon", Type.DRAGON, null, 2, 150.5, Abilities.SAP_SIPPER, Abilities.HYDRATION, Abilities.GOOEY, 600, 90, 100, 70, 110, 150, 80, 45, 35, 300, GrowthRate.SLOW, 50, false, true,
      new PokemonForm("Normal", "", Type.DRAGON, null, 2, 150.5, Abilities.SAP_SIPPER, Abilities.HYDRATION, Abilities.GOOEY, 600, 90, 100, 70, 110, 150, 80, 45, 35, 300),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GROUND, Type.WATER, 2.0, 150.5, Abilities.OVERCOAT, Abilities.WATER_ABSORB, Abilities.GOOEY, 600, 90, 100, 70, 110, 150, 80, 45, 50, 200, false, null, true),
	),
    ...
    new PokemonSpecies(Species.PHANTUMP, 6, false, false, false, "Stump Pokémon", Type.GHOST, Type.GRASS, 0.4, 7, Abilities.NATURAL_CURE, Abilities.FRISK, Abilities.HARVEST, 309, 43, 70, 48, 50, 60, 38, 120, 50, 62, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.GHOST, Type.GRASS, 0.4, 7, Abilities.NATURAL_CURE, Abilities.FRISK, Abilities.HARVEST, 309, 43, 70, 48, 50, 60, 38, 120, 50, 62),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FAIRY, null, 0.4, 7.0, Abilities.SNOW_WARNING, Abilities.OVERCOAT, Abilities.SNOW_CLOAK, 309, 43, 70, 48, 50, 60, 38, 120, 50, 103, false, null, true),
	),
    new PokemonSpecies(Species.TREVENANT, 6, false, false, false, "Elder Tree Pokémon", Type.GHOST, Type.GRASS, 1.5, 71, Abilities.NATURAL_CURE, Abilities.FRISK, Abilities.HARVEST, 474, 85, 110, 76, 65, 82, 56, 60, 50, 166, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.GHOST, Type.GRASS, 1.5, 71, Abilities.NATURAL_CURE, Abilities.FRISK, Abilities.HARVEST, 474, 85, 110, 76, 65, 82, 56, 60, 50, 166),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FAIRY, Type.FIGHTING, 1.5, 71.0, Abilities.SNOW_WARNING, Abilities.OVERCOAT, Abilities.SNOW_CLOAK, 474, 85, 110, 76, 65, 82, 56, 60, 50, 158, false, null, true),
	),
    ...
    new PokemonSpecies(Species.BERGMITE, 6, false, false, false, "Ice Chunk Pokémon", Type.ICE, null, 1, 99.5, Abilities.OWN_TEMPO, Abilities.ICE_BODY, Abilities.STURDY, 304, 55, 69, 85, 32, 35, 28, 190, 50, 61, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.ICE, null, 1, 99.5, Abilities.OWN_TEMPO, Abilities.ICE_BODY, Abilities.STURDY, 304, 55, 69, 85, 32, 35, 28, 190, 50, 61),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ROCK, Type.ROCK, 1.0, 99.5, Abilities.SOLID_ROCK, Abilities.BATTLE_ARMOR, Abilities.SAND_STREAM, 304, 55, 69, 85, 32, 35, 28, 190, 50, 101, false, null, true),
	),
    new PokemonSpecies(Species.AVALUGG, 6, false, false, false, "Iceberg Pokémon", Type.ICE, null, 2, 505, Abilities.OWN_TEMPO, Abilities.ICE_BODY, Abilities.STURDY, 514, 95, 117, 184, 44, 46, 28, 55, 50, 180, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.ICE, null, 2, 505, Abilities.OWN_TEMPO, Abilities.ICE_BODY, Abilities.STURDY, 514, 95, 117, 184, 44, 46, 28, 55, 50, 180),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.ROCK, Type.DRAGON, 2.0, 505.0, Abilities.SOLID_ROCK, Abilities.BATTLE_ARMOR, Abilities.SAND_STREAM, 514, 95, 117, 184, 44, 46, 28, 55, 50, 171, false, null, true),
	),
    new PokemonSpecies(Species.NOIBAT, 6, false, false, false, "Sound Wave Pokémon", Type.FLYING, Type.DRAGON, 0.5, 8, Abilities.FRISK, Abilities.INFILTRATOR, Abilities.TELEPATHY, 245, 40, 30, 35, 45, 40, 55, 190, 50, 49, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.FLYING, Type.DRAGON, 0.5, 8, Abilities.FRISK, Abilities.INFILTRATOR, Abilities.TELEPATHY, 245, 40, 30, 35, 45, 40, 55, 190, 50, 49),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GRASS, Type.STEEL, 0.5, 16.0, Abilities.CHLOROPHYLL, Abilities.NATURAL_CURE, Abilities.SOLAR_POWER, 245, 40, 30, 35, 45, 40, 55, 190, 50, 81, false, null, true),
	),
    new PokemonSpecies(Species.NOIVERN, 6, false, false, false, "Sound Wave Pokémon", Type.FLYING, Type.DRAGON, 1.5, 85, Abilities.FRISK, Abilities.INFILTRATOR, Abilities.TELEPATHY, 535, 85, 70, 80, 97, 80, 123, 45, 50, 187, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal", "", Type.FLYING, Type.DRAGON, 1.5, 85, Abilities.FRISK, Abilities.INFILTRATOR, Abilities.TELEPATHY, 535, 85, 70, 80, 97, 80, 123, 45, 50, 187),
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.GRASS, Type.STEEL, 1.5, 170.0, Abilities.CHLOROPHYLL, Abilities.SOLAR_POWER, Abilities.FLOWER_GIFT, 535, 85, 70, 80, 97, 80, 123, 190, 50, 178, false, null, true),
	),
    ...
    new PokemonSpecies(Species.HOOPA, 6, false, false, true, "Mischief Pokémon", Type.PSYCHIC, Type.GHOST, 0.5, 9, Abilities.MAGICIAN, Abilities.NONE, Abilities.NONE, 600, 80, 110, 60, 150, 130, 70, 3, 100, 270, GrowthRate.SLOW, null, false, false,
      ...
      new PokemonForm("Delta", SpeciesFormKey.DELTA, Type.FLYING, null, 0.5, 9.0, Abilities.CLOUD_NINE, Abilities.NONE, Abilities.NONE, 600, 80, 110, 60, 150, 130, 70, 3, 50, 200, false, null, true),
