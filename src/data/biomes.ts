...
export const biomeLinks: BiomeLinks = {
  ...
  [Biome.MOUNTAIN]: [ Biome.VOLCANO, [ Biome.DOJO, 2] [ Biome.WASTELAND, 2 ] [ Biome.SPACE, 3 ] ],
  [Biome.BADLANDS]: [ Biome.DESERT, Biome.MOUNTAIN ],
  [Biome.CAVE]: [ Biome.BADLANDS, Biome.LAKE [ Biome.LAB, 2 ],
  ...
  [Biome.CONSTRUCTION_SITE]: [ Biome.POWER_PLANT, Biome.METROPOLIS, [ Biome.DOJO, 2 ] ],
