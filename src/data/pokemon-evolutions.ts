...
export const pokemonEvolutions: PokemonEvolutions = {
  ...
  [Species.KOFFING]: [
    new SpeciesEvolution(
      ...
      null,
      new SpeciesEvolutionCondition(
        (p) => p.scene.arena.biomeType === Biome.METROPOLIS || p.scene.arena.biomeType === Biome.SLUM,
      ),
      SpeciesWildEvolutionDelay.MEDIUM,
    ),
  ...
  [Species.PANCHAM]: [
    new SpeciesEvolution(
      ...
      null,
      new SpeciesEvolutionCondition(
        (p) => !!p.scene.getParty().find((p) => p.getTypes(false, false, true).indexOf(Type.DARK) > -1),
      ),
      SpeciesWildEvolutionDelay.MEDIUM,
    ),
  ],
  ...
  [Species.EEVEE]: [
    ...
    new SpeciesFormEvolution(
      ...
      1,
      null,
      new SpeciesFriendshipEvolutionCondition(70, (p) => p.scene.arena.getTimeOfDay() === TimeOfDay.DAY),
      SpeciesWildEvolutionDelay.LONG,
    ),
    new SpeciesFormEvolution(
      Species.ESPEON,
    ...
    new SpeciesFormEvolution(
      ...
      1,
      null,
      new SpeciesFriendshipEvolutionCondition(70, (p) => p.scene.arena.getTimeOfDay() === TimeOfDay.NIGHT),
      SpeciesWildEvolutionDelay.LONG,
    ),
    new SpeciesFormEvolution(
      Species.UMBREON,
  ...
  [Species.GLIGAR]: [
    new SpeciesEvolution(
      ...
      1,
      null,
      new SpeciesEvolutionCondition((p) => p.scene.arena.getTimeOfDay() === TimeOfDay.NIGHT /* Razor fang at night*/),
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  [Species.SNEASEL]: [
    new SpeciesEvolution(
      ...
      1,
      null,
      new SpeciesEvolutionCondition((p) => p.scene.arena.getTimeOfDay() === TimeOfDay.NIGHT /* Razor claw at night*/),
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  [Species.URSARING]: [
    ...
    new SpeciesEvolution(
      ...
      new SpeciesEvolutionCondition(
        (p) =>
          ...
          (p.scene.arena.biomeType === Biome.ICE_CAVE || p.scene.arena.biomeType === Biome.SNOWY_FOREST),
      ),
      SpeciesWildEvolutionDelay.MEDIUM,
    ),
    new SpeciesEvolution(
  ...
  [Species.CLOBBOPUS]: [
    new SpeciesEvolution(
      ...
      35,
      null,
      new SpeciesEvolutionCondition((p) => p.moveset.filter((m) => m?.moveId === Moves.TAUNT).length > 0),
      SpeciesWildEvolutionDelay.MEDIUM,
    ),
  ],
  [Species.SINISTEA]: [
  ...
  [Species.HISUI_SNEASEL]: [
    new SpeciesEvolution(
      ...
      1,
      null,
      new SpeciesEvolutionCondition((p) => p.scene.arena.getTimeOfDay() === TimeOfDay.DAY /* Razor claw at day*/),
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  [Species.CHARCADET]: [
