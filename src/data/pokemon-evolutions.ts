...
export const pokemonEvolutions: PokemonEvolutions = {
  [Species.BULBASAUR]: [
	...
	new SpeciesFormEvolution(Species.IVYSAUR, "delta", "delta", 16, null, null),
  ],
  [Species.IVYSAUR]: [
    new SpeciesEvolution(Species.VENUSAUR, 32, null, null) ,
	new SpeciesFormEvolution(Species.VENUSAUR, "delta", "delta", 32, null, null),
  ],
  [Species.CHARMANDER]: [
    new SpeciesEvolution(Species.CHARMELEON, 16, null, null) ,
	new SpeciesFormEvolution(Species.CHARMELEON, "delta", "delta", 16, null, null),
  ],
  [Species.CHARMELEON]: [
    new SpeciesEvolution(Species.CHARIZARD, 36, null, null) ,
	new SpeciesFormEvolution(Species.CHARIZARD, "delta", "delta", 36, null, null),
  ],
  [Species.SQUIRTLE]: [
    new SpeciesEvolution(Species.WARTORTLE, 16, null, null) ,
	new SpeciesFormEvolution(Species.WARTORTLE, "delta", "delta", 16, null, null),
  ],
  [Species.WARTORTLE]: [
    new SpeciesEvolution(Species.BLASTOISE, 36, null, null) ,
	new SpeciesFormEvolution(Species.BLASTOISE, "delta", "delta", 36, null, null),
  ],
  [Species.CATERPIE]: [
  ...
  [Species.PIDGEY]: [
	...
	new SpeciesFormEvolution(Species.PIDGEOTTO, "delta", "delta", 18, null, null),
  ],
  [Species.PIDGEOTTO]: [
    new SpeciesEvolution(Species.PIDGEOT, 36, null, null) ,
	new SpeciesFormEvolution(Species.PIDGEOT, "delta", "delta", 36, null, null),
  ],
  [Species.RATTATA]: [
  ...
  [Species.DIGLETT]: [
	...
	new SpeciesFormEvolution(Species.DUGTRIO, "delta", "delta", 26, null, null),
  ],
  [Species.MEOWTH]: [
  ...
  [Species.TENTACOOL]: [
	...
	new SpeciesFormEvolution(Species.TENTACRUEL, "delta", "delta", 30, null, null),
  ],
  [Species.GEODUDE]: [
    new SpeciesEvolution(Species.GRAVELER, 25, null, null) ,
	new SpeciesFormEvolution(Species.GRAVELER, "delta", "delta", 25, null, null),
  ],
  [Species.PONYTA]: [
  ...
  [Species.DODUO]: [
	...
	new SpeciesFormEvolution(Species.DODRIO, "delta", "delta", 31, null, null),
  ],
  [Species.SEEL]: [
  ...
  [Species.GRIMER]: [
	...
	new SpeciesFormEvolution(Species.MUK, "delta", "delta", 38, null, null),
  ],
  [Species.GASTLY]: [
  ...
  [Species.KOFFING]: [
	...
	new SpeciesFormEvolution(Species.WEEZING, "delta", "delta", 35, null, null),
  ...
  [Species.ELEKID]: [
	...
	new SpeciesFormEvolution(Species.ELECTABUZZ, "delta", "delta", 30, null, null),
  ],
  [Species.MAGBY]: [
    new SpeciesEvolution(Species.MAGMAR, 30, null, null) ,
	new SpeciesFormEvolution(Species.MAGMAR, "delta", "delta", 30, null, null),
  ],
  [Species.MAGIKARP]: [
  ...
  [Species.KABUTO]: [
	...
	new SpeciesFormEvolution(Species.KABUTOPS, "delta", "delta", 40, null, null),
  ],
  [Species.DRATINI]: [
    new SpeciesEvolution(Species.DRAGONAIR, 30, null, null) ,
	new SpeciesFormEvolution(Species.DRAGONAIR, "delta", "delta", 30, null, null),
  ],
  [Species.DRAGONAIR]: [
    new SpeciesEvolution(Species.DRAGONITE, 55, null, null) ,
	new SpeciesFormEvolution(Species.DRAGONITE, "delta", "delta", 55, null, null),
  ],
  [Species.CHIKORITA]: [
  ...
  [Species.CYNDAQUIL]: [
	...
	new SpeciesFormEvolution(Species.QUILAVA, "delta", "delta", 14, null, null),
  ],
  [Species.QUILAVA]: [
	...
	new SpeciesFormEvolution(Species.TYPHLOSION, "delta", "delta", 36, null, null),
  ...
  [Species.HOOTHOOT]: [
	...
	new SpeciesFormEvolution(Species.NOCTOWL, "delta", "delta", 20, null, null),
  ],
  [Species.LEDYBA]: [
  ...
  [Species.CHINCHOU]: [
	...
	new SpeciesFormEvolution(Species.LANTURN, "delta", "delta", 27, null, null),
  ],
  [Species.NATU]: [
  ...
  [Species.WOOPER]: [
	...
	new SpeciesFormEvolution(Species.QUAGSIRE, "delta", "delta", 20, null, null),
  ],
  [Species.WYNAUT]: [
  ...
  [Species.REMORAID]: [
	...
	new SpeciesFormEvolution(Species.OCTILLERY, "delta", "delta", 25, null, null),
  ],
  [Species.HOUNDOUR]: [
  ...
  [Species.TREECKO]: [
	...
	new SpeciesFormEvolution(Species.GROVYLE, "delta", "delta", 16, null, null),
  ],
  [Species.GROVYLE]: [
    new SpeciesEvolution(Species.SCEPTILE, 36, null, null) ,
	new SpeciesFormEvolution(Species.SCEPTILE, "delta", "delta", 36, null, null),
  ],
  [Species.TORCHIC]: [
    new SpeciesEvolution(Species.COMBUSKEN, 16, null, null) ,
	new SpeciesFormEvolution(Species.COMBUSKEN, "delta", "delta", 16, null, null),
  ],
  [Species.COMBUSKEN]: [
    new SpeciesEvolution(Species.BLAZIKEN, 36, null, null) ,
	new SpeciesFormEvolution(Species.BLAZIKEN, "delta", "delta", 36, null, null),
  ],
  [Species.MUDKIP]: [
  ...
  [Species.LOTAD]: [
	...
	new SpeciesFormEvolution(Species.LOMBRE, "delta", "delta", 14, null, null),
  ],
  [Species.SEEDOT]: [
    new SpeciesEvolution(Species.NUZLEAF, 14, null, null) ,
	new SpeciesFormEvolution(Species.NUZLEAF, "delta", "delta", 14, null, null),
  ],
  [Species.TAILLOW]: [
  ...
  [Species.RALTS]: [
	...
	new SpeciesFormEvolution(Species.KIRLIA, "delta", "delta",20,null,null ),
  ],
  [Species.KIRLIA]: [
    new SpeciesEvolution(Species.GARDEVOIR, 30, null, new SpeciesEvolutionCondition(p => p.gender === Gender.FEMALE, p => p.gender = Gender.FEMALE) ,),
	  new SpeciesFormEvolution(Species.GARDEVOIR, "delta", "delta",30, null, new SpeciesEvolutionCondition(p => p.gender === Gender.FEMALE, p => p.gender = Gender.FEMALE)),
    new SpeciesFormEvolution(Species.GALLADE, "delta", "delta",1,EvolutionItem.SHINY_STONE, new SpeciesEvolutionCondition(p => p.gender === Gender.MALE, p => p.gender = Gender.MALE)),
  ...
  [Species.ARON]: [
	...
	new SpeciesFormEvolution(Species.LAIRON, "delta", "delta", 32, null, null),
  ],
  [Species.LAIRON]: [
    new SpeciesEvolution(Species.AGGRON, 42, null, null) ,
	new SpeciesFormEvolution(Species.AGGRON, "delta", "delta", 42, null, null),
  ],
  [Species.MEDITITE]: [
    new SpeciesEvolution(Species.MEDICHAM, 37, null, null) ,
	new SpeciesFormEvolution(Species.MEDICHAM, "delta", "delta", 37, null, null),
  ],
  [Species.ELECTRIKE]: [
  ...
  [Species.WAILMER]: [
	...
	new SpeciesFormEvolution(Species.WAILORD, "delta", "delta", 40, null, null),
  ],
  [Species.NUMEL]: [
    new SpeciesEvolution(Species.CAMERUPT, 33, null, null) ,
	new SpeciesFormEvolution(Species.CAMERUPT, "delta", "delta", 33, null, null),
  ],
  [Species.SPOINK]: [
  ...
  [Species.SNORUNT]: [
	...
	new SpeciesFormEvolution(Species.GLALIE, "delta", "delta", 42, null, new SpeciesEvolutionCondition(p => p.gender === Gender.MALE, p => p.gender = Gender.MALE) ,),
    new SpeciesFormEvolution(Species.FROSLASS, "delta", "delta", 42, null, new SpeciesEvolutionCondition(p => p.gender === Gender.FEMALE, p => p.gender = Gender.FEMALE) ,),
  ...
  [Species.BELDUM]: [
	...
	new SpeciesFormEvolution(Species.METANG, "delta-ruin", "delta-ruin", 20, null, null),
			new SpeciesFormEvolution(Species.METANG, "delta-spider", "delta-spider", 20, null, null),
  ],
  [Species.METANG]: [
    new SpeciesEvolution(Species.METAGROSS, 45, null, null) ,
	new SpeciesFormEvolution(Species.METAGROSS, "delta-ruin", "delta-ruin", 45, null, null),
			new SpeciesFormEvolution(Species.METAGROSS, "delta-spider", "delta-spider", 45, null, null),
  ],
  [Species.TURTWIG]: [
    new SpeciesEvolution(Species.GROTLE, 18, null, null) ,
	new SpeciesFormEvolution(Species.GROTLE, "delta", "delta", 18, null, null),
  ],
  [Species.GROTLE]: [
    new SpeciesEvolution(Species.TORTERRA, 32, null, null) ,
	new SpeciesFormEvolution(Species.TORTERRA, "delta", "delta", 32, null, null),
  ],
  [Species.CHIMCHAR]: [
  ...
  [Species.SHINX]: [
	...
	new SpeciesFormEvolution(Species.LUXIO, "delta", "delta", 15, null, null),
  ],
  [Species.LUXIO]: [
    new SpeciesEvolution(Species.LUXRAY, 30, null, null) ,
	new SpeciesFormEvolution(Species.LUXRAY, "delta", "delta", 30, null, null),
  ],
  [Species.CRANIDOS]: [
  ...
  [Species.COMBEE]: [
	...
	new SpeciesFormEvolution(Species.VESPIQUEN, "delta", "delta", 21, null, null),
  ],
  [Species.BUIZEL]: [
  ...
  [Species.DRIFLOON]: [
	...
	new SpeciesFormEvolution(Species.DRIFBLIM, "delta", "delta", 28, null, null),
  ],
  [Species.GLAMEOW]: [
  ...
  [Species.CROAGUNK]: [
	...
	new SpeciesFormEvolution(Species.TOXICROAK, "delta", "delta", 37, null, null),
  ],
  [Species.FINNEON]: [
  ...
  [Species.SNIVY]: [
	...
	new SpeciesFormEvolution(Species.SERVINE, "delta", "delta", 17, null, null),
  ],
  [Species.SERVINE]: [
    new SpeciesEvolution(Species.SERPERIOR, 36, null, null) ,
	new SpeciesFormEvolution(Species.SERPERIOR, "delta", "delta", 36, null, null),
  ],
  [Species.TEPIG]: [
  ...
  [Species.PURRLOIN]: [
	...
	new SpeciesFormEvolution(Species.LIEPARD, "delta", "delta", 20, null, null),
  ],
  [Species.PIDOVE]: [
  ...
  [Species.VENIPEDE]: [
	...
	new SpeciesFormEvolution(Species.WHIRLIPEDE, "delta", "delta", 22, null, null),
  ],
  [Species.WHIRLIPEDE]: [
    new SpeciesEvolution(Species.SCOLIPEDE, 30, null, null) ,
	new SpeciesFormEvolution(Species.SCOLIPEDE, "delta", "delta", 30, null, null),
  ],
  [Species.SANDILE]: [
  ...
  [Species.DARUMAKA]: [
	...
	new SpeciesFormEvolution(Species.DARMANITAN, "delta", "delta", 35, null, null),
  ],
  [Species.DWEBBLE]: [
    new SpeciesEvolution(Species.CRUSTLE, 34, null, null) ,
	new SpeciesFormEvolution(Species.CRUSTLE, "delta-berry", "delta-berry", 34, null, null),
			new SpeciesFormEvolution(Species.CRUSTLE, "delta-cake", "delta-cake", 34, null, null),
  ],
  [Species.SCRAGGY]: [
    new SpeciesEvolution(Species.SCRAFTY, 39, null, null) ,
	new SpeciesFormEvolution(Species.SCRAFTY, "delta", "delta", 39, null, null),
  ],
  [Species.YAMASK]: [
    new SpeciesEvolution(Species.COFAGRIGUS, 34, null, null) ,
	new SpeciesFormEvolution(Species.COFAGRIGUS, "delta", "delta", 34, null, null),
  ],
  [Species.TIRTOUGA]: [
  ...
  [Species.SOLOSIS]: [
	...
	new SpeciesFormEvolution(Species.DUOSION, "delta", "delta", 32, null, null),
  ],
  [Species.DUOSION]: [
    new SpeciesEvolution(Species.REUNICLUS, 41, null, null) ,
	new SpeciesFormEvolution(Species.REUNICLUS, "delta", "delta", 41, null, null),
  ],
  [Species.DUCKLETT]: [
  ...
  [Species.FOONGUS]: [
	...
	new SpeciesFormEvolution(Species.AMOONGUSS, "delta", "delta", 39, null, null),
  ],
  [Species.FRILLISH]: [
  ...
  [Species.LITWICK]: [
	...
	new SpeciesFormEvolution(Species.LAMPENT, "delta", "delta", 41, null, null),
  ],
  [Species.AXEW]: [
    new SpeciesEvolution(Species.FRAXURE, 38, null, null) ,
	new SpeciesFormEvolution(Species.FRAXURE, "delta", "delta", 38, null, null),
  ],
  [Species.FRAXURE]: [
    new SpeciesEvolution(Species.HAXORUS, 48, null, null) ,
	new SpeciesFormEvolution(Species.HAXORUS, "delta", "delta", 48, null, null),
  ],
  [Species.CUBCHOO]: [
  ...
  [Species.GOLETT]: [
	...
	new SpeciesFormEvolution(Species.GOLURK, "delta", "delta", 43, null, null),
  ],
  [Species.PAWNIARD]: [
    new SpeciesEvolution(Species.BISHARP, 52, null, null) ,
	new SpeciesFormEvolution(Species.BISHARP, "delta", "delta", 52, null, null),
  ],
  [Species.BISHARP]: [
  ...
  [Species.DEINO]: [
	...
	new SpeciesFormEvolution(Species.ZWEILOUS, "delta", "delta", 50, null, null),
  ],
  [Species.ZWEILOUS]: [
    new SpeciesEvolution(Species.HYDREIGON, 64, null, null) ,
	new SpeciesFormEvolution(Species.HYDREIGON, "delta", "delta", 64, null, null),
  ],
  [Species.LARVESTA]: [
    new SpeciesEvolution(Species.VOLCARONA, 59, null, null) ,
	new SpeciesFormEvolution(Species.VOLCARONA, "delta", "delta", 59, null, null),
  ],
  [Species.CHESPIN]: [
  ...
  [Species.FROAKIE]: [
	...
	new SpeciesFormEvolution(Species.FROGADIER, "delta", "delta", 16, null, null),
  ],
  [Species.FROGADIER]: [
    new SpeciesEvolution(Species.GRENINJA, 36, null, null) ,
	new SpeciesFormEvolution(Species.GRENINJA, "delta", "delta", 36, null, null),
  ],
  [Species.BUNNELBY]: [
  ...
  [Species.AMAURA]: [
	...
	new SpeciesFormEvolution(Species.AURORUS, "delta", "delta", 39, null, null),
  ],
  [Species.GOOMY]: [
	...
	new SpeciesFormEvolution(Species.SLIGGOO, "delta", "delta", 40, null, null),
  ...
  [Species.SLIGGOO]: [
	...
	new SpeciesFormEvolution(Species.GOODRA, "delta", "delta", 50, null, new SpeciesEvolutionCondition(p => [ WeatherType.RAIN, WeatherType.FOG, WeatherType.HEAVY_RAIN ].indexOf(p.scene.arena.weather?.weatherType || WeatherType.NONE) > -1), SpeciesWildEvolutionDelay.LONG),
  ],
  [Species.BERGMITE]: [
	...
	new SpeciesFormEvolution(Species.AVALUGG, "delta", "delta", 37, null, null),
  ...
  [Species.NOIBAT]: [
	...
	new SpeciesFormEvolution(Species.NOIVERN, "delta", "delta", 48, null, null),
  ],
  [Species.ROWLET]: [
  ...
  [Species.GROWLITHE]: [
	...
	new SpeciesFormEvolution(Species.ARCANINE, "delta", "delta", 1, EvolutionItem.SHINY_STONE, null),
  ],
  [Species.POLIWHIRL]: [
  ...
  [Species.TANGELA]: [
	...
	new SpeciesFormEvolution(Species.TANGROWTH, "delta", "delta", 32, null, new SpeciesEvolutionCondition(p => p.moveset.filter(m => m.moveId === Moves.ANCIENT_POWER).length > 0) ,),
  ],
  [Species.LICKITUNG]: [
  ...
  [Species.AIPOM]: [
	...
	new SpeciesFormEvolution(Species.AMBIPOM, "delta", "delta", 32, null, new SpeciesEvolutionCondition(p => p.moveset.filter(m => m.moveId === Moves.DOUBLE_HIT).length > 0) ,),
  ],
  [Species.SUNKERN]: [
    new SpeciesEvolution(Species.SUNFLORA, 1, EvolutionItem.SUN_STONE, null, SpeciesWildEvolutionDelay.LONG) ,
	new SpeciesFormEvolution(Species.SUNFLORA, "delta", "delta", 1, EvolutionItem.FIRE_STONE, null),
  ],
  [Species.YANMA]: [
	...
	new SpeciesFormEvolution(Species.YANMEGA, "delta", "delta", 32, null, new SpeciesEvolutionCondition(p => p.moveset.filter(m => m.moveId === Moves.ANCIENT_POWER).length > 0) ,),
  ],
  [Species.MURKROW]: [
  ...
  [Species.MISDREAVUS]: [
	...
	new SpeciesFormEvolution(Species.MISMAGIUS, "delta", "delta", 1, EvolutionItem.SHINY_STONE, null),
  ],
  [Species.GIRAFARIG]: [
  ...
  [Species.LOMBRE]: [
	...
	new SpeciesFormEvolution(Species.LUDICOLO, "delta", "delta", 1, EvolutionItem.WATER_STONE, null),
  ],
  [Species.NUZLEAF]: [
    new SpeciesEvolution(Species.SHIFTRY, 1, EvolutionItem.LEAF_STONE, null, SpeciesWildEvolutionDelay.LONG) ,
	new SpeciesFormEvolution(Species.SHIFTRY, "delta", "delta", 1, EvolutionItem.THUNDER_STONE, null),
  ],
  [Species.NOSEPASS]: [
  ...
  [Species.ROSELIA]: [
	...
	new SpeciesFormEvolution(Species.ROSERADE, "delta", "delta", 1, EvolutionItem.DUSK_STONE, null),
  ],
  [Species.BONSLY]: [
  ...
  [Species.PETILIL]: [
	...
	new SpeciesFormEvolution(Species.LILLIGANT, "delta-fairy", "delta-fairy", 1, EvolutionItem.SHINY_STONE, null),
			new SpeciesFormEvolution(Species.LILLIGANT, "delta-water", "delta-water", 1, EvolutionItem.FIRE_STONE, null),
  ...
  [Species.LAMPENT]: [
	...
	new SpeciesFormEvolution(Species.CHANDELURE, "delta", "delta", 1, EvolutionItem.SHINY_STONE, null),
  ],
  [Species.FLOETTE]: [
  ...
  [Species.GRAVELER]: [
	...
	new SpeciesFormEvolution(Species.GOLEM, "delta", "delta", 1, EvolutionItem.LINKING_CORD, new SpeciesEvolutionCondition(p => true /* DexNav*/) ,),
  ],
  [Species.HAUNTER]: [
  ...
  [Species.SCYTHER]: [
    new SpeciesEvolution(Species.SCIZOR, 1, EvolutionItem.LINKING_CORD, new SpeciesEvolutionCondition(
      p => p.moveset.filter(m => m.getMove().type === Type.STEEL).length > 0),
    SpeciesWildEvolutionDelay.VERY_LONG),
    new SpeciesFormEvolution(Species.SCIZOR, "delta", "delta", 1, EvolutionItem.LINKING_CORD, null),
  ...
  [Species.ELECTABUZZ]: [
	...
	new SpeciesFormEvolution(Species.ELECTIVIRE, "delta", "delta", 1, EvolutionItem.LINKING_CORD, new SpeciesEvolutionCondition(p => true /* Electirizer*/) ,),
  ],
  [Species.MAGMAR]: [
	...
	new SpeciesFormEvolution(Species.MAGMORTAR, "delta", "delta", 1, EvolutionItem.LINKING_CORD, new SpeciesEvolutionCondition(p => true /* Magmarizer*/) ,),
  ],
  [Species.PORYGON]: [
  ...
  [Species.FEEBAS]: [
	...
	new SpeciesFormEvolution(Species.MILOTIC, "delta", "delta", 1, EvolutionItem.LINKING_CORD, new SpeciesEvolutionCondition(p => true /* Cleanse Tag*/) ,),
  ],
  [Species.DUSCLOPS]: [
  ...
  [Species.CLAMPERL]: [
	...
	new SpeciesFormEvolution(Species.HUNTAIL, "delta", "delta", 1, EvolutionItem.LINKING_CORD, new SpeciesEvolutionCondition(p => p.gender === Gender.MALE, p => p.gender = Gender.MALE /* Deep Sea Tooth */), SpeciesWildEvolutionDelay.VERY_LONG),
    new SpeciesFormEvolution(Species.GOREBYSS, "delta", "delta", 1, EvolutionItem.LINKING_CORD, new SpeciesEvolutionCondition(p => p.gender === Gender.FEMALE, p => p.gender = Gender.FEMALE /* Deep Sea Scale */), SpeciesWildEvolutionDelay.VERY_LONG),
  ...
  [Species.KARRABLAST]: [
    new SpeciesEvolution(Species.ESCAVALIER, 1, EvolutionItem.LINKING_CORD, new SpeciesEvolutionCondition(p => !!p.scene.gameData.dexData[Species.SHELMET].caughtAttr), SpeciesWildEvolutionDelay.VERY_LONG) ,
	  new SpeciesFormEvolution(Species.ESCAVALIER, "delta", "delta", 1, EvolutionItem.LINKING_CORD, new SpeciesEvolutionCondition(p => true /* DexNav*/) ,),
  ],
  [Species.SHELMET]: [
  ...
  [Species.PHANTUMP]: [
	...
	new SpeciesFormEvolution(Species.TREVENANT, "delta", "delta", 1, EvolutionItem.LINKING_CORD, null),
  ],
  [Species.PUMPKABOO]: [
  ...
  [Species.BUDEW]: [
	...
	new SpeciesFormEvolution(Species.ROSELIA, "delta", "delta", 1, null, new SpeciesFriendshipEvolutionCondition(100) ,),
  ],
  [Species.BUNEARY]: [
    new SpeciesEvolution(Species.LOPUNNY, 1, null, new SpeciesFriendshipEvolutionCondition(70), SpeciesWildEvolutionDelay.MEDIUM) ,
	new SpeciesFormEvolution(Species.LOPUNNY, "delta", "delta", 1, null, new SpeciesFriendshipEvolutionCondition(100) ,),
  ],
  [Species.CHINGLING]: [
  ...
  [Species.MUNCHLAX]: [
	...
	new SpeciesFormEvolution(Species.SNORLAX, "delta", "delta", 1, null, new SpeciesFriendshipEvolutionCondition(100) ,),
  ],
  [Species.RIOLU]: [
	...
	new SpeciesFormEvolution(Species.LUCARIO, "delta", "delta", 1, null, new SpeciesFriendshipEvolutionCondition(100) ,),
  ],
  [Species.WOOBAT]: [
