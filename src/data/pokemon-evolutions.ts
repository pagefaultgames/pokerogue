...
export const pokemonEvolutions: PokemonEvolutions = {
  ...
  [Species.ROCKRUFF]: [
    new SpeciesFormEvolution(Species.LYCANROC, '', 'midday', 25, null, new SpeciesEvolutionCondition(p => (p.scene.arena.getTimeOfDay() === TimeOfDay.DAY || p.scene.arena.getTimeOfDay() === TimeOfDay.DAWN) && (p.formIndex === 0)), null),
    new SpeciesFormEvolution(Species.LYCANROC, '', 'dusk', 25, null, new SpeciesEvolutionCondition(p =>  p.formIndex === 1), null),
    new SpeciesFormEvolution(Species.LYCANROC, '', 'midnight', 25, null, new SpeciesEvolutionCondition(p => (p.scene.arena.getTimeOfDay() === TimeOfDay.NIGHT || p.scene.arena.getTimeOfDay() === TimeOfDay.DUSK) && (p.formIndex === 0)), null)
  ],
  [Species.STEENEE]: [
