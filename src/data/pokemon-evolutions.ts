...
export class SpeciesFriendshipEvolutionCondition extends SpeciesEvolutionCondition {
  constructor(
    ...
    super(
      (p) => p.friendship >= friendshipAmount && (!predicate || predicate(p)),
      enforceFunc,
    );
  }
}
...
export const pokemonEvolutions: PokemonEvolutions = {
      ...
      new SpeciesEvolutionCondition(
        (p) =>
          !!p.scene.findModifier(
            (m) =>
              m instanceof FlinchChanceModifier &&
              (m as FlinchChanceModifier).pokemonId === p.id,
            true,
          ),
      ),
  ...
  [Species.CUBONE]: [
    new SpeciesEvolution(
      ...
      new SpeciesEvolutionCondition(
        (p) =>
          p.scene.arena.biomeType === Biome.ISLAND ||
  ...
  [Species.TYROGUE]: [
    new SpeciesEvolution(
      ...
      null,
      new SpeciesEvolutionCondition(
        (p) => p.stats[Stat.ATK] > p.stats[Stat.DEF],
      ),
    ),
    new SpeciesEvolution(
      Species.HITMONCHAN,
  ...
  [Species.NINCADA]: [
    ...
    new SpeciesEvolution(
      ...
      new SpeciesEvolutionCondition(
        (p) =>
          p.scene.getParty().length < 6 &&
          p.scene.pokeballCounts[PokeballType.POKEBALL] > 0,
      ),
    ),
  ],
  ...
  [Species.MANTYKE]: [
    new SpeciesEvolution(
      ...
      null,
      new SpeciesEvolutionCondition(
        (p) => !!p.scene.gameData.dexData[Species.REMORAID].caughtAttr,
      ),
      SpeciesWildEvolutionDelay.MEDIUM,
    ),
  ],
      ...
      new SpeciesEvolutionCondition(
        (p) =>
          !!p.scene
            .getParty()
            .find(
              (p) => p.getTypes(false, false, true).indexOf(Type.DARK) > -1,
            ),
      ),
      SpeciesWildEvolutionDelay.MEDIUM,
    ),
  ...
  [Species.TANGELA]: [
    new SpeciesEvolution(
      ...
      new SpeciesEvolutionCondition(
        (p) =>
          p.moveset.filter((m) => m.moveId === Moves.ANCIENT_POWER).length > 0,
      ),
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  ...
  [Species.AIPOM]: [
    new SpeciesEvolution(
      ...
      new SpeciesEvolutionCondition(
        (p) =>
          p.moveset.filter((m) => m.moveId === Moves.DOUBLE_HIT).length > 0,
      ),
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  ...
  [Species.DUNSPARCE]: [
    new SpeciesFormEvolution(
      ...
      new SpeciesEvolutionCondition((p) => {
        ...
        if (p.moveset.filter((m) => m.moveId === Moves.HYPER_DRILL).length > 0)
          p.scene.executeWithSeedOffset(
            () => (ret = !Utils.randSeedInt(4)),
            p.id,
          );
        return ret;
      }),
    ...
    new SpeciesEvolution(
      ...
      new SpeciesEvolutionCondition(
        (p) =>
          p.moveset.filter((m) => m.moveId === Moves.HYPER_DRILL).length > 0,
      ),
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  [Species.GLIGAR]: [
    new SpeciesEvolution(
      ...
      new SpeciesEvolutionCondition(
        (p) =>
          p.scene.arena.getTimeOfDay() ===
          TimeOfDay.NIGHT /* Razor fang at night*/,
      ),
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  [Species.SNEASEL]: [
    new SpeciesEvolution(
      ...
      new SpeciesEvolutionCondition(
        (p) =>
          p.scene.arena.getTimeOfDay() ===
          TimeOfDay.NIGHT /* Razor claw at night*/,
      ),
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  ...
  [Species.STANTLER]: [
    new SpeciesEvolution(
      ...
      new SpeciesEvolutionCondition(
        (p) =>
          p.moveset.filter((m) => m.moveId === Moves.PSYSHIELD_BASH).length > 0,
      ),
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  ...
  [Species.ROCKRUFF]: [
    ...
    new SpeciesFormEvolution(
      ...
      null,
      new SpeciesEvolutionCondition(
        (p) => p.scene.getSpeciesFormIndex(p.species) === 1,
      ),
      null,
    ),
    new SpeciesFormEvolution(
  ...
  [Species.POIPOLE]: [
    new SpeciesEvolution(
      ...
      new SpeciesEvolutionCondition(
        (p) =>
          p.moveset.filter((m) => m.moveId === Moves.DRAGON_PULSE).length > 0,
      ),
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  ...
  [Species.MILCERY]: [
    ...
    new SpeciesFormEvolution(
      ...
      new SpeciesEvolutionCondition(
        (p) =>
          p.scene.arena.biomeType === Biome.TEMPLE ||
          p.scene.arena.biomeType === Biome.ISLAND,
      ),
      SpeciesWildEvolutionDelay.LONG,
    ),
  ...
  [Species.HISUI_QWILFISH]: [
    new SpeciesEvolution(
      ...
      new SpeciesEvolutionCondition(
        (p) =>
          p.moveset.filter((m) => m.moveId === Moves.BARB_BARRAGE).length > 0,
      ),
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  ...
  [Species.DIPPLIN]: [
    new SpeciesEvolution(
      ...
      new SpeciesEvolutionCondition(
        (p) =>
          p.moveset.filter((m) => m.moveId === Moves.DRAGON_CHEER).length > 0,
      ),
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  ...
  [Species.ONIX]: [
    new SpeciesEvolution(
      ...
      new SpeciesEvolutionCondition(
        (p) =>
          p.moveset.filter((m) => m.getMove().type === Type.STEEL).length > 0,
      ),
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  ...
  [Species.KARRABLAST]: [
    new SpeciesEvolution(
      ...
      EvolutionItem.LINKING_CORD,
      new SpeciesEvolutionCondition(
        (p) => !!p.scene.gameData.dexData[Species.SHELMET].caughtAttr,
      ),
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
...

{
  ...
  prevolutionKeys.forEach((pk) => {
    ...
    for (const ev of evolutions) {
      if (ev.evoFormKey && megaFormKeys.indexOf(ev.evoFormKey) > -1) continue;
