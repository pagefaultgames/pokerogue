...
import { EncoreTag, SemiInvulnerableTag, StockpilingTag } from "./battler-tags";
...
export function initMoves() {
  allMoves.push(
    ...
    new SelfStatusMove(Moves.STOCKPILE, Type.NORMAL, -1, 20, -1, 0, 3)
      .condition(user => ((user.getTag(BattlerTagType.STOCKPILING) as StockpilingTag)?.stockpiledCount ?? 0) < 3)
