...
export interface TrainerTypeDialogue {
  [key: integer]:
    | TrainerTypeMessages
    | [TrainerTypeMessages, TrainerTypeMessages];
}
...
export const trainerTypeDialogue = {
  ...
  [TrainerType.PARASOL_LADY]: [
    {
      encounter: [`Time to grace the battlefield with elegance and poise!`],
      victory: [`My elegance remains unbroken!`],
    },
  ],
  [TrainerType.TWINS]: [
    {
  ...
  [TrainerType.BLACK_BELT]: [
    ...
    //BATTLE GIRL
    {
      ...
      victory: [`It's hard to say good-bye, but we are running out of time…`],
    },
  ],
  [TrainerType.HIKER]: [
    {
  ...
  [TrainerType.SCIENTIST]: [
    {
      encounter: [`My research will lead this world to peace and joy.`],
      victory: [
  ...
  [TrainerType.ARTIST]: [
    {
      encounter: [`I used to be popular, but now I am all washed up.`],
      victory: [
  ...
  [TrainerType.GUITARIST]: [
    {
      ...
      victory: [`Silenced for now, but my melody of resilience will play on.`],
    },
  ],
  [TrainerType.WORKER]: [
    {
    ...
    },
    {
      ...
      defeat: [`My body and mind aren't necessarily always in sync.`],
    },
    {
      encounter: [
  ...
  [TrainerType.BEAUTY]: [
    {
      ...
      victory: [`It's been fun… Let's have another last battle again someday…`],
    },
  ],
  [TrainerType.BAKER]: [
    {
      encounter: [`Hope you're ready to taste defeat!`],
      victory: [`I'll bake a comeback.`],
    },
  ],
  [TrainerType.BIKER]: [
    {
      encounter: [`Time to rev up and leave you in the dust!`],
      victory: [`I'll tune up for the next race.`],
    },
  ],
  [TrainerType.BROCK]: {
    encounter: [
  ...
  [TrainerType.MARSHAL]: {
    ...
    defeat: [`Hmm.`, `That was good battle.`, `Haaah! Haaah! Haiyaaaah!`],
  },
  [TrainerType.CHEREN]: {
    encounter: [
  ...
  [TrainerType.CRISPIN]: {
    ...
    victory: [`I wanted to win…but I lost!`, `I lost…'cause I couldn't win!`],
    defeat: [
  ...
  [TrainerType.AMARYS]: {
    ...
    victory: [`I am… not enough, I see.`],
    defeat: [`Victory belongs to me. Well fought.`],
  },
  [TrainerType.LACEY]: {
    encounter: [
      `I'll be facing you with my usual party as a member of the Elite Four.`,
    ],
    victory: [`That was a great battle!`],
    defeat: [
  ...
  [TrainerType.DRAYTON]: {
    ...
    victory: [`Guess I should've expected that!`],
    defeat: [
  ...
  [TrainerType.GARDENIA]: {
    ...
    victory: [`Amazing! You're very good, aren't you?`],
    defeat: [`Yes! My Pokémon and I are perfectly good!`],
  },
  [TrainerType.AARON]: {
    encounter: [`Ok! Let me take you on!`],
    victory: [`Battling is a deep and complex affair…`],
    defeat: [`Victory over an Elite Four member doesn't come easily.`],
  },
  [TrainerType.CRESS]: {
    encounter: [
      `That is correct! It shall be I and my esteemed Water types that you must face in battle!`,
    ],
    victory: [`Lose? Me? I don't believe this.`],
    defeat: [`This is the appropriate result when I'm your opponent.`],
  },
  [TrainerType.ALLISTER]: {
    encounter: [`'M Allister.\nH-here… I go…`],
    victory: [
      `I nearly lost my mask from the shock… That was…
      $Wow. I can see your skill for what it is.`,
    ],
    defeat: [`Th-that was ace!`],
  },
  [TrainerType.CLAY]: {
    encounter: [
      `Harrumph! Kept me waitin', didn't ya, kid? All right, time to see what ya can do!`,
    ],
    victory: [`Man oh man… It feels good to go all out and still be defeated!`],
    defeat: [
  ...
  [TrainerType.KOFU]: {
    ...
    defeat: [`You come back to see me again now, ya hear?`],
  },
  [TrainerType.TULIP]: {
    encounter: [
      `Allow me to put my skills to use to make your cute little Pokémon even more beautiful!`,
    ],
    victory: [`Your strength has a magic to it that cannot be washed away.`],
    defeat: [
  ...
  [TrainerType.SIDNEY]: {
    ...
    defeat: [`No hard feelings, alright?`],
  },
  [TrainerType.PHOEBE]: {
    encounter: [
    ...
    victory: [`Oh, darn. I've gone and lost.`],
    defeat: [`I look forward to battling you again sometime!`],
  },
  [TrainerType.GLACIA]: {
    encounter: [
    ...
    defeat: [`A fiercely passionate battle, indeed.`],
  },
  [TrainerType.DRAKE]: {
    encounter: [
    ...
    victory: [`Superb, it should be said.`],
    defeat: [`I gave my all for that battle!`],
  },
  [TrainerType.WALLACE]: {
    encounter: [
  ...
  [TrainerType.LORELEI]: {
    ...
    victory: [`How dare you!`],
    defeat: [`There's nothing you can do once you're frozen.`],
  },
  [TrainerType.WILL]: {
    encounter: [
    ...
    victory: [`I… I can't… believe it…`],
    defeat: [`That was close. I wonder what it is that you lack.`],
  },
  [TrainerType.MALVA]: {
    encounter: [
    ...
    victory: [`What news… So a new challenger has defeated Malva!`],
    defeat: [
      `I am delighted! Yes, delighted that I could squash you beneath my heel.`,
    ],
  },
  [TrainerType.HALA]: {
    encounter: [`Old Hala is here to make you holler!`],
    victory: [`I could feel the power you gained on your journey.`],
    defeat: [`Haha! What a delightful battle!`],
  },
  [TrainerType.MOLAYNE]: {
    encounter: [
    ...
    victory: [`I certainly found an interesting Trainer to face!`],
    defeat: [`Ahaha. What an interesting battle.`],
  },
  [TrainerType.RIKA]: {
    encounter: [`I'd say I'll go easy on you, but… I'd be lying! Think fast!`],
    victory: [`Not bad, kiddo.`],
    defeat: [`Nahahaha! You really are something else, kiddo!`],
  },
  [TrainerType.BRUNO]: {
    encounter: [`We will grind you down with our superior power! Hoo hah!`],
    victory: [`Why? How could I lose?`],
    defeat: [
      `You can challenge me all you like, but the results will never change!`,
    ],
  },
  [TrainerType.BUGSY]: {
    encounter: [`Let me demonstrate what I've learned from my studies.`],
    victory: [
  ...
  [TrainerType.KOGA]: {
    ...
    victory: [`Ah! You've proven your worth!`],
    defeat: [`Have you learned to fear the techniques of the ninja?`],
  },
  [TrainerType.BERTHA]: {
    encounter: [`Well, would you show this old lady how much you've learned?`],
    victory: [
    ...
    defeat: [`Hahahahah! Looks like this old lady won!`],
  },
  [TrainerType.LENORA]: {
    encounter: [
  ...
  [TrainerType.ROXIE]: {
    encounter: [`Get ready! I'm gonna knock some sense outta ya!`],
    victory: [`Wild! Your reason's already more toxic than mine!`],
    defeat: [`Hey, c'mon! Get serious! You gotta put more out there!`],
  },
  [TrainerType.OLIVIA]: {
    encounter: [`No introduction needed here. Time to battle me, Olivia!`],
    victory: [`Really lovely… Both you and your Pokémon…`],
    defeat: [`Mmm-hmm.`],
  },
  [TrainerType.POPPY]: {
    encounter: [`Oooh! Do you wanna have a Pokémon battle with me?`],
    victory: [`Uagh?! Mmmuuuggghhh…`],
    defeat: [
  ...
  [TrainerType.AGATHA]: {
    ...
    victory: [`Oh my! You're something special, child!`],
    defeat: [`Bahaha. That's how a proper battle's done!`],
  },
  [TrainerType.FLINT]: {
    encounter: [`Hope you're warmed up, cause here comes the Big Bang!`],
    victory: [
      `Incredible! Your moves are so hot, they make mine look lukewarm!`,
    ],
    defeat: [`Huh? Is that it? I think you need a bit more passion.`],
  },
  ...
  [TrainerType.CAITLIN]: {
    ...
    victory: [`My Pokémon and I learned so much! I offer you my thanks.`],
    defeat: [`I aspire to claim victory with elegance and grace.`],
  },
  [TrainerType.DIANTHA]: {
    encounter: [
  ...
  [TrainerType.ACEROLA]: {
    encounter: [`Battling is just plain fun! Come on, I can take you!`],
    victory: [`I'm… I'm speechless! How did you do it?!`],
    defeat: [`Ehaha! What an amazing victory!`],
  },
  [TrainerType.LARRY_ELITE]: {
    ...
    victory: [`Well, that took the wind from under our wings…`],
    defeat: [`It's time for a meeting with the boss.`],
  },
  [TrainerType.LANCE]: {
    encounter: [
  ...
  [TrainerType.MILO]: {
    ...
    victory: [`The power of Grass has wilted… What an incredible Challenger!`],
    defeat: [`This'll really leave you in shock and awe.`],
  },
  [TrainerType.LUCIAN]: {
    encounter: [
    ...
    victory: [`I see… It appears you've put me in checkmate.`],
    defeat: [`I have a reputation to uphold.`],
  },
  [TrainerType.DRASNA]: {
    encounter: [
  ...
  [TrainerType.BLUE]: {
    encounter: [`You must be pretty good to get this far.`],
    victory: [`I've only lost to him and now to you… Him? Hee, hee…`],
    defeat: [`See? My power is what got me here.`],
  },
  [TrainerType.PIERS]: {
    encounter: [
  ...
  [TrainerType.JASMINE]: {
    encounter: [`Oh… Your Pokémon are impressive. I think I will enjoy this.`],
    victory: [`You are truly strong. I'll have to try much harder, too.`],
    defeat: [`I never expected to win.`],
  },
  [TrainerType.LANCE_CHAMPION]: {
    encounter: [`I am still the Champion. I won't hold anything back.`],
    victory: [`This is the emergence of a new Champion.`],
    defeat: [`I successfully defended my Championship.`],
  },
  [TrainerType.STEVEN]: {
    encounter: [
    ...
    victory: [`So I, the Champion, fall in defeat…`],
    defeat: [`That was time well spent! Thank you!`],
  },
  [TrainerType.CYNTHIA]: {
    encounter: [
      `I, Cynthia, accept your challenge! There won't be any letup from me!`,
    ],
    victory: [`No matter how fun the battle is, it will always end sometime…`],
    defeat: [`Even if you lose, never lose your love of Pokémon.`],
  },
  [TrainerType.IRIS]: {
    encounter: [
    ...
    victory: [`Aghhhh… I did my best, but we lost…`],
    defeat: [`Yay! We won!`],
  },
  [TrainerType.HAU]: {
    encounter: [
    ...
    defeat: [`Ma-an, that was some kinda battle!`],
  },
  [TrainerType.GEETA]: {
    encounter: [
    ...
    victory: [`I eagerly await news of all your achievements!`],
    defeat: [`What's the matter? This isn't all, is it?`],
  },
  [TrainerType.NEMONA]: {
    encounter: [`Yesss! I'm so psyched! Time for us to let loose!`],
    victory: [`Well, that stinks, but I still had fun! I'll getcha next time!`],
    defeat: [`Well, that was a great battle! Fruitful for sure.`],
  },
  [TrainerType.LEON]: {
    encounter: [`We're gonna have an absolutely champion time!`],
    victory: [
      `My time as Champion is over… 
      $But what a champion time it's been! 
      $Thank you for the greatest battle I've ever had!`,
    ],
    defeat: [`An absolute champion time, that was!`],
  },
  [TrainerType.WHITNEY]: {
    encounter: [`Hey! Don't you think Pokémon are, like, super cute?`],
    victory: [`Waaah! Waaah! You're so mean!`],
  ...
  [TrainerType.CHUCK]: {
    ...
    victory: [`You're strong! Would you please make me your apprentice?`],
    defeat: [`There. Do you realize how much more powerful I am than you?`],
  },
  [TrainerType.KATY]: {
    encounter: [
      `Don't let your guard down unless you would like to find yourself knocked off your feet!`,
    ],
    victory: [`All of my sweet little Pokémon dropped like flies!`],
    defeat: [`Eat up, my cute little Vivillon!`],
  },
  [TrainerType.PRYCE]: {
    encounter: [
    ...
    defeat: [`Just as I envisioned.`],
  },
  [TrainerType.CLAIR]: {
    encounter: [`Do you know who I am? And you still dare to challenge me?`],
    victory: [
  ...
  [TrainerType.MAYLENE]: {
    ...
    victory: [`I admit defeat…`],
    defeat: [`That was awesome.`],
  },
  [TrainerType.FANTINA]: {
    encounter: [
    ...
    victory: [`You are so fantastically strong. I know why I have lost.`],
    defeat: [`I am so, so, very happy!`],
  },
  [TrainerType.BYRON]: {
    encounter: [
    ...
    victory: [`Hmm! My sturdy Pokémon--defeated!`],
    defeat: [`Gwahahaha! How were my sturdy Pokémon?!`],
  },
  [TrainerType.OLYMPIA]: {
    encounter: [`An ancient custom deciding one's destiny. The battle begins!`],
    victory: [
      `Create your own path. Let nothing get in your way. Your fate, your future.`,
    ],
    defeat: [`Our path is clear now.`],
  },
  [TrainerType.VOLKNER]: {
    encounter: [
  ...
  [TrainerType.ELESA]: {
    ...
    victory: [`I meant to make your head spin, but you shocked me instead.`],
    defeat: [
  ...
  [TrainerType.SKYLA]: {
    ...
    defeat: [`Win or lose, you always gain something from a battle, right?`],
  },
  [TrainerType.BRYCEN]: {
    encounter: [
    ...
    defeat: [`Extreme conditions really test you and train you!`],
  },
  [TrainerType.DRAYDEN]: {
    encounter: [
    ...
    defeat: [`Harrumph! I know your ability is greater than that!`],
  },
  [TrainerType.GRANT]: {
    encounter: [
    ...
    victory: [`You are a wall that I am unable to surmount!`],
    defeat: [
      `Do not give up. 
  ...
  [TrainerType.KORRINA]: {
    encounter: [`Time for Lady Korrina's big appearance!`],
    victory: [`It's your very being that allows your Pokémon to evolve!`],
    defeat: [`What an explosive battle!`],
  },
  [TrainerType.CLEMONT]: {
    encounter: [`Oh! I'm glad that we got to meet!`],
    victory: [`Your passion for battle inspires me!`],
    defeat: [
  ...
  [TrainerType.VALERIE]: {
    ...
    victory: [`I hope that you will find things worth smiling about tomorrow…`],
    defeat: [`Oh goodness, what a pity…`],
  },
  [TrainerType.WULFRIC]: {
    encounter: [
    ...
    defeat: [`Tussle with me and this is what happens!`],
  },
  [TrainerType.KABU]: {
    encounter: [
    ...
    victory: [`I'm glad I could battle you today!`],
    defeat: [`That's a great way for me to feel my own growth!`],
  },
  [TrainerType.BEA]: {
    encounter: [
    ...
    defeat: [`That was the best sort of match anyone could ever hope for.`],
  },
  [TrainerType.OPAL]: {
    encounter: [
    ...
    defeat: [`Too bad for you, I guess.`],
  },
  [TrainerType.BEDE]: {
    encounter: [
    ...
    defeat: [`Not a bad job, I suppose.`],
  },
  [TrainerType.GORDIE]: {
    encounter: [`So, let's get this over with.`],
    victory: [
      `I just want to climb into a hole… Well, I guess it'd be more like falling from here.`,
    ],
    defeat: [`Battle like you always do, victory will follow!`],
  },
  [TrainerType.MARNIE]: {
    encounter: [
    ...
    defeat: [`Hope you enjoyed our battle tactics.`],
  },
  [TrainerType.RAIHAN]: {
    encounter: [
    ...
    defeat: [`Let's take a selfie to remember this.`],
  },
  [TrainerType.BRASSIUS]: {
    encounter: [
      `I assume you are ready? Let our collaborative work of art begin!`,
    ],
    victory: [`Ahhh…vant-garde!`],
    defeat: [`I will begin on a new piece at once!`],
  },
  [TrainerType.IONO]: {
    encounter: [
    ...
    defeat: [`Your eyeballs are MINE!`],
  },
  [TrainerType.LARRY]: {
    encounter: [`When all's said and done, simplicity is strongest.`],
    victory: [`A serving of defeat, huh?`],
    defeat: [`I'll call it a day.`],
  },
  [TrainerType.RYME]: {
    encounter: [`Come on, baby! Rattle me down to the bone!`],
    victory: [`You're cool, my friend—you move my SOUL!`],
    defeat: [`Later, baby!`],
  },
  [TrainerType.GRUSHA]: {
    encounter: [
    ...
    victory: [`Your burning passion… I kinda like it, to be honest.`],
    defeat: [`Things didn't heat up for you.`],
  },
  [TrainerType.RIVAL]: [
    {
      encounter: [
  ...
  [TrainerType.RIVAL_2]: [
    ...
    },
    {
      ...
      defeat: [`It's OK to lose sometimes…`],
    },
  ],
  [TrainerType.RIVAL_3]: [
    {
    ...
    },
    {
      ...
      defeat: [`You gave it your best, now let's go home.`],
    },
  ],
  [TrainerType.RIVAL_4]: [
    {
      ...
      victory: [`@c{neutral}What…@d{64} What are you?`],
    },
    {
      encounter: [
      ...
      victory: [`@c{neutral}What…@d{64} What are you?`],
      defeat: [`$@c{smile}You should be proud of how far you made it.`],
    },
  ],
  [TrainerType.RIVAL_5]: [
    {
...
export function initTrainerTypeDialogue(): void {
  const trainerTypes = Object.keys(trainerTypeDialogue).map(
    (t) => Number.parseInt(t) as TrainerType,
  );
    ...
    for (const messageType of messageTypes) {
      if (Array.isArray(messages)) {
        if (messages[0][messageType])
          trainerConfigs[trainerType][`${messageType}Messages`] =
            messages[0][messageType];
        if (messages.length > 1)
          trainerConfigs[trainerType][
            `female${messageType.slice(0, 1).toUpperCase()}${messageType.slice(
              1,
            )}Messages`
