...
export abstract class CallMoveAttr extends OverrideMoveEffectAttr {
  ...
  constructor(
    ...
    super(false); // NB: We probably won't care about this after move-calling-move refactor
  ...
  public override apply(user: Pokemon, target: Pokemon): boolean {
    ...
    globalScene.phaseManager.unshiftNew("MovePhase", user, targets, new PokemonMove(copiedMove.id), MoveUseMode.FOLLOW_UP, MovePhaseTimingModifier.FIRST);
    return true;
  }
}
