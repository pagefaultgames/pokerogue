...
const trainerNameConfigs: TrainerNameConfigs = {
  ...
  [TrainerType.CAMPER]: new TrainerNameConfig(TrainerType.CAMPER).hasGenderVariant("Picknicker"),
  ...
  [TrainerType.PRISONER]: new TrainerNameConfig(TrainerType.PRISONER),
...
export const trainerNamePools = {
  ...
  [TrainerType.CAMPER]: [["Anthony","Barry","Beau","Beck","Branden","Bryce","Carter","Clark","Cliff","Chris","Cole","Curtis","Dean","Diego","Drew","Dustin","Elliot","Ethan","Flint","Grant","Haruhito","Ivan","Jacob","Jeff","Jerry","Joey","Junta","Justin","Kevin","Larry","Lawrence","Lenny","Leroy","Liam","Lloyd","Nash","Parker","Pedro","Perry","Quentin","Ricky","Riley","Roland","Ruben","Shane","Sid","Spencer","Tanner","Ted","Terrel","Todd","Travis","Trent","Tyron","Vance","Victor","Virgil","Zackary"],["Adrian","Alicia","Alma","Amara","Ana","Angelina","Ariana","Ashley","Autumn","Becky","Bianca","Brooke","Caitlin","Camryn","Carol","Celia","Charlotte","Cheyenne","Claire","Cindy","Dalia","Dana","Debra","Diana","Edna","Erin","Gina","Ginger","Gwen","Heidi","Hope","Irene","Isabelle","Karina","Kelsey","Kim","Kindra","Kylee","Lauren","Leah","Liz","Marcy","Martha","Misaki","Missy","Nancy","Piper","Robin","Shelina","Sharon","Shihori","Siena","Stacy","Sofia","Sophie","Summer","Susie","Tanya","Tiffany","Tina","Tori","Valerie","Yazmin"]],
...
["Bill","Burt","Cliff","Dick","Lyle","Ned","Otis","Ray","Richard","Walt"],
