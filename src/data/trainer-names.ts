...
class TrainerNameConfig {
  ...
  constructor(type: TrainerType, ...urls: string[]) {
    this.urls = urls.length
      ? urls
      : [Utils.toReadableString(TrainerType[type]).replace(/ /g, "_")];
  }
...
const trainerNameConfigs: TrainerNameConfigs = {
  ...
  [TrainerType.BLACK_BELT]: new TrainerNameConfig(
    TrainerType.BLACK_BELT,
  ).hasGenderVariant("Battle_Girl"),
  [TrainerType.BREEDER]: new TrainerNameConfig(
    TrainerType.BREEDER,
    "Pokémon_Breeder",
  ),
  ...
  [TrainerType.DOCTOR]: new TrainerNameConfig(
    TrainerType.DOCTOR,
  ).hasGenderVariant("Nurse"),
  ...
  [TrainerType.RICH]: new TrainerNameConfig(
    TrainerType.RICH,
    "Gentleman",
  ).hasGenderVariant("Madame"),
  [TrainerType.RICH_KID]: new TrainerNameConfig(
    TrainerType.RICH_KID,
    "Rich_Boy",
  ).hasGenderVariant("Lady"),
  ...
  [TrainerType.SNOW_WORKER]: new TrainerNameConfig(
    TrainerType.SNOW_WORKER,
    "Worker",
  ),
  [TrainerType.STRIKER]: new TrainerNameConfig(TrainerType.STRIKER),
  [TrainerType.STUDENT]: new TrainerNameConfig(
    TrainerType.STUDENT,
    "School_Kid",
  ),
  ...
  [TrainerType.WAITER]: new TrainerNameConfig(
    TrainerType.WAITER,
  ).hasGenderVariant("Waitress"),
  [TrainerType.WORKER]: new TrainerNameConfig(TrainerType.WORKER),
  [TrainerType.YOUNGSTER]: new TrainerNameConfig(
    TrainerType.YOUNGSTER,
  ).hasGenderVariant("Lass"),
};
    ...
    fetch(`https://bulbapedia.bulbagarden.net/wiki/${url}_(Trainer_class)`)
      ...
      .then((html) => {
        ...
        const trainerListHeader =
          htmlDoc.querySelector("#Trainer_list").parentElement;
