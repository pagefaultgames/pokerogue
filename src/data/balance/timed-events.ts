...
export const timedEvents: readonly TimedEvent[] = [
  ...
  },
  {
    ...
    eventEncounters: [
      { species: SpeciesId.WEEDLE },
      { species: SpeciesId.VENONAT },
      ...
      { species: SpeciesId.ANORITH },
      { species: SpeciesId.SNORUNT },
      { species: SpeciesId.SPHEAL },
      { species: SpeciesId.STUNKY },
      { species: SpeciesId.GIBLE },
      { species: SpeciesId.RIOLU },
      { species: SpeciesId.PATRAT },
      { species: SpeciesId.DRILBUR },
      { species: SpeciesId.VENIPEDE },
      { species: SpeciesId.SCRAGGY },
      { species: SpeciesId.TYNAMO },
      { species: SpeciesId.LITWICK },
      { species: SpeciesId.GOLETT },
      { species: SpeciesId.FENNEKIN },
      { species: SpeciesId.SKRELP },
      { species: SpeciesId.TYPE_NULL },
      { species: SpeciesId.CAPSAKID },
      { species: SpeciesId.TATSUGIRI },
      { species: SpeciesId.FRIGIBAX },
      { species: SpeciesId.IRON_HANDS },
      { species: SpeciesId.ALOLA_DIGLETT },
  ...
  },
  {
    ...
    dailyRunStartingItems: [TrainerItemId.ABILITY_CHARM, TrainerItemId.SHINY_CHARM],
  },
  {
