 ...
 */
export const WORSE_OFFENSIVE_STAT_SPECIES_DENYLIST = new Map<SpeciesId | [SpeciesId, number], typeof DENY_PHYSICAL_MOVES | typeof DENY_SPECIAL_MOVES >(
  [
    ...
    [[SpeciesId.DELPHOX, 1], DENY_PHYSICAL_MOVES],
