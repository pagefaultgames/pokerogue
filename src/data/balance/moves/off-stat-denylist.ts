...
>([
  ...
  [[SpeciesId.CHARIZARD, 2], DENY_PHYSICAL_MOVES], // Mega Charizard Y
  [[SpeciesId.CHARIZARD, 3], DENY_PHYSICAL_MOVES], // Gigantamax Charizard
  ...
  [[SpeciesId.CHARIZARD, 1], DENY_SPECIAL_MOVES], // Charizard X
