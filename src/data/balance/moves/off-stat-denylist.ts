...
const WORSE_OFFENSIVE_STAT_SPECIES_DENYLIST: Readonly<Partial<Record<SpeciesId, 0 | 1 | Record<number, 0 | 1>>>> = {
  ...
  [SpeciesId.APPLETUN]: DENY_PHYSICAL_MOVES,
  [SpeciesId.ARBOLIVA]: DENY_PHYSICAL_MOVES,
  [SpeciesId.ARMAROUGE]: DENY_PHYSICAL_MOVES,
  [SpeciesId.BEAUTIFLY]: DENY_PHYSICAL_MOVES,
  ...
  [SpeciesId.ELDEGOSS]: DENY_PHYSICAL_MOVES,
  ...
  [SpeciesId.JELLICENT]: DENY_PHYSICAL_MOVES,
  [SpeciesId.JOLTEON]: DENY_PHYSICAL_MOVES,
  [SpeciesId.JYNX]: DENY_PHYSICAL_MOVES,
  [SpeciesId.LANTURN]: DENY_PHYSICAL_MOVES,
  [SpeciesId.LILLIGANT]: DENY_PHYSICAL_MOVES,
  [SpeciesId.LUNATONE]: DENY_PHYSICAL_MOVES,
  ...
  [SpeciesId.BEARTIC]: DENY_SPECIAL_MOVES,
  ...
  [SpeciesId.GOURGEIST]: DENY_SPECIAL_MOVES,
  ...
  [SpeciesId.KOMALA]: DENY_SPECIAL_MOVES,
  ...
  [SpeciesId.MAMOSWINE]: DENY_SPECIAL_MOVES,
  [SpeciesId.MAROWAK]: DENY_SPECIAL_MOVES,
  [SpeciesId.MEDICHAM]: DENY_SPECIAL_MOVES,
  [SpeciesId.MEOWSCARADA]: DENY_SPECIAL_MOVES,
  [SpeciesId.MIGHTYENA]: DENY_SPECIAL_MOVES,
  ...
  [SpeciesId.SEAKING]: DENY_SPECIAL_MOVES,
  ...
  [SpeciesId.SPIDOPS]: DENY_SPECIAL_MOVES,
  ...
  [SpeciesId.VELUZA]: DENY_SPECIAL_MOVES,
  [SpeciesId.WATCHOG]: DENY_SPECIAL_MOVES,
