...
const WORSE_OFFENSIVE_STAT_SPECIES_DENYLIST: Readonly<Partial<Record<SpeciesId, 0 | 1 | Record<number, 0 | 1>>>> = {
  ...
  [SpeciesId.ALCREMIE]: DENY_PHYSICAL_MOVES,
  [SpeciesId.ALOLA_RAICHU]: DENY_PHYSICAL_MOVES,
  [SpeciesId.ARBOLIVA]: DENY_PHYSICAL_MOVES,
  [SpeciesId.ARMAROUGE]: DENY_PHYSICAL_MOVES,
  [SpeciesId.BEHEEYEM]: DENY_PHYSICAL_MOVES,
  [SpeciesId.BELLIBOLT]: DENY_PHYSICAL_MOVES,
  [SpeciesId.BUTTERFREE]: DENY_PHYSICAL_MOVES,
  [SpeciesId.CHANDELURE]: DENY_PHYSICAL_MOVES,
  [SpeciesId.CHIMECHO]: DENY_PHYSICAL_MOVES,
  [SpeciesId.CLAWITZER]: DENY_PHYSICAL_MOVES,
  [SpeciesId.COFAGRIGUS]: DENY_PHYSICAL_MOVES,
  [SpeciesId.COMFEY]: DENY_PHYSICAL_MOVES,
  [SpeciesId.CRYOGONAL]: DENY_PHYSICAL_MOVES,
  [SpeciesId.CURSOLA]: DENY_PHYSICAL_MOVES,
  ...
  [SpeciesId.GALAR_SLOWKING]: DENY_PHYSICAL_MOVES,
  ...
  [SpeciesId.HELIOLISK]: DENY_PHYSICAL_MOVES,
  ...
  [SpeciesId.MAGCARGO]: DENY_PHYSICAL_MOVES,
  ...
  [SpeciesId.VAPOREON]: DENY_PHYSICAL_MOVES,
  [SpeciesId.VIKAVOLT]: DENY_PHYSICAL_MOVES,
  [SpeciesId.VIVILLON]: DENY_PHYSICAL_MOVES,
  [SpeciesId.VOLCARONA]: DENY_PHYSICAL_MOVES,
  [SpeciesId.YANMEGA]: DENY_PHYSICAL_MOVES,
  ...
  [SpeciesId.LATIOS]: DENY_PHYSICAL_MOVES,
  [SpeciesId.LATIAS]: DENY_PHYSICAL_MOVES,
  ...
  [SpeciesId.ARMALDO]: DENY_SPECIAL_MOVES,
  ...
  [SpeciesId.AMBIPOM]: DENY_SPECIAL_MOVES,
  [SpeciesId.ANNIHILAPE]: DENY_SPECIAL_MOVES,
  [SpeciesId.AVALUGG]: DENY_SPECIAL_MOVES,
  [SpeciesId.BARBARACLE]: DENY_SPECIAL_MOVES,
  ...
  [SpeciesId.FERROTHORN]: DENY_SPECIAL_MOVES,
  ...
  [SpeciesId.GRAPPLOCT]: DENY_SPECIAL_MOVES,
  [SpeciesId.GREEDENT]: DENY_SPECIAL_MOVES,
  ...
  [SpeciesId.HIPPOWDON]: DENY_SPECIAL_MOVES,
  ...
  [SpeciesId.KABUTOPS]: DENY_SPECIAL_MOVES,
  ...
  [SpeciesId.LOKIX]: DENY_SPECIAL_MOVES,
  ...
  [SpeciesId.NINJASK]: DENY_SPECIAL_MOVES,
  [SpeciesId.OINKOLOGNE]: DENY_SPECIAL_MOVES,
  [SpeciesId.OVERQWIL]: DENY_SPECIAL_MOVES,
  [SpeciesId.PALDEA_TAUROS]: DENY_SPECIAL_MOVES,
  [SpeciesId.PANGORO]: DENY_SPECIAL_MOVES,
  [SpeciesId.PASSIMIAN]: DENY_SPECIAL_MOVES,
  [SpeciesId.PAWMOT]: DENY_SPECIAL_MOVES,
  ...
  [SpeciesId.RUNERIGUS]: DENY_SPECIAL_MOVES,
  [SpeciesId.SANDACONDA]: DENY_SPECIAL_MOVES,
  [SpeciesId.SANDSLASH]: DENY_SPECIAL_MOVES,
  [SpeciesId.SAWK]: DENY_SPECIAL_MOVES,
  [SpeciesId.SAWSBUCK]: DENY_SPECIAL_MOVES,
  ...
  [SpeciesId.TREVENANT]: DENY_SPECIAL_MOVES,
  [SpeciesId.TSAREENA]: DENY_SPECIAL_MOVES,
  [SpeciesId.URSALUNA]: DENY_SPECIAL_MOVES,
  [SpeciesId.UNFEZANT]: DENY_SPECIAL_MOVES,
