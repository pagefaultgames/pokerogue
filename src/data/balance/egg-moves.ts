...
export const speciesEggMoves = {
  ...
  [Species.PIPLUP]: [ Moves.KING'S_SHIELD, Moves.TACHYON_CUTTER, Moves.FREEZE_DRY, Moves.STEAM_ERUPTION ],
  ...
  [Species.SHIELDON]: [ Moves.SHORE_UP, Moves.BODY_PRESS, Moves.KING'S_SHIELD, Moves.DIAMOND_STORM ],
  [Species.BURMY]: [ Moves.FIERY_DANCE, Moves.DEFEND_ORDER, Moves.HEAL_ORDER, Moves.SAPPY_SEED ],
  [Species.COMBEE]: [ Moves.SPORE, Moves.FLOATY_FALL, Moves.KING'S_SHIELD, Moves.VICTORY_DANCE ],
  ...
  [Species.SNOVER]: [ Moves.LAND'S_WRATH, Moves.POWDER, Moves.CALM_MIND, Moves.MATCHA_GOTCHA ],
  ...
  [Species.ROOKIDEE]: [ Moves.ROOST, Moves.BODY_PRESS, Moves.KING'S_SHIELD, Moves.BEHEMOTH_BASH ],
  ...
  [Species.GALAR_FARFETCHD]: [ Moves.ROOST, Moves.SACRED_SWORD, Moves.KING'S_SHIELD, Moves.BEHEMOTH_BLADE ],
  ...
  [Species.POLTCHAGEIST]: [ Moves.PARABOLIC_CHARGE, Moves.SPARKLY_SWIRL, Moves.LEECH_SEED, Moves.BOUNCY_BUBBLE ],
