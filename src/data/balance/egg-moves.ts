...
export const speciesEggMoves = {
  ...
  [Species.AIPOM]: [ Moves.ROCK_BLAST, Moves.STORM_THROW, Moves.FAKE_OUT, Moves.VICTORY_DANCE ],
  ...
  [Species.DRILBUR]: [ Moves.METEOR_MASH, Moves.MOUNTAIN_GALE, Moves.SHIFT_GEAR, Moves.THOUSAND_ARROWS ],
  ...
  [Species.FERROSEED]: [ Moves.SYNTHESIS, Moves.BODY_PRESS, Moves.SPIKY_SHIELD, Moves.SAPPY_SEED ],
  ...
  [Species.GENESECT]: [ Moves.EXTREME_SPEED, Moves.SHIFT_GEAR, Moves.TACHYON_CUTTER, Moves.TAIL_GLOW ],
  ...
  [Species.FEZANDIPITI]: [ Moves.BARB_BARRAGE, Moves.BONEMARANG, Moves.TRIPLE_AXEL, Moves.VICTORY_DANCE ],
