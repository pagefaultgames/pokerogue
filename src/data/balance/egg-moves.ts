...
export const speciesEggMoves = {
  ...
  [SpeciesId.CHIKORITA]: [ MoveId.MOONBLAST, MoveId.EARTH_POWER, MoveId.CALM_MIND, MoveId.SPORE ],
  ...
  [SpeciesId.SKARMORY]: [ MoveId.ROOST, MoveId.HARD_PRESS, MoveId.CEASELESS_EDGE, MoveId.BEAK_BLAST ],
  ...
  [SpeciesId.LUGIA]: [ MoveId.TAKE_HEART, MoveId.SCALD, MoveId.AURA_SPHERE, MoveId.LUMINA_CRASH ],
  [SpeciesId.HO_OH]: [ MoveId.BEAK_BLAST, MoveId.PETAL_BLIZZARD, MoveId.REVIVAL_BLESSING, MoveId.BOLT_BEAK ],
  ...
  [SpeciesId.SCRAGGY]: [ MoveId.SUCKER_PUNCH, MoveId.SLACK_OFF, MoveId.GUNK_SHOT, MoveId.TRIPLE_AXEL ],
  ...
  [SpeciesId.HAWLUCHA]: [ MoveId.THUNDEROUS_KICK, MoveId.HEADLONG_RUSH, MoveId.FLOATY_FALL, MoveId.WICKED_BLOW ],
  ...
  [SpeciesId.CAPSAKID]: [ MoveId.STRENGTH_SAP, MoveId.FIRE_LASH, MoveId.FROST_BREATH, MoveId.APPLE_ACID ],
  ...
  [SpeciesId.IRON_THORNS]: [ MoveId.PLASMA_FISTS, MoveId.RECOVER, MoveId.ICICLE_CRASH, MoveId.SHIFT_GEAR ],
  ...
  [SpeciesId.IRON_VALIANT]: [ MoveId.PHOTON_GEYSER, MoveId.PLAY_ROUGH, MoveId.SECRET_SWORD, MoveId.NO_RETREAT ],
