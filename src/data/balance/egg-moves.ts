...
export const speciesEggMoves = {
  ...
  [Species.PIKACHU]: [ Moves.MOONBLAST, Moves.TRIPLE_AXEL, Moves.FIERY_DANCE, Moves.AURA_WHEEL ],
  ...
  [Species.GROWLITHE]: [ Moves.ZING_ZAP, Moves.DRAGON_DANCE, Moves.MORNING_SUN, Moves.SACRED_FIRE ],
  ...
  [Species.PONYTA]: [ Moves.HEADLONG_RUSH, Moves.HIGH_JUMP_KICK, Moves.SWORDS_DANCE, Moves.VOLT_TACKLE ],
  ...
  [Species.PORYGON]: [ Moves.THUNDERCLAP, Moves.DAZZLING_GLEAM, Moves.FLAMETHROWER, Moves.TECHNO_BLAST ],
  [Species.OMANYTE]: [ Moves.FREEZE_DRY, Moves.GIGA_DRAIN, Moves.POWER_GEM, Moves.STEAM_ERUPTION ],
  [Species.KABUTO]: [ Moves.CEASELESS_EDGE, Moves.HIGH_HORSEPOWER, Moves.MIGHTY_CLEAVE, Moves.CRABHAMMER ],
  ...
  [Species.CYNDAQUIL]: [ Moves.BURNING_BULWARK, Moves.EARTH_POWER, Moves.FIERY_DANCE, Moves.ELECTRO_DRIFT ],
  [Species.TOTODILE]: [ Moves.THUNDER_FANG, Moves.DRAGON_DANCE, Moves.DRAIN_PUNCH, Moves.SURGING_STRIKES ],
  ...
  [Species.PINECO]: [ Moves.METAL_BURST, Moves.RECOVER, Moves.LEECH_LIFE, Moves.SPIN_OUT ],
  ...
  [Species.HERACROSS]: [ Moves.ROCK_BLAST, Moves.STORM_THROW, Moves.ICICLE_SPEAR, Moves.SCALE_SHOT ],
  ...
  [Species.SKARMORY]: [ Moves.ROOST, Moves.BODY_PRESS, Moves.CEASELESS_EDGE, Moves.BEAK_BLAST ],
  ...
  [Species.TYROGUE]: [ Moves.DARKEST_LARIAT, Moves.THUNDEROUS_KICK, Moves.METEOR_MASH, Moves.VICTORY_DANCE ],
  ...
  [Species.SLAKOTH]: [ Moves.CRUSH_GRIP, Moves.DRAIN_PUNCH, Moves.PARTING_SHOT, Moves.SKILL_SWAP ],
  [Species.NINCADA]: [ Moves.BULLDOZE, Moves.STICKY_WEB, Moves.SHADOW_BONE, Moves.SHELL_SMASH ],
  ...
  [Species.MAWILE]: [ Moves.BULLET_PUNCH, Moves.HORN_LEECH, Moves.EARTHQUAKE, Moves.MAGICAL_TORQUE ],
  ...
  [Species.SWABLU]: [ Moves.ROOST, Moves.TAKE_HEART, Moves.AEROBLAST, Moves.BOOMBURST ],
  ...
  [Species.BELDUM]: [ Moves.HEADLONG_RUSH, Moves.DRAIN_PUNCH, Moves.ICE_SPINNER, Moves.SHIFT_GEAR ],
  ...
  [Species.TURTWIG]: [ Moves.SHELL_SMASH, Moves.STONE_AXE, Moves.ICE_SPINNER, Moves.SAPPY_SEED ],
  ...
  [Species.SHINX]: [ Moves.THUNDEROUS_KICK, Moves.TRIPLE_AXEL, Moves.ZIPPY_ZAP, Moves.BOLT_STRIKE ],
  ...
  [Species.GIBLE]: [ Moves.METEOR_MASH, Moves.BITTER_BLADE, Moves.LANDS_WRATH, Moves.DRAGON_DANCE ],
  ...
  [Species.OSHAWOTT]: [ Moves.FREEZE_DRY, Moves.SHELL_SIDE_ARM, Moves.SACRED_SWORD, Moves.SHELL_SMASH ],
  [Species.PATRAT]: [ Moves.FAKE_OUT, Moves.INSTRUCT, Moves.DYNAMIC_PUNCH, Moves.EXTREME_SPEED ],
  ...
  [Species.ROGGENROLA]: [ Moves.BODY_PRESS, Moves.SPIKY_SHIELD, Moves.SHORE_UP, Moves.DIAMOND_STORM ],
  ...
  [Species.HEATMOR]: [ Moves.EARTH_POWER, Moves.OVERHEAT, Moves.SUPERCELL_SLAM, Moves.V_CREATE ],
  [Species.DURANT]: [ Moves.HIGH_HORSEPOWER, Moves.FIRST_IMPRESSION, Moves.U_TURN, Moves.BEHEMOTH_BASH ],
  ...
  [Species.PIKIPEK]: [ Moves.TRAILBLAZE, Moves.BONE_RUSH, Moves.BURNING_BULWARK, Moves.POPULATION_BOMB ],
  [Species.YUNGOOS]: [ Moves.FAKE_OUT, Moves.HIGH_HORSEPOWER, Moves.TIDY_UP, Moves.EXTREME_SPEED ],
  [Species.GRUBBIN]: [ Moves.ICE_BEAM, Moves.EARTH_POWER, Moves.CALM_MIND, Moves.THUNDERCLAP ],
  ...
  [Species.BOUNSWEET]: [ Moves.TRIPLE_AXEL, Moves.AQUA_STEP, Moves.THUNDEROUS_KICK, Moves.FLOWER_TRICK ],
  ...
  [Species.KARTANA]: [ Moves.MIGHTY_CLEAVE, Moves.DUAL_CHOP, Moves.BEHEMOTH_BLADE, Moves.BITTER_BLADE ],
  ...
  [Species.ZERAORA]: [ Moves.SWORDS_DANCE, Moves.FIRE_LASH, Moves.COLLISION_COURSE, Moves.TRIPLE_AXEL ],
  ...
  [Species.ALOLA_VULPIX]: [ Moves.MOONBLAST, Moves.GLARE, Moves.MYSTICAL_FIRE, Moves.LUNAR_BLESSING ],
  ...
  [Species.ALOLA_GEODUDE]: [ Moves.LANDS_WRATH, Moves.FUSION_BOLT, Moves.STONE_AXE, Moves.EXTREME_SPEED ],
  ...
  [Species.SCORBUNNY]: [ Moves.EXTREME_SPEED, Moves.HIGH_JUMP_KICK, Moves.SUPERCELL_SLAM, Moves.TRIPLE_AXEL ],
  ...
  [Species.NICKIT]: [ Moves.BADDY_BAD, Moves.MYSTICAL_FIRE, Moves.SPARKLY_SWIRL, Moves.MAKE_IT_RAIN ],
  ...
  [Species.APPLIN]: [ Moves.CORE_ENFORCER, Moves.COMBAT_TORQUE, Moves.SAPPY_SEED, Moves.MATCHA_GOTCHA ],
  ...
  [Species.STONJOURNER]: [ Moves.AXE_KICK, Moves.HELPING_HAND, Moves.ACCELEROCK, Moves.DIAMOND_STORM ],
  ...
  [Species.HISUI_QWILFISH]: [ Moves.CEASELESS_EDGE, Moves.BANEFUL_BUNKER, Moves.RECOVER, Moves.FISHIOUS_REND ],
  ...
  [Species.TAROUNTULA]: [ Moves.STONE_AXE, Moves.LEECH_LIFE, Moves.FAKE_OUT, Moves.SPORE ],
  ...
  [Species.NACLI]: [ Moves.KNOCK_OFF, Moves.TOXIC, Moves.SAND_TOMB, Moves.DIAMOND_STORM ],
  ...
  [Species.WATTREL]: [ Moves.NASTY_PLOT, Moves.SPLISHY_SPLASH, Moves.SANDSEAR_STORM, Moves.WILDBOLT_STORM ],
  [Species.MASCHIFF]: [ Moves.PARTING_SHOT, Moves.LEECH_LIFE, Moves.PSYCHIC_FANGS, Moves.NO_RETREAT ],
  ...
  [Species.CYCLIZAR]: [ Moves.PARTING_SHOT, Moves.FIRE_LASH, Moves.HIGH_HORSEPOWER, Moves.MAGICAL_TORQUE ],
  ...
  [Species.SLITHER_WING]: [ Moves.ROCK_SLIDE, Moves.THUNDEROUS_KICK, Moves.SUNSTEEL_STRIKE, Moves.VICTORY_DANCE ],
  ...
  [Species.IRON_VALIANT]: [ Moves.PHOTON_GEYSER, Moves.NO_RETREAT, Moves.SECRET_SWORD, Moves.MAGICAL_TORQUE ],
  ...
  [Species.MUNKIDORI]: [ Moves.TWIN_BEAM, Moves.HEAT_WAVE, Moves.EARTH_POWER, Moves.MALIGNANT_CHAIN ],
  [Species.FEZANDIPITI]: [ Moves.BARB_BARRAGE, Moves.BONEMERANG, Moves.TRIPLE_AXEL, Moves.VICTORY_DANCE ],
  [Species.GOUGING_FIRE]: [ Moves.EXTREME_SPEED, Moves.DRAGON_DANCE, Moves.ZING_ZAP, Moves.SACRED_FIRE ],
