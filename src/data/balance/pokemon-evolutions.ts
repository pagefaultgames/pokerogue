        ...
        switch (cond.key) {
          ...
          case EvoCondKey.MOVE_TYPE:
            return i18next.t("pokemonEvolutions:moveType", {
              type: i18next.t(`pokemonInfo:Type.${PokemonType[cond.pkmnType]}`),
            });
...
export class SpeciesFormEvolution {
  ...
  constructor(
    ...
    condition: EvolutionConditionData | EvolutionConditionData[] | null,
  ...
  public validate(pokemon: Pokemon, forFusion = false, item?: EvolutionItem): boolean {
    return (
      ...
      && (isNullOrUndefined(this.preFormKey)
...
export const pokemonEvolutions: PokemonEvolutions = {
  ...
  [SpeciesId.CUBONE]: [
    new SpeciesEvolution(SpeciesId.ALOLA_MAROWAK, 28, null, {
      key: EvoCondKey.TIME,
  ...
  [SpeciesId.KOFFING]: [
    new SpeciesEvolution(SpeciesId.GALAR_WEEZING, 35, null, {
      key: EvoCondKey.TIME,
      time: [TimeOfDay.DUSK, TimeOfDay.NIGHT],
    }),
  ...
  [SpeciesId.QUILAVA]: [
    ...
    new SpeciesEvolution(SpeciesId.TYPHLOSION, 36, null, {
      key: EvoCondKey.TIME,
  ...
  [SpeciesId.KIRLIA]: [
    ...
    new SpeciesEvolution(SpeciesId.GALLADE, 1, EvolutionItem.DAWN_STONE, {
  ...
  [SpeciesId.SNORUNT]: [
    ...
    new SpeciesEvolution(SpeciesId.FROSLASS, 1, EvolutionItem.DAWN_STONE, {
      key: EvoCondKey.GENDER,
  ...
  [SpeciesId.DEWOTT]: [
    new SpeciesEvolution(SpeciesId.HISUI_SAMUROTT, 36, null, {
      key: EvoCondKey.TIME,
      time: [TimeOfDay.DUSK, TimeOfDay.NIGHT],
    }),
  ...
  [SpeciesId.RUFFLET]: [
    new SpeciesEvolution(SpeciesId.HISUI_BRAVIARY, 54, null, {
      key: EvoCondKey.TIME,
      time: [TimeOfDay.DUSK, TimeOfDay.NIGHT],
    }),
  ...
  [SpeciesId.PANCHAM]: [
    new SpeciesEvolution(
      ...
      32,
      null,
      { key: EvoCondKey.PARTY_TYPE, pkmnType: PokemonType.DARK },
      SpeciesWildEvolutionDelay.MEDIUM,
    ),
  ],
  [SpeciesId.ESPURR]: [
    new SpeciesFormEvolution(SpeciesId.MEOWSTIC, "", "female", 25, null, {
      key: EvoCondKey.GENDER,
      gender: Gender.FEMALE,
    }),
  ...
  [SpeciesId.TYRUNT]: [
    new SpeciesEvolution(SpeciesId.TYRANTRUM, 39, null, {
      key: EvoCondKey.TIME,
      time: [TimeOfDay.DAWN, TimeOfDay.DAY],
    }),
  ],
  [SpeciesId.AMAURA]: [
    new SpeciesEvolution(SpeciesId.AURORUS, 39, null, {
      key: EvoCondKey.TIME,
      time: [TimeOfDay.DUSK, TimeOfDay.NIGHT],
    }),
  ],
  [SpeciesId.GOOMY]: [
    new SpeciesEvolution(SpeciesId.HISUI_SLIGGOO, 40, null, {
      key: EvoCondKey.TIME,
      time: [TimeOfDay.DUSK, TimeOfDay.NIGHT],
    }),
  ...
  [SpeciesId.SLIGGOO]: [
    new SpeciesEvolution(
      ...
      50,
      null,
      { key: EvoCondKey.WEATHER, weather: [WeatherType.RAIN, WeatherType.FOG, WeatherType.HEAVY_RAIN] },
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  [SpeciesId.BERGMITE]: [
    new SpeciesEvolution(SpeciesId.HISUI_AVALUGG, 37, null, {
      key: EvoCondKey.TIME,
      time: [TimeOfDay.DUSK, TimeOfDay.NIGHT],
    }),
  ...
  [SpeciesId.DARTRIX]: [
    new SpeciesEvolution(SpeciesId.HISUI_DECIDUEYE, 36, null, {
      key: EvoCondKey.TIME,
      time: [TimeOfDay.DUSK, TimeOfDay.NIGHT],
    }),
    new SpeciesEvolution(SpeciesId.DECIDUEYE, 34, null, {
      key: EvoCondKey.TIME,
      time: [TimeOfDay.DAWN, TimeOfDay.DAY],
    }),
  ],
  ...
  [SpeciesId.COSMOG]: [
    new SpeciesEvolution(
      ...
      1,
      null,
      { key: EvoCondKey.FRIENDSHIP, value: 43 },
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  [SpeciesId.COSMOEM]: [
  ...
  [SpeciesId.ALOLA_RATTATA]: [
    new SpeciesEvolution(SpeciesId.ALOLA_RATICATE, 20, null, {
      key: EvoCondKey.TIME,
      time: [TimeOfDay.DUSK, TimeOfDay.NIGHT],
    }),
  ],
  ...
  [SpeciesId.GALAR_LINOONE]: [
    new SpeciesEvolution(SpeciesId.OBSTAGOON, 35, null, {
      key: EvoCondKey.TIME,
      time: [TimeOfDay.DUSK, TimeOfDay.NIGHT],
    }),
  ],
  ...
  [SpeciesId.LECHONK]: [
    new SpeciesFormEvolution(SpeciesId.OINKOLOGNE, "", "female", 18, null, {
      key: EvoCondKey.GENDER,
      gender: Gender.FEMALE,
    }),
  ...
  [SpeciesId.PAWMO]: [new SpeciesEvolution(SpeciesId.PAWMOT, 32, null, null)],
  [SpeciesId.TANDEMAUS]: [
  ...
  [SpeciesId.BRAMBLIN]: [new SpeciesEvolution(SpeciesId.BRAMBLEGHAST, 30, null, null)],
  [SpeciesId.TOEDSCOOL]: [new SpeciesEvolution(SpeciesId.TOEDSCRUEL, 30, null, null)],
  [SpeciesId.RELLOR]: [new SpeciesEvolution(SpeciesId.RABSCA, 29, null, null)],
  ...
  [SpeciesId.GREAVARD]: [
    new SpeciesEvolution(SpeciesId.HOUNDSTONE, 30, null, {
      key: EvoCondKey.TIME,
      time: [TimeOfDay.DUSK, TimeOfDay.NIGHT],
    }),
  ],
  ...
  [SpeciesId.TANGELA]: [
    new SpeciesEvolution(
      ...
      34,
      null,
      { key: EvoCondKey.MOVE, move: MoveId.ANCIENT_POWER },
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  [SpeciesId.LICKITUNG]: [
    new SpeciesEvolution(
      ...
      32,
      null,
      { key: EvoCondKey.MOVE, move: MoveId.ROLLOUT },
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  [SpeciesId.STARYU]: [
  ...
  [SpeciesId.AIPOM]: [
    new SpeciesEvolution(
      ...
      32,
      null,
      { key: EvoCondKey.MOVE, move: MoveId.DOUBLE_HIT },
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  [SpeciesId.SUNKERN]: [
  ...
  [SpeciesId.GIRAFARIG]: [
    new SpeciesEvolution(
      ...
      32,
      null,
      { key: EvoCondKey.MOVE, move: MoveId.TWIN_BEAM },
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  [SpeciesId.DUNSPARCE]: [
  ...
  [SpeciesId.GLIGAR]: [
    new SpeciesEvolution(
      ...
      { key: EvoCondKey.TIME, time: [TimeOfDay.DUSK, TimeOfDay.NIGHT] } /* Razor fang at night*/,
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  [SpeciesId.SNEASEL]: [
    new SpeciesEvolution(
      ...
      { key: EvoCondKey.TIME, time: [TimeOfDay.DUSK, TimeOfDay.NIGHT] } /* Razor claw at night*/,
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  [SpeciesId.URSARING]: [
  ...
  [SpeciesId.STANTLER]: [
    new SpeciesEvolution(
      ...
      25,
      null,
      { key: EvoCondKey.MOVE, move: MoveId.PSYSHIELD_BASH },
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  [SpeciesId.LOMBRE]: [
  ...
  [SpeciesId.ROCKRUFF]: [
    ...
    new SpeciesFormEvolution(SpeciesId.LYCANROC, "", "midday", 25, null, {
      key: EvoCondKey.TIME,
      time: [TimeOfDay.DAWN, TimeOfDay.DAY],
    }),
    new SpeciesFormEvolution(SpeciesId.LYCANROC, "", "midnight", 25, null, {
      key: EvoCondKey.TIME,
      time: [TimeOfDay.DUSK, TimeOfDay.NIGHT],
    }),
  ],
  [SpeciesId.STEENEE]: [
    new SpeciesEvolution(
      ...
      28,
      null,
      { key: EvoCondKey.MOVE, move: MoveId.STOMP },
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  [SpeciesId.POIPOLE]: [
    new SpeciesEvolution(
      ...
      1,
      null,
      { key: EvoCondKey.MOVE, move: MoveId.DRAGON_PULSE },
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  ...
  [SpeciesId.HISUI_QWILFISH]: [
    new SpeciesEvolution(
      ...
      28,
      null,
      { key: EvoCondKey.MOVE, move: MoveId.BARB_BARRAGE },
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  [SpeciesId.HISUI_SNEASEL]: [
    new SpeciesEvolution(
      ...
      1,
      EvolutionItem.RAZOR_CLAW,
      { key: EvoCondKey.TIME, time: [TimeOfDay.DAWN, TimeOfDay.DAY] } /* Razor claw at day*/,
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  [SpeciesId.CHARCADET]: [
  ...
  [SpeciesId.DIPPLIN]: [
    new SpeciesEvolution(
      ...
      1,
      null,
      { key: EvoCondKey.MOVE, move: MoveId.DRAGON_CHEER },
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  [SpeciesId.KADABRA]: [
  ...
  [SpeciesId.ONIX]: [
    new SpeciesEvolution(
      ...
      { key: EvoCondKey.MOVE_TYPE, pkmnType: PokemonType.STEEL },
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  [SpeciesId.RHYDON]: [
  ...
  [SpeciesId.CLAMPERL]: [
    new SpeciesEvolution(
      ...
      1,
      EvolutionItem.LINKING_CORD,
      { key: EvoCondKey.HELD_ITEM, itemKey: "DEEP_SEA_TOOTH" },
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
    new SpeciesEvolution(
      SpeciesId.GOREBYSS,
      1,
      EvolutionItem.LINKING_CORD,
      { key: EvoCondKey.HELD_ITEM, itemKey: "DEEP_SEA_SCALE" },
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  [SpeciesId.BOLDORE]: [
  ...
  [SpeciesId.KARRABLAST]: [
    new SpeciesEvolution(
      ...
      1,
      EvolutionItem.LINKING_CORD,
      { key: EvoCondKey.SPECIES_CAUGHT, speciesCaught: SpeciesId.SHELMET },
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  [SpeciesId.SHELMET]: [
    new SpeciesEvolution(
      ...
      1,
      EvolutionItem.LINKING_CORD,
      { key: EvoCondKey.SPECIES_CAUGHT, speciesCaught: SpeciesId.KARRABLAST },
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  [SpeciesId.SPRITZEE]: [
  ...
  [SpeciesId.PRIMEAPE]: [
    new SpeciesEvolution(
      ...
      35,
      null,
      { key: EvoCondKey.MOVE, move: MoveId.RAGE_FIST },
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  [SpeciesId.GOLBAT]: [
  ...
  [SpeciesId.CHANSEY]: [
    new SpeciesEvolution(
      ...
      1,
      null,
      { key: EvoCondKey.FRIENDSHIP, value: 200 },
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  [SpeciesId.PICHU]: [
  ...
  [SpeciesId.CLEFFA]: [
    new SpeciesEvolution(
      ...
      1,
      null,
      { key: EvoCondKey.FRIENDSHIP, value: 160 },
      SpeciesWildEvolutionDelay.SHORT,
    ),
  ],
  [SpeciesId.IGGLYBUFF]: [
  ...
  [SpeciesId.BUNEARY]: [
    new SpeciesEvolution(
      ...
      1,
      null,
      { key: EvoCondKey.FRIENDSHIP, value: 50 },
      SpeciesWildEvolutionDelay.MEDIUM,
    ),
  ],
  [SpeciesId.CHINGLING]: [
  ...
  [SpeciesId.TYPE_NULL]: [
    new SpeciesEvolution(
      ...
      1,
      null,
      { key: EvoCondKey.FRIENDSHIP, value: 100 },
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  ...
  [SpeciesId.GIMMIGHOUL]: [
    new SpeciesFormEvolution(
      ...
      1,
      null,
      { key: EvoCondKey.EVO_TREASURE_TRACKER, value: 10 },
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
    new SpeciesFormEvolution(
      SpeciesId.GHOLDENGO,
