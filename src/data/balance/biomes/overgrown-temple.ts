...
const biomeLinks: BiomeLinks = [BiomeId.DESERT, [BiomeId.SWAMP, 2], [BiomeId.ANCIENT_RUINS, 2]];

export const overgrownTempleBiome: Biome = {
  biomeId: BiomeId.OVERGROWN_TEMPLE,
  pokemonPool,
  trainerPool,
  trainerChance: 16,
  weatherPool,
