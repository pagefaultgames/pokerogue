...
export function initGenerationSix(): SpeciesDataMapConfig {
  ...
  generationSixSpeciesData[SpeciesId.GRENINJA] = {
    ...
    levelMoves: [...generationSixSpeciesData[SpeciesId.GRENINJA].levelMoves],
    tms: [...generationSixSpeciesData[SpeciesId.GRENINJA].tms],
  };
  generationSixSpeciesData[SpeciesId.BATTLE_BOND_GRENINJA] = {
    species: new PokemonSpecies({
      id: SpeciesId.GRENINJA,
      generation: 6,
      category: "Ninja Pokémon",
