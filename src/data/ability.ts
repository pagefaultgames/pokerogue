...
import { MovePhase, PokemonHealPhase, PostTurnStatusEffectPhase, ShowAbilityPhase, StatChangePhase } from "../phases";
...
export function initAbilities() {
  allAbilities.push(
    ...
    new Ability(Abilities.POISON_HEAL, 4)
      .conditionalAttr(pokemon => !!pokemon.status && pokemon.status.effect === StatusEffect.POISON, PostTurnHealAbAttr)
      .ignorable(),
