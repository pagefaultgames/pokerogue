...
export const speciesEggMoves = {
  ...
  [Species.TENTACOOL]: [ Moves.KNOCK_OFF, Moves.WHIRLPOOL, Moves.ACUPRESSURE, Moves.MALIGNANT_CHAIN ],
  ...
  [Species.DROWZEE]: [ Moves.DREAM_EATER, Moves.METRONOME, Moves.NIGHTMARE, Moves.DARK_VOID ],
  ...
  [Species.CUBONE]: [ Moves.SHADOW_BONE, Moves.SUCKER_PUNCH, Moves.PAIN_SPLIT, Moves.SKULL_BASH ],
  ...
  [Species.SUNKERN]: [ Moves.SPORE, Moves.SAPPY_SEED, Moves.LIGHT_SCREEN, Moves.CHLOROBLAST ],
  ...
  [Species.KYOGRE]: [ Moves.FREEZE_DRY, Moves.HURRICANE, Moves.CALM_MIND, Moves.FISHIOUS_REND ],
  ...
  [Species.BUDEW]: [ Moves.FLORAL_HEALING, Moves.PIN_MISSILE, Moves.SPORE, Moves.SEED_FLARE ],
