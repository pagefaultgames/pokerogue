...
export const speciesEggMoves = {
  ...
  [Species.TANGELA]: [ Moves.LEAF_STORM, Moves.NATURE_POWER, Moves.LEECH_SEED, Moves.STRENGTH_SAP ],
  [Species.KANGASKHAN]: [ Moves.POWER_UP_PUNCH, Moves.DOUBLE_EDGE, Moves.HAMMER_ARM, Moves.SKULL_BASH ],
