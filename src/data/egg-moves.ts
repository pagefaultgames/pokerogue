...
export const speciesEggMoves = {
  ...
  [Species.GRASSHOLE]: [ Moves.BELLY_DRUM, Moves.NATURE_POWER, Moves.ANCIENT_POWER, Moves.GROWTH ],
  [Species.ARABOMB]: [ Moves.DRAGON_DANCE, Moves.NATURE_POWER, Moves.NASTY_PLOT, Moves.SAND_ATTACK ],
  [Species.EJACASM]: [ Moves.ICE_BALL, Moves.RAPID_SPIN, Moves.AQUA_TAIL, Moves.MUD_SPORT ],
  [Species.SQUIRRAP]: [ Moves.REVERSAL, Moves.PURSUIT, Moves.FLAME_WHEEL, Moves.REVENGE ],
  [Species.KENGEON]: [ Moves.SKY_ATTACK, Moves.PURSUIT, Moves.FLAME_WHEEL, Moves.AIR_SLASH ],
  [Species.CURICRAWL]: [ Moves.STICKY_WEB, Moves.ELECTROWEB, Moves.LUCKY_CHANT, Moves.MEME ],
  [Species.LARVADES]: [ Moves.ELECTROWEB, Moves.TOXIC_SPIKES, Moves.PSYBEAM, Moves.SONIC_BOOM ],
  [Species.CLOVOUR]: [ Moves.GIGA_DRAIN, Moves.PRESENT, Moves.MAGNITUDE, Moves.SIGNAL_BEAM ],
  [Species.NAUSEON]: [ Moves.DESTINY_BOND, Moves.PAIN_SPLIT, Moves.CURSE, Moves.TOXIC_SPIKES ],
  [Species.PIKOTTON]: [ Moves.SURF, Moves.VOLT_TACKLE, Moves.FLY, Moves.FAKE_OUT ],
  [Species.BIRDHOUSE]: [ Moves.BOLT_BEAK, Moves.COVET, Moves.THIEF, Moves.EGG_BOMB ],
  [Species.LANSHIL]: [ Moves.HORN_DRILL, Moves.STEALTH_ROCK, Moves.DRILL_PECK, Moves.DRILL_RUN ],
  [Species.MAYMAY]: [ Moves.PUNISHMENT, Moves.HYPNOSIS, Moves.SNATCH, Moves.FLAIL ],
  [Species.VANDASH]: [ Moves.AMNESIA, Moves.COTTON_SPORE, Moves.BEAT_UP, Moves.LOW_KICK ],
  [Species.PIGUSON]: [ Moves.WAKE_UP_SLAP, Moves.DYNAMIC_PUNCH, Moves.REVENGE, Moves.BULLET_PUNCH ],
  [Species.ARMANDO]: [ Moves.TICKLE, Moves.FIRE_PUNCH, Moves.ICE_PUNCH, Moves.CLOSE_COMBAT ],
  [Species.SEMDROP]: [ Moves.STEALTH_ROCK, Moves.STICKY_WEB, Moves.ROLLOUT, Moves.WATER_PULSE ],
  [Species.FURNAZI]: [ Moves.HEAT_WAVE, Moves.ANCIENT_POWER, Moves.IRON_HEAD, Moves.HOWL ],
  [Species.TROUBAIT]: [ Moves.MUD_SPORT, Moves.KNOCK_OFF, Moves.METAL_CLAW, Moves.AQUA_JET ],
  [Species.PIXILA]: [ Moves.MOONLIGHT, Moves.NIGHTMARE, Moves.SING, Moves.DREAM_EATER ],
  [Species.RIBBIZAP]: [ Moves.AGILITY, Moves.IRON_TAIL, Moves.TAKE_DOWN, Moves.CAMOUFLAGE],
  [Species.ELEPHAS]: [ Moves.FAKE_OUT, Moves.AMNESIA, Moves.FALCON_PUNCH, Moves.FUTURE_SIGHT ],
  [Species.SEAMAPAN]: [ Moves.LOVELY_KISS, Moves.SWEET_KISS, Moves.MIND_READER, Moves.EXPLOSION ],
  [Species.CAROLINE]: [ Moves.MUD_SPORT, Moves.ATTRACT, Moves.CHARM, Moves.SUPERSONIC ],
  [Species.CHOMPEST]: [ Moves.ANCIENT_POWER, Moves.THIEF, Moves.STEALTH_ROCK, Moves.SUCKER_PUNCH ],
  [Species.MASDAWG]: [ Moves.CRUNCH, Moves.ICE_FANG, Moves.FIRE_FANG, Moves.THUNDER_FANG ],
  [Species.SPANKE]: [ Moves.DRAIN_PUNCH, Moves.FIRE_PUNCH, Moves.FOCUS_PUNCH, Moves.WAKE_UP_SLAP ],
  [Species.FISHNISM]: [ Moves.BELLY_DRUM, Moves.SNORE, Moves.SLEEP_TALK, Moves.ZEN_HEADBUTT ],
  [Species.CHEZETTA]: [ Moves.GIGA_DRAIN, Moves.GUNK_SHOT, Moves.GASTRO_ACID, Moves.COVET ],
  [Species.KROKLING]: [ Moves.GIGA_DRAIN, Moves.DRAGON_DANCE, Moves.MEGAHORN, Moves.IRON_HEAD ],
  [Species.CONCHILLA]: [ Moves.AVALANCHE, Moves.ROCK_BLAST, Moves.MUD_SHOT, Moves.WATER_PULSE ],
  [Species.COOLCUBE]: [ Moves.HAZE, Moves.MOUNTAIN_GALE, Moves.SHELTER, Moves.TRIPLE_AXEL ],
  [Species.SMOGAROBEN]: [ Moves.SHELL_SMASH, Moves.DRACO_METEOR, Moves.CLOSE_COMBAT, Moves.BRAVE_BIRD ],
  [Species.MACHMONA]: [ Moves.DRAIN_PUNCH, Moves.ICE_PUNCH, Moves.SUBMISSION, Moves.BULK_UP ],
  [Species.BACUB]: [ Moves.CROSS_CHOP, Moves.SNATCH, Moves.BELLY_DRUM, Moves.PLAY_ROUGH ],
  [Species.MOOSTATIC]: [ Moves.DISCHARGE, Moves.ZAP_CANNON, Moves.IRON_HEAD, Moves.ZEN_HEADBUTT ],
  [Species.PRETZELY]: [ Moves.SING, Moves.NIGHTMARE, Moves.FIERY_DANCE, Moves.NASTY_PLOT ],
  [Species.DEEMDOW]: [ Moves.GIGA_DRAIN, Moves.KINESIS, Moves.PSYBEAM, Moves.DRAGON_BREATH ],
  [Species.CHEERLY]: [ Moves.THUNDER_PUNCH, Moves.SWINDLE, Moves.BARRIER, Moves.SING ],
  [Species.CARACOLD]: [ Moves.ICE_BALL, Moves.ZAP_CANNON, Moves.DRAGON_BREATH, Moves.CRUNCH ],
  [Species.PENGAS]: [ Moves.ICE_BALL, Moves.BULK_UP, Moves.DRILL_PECK, Moves.WING_ATTACK ],
  [Species.PRAETEUR]: [ Moves.HYDRO_PUMP, Moves.SIGNAL_BEAM, Moves.PSYBEAM, Moves.SKULL_BASH ],
  [Species.FLOWRE]: [ Moves.GIGA_DRAIN, Moves.MOONLIGHT, Moves.SHADOW_SNEAK, Moves.PSYCHIC ],
  [Species.JUARECITO]: [ Moves.SHADOW_BONE, Moves.TEETER_DANCE, Moves.WATER_GUN, Moves.ROCK_CLIMB ],
  [Species.PUPPACTI]: [ Moves.GRASS_WHISTLE, Moves.ACUPRESSURE, Moves.MAGICAL_LEAF, Moves.ACID ],
  [Species.TITTAI]: [ Moves.PERISH_SONG, Moves.PRESENT, Moves.SLAM, Moves.TICKLE ],
  [Species.CHARAGON]: [ Moves.HIGH_HORSEPOWER, Moves.OVERDRIVE, Moves.SHIFT_GEAR, Moves.POWER_SHIFT ],
  [Species.EUPHOREAL]: [ Moves.ASTONISH, Moves.BATON_PASS, Moves.COVET, Moves.BULK_UP ],
  [Species.PRAUNCH]: [ Moves.ICE_BALL, Moves.SUPERPOWER, Moves.REFRESH, Moves.ICE_PUNCH ],
  [Species.TRICIENT]: [ Moves.CRUNCH, Moves.CURSE, Moves.DRILL_RUN, Moves.ZEN_HEADBUTT ],
  [Species.POIZOOKIE]: [ Moves.METAL_CLAW, Moves.AGILITY, Moves.CROSS_POISON, Moves.RAZOR_WIND ],
  [Species.SABRECK]: [ Moves.FIRE_FANG, Moves.ICE_FANG, Moves.POISON_FANG, Moves.THUNDER_FANG ],
  [Species.PYRALINK]: [ Moves.DRAGON_DANCE, Moves.CRUNCH, Moves.SUPER_FANG, Moves.ACID ],
  [Species.MIASMER]: [ Moves.IRON_HEAD, Moves.ROCK_BLAST, Moves.SELF_DESTRUCT, Moves.TOXIC_SPIKES ],
  [Species.CACADEMON]: [ Moves.SLACK_OFF, Moves.SLEEP_TALK, Moves.REVENGE, Moves.BODY_SLAM ],
  [Species.HANGINY]: [ Moves.SHADOW_SNEAK, Moves.SUCKER_PUNCH, Moves.SKILL_SWAP, Moves.DESTINY_BOND ],
  [Species.FROSOWL]: [ Moves.AURORA_BEAM, Moves.ROOST, Moves.ICE_BALL, Moves.FUTURE_SIGHT ],
  [Species.DRAPILLAR]: [ Moves.DRAGON_DANCE, Moves.FIRE_FANG, Moves.ICE_FANG, Moves.DRAGON_RAGE ],
  [Species.OGRELORD]: [ Moves.ICE_PUNCH, Moves.THUNDER_PUNCH, Moves.FIRE_PUNCH, Moves.HYPER_VOICE ],
  [Species.CHANTRUTH]: [ Moves.PAY_DAY, Moves.FOUL_PLAY, Moves.DIG, Moves.SMOKESCREEN ],
  [Species.INBITWEEN]: [ Moves.AIR_SLASH, Moves.FEATHER_DANCE, Moves.MOONLIGHT, Moves.HORN_DRILL],
  [Species.BONGECKO]: [ Moves.INCINERATE, Moves.SUNNY_DAY, Moves.SLEEP_TALK, Moves.GRASS_KNOT ],
  [Species.AYYLAMO]: [ Moves.COSMIC_POWER, Moves.NASTY_PLOT, Moves.BARRIER, Moves.ASTONISH ],
  [Species.SMELLOX]: [ Moves.COVET, Moves.SUCKER_PUNCH, Moves.SNATCH, Moves.PLAY_ROUGH ],
  [Species.CHASUMO]: [ Moves.VACUUM_WAVE, Moves.MACH_PUNCH, Moves.HIGH_JUMP_KICK, Moves.COUNTER ],
  [Species.OILSLAM]: [ Moves.AGILITY, Moves.SLASH, Moves.CONFUSION, Moves.NIGHT_SLASH ],
  [Species.STUFFOWL]: [ Moves.FEATHER_DANCE, Moves.STEEL_WING, Moves.TRI_ATTACK, Moves.RAZOR_WIND ],
  [Species.DRAGUN]: [ Moves.DRAGON_DANCE, Moves.DRAGON_BREATH, Moves.DRAGON_PULSE, Moves.WATER_PULSE ],
  [Species.REPTYKE]: [ Moves.SUPERPOWER, Moves.ENDURE, Moves.BULK_UP, Moves.DRAGON_DANCE ],
  [Species.FAERIOCK]: [ Moves.AMNESIA, Moves.FOCUS_ENERGY, Moves.ICE_BALL, Moves.ROLLOUT ],
  [Species.CLOUCAT]: [ Moves.BATON_PASS, Moves.TICKLE, Moves.HEAT_WAVE, Moves.WISH ],
  [Species.KNOGOAT]: [ Moves.HEAL_BELL, Moves.ROCK_CLIMB, Moves.WISH, Moves.BOUNCE ],
  [Species.FLUFFYETI]: [ Moves.MOONLIGHT, Moves.FAKE_OUT, Moves.HAMMER_ARM, Moves.BEAT_UP ],
  [Species.MIRROSTINE]: [ Moves.MIRROR_COAT, Moves.REFLECT, Moves.MIRROR_MOVE, Moves.WILL_O_WISP ],
  [Species.MUDPANTS]: [ Moves.EXTREME_SPEED, Moves.SLUDGE_BOMB, Moves.SUPERPOWER, Moves.VOLT_TACKLE ],
  [Species.MIMIMIE]: [ Moves.HYDRO_PUMP, Moves.LACTOSE_SHOT, Moves.TEETER_DANCE, Moves.TRICK ],
  [Species.SPRUCIFIX]: [ Moves.HEAL_BELL, Moves.REFRESH, Moves.DISABLE, Moves.BRANCH_POKE ],
  [Species.HULKAN]: [ Moves.HAMMER_ARM, Moves.SUPERPOWER, Moves.BELLY_DRUM, Moves.HYPER_VOICE ],
  [Species.NONITE]: [ Moves.ICE_PUNCH, Moves.FIRE_PUNCH, Moves.THUNDER_PUNCH, Moves.WISH ],
  [Species.DUNKYPEA]: [ Moves.SILVER_WIND, Moves.OMINOUS_WIND, Moves.AGILITY, Moves.THRASH ],
  [Species.KUKLUX]: [ Moves.INCINERATE, Moves.MOONBLAST, Moves.GUILLOTINE, Moves.KNOCK_OFF ],
  [Species.FLAMEBOYAN]: [ Moves.FEINT_ATTACK, Moves.MEAN_LOOK, Moves.EXPLOSION, Moves.COPYCAT ],
  [Species.PIICEE]: [ Moves.GUNK_SHOT, Moves.ENEMA, Moves.HEAL_BELL, Moves.DARK_PULSE ],
  [Species.SONNANOS]: [ Moves.FIRE_PUNCH, Moves.ICE_PUNCH, Moves.THUNDER_PUNCH, Moves.DYNAMIC_PUNCH ],
  [Species.PLEBBLES]: [ Moves.ROCK_WRECKER, Moves.BLOCK, Moves.MIRROR_MOVE, Moves.STONE_AXE ],
  [Species.SAPLEAF]: [ Moves.EXPLOSION, Moves.CURSE, Moves.MEMENTO, Moves.SPORE ],
  [Species.HITMONANA ]: [ Moves.STEALTH_ROCK, Moves.INGRAIN, Moves.EARTHQUAKE, Moves.TICKLE ],
  [Species.BALLACLE]: [ Moves.DOUBLE_TEAM, Moves.CIRCLE_THROW, Moves.VITAL_THROW, Moves.TAR_SHOT ],
  [Species.KEKROACH]: [ Moves.BUG_BUZZ, Moves.DIZZY_PUNCH, Moves.RAGE_POWDER, Moves.CLOSE_COMBAT ],
  [Species.RICOSHEEP]: [ Moves.ENERGY_BALL, Moves.AURA_SPHERE, Moves.ICE_BALL, Moves.HEALING_WISH ],
  [Species.SPAGHEFANT]: [ Moves.PLAY_ROUGH, Moves.SWEET_KISS, Moves.CHARM, Moves.STRENGTH_SAP ],
  [Species.CRYSTAQUIL]: [ Moves.ICICLE_CRASH, Moves.SHEER_COLD, Moves.ICY_WIND, Moves.ACUPRESSURE ],
  [Species.FLOCONUT]: [ Moves.WOOD_HAMMER, Moves.GRASS_WHISTLE, Moves.SWEET_SCENT, Moves.WEATHER_BALL ],
  [Species.MANATEET]: [ Moves.HYDRO_PUMP, Moves.ICE_BALL, Moves.SUPER_FANG, Moves.SUPER_FANG ],
  [Species.ANONYMOUSE]: [ Moves.VOLT_SWITCH, Moves.FAKE_TEARS, Moves.SUPER_FANG, Moves.KNOCK_OFF ],
  [Species.MOTHERFUCK]: [ Moves.STEALTH_ROCK, Moves.BLOCK, Moves.MEMENTO, Moves.STEALTH_ROCK ],
  [Species.NINOOP]: [ Moves.FAKE_OUT, Moves.BELLY_DRUM, Moves.DRAGON_RAGE, Moves.DRAGON_BREATH ],
  [Species.TICKTAC]: [ Moves.PURSUIT, Moves.ROLLOUT, Moves.BARRAGE, Moves.THUNDER_FANG ],
  [Species.HONRADE]: [ Moves.REVERSAL, Moves.FOCUS_ENERGY, Moves.PURSUIT, Moves.QUICK_ATTACK ],
  [Species.EMBORTION]: [ Moves.FOCUS_BLAST, Moves.DESTINY_BOND, Moves.PAIN_SPLIT, Moves.NASTY_PLOT ],
  [Species.POLLEFIN]: [ Moves.PETAL_DANCE, Moves.AGILITY, Moves.SWEET_KISS, Moves.LOVELY_KISS ],
  [Species.LASSLEE]: [ Moves.COSMIC_POWER, Moves.MAGICAL_LEAF, Moves.ZEN_HEADBUTT, Moves.LACTOSE_SHOT ],
  [Species.SPOOKSTER]: [ Moves.SHADOW_PUNCH, Moves.TRICK, Moves.OMINOUS_WIND, Moves.WILL_O_WISP ],
  [Species.DERPATO]: [ Moves.MUDDY_WATER, Moves.RAGE, Moves.TEETER_DANCE, Moves.HYPER_VOICE ],
  [Species.SADFISH]: [ Moves.HYDRO_CANNON, Moves.FINAL_GAMBIT, Moves.BUBBLE, Moves.SPLASH ],
  [Species.DELORIS]: [ Moves.SWEET_KISS, Moves.DRAINING_KISS, Moves.FRENZY_PLANT, Moves.SKETCH ],
  [Species.OREON]: [ Moves.LACTOSE_SHOT, Moves.LICK, Moves.SPACE_HOLE, Moves.LICK_CLEAN],
  [Species.FARFIGTRON]: [ Moves.THUNDER_PUNCH, Moves.MEGA_PUNCH, Moves.BLAST_BURN, Moves.FIRE_PUNCH ],
  [Species.SADROG]: [ Moves.KNOCK_OFF, Moves.POWER_UP_PUNCH, Moves.SYNTHESIS, Moves.BOOMBURST ],
  [Species.HODTOG]: [ Moves.CRUNCH, Moves.NATURE_POWER, Moves.ERUPTION, Moves.EARTH_POWER ],
  [Species.GNARRK]: [ Moves.LOW_KICK, Moves.BEAT_UP, Moves.HYDRO_PUMP, Moves.TRICK ],
  [Species.HUMPUNNY]: [ Moves.FLAME_CHARGE, Moves.CHARGE_BEAM, Moves.FAKE_OUT, Moves.SUPER_FANG ],
  [Species.EBINING]: [ Moves.MOONLIGHT, Moves.PLAY_ROUGH, Moves.MIRROR_COAT, Moves.COUNTER ],
  [Species.UPBOTE]: [ Moves.GEAR_UP, Moves.MORNING_SUN, Moves.RECYCLE, Moves.PSYCHO_BOOST ],
  [Species.FLIPBIRD]: [ Moves.EGG_BOMB, Moves.SKY_ATTACK, Moves.AIR_SLASH, Moves.TWISTER ],
  [Species.GANGNOME]: [ Moves.ENTRAINMENT, Moves.FOUL_PLAY, Moves.ROLE_PLAY, Moves.MIRROR_MOVE ],
  [Species.PYONGNOME]: [ Moves.HOLY_DUTY, Moves.PURSUIT, Moves.LOCK_ON, Moves.STUFF_CHEEKS ],
  [Species.BRUHKID]: [ Moves.SMELLING_SALTS, Moves.DESTINY_BOND, Moves.BLAZE_KICK, Moves.FORESIGHT ],
  [Species.WALRUSE]: [ Moves.ICE_BALL, Moves.FISSURE, Moves.ROLLOUT, Moves.ICE_SHARD ],
  [Species.DIOBAT]: [ Moves.DARK_PULSE, Moves.FLYING_PRESS, Moves.HIGH_JUMP_KICK, Moves.VACUUM_WAVE ],
  [Species.DOCEE]: [ Moves.AROMATHERAPY, Moves.FLASH_CANNON, Moves.DOOM_DESIRE, Moves.SHADOW_FORCE ],
  [Species.CAKUPPLE]: [ Moves.COVET, Moves.FLATTER, Moves.FAKE_OUT, Moves.PETAL_DANCE ],
  [Species.SOCCKAT]: [ Moves.FLARE_BLITZ, Moves.VOLT_TACKLE, Moves.CLOSE_COMBAT, Moves.TROP_KICK ],
  [Species.EGYLAMP]: [ Moves.ANCIENT_POWER, Moves.MAGIC_COAT, Moves.TRICK, Moves.RECOVER ],
  [Species.MEHNDIOR]: [ Moves.PERISH_SONG, Moves.HEAT_WAVE, Moves.AGILITY, Moves.DRACO_METEOR ],
  [Species.MISSLETOE]: [ Moves.SIGNAL_BEAM, Moves.ACID_SPRAY, Moves.NIGHT_SLASH, Moves.SHEER_COLD ],
  [Species.FLAA]: [ Moves.HIGH_JUMP_KICK, Moves.FOCUS_ENERGY, Moves.ACROBATICS, Moves.OUTRAGE ],
  [Species.ARAKETSU]: [ Moves.BATON_PASS, Moves.RAGE_POWDER, Moves.TOXIC_SPIKES, Moves.PAIN_SPLIT ],
  [Species.FALCAPTAIN]: [ Moves.FEATHER_DANCE, Moves.CLOSE_COMBAT, Moves.HURRICANE, Moves.SKY_ATTACK ],
  [Species.CIRPENT]: [ Moves.ICE_BALL, Moves.FLAME_WHEEL, Moves.GUNK_SHOT, Moves.ACROBATICS ],
  [Species.LIZASCOOP]: [ Moves.HONE_CLAWS, Moves.IRON_DEFENSE, Moves.ROCK_CLIMB, Moves.DRAGON_RUSH],
  [Species.FEFEION]: [ Moves.BATON_PASS, Moves.BUG_BITE, Moves.MOONLIGHT, Moves.STEALTH_ROCK ],
  [Species.JERKLE]: [ Moves.LICK, Moves.CIRCLE_THROW, Moves.ASSIST, Moves.HELPING_HAND ],
  [Species.FAPTIME]: [ Moves.PHOTON_GEYSER, Moves.DRAIN_PUNCH, Moves.POWER_GEM, Moves.MAGIC_COAT ],
  [Species.SHIRIMAN]: [ Moves.ENEMA, Moves.ACID_SPRAY, Moves.PSYWAVE, Moves.NIGHT_SHADE ],
  [Species.SPARGLE]: [ Moves.SLACK_OFF, Moves.HAMMER_ARM, Moves.SWIFT, Moves.STORED_POWER ],
  [Species.HOUSANT]: [ Moves.POISON_FANG, Moves.SLACK_OFF, Moves.ROCK_CLIMB, Moves.CRUNCH ],
  [Species.FUERMIGA]: [ Moves.ZEN_HEADBUTT, Moves.ENDURE, Moves.PURSUIT, Moves.OVERBITE ],
  [Species.CONFIRMABI]: [ Moves.BATON_PASS, Moves.ZEN_HEADBUTT, Moves.EARTH_POWER, Moves.GIGA_DRAIN ],
  [Species.BULBAPEDO]: [ Moves.EARTH_POWER, Moves.ENERGY_BALL, Moves.SLEEP_POWDER, Moves.AROMATHERAPY ],
  [Species.WASTENAUT]: [ Moves.MIRROR_COAT, Moves.HEAD_SMASH, Moves.CRUNCH, Moves.ROCK_CLIMB ],
  [Species.CANSUMOR]: [ Moves.ACID, Moves.ACID_SPRAY, Moves.PAIN_SPLIT, Moves.CURSE ],
  [Species.SNUFFANT]: [ Moves.HAMMER_ARM, Moves.ACID_ARMOR, Moves.ICICLE_CRASH, Moves.ICICLE_SPEAR ],
  [Species.GRIMDAK]: [ Moves.X_SCISSOR, Moves.STONE_EDGE, Moves.KNOCK_OFF, Moves.FURY_CUTTER ],
  [Species.SHROOFLE]: [ Moves.POISON_POWDER, Moves.STUN_SPORE, Moves.CLEAR_SMOG, Moves.SYNTHESIS ],
  [Species.BETACLUCK]: [ Moves.SKY_ATTACK, Moves.HEAT_WAVE, Moves.HURRICANE, Moves.AIR_SLASH ],
  [Species.TWINFOWL]: [ Moves.ICY_WIND, Moves.IRON_HEAD, Moves.HURRICANE, Moves.WILL_O_WISP ],
  [Species.ILLUMINOWL]: [ Moves.MAGIC_COAT, Moves.HEAT_WAVE, Moves.DARK_PULSE, Moves.HYPNOSIS ],
  [Species.TYPOBOP]: [ Moves.ICE_FANG, Moves.FIRE_FANG, Moves.DRAGON_DANCE, Moves.POISON_FANG ],
  [Species.RANDOMIX]: [ Moves.METRONOME, Moves.SLAM, Moves.MAGNITUDE, Moves.SECRET_POWER ],
  [Species.QUIBOOM]: [ Moves.ACID, Moves.ACID_SPRAY, Moves.ACID_ARMOR, Moves.MUD_SLAP ],
  [Species.RAINGLOCK]: [ Moves.BULLET_PUNCH, Moves.REFRESH, Moves.EXPLOSION, Moves.BUBBLE_BEAM ],
  [Species.HORNIGIRI]: [ Moves.FAKE_TEARS, Moves.POISON_STING, Moves.SHEER_COLD, Moves.EXPLOSION ],
  [Species.PREASU]: [ Moves.PRESENT, Moves.VOLT_SWITCH, Moves.TICKLE, Moves.THUNDER ],
  [Species.WARNEY]: [ Moves.MEGAHORN, Moves.ZEN_HEADBUTT, Moves.IRON_HEAD, Moves.OUTRAGE ],
  [Species.ACUFRONT]: [ Moves.CAMOUFLAGE, Moves.CONVERSION, Moves.CONVERSION_2, Moves.FUTURE_SIGHT ],
  [Species.MILITANT]: [ Moves.MINIMIZE, Moves.OVERBITE, Moves.BODY_PRESS, Moves.NO_RETREAT ],
  [Species.SHIGGYDIG]: [ Moves.WOOD_HAMMER , Moves.SLACK_OFF, Moves.ENDURE, Moves.THRASH ],
  [Species.SIGNOT]: [ Moves.DIG, Moves.U_TURN, Moves.SUCKER_PUNCH, Moves.GASTRO_ACID ],
  [Species.ROLANGO]: [ Moves.DRACO_METEOR, Moves.DRAGON_DANCE, Moves.POWER_WHIP, Moves.KNOCK_OFF ],
  [Species.PEARCHIE]: [ Moves.VOLT_TACKLE, Moves.PLAY_ROUGH, Moves.CLOSE_COMBAT, Moves.FLARE_BLITZ ],
  [Species.TARDITANK]: [ Moves.RAGE_POWDER, Moves.FOLLOW_ME, Moves.HELPING_HAND, Moves.LICK_CLEAN ],
  [Species.IPLORA]: [ Moves.CONVERSION, Moves.CONVERSION_2, Moves.JUMP_KICK, Moves.AGILITY ],
  [Species.PITAYEN]: [ Moves.DRAGON_DANCE, Moves.GRASS_WHISTLE, Moves.AROMATHERAPY, Moves.NATURE_POWER ],
  [Species.SESQUATCH]: [ Moves.DOUBLE_EDGE, Moves.DIVE, Moves.POWER_UP_PUNCH, Moves.PAIN_SPLIT ],
  [Species.FIRESHI]: [ Moves.LAVA_PLUME, Moves.CURSE, Moves.WILL_O_WISP, Moves.NIGHT_SHADE ],
  [Species.SLUGBUD]: [ Moves.DRAGON_PULSE, Moves.ACID_ARMOR, Moves.RECOVER, Moves.ENDURE ],
  [Species.SKELETROLL]: [ Moves.HAMMER_ARM, Moves.ICICLE_CRASH, Moves.HEAL_BELL, Moves.ROCK_SLIDE ],
  [Species.LANKONG]: [ Moves.FIRE_PUNCH, Moves.THUNDER_PUNCH, Moves.ICE_PUNCH, Moves.PUNISHMENT ],
};
