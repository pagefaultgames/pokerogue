...
export const speciesEggMoves = {
  ...
  [Species.LECHONK]: [ Moves.MILK_DRINK, Moves.NONE, Moves.NONE, Moves.HEAD_CHARGE ],
  [Species.TAROUNTULA]: [ Moves.STRENGTH_SAP, Moves.LEECH_LIFE, Moves.PARTING_SHOT, Moves.STEALTH_ROCK ],
  [Species.NYMBLE]: [ Moves.CEASELESS_EDGE, Moves.NONE, Moves.LEECH_LIFE, Moves.WICKED_BLOW ],
