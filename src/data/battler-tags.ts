...
export class RechargingTag extends BattlerTag {
  ...
  lapse(pokemon: Pokemon, lapseType: BattlerTagLapseType): boolean {
    if (lapseType === BattlerTagLapseType.PRE_MOVE) {
      pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsRechargingLapse", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
...
export class TrappedTag extends BattlerTag {
  ...
  onRemove(pokemon: Pokemon): void {
    ...
    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsTrappedOnRemove", {
  ...
  getTrapMessage(pokemon: Pokemon): string {
    return i18next.t("battlerTags:battlerTagsTrappedOnAdd", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) });
  }
}
...
export class FlinchedTag extends BattlerTag {
  ...
  lapse(pokemon: Pokemon, lapseType: BattlerTagLapseType): boolean {
    if (lapseType === BattlerTagLapseType.PRE_MOVE) {
      (pokemon.scene.getCurrentPhase() as MovePhase).cancel();
      pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsFlinchedLapse", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
    }
...
export class ConfusedTag extends BattlerTag {
  ...
  onAdd(pokemon: Pokemon): void {
    ...
    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsConfusedOnAdd", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
  }

  onRemove(pokemon: Pokemon): void {
    super.onRemove(pokemon);

    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsConfusedOnRemove", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
  }

  onOverlap(pokemon: Pokemon): void {
    super.onOverlap(pokemon);

    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsConfusedOnOverlap", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
  }
  ...
  lapse(pokemon: Pokemon, lapseType: BattlerTagLapseType): boolean {
    ...
    if (ret) {
      pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsConfusedLapse", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
      pokemon.scene.unshiftPhase(new CommonAnimPhase(pokemon.scene, pokemon.getBattlerIndex(), undefined, CommonAnim.CONFUSION));
      ...
      if (pokemon.randSeedInt(3) === 0) {
        ...
        pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsConfusedLapseHurtItself"));
...
export class DestinyBondTag extends BattlerTag {
  ...
  lapse(pokemon: Pokemon, lapseType: BattlerTagLapseType): boolean {
    ...
    if (pokemon.isBossImmune()) {
      pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsDestinyBondLapseIsBoss", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
      return false;
    }

    pokemon.scene.queueMessage(
      i18next.t("battlerTags:battlerTagsDestinyBondLapse", {
...
export class InfatuatedTag extends BattlerTag {
  ...
  onAdd(pokemon: Pokemon): void {
    ...
    pokemon.scene.queueMessage(
      i18next.t("battlerTags:battlerTagsInfatuatedOnAdd", {
        pokemonNameWithAffix: getPokemonNameWithAffix(pokemon),
  ...
  onOverlap(pokemon: Pokemon): void {
    ...
    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsInfatuatedOnOverlap", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
  }
  ...
  lapse(pokemon: Pokemon, lapseType: BattlerTagLapseType): boolean {
    ...
    if (ret) {
      pokemon.scene.queueMessage(
        i18next.t("battlerTags:battlerTagsInfatuatedLapse", {
          pokemonNameWithAffix: getPokemonNameWithAffix(pokemon),
          sourcePokemonName: getPokemonNameWithAffix(pokemon.scene.getPokemonById(this.sourceId!) ?? undefined) // TODO: is that bang correct?
        })
      );
      ...
      if (pokemon.randSeedInt(2)) {
        pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsInfatuatedLapseImmobilize", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
        (pokemon.scene.getCurrentPhase() as MovePhase).cancel();
      }
    }
  ...
  onRemove(pokemon: Pokemon): void {
    ...
    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsInfatuatedOnRemove", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
  }
...
export class SeedTag extends BattlerTag {
  ...
  */
  ...
  onAdd(pokemon: Pokemon): void {
    ...
    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsSeededOnAdd", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
      ...
      if (source) {
        ...
        if (!cancelled.value) {
          ...
          pokemon.scene.unshiftPhase(new PokemonHealPhase(pokemon.scene, source.getBattlerIndex(),
            ...
            !reverseDrain ? i18next.t("battlerTags:battlerTagsSeededLapse", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }) : i18next.t("battlerTags:battlerTagsSeededLapseShed", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }),
            false, true));
        }
      }
    }
...
export class NightmareTag extends BattlerTag {
  ...
  onAdd(pokemon: Pokemon): void {
    ...
    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsNightmareOnAdd", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
  }

  onOverlap(pokemon: Pokemon): void {
    super.onOverlap(pokemon);

    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsNightmareOnOverlap", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
  }
  ...
  lapse(pokemon: Pokemon, lapseType: BattlerTagLapseType): boolean {
    ...
    if (ret) {
      pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsNightmareLapse", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
...
export class EncoreTag extends BattlerTag {
  ...
  */
  ...
  onAdd(pokemon: Pokemon): void {
    ...
    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsEncoreOnAdd", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
  ...
  onRemove(pokemon: Pokemon): void {
    ...
    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsEncoreOnRemove", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
  }
}
...
export class HelpingHandTag extends BattlerTag {
  ...
  onAdd(pokemon: Pokemon): void {
    pokemon.scene.queueMessage(
      i18next.t("battlerTags:battlerTagsHelpingHandOnAdd", {
...
export class IngrainTag extends TrappedTag {
    ...
    if (ret) {
      pokemon.scene.unshiftPhase(
        new PokemonHealPhase(
          ...
          i18next.t("battlerTags:battlerTagsIngrainLapse", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }),
          true
        )
      );
    }
  ...
  getTrapMessage(pokemon: Pokemon): string {
    return i18next.t("battlerTags:battlerTagsIngrainOnTrap", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) });
  }
...
export class AquaRingTag extends BattlerTag {
  ...
  onAdd(pokemon: Pokemon): void {
    ...
    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsAquaRingOnAdd", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
  }
    ...
    if (ret) {
      pokemon.scene.unshiftPhase(
        new PokemonHealPhase(
          ...
          pokemon.getBattlerIndex(),
          Math.floor(pokemon.getMaxHp() / 16),
          i18next.t("battlerTags:battlerTagsAquaRingLapse", {
            moveName: this.getMoveName(),
            pokemonName: getPokemonNameWithAffix(pokemon)
          }),
          true));
...
export class DrowsyTag extends BattlerTag {
  ...
  onAdd(pokemon: Pokemon): void {
    ...
    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsDrowsyOnAdd", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
  }
...
export abstract class DamagingTrapTag extends TrappedTag {
  ...
  */
  ...
  lapse(pokemon: Pokemon, lapseType: BattlerTagLapseType): boolean {
    ...
    if (ret) {
      pokemon.scene.queueMessage(
        i18next.t("battlerTags:battlerTagsDamagingTrapLapse", {
          pokemonNameWithAffix: getPokemonNameWithAffix(pokemon),
          moveName: this.getMoveName()
        })
      );
...
export class BindTag extends DamagingTrapTag {
  ...
  getTrapMessage(pokemon: Pokemon): string {
    return i18next.t("battlerTags:battlerTagsBindOnTrap", {
      pokemonNameWithAffix: getPokemonNameWithAffix(pokemon),
      sourcePokemonName: getPokemonNameWithAffix(pokemon.scene.getPokemonById(this.sourceId!) ?? undefined), // TODO: is that bang correct?
      moveName: this.getMoveName()
    });
...
export class WrapTag extends DamagingTrapTag {
  ...
  getTrapMessage(pokemon: Pokemon): string {
    return i18next.t("battlerTags:battlerTagsWrapOnTrap", {
      pokemonNameWithAffix: getPokemonNameWithAffix(pokemon),
      sourcePokemonName: getPokemonNameWithAffix(pokemon.scene.getPokemonById(this.sourceId!) ?? undefined), // TODO: is that bang correct?
    });
  }
...
export abstract class VortexTrapTag extends DamagingTrapTag {
  ...
  getTrapMessage(pokemon: Pokemon): string {
    return i18next.t("battlerTags:battlerTagsVortexOnTrap", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) });
  }
}
...
export class ClampTag extends DamagingTrapTag {
  ...
  getTrapMessage(pokemon: Pokemon): string {
    return i18next.t("battlerTags:battlerTagsClampOnTrap", {
...
export class SandTombTag extends DamagingTrapTag {
  ...
  getTrapMessage(pokemon: Pokemon): string {
    return i18next.t("battlerTags:battlerTagsSandTombOnTrap", {
      pokemonNameWithAffix: getPokemonNameWithAffix(pokemon),
      moveName: this.getMoveName()
    });
  }
...
export class MagmaStormTag extends DamagingTrapTag {
  ...
  getTrapMessage(pokemon: Pokemon): string {
    return i18next.t("battlerTags:battlerTagsMagmaStormOnTrap", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) });
  }
}
...
export class SnapTrapTag extends DamagingTrapTag {
  ...
  getTrapMessage(pokemon: Pokemon): string {
    return i18next.t("battlerTags:battlerTagsSnapTrapOnTrap", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) });
  }
}
...
export class ThunderCageTag extends DamagingTrapTag {
  ...
  getTrapMessage(pokemon: Pokemon): string {
    return i18next.t("battlerTags:battlerTagsThunderCageOnTrap", {
      pokemonNameWithAffix: getPokemonNameWithAffix(pokemon),
      sourcePokemonNameWithAffix: getPokemonNameWithAffix(pokemon.scene.getPokemonById(this.sourceId!) ?? undefined), // TODO: is that bang correct?
    });
  }
...
export class InfestationTag extends DamagingTrapTag {
  ...
  getTrapMessage(pokemon: Pokemon): string {
    return i18next.t("battlerTags:battlerTagsInfestationOnTrap", {
      pokemonNameWithAffix: getPokemonNameWithAffix(pokemon),
      sourcePokemonNameWithAffix: getPokemonNameWithAffix(pokemon.scene.getPokemonById(this.sourceId!) ?? undefined), // TODO: is that bang correct?
    });
  }
...
export class ProtectedTag extends BattlerTag {
  ...
  onAdd(pokemon: Pokemon): void {
    ...
    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsProtectedOnAdd", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
  }

  lapse(pokemon: Pokemon, lapseType: BattlerTagLapseType): boolean {
    if (lapseType === BattlerTagLapseType.CUSTOM) {
      new CommonBattleAnim(CommonAnim.PROTECT, pokemon).play(pokemon.scene);
      pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsProtectedLapse", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
...
export class EnduringTag extends BattlerTag {
  ...
  onAdd(pokemon: Pokemon): void {
    ...
    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsEnduringOnAdd", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
  }

  lapse(pokemon: Pokemon, lapseType: BattlerTagLapseType): boolean {
    if (lapseType === BattlerTagLapseType.CUSTOM) {
      pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsEnduringLapse", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
      return true;
    }
...
export class SturdyTag extends BattlerTag {
  ...
  lapse(pokemon: Pokemon, lapseType: BattlerTagLapseType): boolean {
    if (lapseType === BattlerTagLapseType.CUSTOM) {
      pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsSturdyLapse", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
      return true;
    }
...
export class PerishSongTag extends BattlerTag {
  ...
  lapse(pokemon: Pokemon, lapseType: BattlerTagLapseType): boolean {
    ...
    if (ret) {
      pokemon.scene.queueMessage(
        i18next.t("battlerTags:battlerTagsPerishSongLapse", {
          pokemonNameWithAffix: getPokemonNameWithAffix(pokemon),
...
export class CenterOfAttentionTag extends BattlerTag {
  ...
  onAdd(pokemon: Pokemon): void {
    ...
    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsCenterOfAttentionOnAdd", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
  }
}
...
export class TruantTag extends AbilityBattlerTag {
  ...
  lapse(pokemon: Pokemon, lapseType: BattlerTagLapseType): boolean {
    ...
    if (lastMove && lastMove.move !== Moves.NONE) {
      ...
      pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsTruantLapse", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
    }
...
export class SlowStartTag extends AbilityBattlerTag {
  ...
  onAdd(pokemon: Pokemon): void {
    ...
    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsSlowStartOnAdd", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }), null, false, null, true);
  }
  ...
  onRemove(pokemon: Pokemon): void {
    ...
    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsSlowStartOnRemove", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }), null, false, null);
  }
}
...
export class HighestStatBoostTag extends AbilityBattlerTag {
  ...
  */
  ...
  onAdd(pokemon: Pokemon): void {
    ...
    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsHighestStatBoostOnAdd", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon), statName: getStatName(highestStat) }), null, false, null, true);
  }

  onRemove(pokemon: Pokemon): void {
    super.onRemove(pokemon);

    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsHighestStatBoostOnRemove", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon), abilityName: allAbilities[this.ability].name }));
  }
}
...
export class MagnetRisenTag extends TypeImmuneTag {
  ...
  onAdd(pokemon: Pokemon): void {
    ...
    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsMagnetRisenOnAdd", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
  }

  onRemove(pokemon: Pokemon): void {
    super.onRemove(pokemon);

    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsMagnetRisenOnRemove", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
  }
}
...
export class CritBoostTag extends BattlerTag {
  ...
  onAdd(pokemon: Pokemon): void {
    ...
    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsCritBoostOnAdd", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
  }
  ...
  onRemove(pokemon: Pokemon): void {
    ...
    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsCritBoostOnRemove", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
  }
}
...
export class SaltCuredTag extends BattlerTag {
  ...
  */
  ...
  onAdd(pokemon: Pokemon): void {
    ...
    pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsSaltCuredOnAdd", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
    this.sourceIndex = pokemon.scene.getPokemonById(this.sourceId!)!.getBattlerIndex(); // TODO: are those bangs correct?
  }
  ...
  lapse(pokemon: Pokemon, lapseType: BattlerTagLapseType): boolean {
    ...
    if (ret) {
      ...
      if (!cancelled.value) {
        ...
        pokemon.scene.queueMessage(
          i18next.t("battlerTags:battlerTagsSaltCuredLapse", {
            pokemonNameWithAffix: getPokemonNameWithAffix(pokemon),
            moveName: this.getMoveName()
          })
        );
  ...
  lapse(pokemon: Pokemon, lapseType: BattlerTagLapseType): boolean {
    ...
    if (ret) {
      ...
      if (!cancelled.value) {
        ...
        pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsCursedLapse", { pokemonNameWithAffix: getPokemonNameWithAffix(pokemon) }));
      }
    }
...
export class StockpilingTag extends BattlerTag {
  ...
  onAdd(pokemon: Pokemon): void {
    if (this.stockpiledCount < 3) {
      ...
      pokemon.scene.queueMessage(i18next.t("battlerTags:battlerTagsStockpilingOnAdd", {
        pokemonNameWithAffix: getPokemonNameWithAffix(pokemon),
