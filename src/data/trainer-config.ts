...
export const signatureSpecies: SignatureSpecies = {
  ...
  LORELEI: [Species.JYNX, [Species.SLOWBRO, Species.GALAR_SLOWBRO], [Species.LAPRAS, Species.DEWGONG], Species.ALOLA_SANDSLASH],
  ...
  SIDNEY: [[Species.SHIFTRY, Species.CACTURNE], Species.SHARPEDO, Species.ABSOL, Species.MIGHTYENA],
  ...
  HALA: [Species.HARIYAMA, Species.BEWEAR, Species.CRABOMINABLE, [Species.POLIWRATH, Species.POLIWRATH]],
  ...
  ALLISTER_ELITE:[Species.DUSKNOIR, [Species.CHANDELURE, Species.RUNERIGUS], Species.CURSOLA, Species.GENGAR],
  ...
  LACEY: [Species.PRIMARINA, [Species.ALCREMIE, Species.GRANBULL], Species.WHIMSICOTT, [Species.EXCADRILL, Species.GALAR_SLOWBRO]],
