...
export const trainerConfigs: TrainerConfigs = {
  ...
  [TrainerType.ROCKET_GRUNT]: new TrainerConfig(++t).setHasGenders().setHasDouble('Rocket Grunts').setMoneyMultiplier(1.0).setEncounterBgm(TrainerType.PLASMA_GRUNT).setBattleBgm('battle_plasma_grunt').setPartyTemplates(trainerPartyTemplates.FOUR_WEAK_BALANCED)
    .setSpeciesPools({
  ...
  [TrainerType.MAGMA_GRUNT]: new TrainerConfig(++t).setHasGenders().setHasDouble('Magma Grunts').setMoneyMultiplier(1.0).setEncounterBgm(TrainerType.PLASMA_GRUNT).setBattleBgm('battle_plasma_grunt').setPartyTemplates(trainerPartyTemplates.FOUR_WEAK_BALANCED)
    .setSpeciesPools({
  ...
  [TrainerType.AQUA_GRUNT]: new TrainerConfig(++t).setHasGenders().setHasDouble('Aqua Grunts').setMoneyMultiplier(1.0).setEncounterBgm(TrainerType.PLASMA_GRUNT).setBattleBgm('battle_plasma_grunt').setPartyTemplates(trainerPartyTemplates.FOUR_WEAK_BALANCED)
    .setSpeciesPools({
  ...
  [TrainerType.GALACTIC_GRUNT]: new TrainerConfig(++t).setHasGenders().setHasDouble('Galactic Grunts').setMoneyMultiplier(1.0).setEncounterBgm(TrainerType.PLASMA_GRUNT).setBattleBgm('battle_plasma_grunt').setPartyTemplates(trainerPartyTemplates.FOUR_WEAK_BALANCED)
    .setSpeciesPools({
  ...
  [TrainerType.PLASMA_GRUNT]: new TrainerConfig(++t).setHasGenders().setHasDouble('Plasma Grunts').setMoneyMultiplier(1.0).setEncounterBgm(TrainerType.PLASMA_GRUNT).setBattleBgm('battle_plasma_grunt').setPartyTemplates(trainerPartyTemplates.FOUR_WEAK_BALANCED)
    .setSpeciesPools({
  ...
  [TrainerType.FLARE_GRUNT]: new TrainerConfig(++t).setHasGenders().setHasDouble('Flare Grunts').setMoneyMultiplier(1.0).setEncounterBgm(TrainerType.PLASMA_GRUNT).setBattleBgm('battle_plasma_grunt').setPartyTemplates(trainerPartyTemplates.FOUR_WEAK_BALANCED)
    .setSpeciesPools({
  ...
  [TrainerType.RIVAL_6]: new TrainerConfig(++t).setName('Finn').setHasGenders('Ivy').setHasCharSprite().setTitle('Rival').setBoss().setStaticParty().setMoneyMultiplier(3).setEncounterBgm('final').setBattleBgm('battle_rival_3').setPartyTemplates(trainerPartyTemplates.RIVAL_6)
    ...
    .setPartyMemberFunc(3, getRandomPartyMemberFunc([ Species.MAGMORTAR ]))
    .setPartyMemberFunc(4, getRandomPartyMemberFunc([ Species.FLYGON, Species.CLAYDOL ]))
    ...
    .setPartyMemberFunc(2, getRandomPartyMemberFunc([ Species.CROBAT ]))
    ...
    .setPartyMemberFunc(2, getRandomPartyMemberFunc([ Species.DARUMAKA, Species.GALAR_DARUMAKA ]))
    ...
    .setPartyMemberFunc(4, getRandomPartyMemberFunc([ Species.HELIOPTILE ]))
    ...
    .setPartyMemberFunc(4, getRandomPartyMemberFunc([ Species.VOLCANION ], TrainerSlot.TRAINER, true, p => {
      p.setBoss(true, 3);
      p.generateAndPopulateMoveset();
      p.pokeball = PokeballType.MASTER_BALL;
    }))
