...
export const trainerConfigs: TrainerConfigs = {
  ...
  [TrainerType.CAMPER]: new TrainerConfig(++t).setHasGenders("Picknicker", "picknicker").setEncounterBgm(TrainerType.YOUNGSTER)
    .setSpeciesPools({
      [TrainerPoolTier.COMMON]: [Species.RATTATA, Species.SPEAROW, Species.NIDORAN_F, Species.NIDORAN_M, Species.EKANS, Species.SANDSHREW, Species.DIGLETT, Species.BELLSPROUT, Species.ZIGZAGOON, Species.TAILLOW, Species.WINGULL, Species.SEEDOT, Species.BIDOOF, Species.SHINX, Species.BUIZEL, Species.PATRAT, Species.BUNNELBY, Species.SKIDDO, Species.YUNGOOS, Species.BOUNSWEET, Species.SKWOVET, Species.WOOLOO, Species.SILICOBRA, Species.LECHONK, Species.WATTREL],
      [TrainerPoolTier.UNCOMMON]: [Species.ZUBAT, Species.MANKEY, Species.PSYDUCK, Species.GROWLITHE, Species.PONYTA, Species.GEODUDE, Species.RHYHORN, Species.CHINCHOU, Species.HOPPIP, Species.AIPOM, Species.SLUGMA, Species.WURMPLE, Species.SLAKOTH, Species.VOLBEAT, Species.ILLUMISE, Species.PLUSLE, Species.MINUN, Species.GULPIN, Species.BALTOY, Species.BONSLY, Species.STUNKY, Species.VENIPEDE, Species.COTTONEE, Species.RUFFLET, Species.LITLEO, Species.HELIOPTILE, Species.SALANDIT, Species.MUDBRAY, Species.KOMALA, Species.SHROODLE],
      [TrainerPoolTier.RARE]: [Species.PINSIR, Species.HERACROSS, Species.ZANGOOSE, Species.SEVIPER, Species.KECLEON, Species.ORANGURU, Species.PASSIMIAN, Species.INDEEDEE, Species.CRAMORANT, Species.CHARCADET],
      [TrainerPoolTier.SUPER_RARE]: [Species.BULBASAUR, Species.CHARMANDER, Species.SQUIRTLE, Species.CHIKORITA, Species.CYNDAQUIL, Species.TOTODILE, Species.TREECKO, Species.TORCHIC, Species.MUDKIP, Species.TURTWIG, Species.CHIMCHAR, Species.PIPLUP, Species.SNIVY, Species.TEPIG, Species.OSHAWOTT, Species.CHESPIN, Species.FENNEKIN, Species.FROAKIE, Species.ROWLET, Species.LITTEN, Species.POPPLIO, Species.GROOKEY, Species.SCORBUNNY, Species.SOBBLE, Species.SPRIGATITO, Species.FUECOCO, Species.QUAXLY]
    }),
