...
export const signatureSpecies: SignatureSpecies = {
  ...
  BLUE: [[Species.GYARADOS, Species.EXEGGUTOR, Species.ARCANINE], [Species.HO_OH, Species.LUGIA], Species.ALAKAZAM, [Species.NINETALES, Species.MAGNEZONE, Species.CLOYSTER]],
  RED: [[Species.LUGIA, Species.HO_OH], Species.SNORLAX, [Species.ESPEON, Species.UMBREON, Species.SYLVEON]],
  ...
  LEON: [Species.DRAGAPULT, [Species.ZACIAN, Species.ZAMAZENTA], Species.AEGISLASH, [Species.RILLABOOM, Species.INTELEON]],
  ...
  NEMONA: [Species.LYCANROC, Species.KORAIDON, Species.PAWMOT, [Species.DUSKNOIR, Species.MILOTIC, Species.RIBOMBEE], [Species.MEOWSCARADA, Species.SKELEDIRGE, Species.QUAQUAVAL]],
  KIERAN: [Species.POLITOED, [Species.OGERPON, Species.TERAPAGOS], Species.HYDRAPPLE, Species.PORYGON_Z],
};
...
export const trainerConfigs: TrainerConfigs = {
  ...
  [TrainerType.BLUE]: new TrainerConfig((t = TrainerType.BLUE)).initForChampion(signatureSpecies["BLUE"],true).setBattleBgm("battle_kanto_champion").setHasDouble("blue_red_double").setDoubleTrainerType(TrainerType.RED).setDoubleTitle("champion_double")
    .setPartyMemberFunc(0, getRandomPartyMemberFunc([Species.PIDGEOT], TrainerSlot.TRAINER, true, p => {
      p.formIndex = 1;
  ...
  [TrainerType.RED]: new TrainerConfig(++t).initForChampion(signatureSpecies["RED"],true).setBattleBgm("battle_johto_champion").setHasDouble("red_blue_double").setDoubleTrainerType(TrainerType.BLUE).setDoubleTitle("champion_double")
    .setPartyMemberFunc(0, getRandomPartyMemberFunc([Species.VENUSAUR, Species.CHARIZARD, Species.BLASTOISE], TrainerSlot.TRAINER, true, p => {
      p.formIndex = 1;
      p.generateAndPopulateMoveset();
    }))
    .setPartyMemberFunc(1, getRandomPartyMemberFunc([Species.PIKACHU], TrainerSlot.TRAINER, true, p => {
      p.formIndex = 8;
      p.generateAndPopulateMoveset();
    })),
  ...
  [TrainerType.STEVEN]: new TrainerConfig(++t).initForChampion(signatureSpecies["STEVEN"],true).setBattleBgm("battle_hoenn_champion").setHasDouble("steven_wallace_double").setDoubleTrainerType(TrainerType.WALLACE).setDoubleTitle("champion_double")
    .setPartyMemberFunc(0, getRandomPartyMemberFunc([Species.METAGROSS], TrainerSlot.TRAINER, true, p => {
      p.formIndex = 1;
      p.generateAndPopulateMoveset();
    })),
  [TrainerType.WALLACE]: new TrainerConfig(++t).initForChampion(signatureSpecies["WALLACE"],true).setBattleBgm("battle_hoenn_champion").setHasDouble("wallace_steven_double").setDoubleTrainerType(TrainerType.STEVEN).setDoubleTitle("champion_double")
    .setPartyMemberFunc(0, getRandomPartyMemberFunc([Species.SWAMPERT], TrainerSlot.TRAINER, true, p => {
      p.formIndex = 1;
      p.generateAndPopulateMoveset();
    })),
  [TrainerType.CYNTHIA]: new TrainerConfig(++t).initForChampion(signatureSpecies["CYNTHIA"],false).setBattleBgm("battle_sinnoh_champion")
    .setPartyMemberFunc(0, getRandomPartyMemberFunc([Species.GARCHOMP], TrainerSlot.TRAINER, true, p => {
      p.formIndex = 1;
      p.generateAndPopulateMoveset();
    })),
  ...
  [TrainerType.IRIS]: new TrainerConfig(++t).initForChampion(signatureSpecies["IRIS"],false).setBattleBgm("battle_champion_iris").setHasDouble("iris_alder_double").setDoubleTrainerType(TrainerType.ALDER).setDoubleTitle("champion_double")
    .setPartyMemberFunc(0, getRandomPartyMemberFunc([Species.AGGRON], TrainerSlot.TRAINER, true, p => {
      p.formIndex = 1;
      p.generateAndPopulateMoveset();
    })),
  [TrainerType.DIANTHA]: new TrainerConfig(++t).initForChampion(signatureSpecies["DIANTHA"],false)
    .setPartyMemberFunc(0, getRandomPartyMemberFunc([Species.GARDEVOIR], TrainerSlot.TRAINER, true, p => {
      p.formIndex = 1;
      p.generateAndPopulateMoveset();
    })),
  ...
  [TrainerType.LEON]: new TrainerConfig(++t).initForChampion(signatureSpecies["LEON"],true)
    .setPartyMemberFunc(0, getRandomPartyMemberFunc([Species.CHARIZARD], TrainerSlot.TRAINER, true, p => {
      p.formIndex = 3;
      p.generateAndPopulateMoveset();
    })),
  ...
  [TrainerType.KIERAN]: new TrainerConfig(++t).initForChampion(signatureSpecies["KIERAN"],true)
    .setPartyMemberFunc(0, getRandomPartyMemberFunc([Species.GRIMMSNARL], TrainerSlot.TRAINER, true, p => {
      p.formIndex = 1;
      p.generateAndPopulateMoveset();
    })),
