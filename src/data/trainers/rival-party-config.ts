...
// TODO: check invocations of this function due to changed params
function forceRivalBirdAbility(pokemon: EnemyPokemon, bars = 0, useRivalSignature = false, forceGutsFlameOrb = false): void {
