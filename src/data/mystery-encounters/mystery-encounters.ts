...
export const NON_EXTREME_ENCOUNTER_BIOMES = [
  ...
  BiomeId.OVERGROWN_TEMPLE,
  BiomeId.SLUM,
  BiomeId.SNOWY_TAIGA,
  BiomeId.UNDERGROUND_WELL,
  BiomeId.ROCKY_COAST,
  BiomeId.SAVANNAH,
  BiomeId.CRYSTAL_CAVERN,
  BiomeId.ISLAND,
...
export const mysteryEncountersByBiome = new Map<BiomeId, MysteryEncounterType[]>([
  ...
  [BiomeId.HAUNTED_PASS, [MysteryEncounterType.DANCING_LESSONS]],
  [BiomeId.DOJO, []],
  [BiomeId.FACTORY, []],
  [BiomeId.ANCIENT_RUINS, [MysteryEncounterType.DANCING_LESSONS]],
  [BiomeId.WASTELAND, []],
  [BiomeId.ABYSS, []],
  ...
  [BiomeId.ENCHANTED_CAVE, []],
  [BiomeId.OVERGROWN_TEMPLE, [MysteryEncounterType.DANCING_LESSONS]],
  [BiomeId.SLUM, []],
  [BiomeId.SNOWY_TAIGA, []],
  [BiomeId.UNDERGROUND_WELL, []],
  [BiomeId.ROCKY_COAST, []],
