...
export const achvs = {
  ...
  MONO_GEN_ONE_VICTORY: new ChallengeAchv("MONO_GEN_ONE","",  "MONO_GEN_ONE.description", "ribbon-gen1", 100, c => c instanceof SingleGenerationChallenge && c.value === 1),
  MONO_GEN_TWO_VICTORY: new ChallengeAchv("MONO_GEN_TWO","",  "MONO_GEN_TWO.description", "ribbon-gen2", 100, c => c instanceof SingleGenerationChallenge && c.value === 2),
  MONO_GEN_THREE_VICTORY: new ChallengeAchv("MONO_GEN_THREE","",  "MONO_GEN_THREE.description", "ribbon-gen3", 100, c => c instanceof SingleGenerationChallenge && c.value === 3),
  MONO_GEN_FOUR_VICTORY: new ChallengeAchv("MONO_GEN_FOUR","",  "MONO_GEN_FOUR.description", "ribbon-gen4", 100, c => c instanceof SingleGenerationChallenge && c.value === 4),
  MONO_GEN_FIVE_VICTORY: new ChallengeAchv("MONO_GEN_FIVE","",  "MONO_GEN_FIVE.description", "ribbon-gen5", 100, c => c instanceof SingleGenerationChallenge && c.value === 5),
  MONO_GEN_SIX_VICTORY: new ChallengeAchv("MONO_GEN_SIX","",  "MONO_GEN_SIX.description", "ribbon-gen6", 100, c => c instanceof SingleGenerationChallenge && c.value === 6),
  MONO_GEN_SEVEN_VICTORY: new ChallengeAchv("MONO_GEN_SEVEN","",  "MONO_GEN_SEVEN.description", "ribbon-gen7", 100, c => c instanceof SingleGenerationChallenge && c.value === 7),
  MONO_GEN_EIGHT_VICTORY: new ChallengeAchv("MONO_GEN_EIGHT","",  "MONO_GEN_EIGHT.description", "ribbon-gen8", 100, c => c instanceof SingleGenerationChallenge && c.value === 8),
  MONO_GEN_NINE_VICTORY: new ChallengeAchv("MONO_GEN_NINE","",  "MONO_GEN_NINE.description", "ribbon-gen9", 100, c => c instanceof SingleGenerationChallenge && c.value === 9),
