...
export const achvs = {
  ...
  FLIP_STATS: new ChallengeAchv("FLIP_STATS", "", "FLIP_STATS.description", "flipstat", 100, (c, scene) => c instanceof FlipStatChallenge && c.value > 0 && !scene.gameMode.challenges.some(c => c.id === Challenges.INVERSE_BATTLE && c.value > 0)),
