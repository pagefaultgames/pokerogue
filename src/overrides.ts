 ...
 */
const overrides = {
  ABILITY_OVERRIDE: Abilities.LIBERO,
  MOVESET_OVERRIDE: [Moves.AQUA_JET, Moves.SPORE, Moves.PSYCHIC_TERRAIN, Moves.SIMPLE_BEAM],
  OPP_ABILITY_OVERRIDE: Abilities.DESOLATE_LAND,
