 ...
 */
const overrides = {
  OPP_MOVESET_OVERRIDE: [ Moves.GRASS_PLEDGE, Moves.WATERFALL, Moves.SKETCH, Moves.WATER_PLEDGE ],
  STARTING_LEVEL_OVERRIDE: 100,
  PASSIVE_ABILITY_OVERRIDE: Abilities.STALL,
  ABILITY_OVERRIDE: Abilities.ICE_SCALES,
