...
describe("Moves - Glaive Rush", () => {
  ...
  it(
    "interacts properly with multi-lens",
    async () => {
  ...
  it(
    "secondary effects only last until next move",
    async () => {
  ...
  it(
    "secondary effects are removed upon switching",
    async () => {
  ...
  it(
    "secondary effects don't activate if move fails",
    async () => {
