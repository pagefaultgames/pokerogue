...
describe("Moves - Safeguard", () => {
  ...
  it(
    "protects from damaging moves with additional effects",
    async () => {
  ...
  it(
    "doesn't protect from already existing Yawn",
    async () => {
      await game.classicMode.startBattle();
      const enemyPokemon = game.scene.getEnemyPokemon()!;
  ...
  it(
    "doesn't protect from self-inflicted via Rest or Flame Orb",
    async () => {
  ...
  it(
    "protects from ability-inflicted status",
    async () => {
