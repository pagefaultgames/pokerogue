...
describe("Moves - Transform", () => {
  ...
  beforeEach(() => {
    ...
    vi.spyOn(Overrides, "MOVESET_OVERRIDE", "get").mockReturnValue([ Moves.TRANSFORM ]);
  ...
  it("should copy all stats except HP", async () => {
  ...
  it("should cause Power Split to effectively do nothing", async () => {
    vi.spyOn(Overrides, "OPP_MOVESET_OVERRIDE", "get").mockReturnValue([ Moves.TRANSFORM, Moves.TRANSFORM, Moves.TRANSFORM, Moves.TRANSFORM ]);
    ...
    const avgAtk = player.getStat(Stat.ATK, false);
    const avgSpAtk = player.getStat(Stat.SPATK, false);
