...
describe("Abilities - Moxie", () => {
  ...
  beforeEach(() => {
    ...
    vi.spyOn(overrides.STARTER_OVERRIDE[0], "ability", "get").mockReturnValue(Abilities.MOXIE);
    vi.spyOn(overrides.STARTER_OVERRIDE[1], "ability", "get").mockReturnValue(Abilities.MOXIE);
