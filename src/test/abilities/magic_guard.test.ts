...
describe("Abilities - Magic Guard", () => {
  ...
  it(
    "Magic Guard prevents damage caused by burn but other non-damaging effects are still applied",
    async () => {
  ...
  it(
    "Magic Guard prevents damage caused by toxic but other non-damaging effects are still applied",
    async () => {
  ...
  it(
    "Magic Guard prevents damage caused by entry hazards",
    async () => {
  ...
  it(
    "Magic Guard does not prevent poison from Toxic Spikes",
    async () => {
      //Adds and applies Spikes to both sides of the arena
  ...
  it(
    "Magic Guard prevents against damage from volatile status effects",
    async () => {
  ...
  it(
    "Magic Guard prevents crash damage",
    async () => {
  ...
  it(
    "Magic Guard prevents damage from recoil",
    async () => {
  ...
  it(
    "Magic Guard does not prevent damage from Struggle's recoil",
    async () => {
  ...
  it(
    "Magic Guard prevents self-damage from attacking moves",
    async () => {
...
*/
  ...
  it(
    "Magic Guard does not prevent self-damage from non-attacking moves",
    async () => {
  ...
  it(
    "Magic Guard prevents damage from abilities with PostTurnHurtIfSleepingAbAttr",
    async () => {
  ...
  it(
    "Magic Guard prevents damage from abilities with PostFaintContactDamageAbAttr",
    async () => {
  ...
  it(
    "Magic Guard prevents damage from abilities with PostDefendContactDamageAbAttr",
    async () => {
  ...
  it(
    "Magic Guard prevents damage from abilities with ReverseDrainAbAttr",
    async () => {
  ...
  it(
    "Magic Guard prevents HP loss from abilities with PostWeatherLapseDamageAbAttr",
    async () => {
