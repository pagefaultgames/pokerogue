...
describe("Abilities - Disguise", () => {
  ...
  it(
    "takes no damage from attacking move and transforms to Busted form, takes 1/8 max HP damage from the disguise breaking",
    async () => {
  ...
  it(
    "doesn't break disguise when attacked with ineffective move",
    async () => {
      await game.classicMode.startBattle();
  ...
  it(
    "takes no damage from the first hit of a multihit move and transforms to Busted form, then takes damage from the second hit",
    async () => {
  ...
  it(
    "takes effects from status moves and damage from status effects",
    async () => {
      await game.classicMode.startBattle();
  ...
  it(
    "persists form change when switched out",
    async () => {
  ...
  it(
    "persists form change when wave changes with no arena reset",
    async () => {
      game.override.starterSpecies(0);
  ...
  it(
    "reverts to Disguised form on arena reset",
    async () => {
  ...
  it(
    "reverts to Disguised form on biome change when fainted",
    async () => {
  ...
  it(
    "doesn't faint twice when fainting due to Disguise break damage, nor prevent faint from Disguise break damage if using Endure",
    async () => {
  ...
  it(
    "activates when Aerilate circumvents immunity to the move's base type",
    async () => {
