...
describe("Evolution", () => {
  ...
  it(
    "should keep hidden ability after evolving",
    async () => {
  ...
  it(
    "should keep same ability slot after evolving",
    async () => {
  ...
  it(
    "should handle illegal abilityIndex values",
    async () => {
  ...
  it(
    "should handle nincada's unique evolution",
    async () => {
  ...
  it(
    "should increase both HP and max HP when evolving",
    async () => {
      game.override
        .moveset([Moves.SURF])
  ...
  it(
    "should not fully heal HP when evolving",
    async () => {
      game.override
        .moveset([Moves.SURF])
        .enemySpecies(Species.GOLEM)
  ...
  it(
    "should handle rng-based split evolution",
    async () => {
