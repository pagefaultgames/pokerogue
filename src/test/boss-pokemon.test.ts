...
describe("Boss Pokemon / Shields", () => {
  ...
  it(
    "Pokemon should get shields based on their Species and level and the current wave",
    async () => {
      let level = 50;
      let wave = 5;
  ...
  it(
    "should reduce the number of shields if we are in a double battle",
    async () => {
  ...
  it(
    "shields should stop overflow damage and give stat stage boosts when broken",
    async () => {
  ...
  it(
    "breaking multiple shields at once requires extra damage",
    async () => {
  ...
  it(
    "the number of stat stage boosts is consistent when several shields are broken at once",
    async () => {
