...
export function initI18n(): void {
  ...
  i18next.use(LanguageDetector).init({
    ...
    resources: {
      ...
      de: {
        menu: deConfig.menu,
        menuUiHandler: deConfig.menuUiHandler,
        battle: deConfig.battle,
        move: deConfig.move,
        ability: deConfig.ability,
        pokeball: deConfig.pokeball,
        pokemon: deConfig.pokemon,
        pokemonStat: deConfig.pokemonStat,
        commandUiHandler: deConfig.commandUiHandler,
        fightUiHandler: deConfig.fightUiHandler,
        tutorial: deConfig.tutorial,
        starterSelectUiHandler: deConfig.starterSelectUiHandler
      }
    },
  });
}
