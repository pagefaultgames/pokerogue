...
describe("battle", () => {
  ...
  describe("initBattleSpec", () => {
    ...
    it("has final boss as battleSpec when wave 200 and classic mode", () => {
        const battle = new Battle(new GameMode(0, { isClassic: true }), 200, BattleType.TRAINER, trainer, false);

        expect(battle.battleSpec).toBe(BattleSpec.FINAL_BOSS);
    });

    it("has default as battleSpec when not wave 200 and classic mode", () => {
        const battle = new Battle(new GameMode(0, { isClassic: true }), 190, BattleType.TRAINER, trainer, false);
  ...
  describe("getLevelForWave", () => {
    ...
    it("has 2 or 3 as enemyLevels when first wave and single battle", () => {
        for (let i = 0; i < NUM_TEST_RUNS; i++) {
          const battle = new Battle(new GameMode(0, { isClassic: true }), 1, BattleType.WILD, trainer, false);
    ...
    it("has 2 or 3 x2 as enemyLevels when first wave and double battle", () => {
      for (let i = 0; i < NUM_TEST_RUNS; i++) {
        const battle = new Battle(new GameMode(0, { isClassic: true }), 1, BattleType.WILD, trainer, true);
    ...
    it("has 164<=x<=184 as enemyLevels when 199th wave and single battle", () => {
      for (let i = 0; i < NUM_TEST_RUNS; i++) {
        const battle = new Battle(new GameMode(0, { isClassic: true }), 199, BattleType.WILD, trainer, false);
    ...
    it("has 164<=x<=184 x2 as enemyLevels when 199th wave and double battle", () => {
      for (let i = 0; i < NUM_TEST_RUNS; i++) {
        const battle = new Battle(new GameMode(0, { isClassic: true }), 199, BattleType.WILD, trainer, true);
    ...
    it("has 6<=x<=8 as enemyLevels when 10th wave and single battle", () => {
      for (let i = 0; i < NUM_TEST_RUNS; i++) {
        const battle = new Battle(new GameMode(0, { isClassic: true }), 10, BattleType.WILD, trainer, false);
    ...
    it("has 6<=x<=8 x2 as enemyLevels when 10th wave and double battle", () => {
      for (let i = 0; i < NUM_TEST_RUNS; i++) {
        const battle = new Battle(new GameMode(0, { isClassic: true }), 10, BattleType.WILD, trainer, true);
    ...
    it("has 165<=x<=203 as enemyLevels when 190th wave and single battle", () => {
      for (let i = 0; i < NUM_TEST_RUNS; i++) {
        const battle = new Battle(new GameMode(0, { isClassic: true }), 190, BattleType.WILD, trainer, false);
    ...
    it("has 165<=x<=203 x2 as enemyLevels when 190th wave and double battle", () => {
      for (let i = 0; i < NUM_TEST_RUNS; i++) {
        const battle = new Battle(new GameMode(0, { isClassic: true }), 190, BattleType.WILD, trainer, true);
    ...
    it("has 200 as enemyLevels when 200th wave, final boss", () => {
      for (let i = 0; i < NUM_TEST_RUNS; i++) {
        const battle = new Battle(new GameMode(0, { isClassic: true }), 200, BattleType.WILD, trainer, false);
    ...
    it("has 275 as enemyLevels when 250th wave", () => {
      for (let i = 0; i < NUM_TEST_RUNS; i++) {
        const battle = new Battle(new GameMode(0, { isClassic: true }), 250, BattleType.WILD, trainer, false);
    ...
    it("has 800 as enemyLevels when 500th wave", () => {
      for (let i = 0; i < NUM_TEST_RUNS; i++) {
        const battle = new Battle(new GameMode(0, { isClassic: true }), 500, BattleType.WILD, trainer, false);
