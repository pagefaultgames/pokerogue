...
export const ability: AbilityTranslationEntries = {
  ...
  tintedLens: {
    name: "有色眼镜",
    description: 'The Pokémon can use "可以将效果不好的招式以通\n常的威力使出。" moves to deal regular damage.',
  },
  filter: {
    name: "过滤",
  ...
  auraBreak: {
    name: "气场破坏",
    description: 'The effects of "让气场的效果发生逆转，降\n低威力。" Abilities are reversed to lower the power of affected moves.',
  },
  primordialSea: {
    name: "始源之海",
