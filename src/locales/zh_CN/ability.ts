...
export const ability: AbilityTranslationEntries = {
  ...
  overgrow: {
    name: "茂盛",
    description: "ＨＰ减少的时候，草属性的招式威\n力会提高。",
  },
  blaze: {
    name: "猛火",
    description: "ＨＰ减少的时候，火属性的招式威\n力会提高。",
  },
  torrent: {
    name: "激流",
    description: "ＨＰ减少的时候，水属性的招式威\n力会提高。",
  },
  swarm: {
    name: "虫之预感",
    description: "ＨＰ减少的时候，虫属性的招式威\n力会提高。",
  },
  rockHead: {
    name: "坚硬脑袋",
  ...
  wimpOut: {
    name: "跃跃欲逃",
    description: "ＨＰ变为一半时，会慌慌张张逃走\n，退回同行队伍中。",
  },
  emergencyExit: {
    name: "危险回避",
    description: "ＨＰ变为一半时，为了回避危险，\n会退回到同行队伍中。",
  },
  waterCompaction: {
    name: "遇水凝固",
  ...
  shieldsDown: {
    name: "界限盾壳",
    description: "ＨＰ变为一半时，壳会坏掉，变得\n有攻击性。",
  },
  stakeout: {
    name: "蹲守",
    description: "可以对替换出场的对手以２倍的伤\n害进行攻击。",
  },
  waterBubble: {
    name: "水泡",
  ...
  schooling: {
    name: "鱼群",
    description: "ＨＰ多的时候会聚起来变强。ＨＰ\n剩余量变少时，群体会分崩离析。",
  },
  disguise: {
    name: "画皮",
    description: "通过画皮覆盖住身体，可以防住１\n次攻击。",
  },
  battleBond: {
    name: "牵绊变身",
  ...
  poisonPuppeteer: {
    name: "毒傀儡",
    description: "因桃歹郎的招式而陷入中毒状态的\n对手同时也会陷入混乱状态。", // TODO: Remove reference to Pecharunt
  },
} as const;
