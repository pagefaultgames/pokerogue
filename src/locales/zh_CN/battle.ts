...
export const battle: SimpleTranslationEntries = {
  ...
  "statsAnd": "和",
  "stats": "能力",
  "statRose_other": "{{pokemonNameWithAffix}}的{{stats}}\n提高了！",
  "statSharplyRose_other": "{{pokemonNameWithAffix}}的{{stats}}\n大幅提高了！",
  "statRoseDrastically_other": "{{pokemonNameWithAffix}}的{{stats}}\n极大幅提高了！",
  "statWontGoAnyHigher_other": "{{pokemonNameWithAffix}}的{{stats}}\n已经无法再提高了！",
  "statFell_other": "{{pokemonNameWithAffix}}的{{stats}}\n降低了！",
  "statHarshlyFell_other": "{{pokemonNameWithAffix}}的{{stats}}\n大幅降低了！",
  "statSeverelyFell_other": "{{pokemonNameWithAffix}}的{{stats}}\n极大幅降低了！",
  "statWontGoAnyLower_other": "{{pokemonNameWithAffix}}的{{stats}}\n已经无法再降低了！",
