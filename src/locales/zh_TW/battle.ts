...
export const battle: SimpleTranslationEntries = {
  ...
  "statRoseDrastically_one": "{{pokemonNameWithAffix}} 的 {{stats}} 極大幅提高了！",
  "statWontGoAnyHigher_one": "{{pokemonNameWithAffix}} 的 {{stats}} 已經無法再提高了！",
  "statFell_one": "{{pokemonNameWithAffix}} 的 {{stats}} 降低了！",
  "statHarshlyFell_one": "{{pokemonNameWithAffix}} 的 {{stats}} 大幅降低了！",
  "statSeverelyFell_one": "{{pokemonNameWithAffix}} 的 {{stats}} 極大幅降低了！",
  "statWontGoAnyLower_one": "{{pokemonNameWithAffix}} 的 {{stats}} 已經無法再降低了！",
