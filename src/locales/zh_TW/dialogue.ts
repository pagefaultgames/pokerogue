...
export const PGMdialogue: DialogueTranslationEntries = {
  ...
  "rival": {
    ...
    "victory": {
      1: "@c{shock}哇…你徹底擊敗了我。\n你是真初學者嗎？$@c{smile}也許是靠點運氣，但是…\n誰知道，你可能真的能一路走下去。$順便說一下，博士讓我給你這些東西。它們看起來可牛了。$@c{serious_smile_fists}祝你好运！$@c{smile}Oh- and I hope you enjoy the event! ",
    },
  },
  "rival_female": {
    "encounter": {
