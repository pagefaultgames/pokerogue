...
export const battle: SimpleTranslationEntries = {
  ...
  "statRoseMultiple": "{{stats}} de {{pokemonNameWithAffix}} aumentaram!",
  "statSharplyRoseMultiple": "{{stats}} de {{pokemonNameWithAffix}} aumentaram bruscamente!",
  "statRoseDrasticallyMultiple": "{{stats}} de {{pokemonNameWithAffix}} aumentaram drasticamente!",
  "statWontGoAnyHigherMultiple": "{{stats}} de {{pokemonNameWithAffix}} não vão mais aumentar!",
  "statFellMultiple": "{{stats}} de {{pokemonNameWithAffix}} diminuíram!",
  "statHarshlyFellMultiple": "{{stats}} de {{pokemonNameWithAffix}} diminuíram duramente!",
  "statSeverelyFellMultiple": "{{stats}} de {{pokemonNameWithAffix}} diminuíram severamente!",
  "statWontGoAnyLowerMultiple": "{{stats}} de {{pokemonNameWithAffix}} não vão mais diminuir!",
