...
export const move: MoveTranslationEntries = {
  ...
  dynamaxCannon: {
    name: "Dynamax Cannon",
    effect: "O usuário libera um forte feixe de seu núcleo. Este movimento causa o dobro do dano se o alvo estiver acima do nível 200." // Check new English description
  },
  snipeShot: {
    name: "Snipe Shot",
