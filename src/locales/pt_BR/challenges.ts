...
export const challenges: SimpleTranslationEntries = {
  ...
  "singleGeneration.value.7": "Geração VII",
  "singleGeneration.desc.7": "Você só pode user Pokémon da sétima geração.",
  "singleGeneration.value.8": "Geração VIII",
