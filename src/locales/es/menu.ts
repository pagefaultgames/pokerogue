...
export const menu: SimpleTranslationEntries = {
  ...
  "stoppedEvolving": "{{pokemonName}} paró de evolucionar.",
  "pauseEvolutionsQuestion": "¿Quieres pausar la evolución para {{pokemonName}}?\nLa evolución se puede reanudar desde el menú de equipo.",
  "evolutionsPaused": "Se pausó la evolución para {{pokemonName}}.",
  "evolutionDone": "¡Enhorabuena!\n¡Tu {{pokemonName}} evolucionó a {{evolvedPokemonName}}!",
