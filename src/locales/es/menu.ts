...
export const menu: SimpleTranslationEntries = {
  ...
  "pauseEvolutionsQuestion": "¿Quieres parar las evoluciones de {{pokemonName}}?\nSe puede volver a habilitar desde la pantalla del equipo.",
  "evolutionsPaused": "Las evoluciones se han parado para {{pokemonName}}.",
