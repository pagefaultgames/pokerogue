...
export const move: MoveTranslationEntries = {
  ...
  waterShuriken: {
    ...
    effect:
      "Golpea al objetivo de dos a cinco veces seguidas con estrellas arrojadizas hechas de mucosidad. Este movimiento tiene prioridad alta.",
  },
  mysticalFire: {
  ...
  holdHands: {
    name: "Manos Juntas",
    effect:
      "El usuario le da la mano a un aliado y ambos se sienten muy felices.",
  },
  babyDollEyes: {
    name: "Ojitos Tiernos",
    effect:
  ...
  maxPhantasm: {
    name: "Maxiespectro",
    effect:
      "Ataque de tipo Fantasma ejecutado por un Pokémon Dinamax. Reduce la Defensa del objetivo.",
  },
  maxHailstorm: {
    name: "Maxihelada",
    effect:
