...
export const battle: SimpleTranslationEntries = {
  ...
  multiWildAppeared:
    "¡Un {{pokemonName1}} y un {{pokemonName2}} salvajes\nte cortan el paso!",
  ...
  learnMoveReplaceQuestion:
    "¿Quieres sustituir uno de sus movimientos por {{moveName}}?",
  ...
  learnMoveForgetSuccess:
    "{{pokemonName}} ha olvidado cómo utilizar {{moveName}}.",
  levelCapUp: "¡Se ha incrementado el\nnivel máximo a {{levelCap}}!",
  moveNotImplemented:
    "{{moveName}} aún no está implementado y no se puede seleccionar.",
  ...
  noPokeballMulti:
    "¡No se pueden lanzar Poké Balls\ncuando hay más de un Pokémon!",
  noPokeballStrong:
  ...
  noEscapePokemon:
    "¡El movimiento {{moveName}} de {{pokemonName}} impide la huida!",
