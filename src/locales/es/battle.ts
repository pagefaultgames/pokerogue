...
export const battle: SimpleTranslationEntries = {
  ...
  "ppReduced": "¡Redujo {{reduction}} PP de {{moveName}}\ndel {{targetName}}!",
  ...
  "battlerTagsSeededLapseShed": "¡Las drenadoras del {{pokemonNameWithAffix}}\nha absorbido el lodo líquido!",
  ...
  "battlerTagsBindOnTrap": "¡{{moveName}} de {{sourcePokemonName}} oprime\nal {{pokemonNameWithAffix}}!",
  "battlerTagsWrapOnTrap": "¡{{moveName}} de {{sourcePokemonName}} atrapó\nal {{pokemonNameWithAffix}}!",
  ...
  "battlerTagsPerishSongLapse": "La cuenta atrás de Canto Mortal del\n{{pokemonNameWithAffix}} ha bajado a {{turnCount}}.",
  ...
  "battlerTagsSlowStartOnRemove": "¡{{pokemonNameWithAffix}} vuelve a ir por todas!",
