...
export const menu: SimpleTranslationEntries = {
  ...
  logInOrCreateAccount:
    "Logge dich ein oder erstelle einen Account zum starten. Keine Email nötig!",
  ...
  invalidRegisterUsername:
    "Benutzername darf nur Buchstaben, Zahlen oder Unterstriche enthalten",
