...
export const move: MoveTranslationEntries = {
  ...
  "stoneAxe": {
    name: "Felsaxt",
    effect: "Der Anwender greift mit seinen Felsäxten die Schwachstelle des Zieles an. Dadurch verstreut er schwebende Felssplitter im Umkreis des Zieles."
  },
  "springtideStorm": {
    name: "Frühlingsorkan",
  ...
  "blazingTorque": {
    name: "Hitzeturbo",
    effect: "Der Anwender lässt den glühenden Motor in Richtung des Gegners aufheulen. Eventuell erleidet das Ziel Verbrennungen."
  },
  "wickedTorque": {
    name: "Finsterturbo",
    effect: "Der Anwender lässt den Motor mit böswilliger Absicht in Richtung des Gegners aufheulen. Eventuell schläft das Ziel ein."
  },
  "noxiousTorque": {
    name: "Toxiturbo",
    effect: "Der Anwender lässt den giftigen Motor in Richtung des Gegners aufheulen. Eventuell wird das Ziel vergiftet."
  },
  "combatTorque": {
    name: "Raufturbo",
    effect: "Der Anwender lässt den Motor ruppig in Richtung des Gegners aufheulen. Eventuell wird das Ziel paralysiert."
  },
  "magicalTorque": {
    name: "Zauberturbo",
    effect: "Der Anwender lässt den feenartigen Motor in Richtung des Gegners aufheulen. Eventuell wird das Ziel verwirrt."
  },
  "bloodMoon": {
    name: "Blutmond",
  ...
  "thunderclap": {
    name: "Sturmblitz",
    effect: "Erstschlag-Attacke, die aber nur gelingt, wenn das Ziel gerade eine Attacke vorbereitet, die KP-Schaden zufügen würde. This move fails if the target is not readying an attack."
  },
  "mightyCleave": {
    name: "Wuchtklinge",
