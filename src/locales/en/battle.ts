...
export const battle: SimpleTranslationEntries = {
  ...
  learnMoveReplaceQuestion:
    "Should a move be forgotten and\nreplaced with {{moveName}}?",
  ...
  moveNotImplemented:
    "{{moveName}} is not yet implemented and cannot be selected.",
  moveNoPP: "There's no PP left for\nthis move!",
  moveDisabled: "{{moveName}} is disabled!",
  noPokeballForce: "An unseen force\nprevents using Poké Balls.",
  noPokeballTrainer: "You can't catch\nanother trainer's Pokémon!",
  noPokeballMulti:
    "You can only throw a Poké Ball\nwhen there is one Pokémon remaining!",
  noPokeballStrong:
    "The target Pokémon is too strong to be caught!\nYou need to weaken it first!",
