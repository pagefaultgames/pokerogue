...
export const pokemonForm: SimpleTranslationEntries = {
  ...
  "koraidonLimitedBuild":"제한형태",
  "koraidonSprintingBuild":"질주형태",
  "koraidonSwimmingBuild":"유영형태",
  "koraidonGlidingBuild":"활공형태",
  "miraidonUltimateMode":"컴플리트모드",
  "miraidonLowPowerMode":"리미티드모드",
  "miraidonDriveMode":"드라이브모드",
  "miraidonAquaticMode":"플로트모드",
