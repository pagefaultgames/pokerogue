...
export const PGMdialogue: DialogueTranslationEntries = {
  ...
  "zinzolin": {
    "encounter": {
      ...
      2: "이렇게 말해도 포기를 못 하나? 그렇다면 마지막 선고를 하는 것이 내 나름의 친절이지!",
      3: "여기까지 오다니 대단한 트레이너군. 그러나 여기가 끝이다."
    },
    "victory": {
      1: "게치스님… 제가 실패했습니다…",
      2: "힘들구나. 나는 떨고 있다. 괴롭지만 살아 있다. 그것이야말로 살아 있다는 실감!",
  ...
  "rood": {
    "encounter": {
      ...
      2: "넌 포기할 줄을 모르는 모양이구나. 그러나 누구도 우리의 계획을 방해할 수는 없다.",
      3: "너는 여기까지 온 것으로 보니 뛰어난 트레이너구나. 그렇다만 이젠 끝이다."
    },
    "victory": {
      1: "게치스님… 임무를 실패했습니다…",
      2: "나는 떨고 있다. 우리는 괴롭지만 이겨냈다.",
