...
export const move: MoveTranslationEntries = {
  "pound": {
    name: "Botta",
    effect: "	Il Pokémon attacca il bersaglio con la coda o le zampe anteriori."
  },
  "karateChop": {
    name: "Colpokarate",
    effect: "Colpisce il bersaglio con un colpo netto. Probabile brutto colpo."
  },
  "doubleSlap": {
    name: "Doppiasberla",
    effect: "Schiaffeggia il bersaglio da due a cinque volte di fila."
  },
  "cometPunch": {
    name: "Cometapugno",
    effect: "Colpisce il bersaglio con una scarica di pugni da due a cinque volte di fila."
  },
  "megaPunch": {
    name: "Megapugno",
    effect: "Il Pokémon attacca il bersaglio con un pugno poderoso."
  },
  "payDay": {
    name: "Giornopaga",
    effect: "Il Pokémon attacca il bersaglio con una gran quantità di monete recuperabili dopo la lotta."
  },
  "firePunch": {
    name: "Fuocopugno",
    effect: "Ha una certa percentuale (10%) di scottare il bersaglio."
  },
  "icePunch": {
    name: "Gelopugno",
    effect: "Ha una certa probabilità (10%) di congelare il bersaglio."
  },
  "thunderPunch": {
    name: "Tuonopugno",
    effect: "Ha una certa probabilità (10%) di paralizzare il bersaglio."
  },
  "scratch": {
    name: "Graffio",
    effect: "Il Pokémon attacca il bersaglio graffiandolo con artigli acuminati, duri e affilati."
  },
  "viseGrip": {
    name: "Presa",
    effect: "Il Pokémon stringe il bersaglio in una morsa, infliggendogli danni."
  },
  "guillotine": {
    name: "Ghigliottina",
    effect: "Il Pokémon attacca il bersaglio con pericolose tenaglie. Se la mossa va a segno, il Pokémon colpito va KO."
  },
  "razorWind": {
    name: "Ventagliente",
  ...
  "swordsDance": {
    name: "Danzaspada",
    effect: "Danza frenetica che aumenta la forza offensiva di chi la usa."
  },
  "cut": {
    name: "Taglio",
  ...
  "gust": {
    name: "Raffica",
    effect: "Non ha effetti aggiuntivi."
  },
  "wingAttack": {
    name: "Attacco d'Ala",
    effect: "Il Pokémon attacca il bersaglio spiegando delle grandi ali possenti."
  },
  "whirlwind": {
    name: "Turbine",
  ...
  "fly": {
    name: "Volo",
    effect: "Chi la usa entra in modalità Volo. Dopo un certo lasso di tempo, la modalità Volo termina e chi la usa attacca. Mentre la modalità Volo è attiva, chi la usa non può fare altre azioni. Quasi tutte le mosse avversarie che hanno come bersaglio chi la usa falliscono mentre è in modalità Volo. Se chi la usa subisce un attacco con un'Unimossa o una mossa UniDynamax mentre è attiva, la modalità Volo termina."
  },
  "bind": {
    name: "Legatutto",
    effect: "Il Pokémon attacca il bersaglio stritolandolo per quattro o cinque turni con il suo lungo corpo o le sue liane."
  },
  "slam": {
    name: "Schianto",
    effect: "Infligge danni al nemico con una coda, con una liana o con qualcosa di simile."
  },
  "vineWhip": {
    name: "Frustata",
    effect: "Non ha effetti aggiuntivi."
  ...
  "stomp": {
    name: "Pestone",
    effect: "Il Pokémon attacca il bersaglio pestandolo con un grosso piede e può anche farlo tentennare."
  },
  "doubleKick": {
    name: "Doppiocalcio",
  ...
  "megaKick": {
    name: "Megacalcio",
    effect: "Il Pokémon attacca il bersaglio con un calcio sferrato con la forza di muscoli poderosi."
  },
  "jumpKick": {
    name: "Calciosalto",
  ...
  "rollingKick": {
    name: "Calciorullo",
    effect: "Chi la usa infierisce sul bersaglio con un calcio rotante. Può anche farlo tentennare."
  },
  "sandAttack": {
    name: "Turbosabbia",
  ...
  "headbutt": {
    name: "Bottintesta",
    effect: "Il Pokémon attacca lanciandosi diritto di testa contro il bersaglio. Può anche farlo tentennare."
  },
  "hornAttack": {
    name: "Incornata",
    effect: "Il Pokémon attacca il bersaglio infilzandolo con un corno affilato."
  },
  "furyAttack": {
    name: "Furia",
    effect: "Il Pokémon attacca il bersaglio infilzandolo con corna affilate o con il becco da due a cinque volte di fila."
  },
  "hornDrill": {
    name: "Perforcorno",
    effect: "Il Pokémon attacca il bersaglio infilzandolo con un corno rotante. Se la mossa va a segno, il Pokémon colpito va KO."
  },
  "tackle": {
    name: "Azione",
    effect: "Il Pokémon attacca il bersaglio lanciandosi contro di lui con tutto il suo corpo."
  },
  "bodySlam": {
    name: "Corposcontro",
    effect: "Il Pokémon attacca il bersaglio scagliandosi contro di lui con tutto il corpo. Può causarne anche la paralisi."
  },
  "wrap": {
    name: "Avvolgibotta",
    effect: "Il Pokémon attacca il bersaglio stritolandolo con il suo lungo corpo o le sue liane per quattro o cinque turni."
  },
  "takeDown": {
    name: "Riduttore",
  ...
  "thrash": {
    name: "Colpo",
    effect: "Il Pokémon s'infuria e attacca il bersaglio per due o tre turni, ma rimane confuso."
  },
  "doubleEdge": {
    name: "Sdoppiatore",
    effect: "Chi la usa subisce una quantità di danni pari a 1/4 del danno inflitto."
  },
  "tailWhip": {
    name: "Colpocoda",
    effect: "Il Pokémon agita la coda per distrarre gli avversari, riducendone la Difesa."
  },
  "poisonSting": {
    name: "Velenospina",
  ...
  "twineedle": {
    name: "Doppio Ago",
    effect: "Colpisce due volte di seguito. Ha una certa probabilità (20%) di avvelenare il bersaglio."
  },
  "pinMissile": {
    name: "Missilspillo",
    effect: "Attacca il bersaglio da due a cinque volte di fila."
  },
  "leer": {
    name: "Fulmisguardo",
    effect: "Il Pokémon terrorizza gli avversari con uno sguardo fulminante e intimidatorio, riducendone la Difesa."
  },
  "bite": {
    name: "Morso",
    effect: "Ha una certa probabilità (30%) di far tentennare il bersaglio."
  },
  "growl": {
    name: "Ruggito",
  ...
  "roar": {
    name: "Boato",
    effect: "Il bersaglio lascia il campo e viene sostituito. Se usata contro singoli Pokémon selvatici, mette fine alla lotta."
  },
  "sing": {
    name: "Canto",
    effect: "Dolce ninnananna, cantata da una voce suadente, che fa addormentare il bersaglio."
  },
  "supersonic": {
    name: "Supersuono",
  ...
  "sonicBoom": {
    name: "Sonicboom",
    effect: "Il nemico viene colpito con un suono distruttivo che infligge un danno sempre di 20 PS."
  },
  "disable": {
    name: "Inibitore",
    effect: "Per quattro turni, questa mossa impedisce al bersaglio di riutilizzare l'ultima mossa usata."
  },
  "acid": {
    name: "Acido",
    effect: "Ha una certa probabilità (10%) di ridurre la Difesa Speciale del bersaglio di 1 grado."
  },
  "ember": {
    name: "Braciere",
    effect: "Il Pokémon attacca il bersaglio lanciando fiammelle che possono anche scottarlo."
  },
  "flamethrower": {
    name: "Lanciafiamme",
    effect: "Ha una certa probabilità (10%) di scottare il bersaglio."
  },
  "mist": {
    name: "Nebbia",
  ...
  "hydroPump": {
    name: "Idropompa",
    effect: "Il Pokémon attacca il bersaglio travolgendolo con un potente getto d'acqua spruzzato ad altissima pressione."
  },
  "surf": {
    name: "Surf",
  ...
  "blizzard": {
    name: "Bora",
    effect: "Il Pokémon attacca il bersaglio con una tremenda tempesta di ghiaccio che può anche congelarlo."
  },
  "psybeam": {
    name: "Psicoraggio",
    effect: "Ha una certa probabilità (10%) di confondere il bersaglio."
  },
  "bubbleBeam": {
    name: "Bollaraggio",
    effect: "Ha una certa probabilità (10%) di ridurre la Velocità del bersaglio di 1 grado."
  },
  "auroraBeam": {
    name: "Raggiaurora",
  ...
  "hyperBeam": {
    name: "Iper Raggio",
    effect: "Il Pokémon attacca il bersaglio con un potente raggio, ma al turno successivo non può muoversi."
  },
  "peck": {
    name: "Beccata",
    effect: "Non ha effetti aggiuntivi."
  ...
  "lowKick": {
    name: "Colpo Basso",
    effect: "Il Pokémon attacca il bersaglio con un calcio basso e potente che lo fa cadere. Più il bersaglio è pesante, maggiore è la potenza della mossa."
  },
  "counter": {
    name: "Contrattacco",
    effect: "Mossa che contrasta ogni attacco fisico, arrecando il doppio del danno ricevuto."
  },
  "seismicToss": {
    name: "Movim. Sismico",
  ...
  "strength": {
    name: "Forza",
    effect: "Il Pokémon attacca il bersaglio colpendolo con tutte le sue forze."
  },
  "absorb": {
    name: "Assorbimento",
    effect: "Il Pokémon attacca assorbendo sostanze nutritive e recupera una quantità di PS pari alla metà del danno inflitto."
  },
  "megaDrain": {
  ...
  "razorLeaf": {
    name: "Foglielama",
    effect: "Probabile brutto colpo."
  },
  "solarBeam": {
    name: "Solarraggio",
    effect: "Il Pokémon assorbe luce al primo turno per attaccare con un raggio intenso al turno successivo."
  },
  "poisonPowder": {
    name: "Velenpolvere",
  ...
  "stunSpore": {
    name: "Paralizzante",
    effect: "Paralizza il bersaglio."
  },
  "sleepPowder": {
    name: "Sonnifero",
    effect: "Addormenta il bersaglio."
  },
  "petalDance": {
    name: "Petalodanza",
  ...
  "fireSpin": {
    name: "Turbofuoco",
    effect: "Imprigiona il bersaglio."
  },
  "thunderShock": {
    name: "Tuonoshock",
    effect: "Ha una certa probabilità (10%) di paralizzare il bersaglio."
  ...
  "thunderbolt": {
    name: "Fulmine",
    effect: "Il Pokémon attacca il bersaglio con una potente scarica elettrica che può anche paralizzarlo."
  },
  "thunderWave": {
    name: "Tuononda",
    effect: "Paralizza il bersaglio."
  ...
  "thunder": {
    name: "Tuono",
    effect: "Il Pokémon attacca il bersaglio con un fulmine molto violento che può anche paralizzarlo."
  },
  "rockThrow": {
    name: "Sassata",
    effect: "Non ha effetti aggiuntivi."
  ...
  "earthquake": {
    name: "Terremoto",
    effect: "Chi la usa attacca gli altri Pokémon attorno provocando un potente sisma."
  },
  "fissure": {
    name: "Abisso",
  ...
  "toxic": {
    name: "Tossina",
    effect: "Iperavvelena il bersaglio con una potente tossina. Il danno peggiora a ogni turno."
  },
  "confusion": {
    name: "Confusione",
    effect: "Ha una certa probabilità (10%) di confondere il bersaglio."
  ...
  "quickAttack": {
    name: "Attacco Rapido",
    effect: "Il Pokémon colpisce a una tale velocità da rendersi quasi invisibile. Questo attacco ha priorità alta."
  },
  "rage": {
    name: "Ira",
  ...
  "teleport": {
    name: "Teletrasporto",
    effect: "Teletrasporto permette a chi lo usa di spostarsi istantaneamente da un posto all'altro."
  },
  "nightShade": {
    name: "Ombra Notturna",
  ...
  "mimic": {
    name: "Mimica",
    effect: "Il Pokémon copia l'ultima mossa usata dal bersaglio e la conserva finché rimane in campo."
  },
  "screech": {
    name: "Stridio",
    effect: "Riduce la Difesa del bersaglio di 2 gradi."
  },
  "doubleTeam": {
    name: "Doppioteam",
    effect: "Il Pokémon si muove in fretta e crea copie illusorie di se stesso che aumentano l'elusione."
  },
  "recover": {
    name: "Ripresa",
  ...
  "minimize": {
    name: "Minimizzato",
    effect: "Il corpo del Pokémon si comprime e diventa più piccolo. La sua elusione aumenta di molto."
  },
  "smokescreen": {
    name: "Muro di Fumo",
    effect: "Nuvola di fumo o inchiostro che riduce la precisione del bersaglio."
  },
  "confuseRay": {
    name: "Stordiraggio",
    effect: "Confonde il bersaglio."
  },
  "withdraw": {
    name: "Ritirata",
  ...
  "haze": {
    name: "Nube",
    effect: "Il Pokémon crea una nube nera che annulla ogni modifica alle statistiche di tutti i Pokémon in campo."
  },
  "reflect": {
    name: "Riflesso",
  ...
  "focusEnergy": {
    name: "Focalenergia",
    effect: "Il Pokémon fa un profondo respiro e si concentra per rendere più probabili i brutti colpi."
  },
  "bide": {
    name: "Pazienza",
  ...
  "selfDestruct": {
    name: "Autodistruz.",
    effect: "Chi la usa attacca gli altri Pokémon attorno causando un'esplosione, ma poi va KO."
  },
  "eggBomb": {
    name: "Uovobomba",
  ...
  "lick": {
    name: "Leccata",
    effect: "Ha una certa probabilità (30%) di paralizzare il bersaglio."
  },
  "smog": {
    name: "Smog",
    effect: "Ha una certa probabilità (40%) di avvelenare il bersaglio."
  },
  "sludge": {
    name: "Fango",
    effect: "Ha una certa probabilità (30%) di avvelenare il bersaglio."
  },
  "boneClub": {
    name: "Ossoclava",
  ...
  "waterfall": {
    name: "Cascata",
    effect: "Ha una certa probabilità (20%) di far tentennare il bersaglio."
  },
  "clamp": {
    name: "Tenaglia",
  ...
  "swift": {
    name: "Comete",
    effect: "Il Pokémon attacca il bersaglio con raggi a forma di stella. Questo attacco va sempre a segno."
  },
  "skullBash": {
    name: "Capocciata",
  ...
  "constrict": {
    name: "Limitazione",
    effect: "Colpisce il bersaglio con lunghi tentacoli o piante rampicanti. Può anche ridurne la Velocità."
  },
  "amnesia": {
    name: "Amnesia",
  ...
  "kinesis": {
    name: "Cinèsi",
    effect: "Il Pokémon distrae il bersaglio piegando un cucchiaio e ne riduce la precisione."
  },
  "softBoiled": {
    name: "Covauova",
    effect: "Il Pokémon recupera metà dei propri PS massimi."
  },
  "highJumpKick": {
    name: "Calcinvolo",
    effect: "Quando la mossa fallisce, chi l'ha usata subisce una quantità di danni pari al 50% dei suoi PS massimi."
  },
  "glare": {
    name: "Sguardo Feroce",
  ...
  "leechLife": {
    name: "Sanguisuga",
    effect: "Questa mossa aumenta il recupero di PS di chi la usa in proporzione al danno inferto al bersaglio."
  },
  "lovelyKiss": {
    name: "Demonbacio",
    effect: "Il Pokémon intimidisce il bersaglio con una faccia paurosa e gli schiocca un bacio che lo fa addormentare."
  },
  "skyAttack": {
    name: "Aeroattacco",
  ...
  "bubble": {
    name: "Bolla",
    effect: "Investe il bersaglio con una pioggia di bolle."
  },
  "dizzyPunch": {
    name: "Stordipugno",
  ...
  "spore": {
    name: "Spora",
    effect: "Il Pokémon sparge una nube di spore che fa addormentare il bersaglio."
  },
  "flash": {
    name: "Flash",
    effect: "Investe il bersaglio con una luce abbagliante che ne riduce la precisione. Fuori dalla lotta serve per illuminare le grotte."
  },
  "psywave": {
    name: "Psiconda",
  ...
  "explosion": {
    name: "Esplosione",
    effect: "Chi la usa attacca gli altri Pokémon attorno causando una grande esplosione, ma poi va KO."
  },
  "furySwipes": {
    name: "Sfuriate",
  ...
  "rockSlide": {
    name: "Frana",
    effect: "Il Pokémon attacca il bersaglio colpendolo violentemente con grandi massi che possono anche farlo tentennare."
  },
  "hyperFang": {
    name: "Iperzanna",
    effect: "Chi la usa morde il bersaglio con i suoi incisivi affilati. Può anche farlo tentennare."
  },
  "sharpen": {
    name: "Affilatore",
  ...
  "conversion": {
    name: "Conversione",
    effect: "Il tipo del Pokémon muta in quello della prima mossa nella lista delle sue mosse."
  },
  "triAttack": {
    name: "Tripletta",
    effect: "Ha una certa probabilità (20%) di scottare, paralizzare o congelare il bersaglio."
  },
  "superFang": {
    name: "Superzanna",
    effect: "Il Pokémon attacca il bersaglio azzannandolo con i suoi incisivi affilati e facendogli perdere metà dei PS."
  },
  "slash": {
    name: "Lacerazione",
    effect: "Il Pokémon attacca il bersaglio lacerandolo con artigli, falci o altro. Probabile brutto colpo."
  },
  "substitute": {
    name: "Sostituto",
  ...
  "mindReader": {
    name: "Leggimente",
    effect: "Chi la usa prevede i movimenti del bersaglio per mandare a segno l'attacco successivo."
  },
  "nightmare": {
    name: "Incubo",
  ...
  "flameWheel": {
    name: "Ruotafuoco",
    effect: "Chi la usa guarisce dal congelamento. Ha una certa probabilità (10%) di scottare il bersaglio."
  },
  "snore": {
    name: "Russare",
  ...
  "flail": {
    name: "Flagello",
    effect: "Il Pokémon si dimena per attaccare. Più i suoi PS sono bassi, più la potenza della mossa aumenta."
  },
  "conversion2": {
    name: "Conversione2",
    effect: "Il Pokémon cambia tipo per rendersi resistente al tipo dell'ultima mossa usata dal bersaglio."
  },
  "aeroblast": {
    name: "Aerocolpo",
  ...
  "cottonSpore": {
    name: "Cottonspora",
    effect: "Riduce la Velocità del bersaglio di 2 gradi."
  },
  "reversal": {
    name: "Contropiede",
    effect: "Il Pokémon attacca con tutte le sue forze. Più i suoi PS sono bassi, più la potenza della mossa aumenta."
  },
  "spite": {
    name: "Dispetto",
    effect: "Il Pokémon sfoga la propria rabbia sull'ultima mossa usata dal bersaglio e le sottrae quattro PP."
  },
  "powderSnow": {
    name: "Polneve",
    effect: "Ha una certa probabilità (10%) di congelara il bersaglio."
  },
  "protect": {
    name: "Protezione",
  ...
  "machPunch": {
    name: "Pugnorapido",
    effect: "Il Pokémon tira un pugno a una tale velocità da rendersi quasi invisibile. Questo attacco ha priorità alta."
  },
  "scaryFace": {
    name: "Visotruce",
  ...
  "bellyDrum": {
    name: "Panciamburo",
    effect: "Il Pokémon massimizza l'Attacco in cambio di metà dei PS massimi."
  },
  "sludgeBomb": {
    name: "Fangobomba",
    effect: "Ha una certa probabilità (30%) di avvelenare il bersaglio."
  ...
  "mudSlap": {
    name: "Fangosberla",
    effect: "Riduce la precisione del bersaglio di 1 grado."
  },
  "octazooka": {
    name: "Octazooka",
    effect: "Ha una certa probabilità (50%) di ridurre la precisione del bersaglio di 1 grado."
  },
  "spikes": {
    name: "Punte",
  ...
  "icyWind": {
    name: "Ventogelato",
    effect: "Riduce la Velocità del bersaglio di 1 grado."
  },
  "detect": {
    name: "Individua",
  ...
  "lockOn": {
    name: "Localizza",
    effect: "Il Pokémon punta il bersaglio con precisione. L'attacco successivo andrà sicuramente a segno."
  },
  "outrage": {
    name: "Oltraggio",
    effect: "Confonde chi la usa."
  },
  "sandstorm": {
    name: "Terrempesta",
    effect: "Causa una tempesta di sabbia."
  },
  "gigaDrain": {
  ...
  "charm": {
    name: "Fascino",
    effect: "Riduce l'Attacco del bersaglio di 2 gradi."
  },
  "rollout": {
    name: "Rotolamento",
  ...
  "falseSwipe": {
    name: "Falsofinale",
    effect: "Il Pokémon attacca in modo contenuto, lasciando il bersaglio con 1 PS."
  },
  "swagger": {
    name: "Bullo",
    effect: "Il Pokémon provoca il bersaglio e lo confonde, facendo aumentare di molto il suo Attacco."
  },
  "milkDrink": {
    name: "Buonlatte",
    effect: "Il Pokémon recupera metà dei propri PS massimi."
  ...
  "furyCutter": {
    name: "Tagliofuria",
    effect: "Questa mossa aumenta di potenza quando viene usata in successione."
  },
  "steelWing": {
    name: "Alacciaio",
  ...
  "meanLook": {
    name: "Malosguardo",
    effect: "Il Pokémon blocca il bersaglio con uno sguardo oscuro e ammaliante, impedendogli di lasciare il campo."
  },
  "attract": {
    name: "Attrazione",
    effect: "Se il bersaglio è del sesso opposto, s'infatua e diventa riluttante ad attaccare."
  },
  "sleepTalk": {
    name: "Sonnolalia",
  ...
  "painSplit": {
    name: "Malcomune",
    effect: "Il Pokémon somma i propri PS a quelli del bersaglio per poi dividerli in parti uguali."
  },
  "sacredFire": {
    name: "Magifuoco",
    effect: "Chi la usa guarisce dal congelamento. Ha una certa probabilità (50%) di scottare il bersaglio."
  },
  "magnitude": {
    name: "Magnitudo",
  ...
  "sweetScent": {
    name: "Profumino",
    effect: "Il Pokémon riduce di molto l'elusione degli avversari con un dolce profumo."
  },
  "ironTail": {
    name: "Codacciaio",
    effect: "Ha una certa probabilità (30%) di ridurre la Difesa del bersaglio di 1 grado."
  },
  "metalClaw": {
    name: "Ferrartigli",
    effect: "Ha una certa probabilità (10%) di aumentare l'Attacco di chi la usa di 1 grado."
  },
  "vitalThrow": {
    name: "Vitaltiro",
  ...
  "morningSun": {
    name: "Mattindoro",
    effect: "Il Pokémon recupera PS. Il numero di PS recuperati dipende dalle condizioni atmosferiche."
  },
  "synthesis": {
    name: "Sintesi",
    effect: "Il Pokémon recupera PS. Il numero di PS recuperati dipende dalle condizioni atmosferiche."
  ...
  "hiddenPower": {
    name: "Introforza",
    effect: "Chi la usa adopera un misterioso potere per rendere il tipo della mossa vantaggioso rispetto a quello del bersaglio."
  },
  "crossChop": {
    name: "Incrocolpo",
    effect: "Probabile brutto colpo."
  ...
  "rainDance": {
    name: "Pioggiadanza",
    effect: "Provoca una forte pioggia."
  },
  "sunnyDay": {
    name: "Giornodisole",
    effect: "Intensifica i raggi solari."
  },
  "crunch": {
    name: "Sgranocchio",
    effect: "Ha una certa probabilità (20%) di ridurre la Difesa del bersaglio di 1 grado."
  },
  "mirrorCoat": {
    name: "Specchiovelo",
    effect: "Chi la usa entra in uno stato di attesa per contrattacco. Se questa mossa viene usata di nuovo, lo stato di attesa termina. Mentre questo stato è attivo, l'Unità non può fare altre azioni. Se chi la usa subisce un attacco semplice speciale mentre è in uno stato di attesa per contrattacco, lo stato di attesa termina e l'Unità attacca l'avversario che ha sferrato il colpo. Aumenta la potenza di questa mossa in proporzione ai danni ricevuti da chi la usa."
  },
  "psychUp": {
    name: "Psicamisù",
  ...
  "extremeSpeed": {
    name: "Extrarapido",
    effect: "Il Pokémon carica il bersaglio a una tale velocità da rendersi quasi invisibile. Questo attacco ha priorità alta."
  },
  "ancientPower": {
    name: "Forzantica",
    effect: "Ha una certa probabilità (10%) di aumentare l'Attacco, la Difesa, l'Attacco Speciale, la Difesa Speciale e la Velocità di chi la usa di 1 grado."
  },
  "shadowBall": {
    name: "Palla Ombra",
    effect: "Il Pokémon attacca lanciando sul bersaglio un grumo di ombre nere. Può anche ridurne la Difesa Speciale."
  },
  "futureSight": {
    name: "Divinazione",
  ...
  "rockSmash": {
    name: "Spaccaroccia",
    effect: "Ha una certa probabilità (50%) di ridurre la Difesa del bersaglio di 1 grado."
  },
  "whirlpool": {
    name: "Mulinello",
    effect: "Imprigiona il bersaglio."
  ...
  "fakeOut": {
    name: "Bruciapelo",
    effect: "Attacco ad alta priorità che fa tentennare il bersaglio. Funziona solo appena scesi in campo."
  },
  "uproar": {
    name: "Baraonda",
    effect: "Il Pokémon attacca per tre turni con un frastuono che non fa dormire nessuno."
  },
  "stockpile": {
    name: "Accumulo",
    effect: "Il Pokémon accumula energia aumentando la Difesa e la Difesa Speciale. Si può utilizzare massimo tre volte."
  },
  "spitUp": {
    name: "Sfoghenergia",
  ...
  "swallow": {
    name: "Introenergia",
    effect: "Il Pokémon assorbe l'energia raccolta con la mossa Accumulo e recupera PS. Maggiore è l'energia, più PS si recuperano."
  },
  "heatWave": {
    name: "Ondacalda",
    effect: "Ha una certa probabilità (10%) di scottare il bersaglio."
  ...
  "hail": {
    name: "Grandine",
    effect: "Causa una grandinata."
  },
  "torment": {
    name: "Attaccalite",
    effect: "Il Pokémon tormenta e fa infuriare il bersaglio, impedendogli di usare la stessa mossa due volte di fila."
  },
  "flatter": {
    name: "Adulazione",
  ...
  "facade": {
    name: "Facciata",
    effect: "Mossa la cui potenza raddoppia se chi la usa è scottato, avvelenato o paralizzato."
  },
  "focusPunch": {
    name: "Centripugno",
    effect: "Il Pokémon prende la mira prima di sferrare un pugno. Fallisce se subisce un attacco prima di eseguire la mossa."
  },
  "smellingSalts": {
    name: "Maniereforti",
    effect: "Infligge un danno doppio a un bersaglio paralizzato, ma ne cura anche la paralisi."
  },
  "followMe": {
    name: "Sonoqui",
  ...
  "charge": {
    name: "Sottocarica",
    effect: "Il Pokémon si carica di elettricità e aumenta la potenza della sua prossima mossa di tipo Elettro. Aumenta anche la propria Difesa Speciale."
  },
  "taunt": {
    name: "Provocazione",
    effect: "Il Pokémon provoca il bersaglio inducendolo a usare solo mosse che infliggono danni per tre turni."
  },
  "helpingHand": {
    name: "Altruismo",
    effect: "Il Pokémon aiuta un alleato aumentandone la potenza della mossa."
  },
  "trick": {
    name: "Raggiro",
  ...
  "wish": {
    name: "Desiderio",
    effect: "Il Pokémon o chi lo sostituisce recupera metà dei PS massimi al turno successivo."
  },
  "assist": {
    name: "Assistente",
  ...
  "knockOff": {
    name: "Privazione",
    effect: "Il Pokémon fa cadere lo strumento del bersaglio, impedendone l'uso nella lotta. Infligge più danni se il bersaglio ha uno strumento."
  },
  "endeavor": {
    name: "Rimonta",
  ...
  "eruption": {
    name: "Eruzione",
    effect: "Riduce la potenza di questa mossa in proporzione alla percentuale di PS residui di chi la usa."
  },
  "skillSwap": {
    name: "Baratto",
  ...
  "snatch": {
    name: "Scippo",
    effect: "Annulla gli aumenti delle statistiche del bersaglio e aumenta le statistiche di chi la usa in egual misura."
  },
  "secretPower": {
    name: "Forzasegreta",
    effect: "Attacco che può avere un effetto aggiuntivo a seconda del luogo in cui si trova chi lo usa. Serve anche per costruire Basi Segrete."
  },
  "dive": {
    name: "Sub",
  ...
  "slackOff": {
    name: "Pigro",
    effect: "Il Pokémon si rilassa recuperando metà dei propri PS massimi."
  },
  "hyperVoice": {
    name: "Granvoce",
    effect: "Il Pokémon attacca il bersaglio lanciando un urlo straziante."
  },
  "poisonFang": {
    name: "Velenodenti",
    effect: "Ha una certa probabilità (50%) di iperavvelenare il bersaglio."
  },
  "crushClaw": {
    name: "Tritartigli",
    effect: "Ha una certa probabilità (50%) di ridurre la Difesa del bersaglio di 1 grado."
  ...
  "meteorMash": {
    name: "Meteorpugno",
    effect: "Ha una certa probabilità (20%) di aumentare l'Attacco di chi la usa di 1 grado."
  },
  "astonish": {
    name: "Sgomento",
    effect: "Ha una certa probabilità (30%) di far tentennare il bersaglio."
  ...
  "weatherBall": {
    name: "Palla Clima",
    effect: "Mossa il cui tipo e la cui potenza variano in base alle condizioni atmosferiche."
  },
  "aromatherapy": {
    name: "Aromaterapia",
  ...
  "fakeTears": {
    name: "Falselacrime",
    effect: "Riduce la Difesa Speciale del bersaglio di 2 gradi."
  },
  "airCutter": {
    name: "Aerasoio",
    effect: "Il Pokémon provoca un vento tagliente che sferza il bersaglio. Probabile brutto colpo."
  },
  "overheat": {
    name: "Vampata",
    effect: "Riduce l'Attacco Speciale di chi la usa di 2 gradi."
  },
  "odorSleuth": {
    name: "Segugio",
    effect: "Chi la usa rende i Pokémon di tipo Spettro vulnerabili a qualsiasi tipo di mossa e può, inoltre, colpire i nemici sfuggenti."
  ...
  "sandTomb": {
    name: "Sabbiotomba",
    effect: "Il Pokémon intrappola il bersaglio in una tempesta di sabbia per quattro o cinque turni."
  },
  "sheerCold": {
    name: "Purogelo",
  ...
  "muddyWater": {
    name: "Fanghiglia",
    effect: "Ha una certa probabilità (30%) di ridurre la precisione del bersaglio di 1 grado."
  },
  "bulletSeed": {
    name: "Semitraglia",
    effect: "Attacca il bersaglio da due a cinque volte di fila."
  ...
  "aerialAce": {
    name: "Aeroassalto",
    effect: "Il Pokémon sconvolge il bersaglio con movimenti velocissimi e lo assale. Questo attacco va sempre a segno."
  },
  "icicleSpear": {
    name: "Gelolancia",
    effect: "Il Pokémon attacca sparando ghiaccioli affilati contro il bersaglio da due a cinque volte di fila."
  },
  "ironDefense": {
    name: "Ferroscudo",
  ...
  "block": {
    name: "Blocco",
    effect: "Il Pokémon sbarra la strada al bersaglio impedendogli di lasciare il campo."
  },
  "howl": {
    name: "Gridodilotta",
    effect: "Il Pokémon emette un forte verso per farsi coraggio e aumentare il proprio Attacco e quello degli alleati."
  },
  "dragonClaw": {
    name: "Dragartigli",
    effect: "Non ha effetti aggiuntivi."
  ...
  "bulkUp": {
    name: "Granfisico",
    effect: "Aumenta l'Attacco e la Difesa di chi la usa di 1 grado."
  },
  "bounce": {
    name: "Rimbalzo",
    effect: "Chi la usa entra in modalità Rimbalzo. Dopo un certo lasso di tempo, la modalità Rimbalzo termina e chi la usa attacca. Ha una certa probabilità (30%) di paralizzare il bersaglio. Chi la usa non può fare altre azioni mentre la modalità Rimbalzo è attiva. Quasi tutte le mosse avversarie che hanno come bersaglio chi la usa falliscono mentre è in modalità Rimbalzo. Se chi la usa subisce un'attacco con un'Unimossa o una mossa UniDynamax, la modalità Rimbalzo termina."
  },
  "mudShot": {
    name: "Colpodifango",
    effect: "Riduce la Velocità del bersaglio di 1 grado."
  ...
  "poisonTail": {
    name: "Velenocoda",
    effect: "Probabile brutto colpo. Ha una certa probabilità (10%) di avvelenare il bersaglio."
  },
  "covet": {
    name: "Supplica",
  ...
  "calmMind": {
    name: "Calmamente",
    effect: "Il Pokémon si concentra e placa il proprio spirito per aumentare l'Attacco Speciale e la Difesa Speciale."
  },
  "leafBlade": {
    name: "Fendifoglia",
    effect: "Probabile brutto colpo."
  ...
  "dragonDance": {
    name: "Dragodanza",
    effect: "Dragodanza. Combina concentrazione e movimenti ritmici per incrementare le capacità fisiche di un Pokémon."
  },
  "rockBlast": {
    name: "Cadutamassi",
  ...
  "waterPulse": {
    name: "Idropulsar",
    effect: "Ha una certa probabilità (20%) di confondere il bersaglio."
  },
  "doomDesire": {
    name: "Obbliderio",
  ...
  "gravity": {
    name: "Gravità",
    effect: "Per cinque turni i Pokémon con Levitazione o di tipo Volante sono vulnerabili alle mosse di tipo Terra. Non è possibile usare mosse che fanno volare."
  },
  "miracleEye": {
    name: "Miracolvista",
  ...
  "gyroBall": {
    name: "Vortexpalla",
    effect: "Il Pokémon si scaglia sul bersaglio facendo ruotare vorticosamente il proprio corpo. Più è lento rispetto al bersaglio, più è forte."
  },
  "healingWish": {
    name: "Curardore",
  ...
  "brine": {
    name: "Acquadisale",
    effect: "Raddoppia la potenza di questa mossa quando i PS residui del bersaglio sono scesi a metà o meno."
  },
  "naturalGift": {
    name: "Dononaturale",
    effect: "Chi la usa trae forza dalla bacca che ha. Da questa dipendono il tipo e la potenza dell'attacco."
  },
  "feint": {
    name: "Fintoattacco",
    effect: "Il Pokémon può attaccare anche un bersaglio che ha usato mosse come Protezione e Individua, annullandone gli effetti."
  },
  "pluck": {
    name: "Spennata",
  ...
  "acupressure": {
    name: "Acupressione",
    effect: "Il Pokémon esercita pressione su alcuni punti nevralgici e aumenta di molto una statistica a caso."
  },
  "metalBurst": {
    name: "Metalscoppio",
  ...
  "uTurn": {
    name: "Retromarcia",
    effect: "Il Pokémon fa marcia indietro per farsi sostituire subito dopo aver sferrato l'attacco."
  },
  "closeCombat": {
    name: "Zuffa",
    effect: "Il Pokémon attacca abbassando la guardia. La sua Difesa e la sua Difesa Speciale diminuiscono."
  },
  "payback": {
    name: "Rivincita",
  ...
  "embargo": {
    name: "Divieto",
    effect: "Impedisce al bersaglio di usare il suo strumento e al suo Allenatore di usarne altri sul Pokémon per cinque turni."
  },
  "fling": {
    name: "Lancio",
  ...
  "trumpCard": {
    name: "Asso",
    effect: "La potenza di questa mossa aumenta man mano che i suoi PP diminuiscono."
  },
  "healBlock": {
    name: "Anticura",
    effect: "Chi la usa impedisce per cinque turni ai nemici che ha intorno di utilizzare mosse, abilità e strumenti recupera-PS che hanno con sé."
  },
  "wringOut": {
    name: "Strizzata",
  ...
  "luckyChant": {
    name: "Fortuncanto",
    effect: "Chi la usa rivolge un incantesimo al cielo, impedendo al nemico di sferrare brutti colpi alla squadra per cinque turni."
  },
  "meFirst": {
    name: "Precedenza",
  ...
  "copycat": {
    name: "Copione",
    effect: "Il Pokémon mima l'ultima mossa eseguita. Fallisce se non è stata ancora usata alcuna mossa."
  },
  "powerSwap": {
    name: "Barattoforza",
  ...
  "suckerPunch": {
    name: "Sbigoattacco",
    effect: "Il Pokémon può attaccare per primo, ma fallisce se il bersaglio sferra una mossa che non è di attacco."
  },
  "toxicSpikes": {
    name: "Fielepunte",
  ...
  "flareBlitz": {
    name: "Fuococarica",
    effect: "Chi la usa guarisce dal congelamento. Chi la usa subisce una quantità di danni pari al 25% del danno inflitto al bersaglio. Ha una certa probabilità (10%) di scottare il bersaglio."
  },
  "forcePalm": {
    name: "Palmoforza",
  ...
  "poisonJab": {
    name: "Velenpuntura",
    effect: "Ha una certa probabilità (10%) di avvelenare il bersaglio."
  },
  "darkPulse": {
    name: "Neropulsar",
    effect: "Ha una certa probabilità (20%) di far tentennare il bersaglio."
  ...
  "powerGem": {
    name: "Gemmoforza",
    effect: "Il Pokémon attacca con un raggio di luce che brilla come se fosse fatto di pietre preziose."
  },
  "drainPunch": {
    name: "Assorbipugno",
    effect: "Pugno che assorbe PS e li fa recuperare a chi lo sferra."
  },
  "vacuumWave": {
    name: "Vuotonda",
    effect: "Il Pokémon rotea i pugni per lanciare un'onda di vuoto assoluto verso il bersaglio. Questo attacco ha priorità alta."
  },
  "focusBlast": {
    name: "Focalcolpo",
    effect: "Ha una certa probabilità (10%) di ridurre la Difesa Speciale del bersaglio di 1 grado."
  ...
  "braveBird": {
    name: "Baldeali",
    effect: "Il Pokémon ripiega le ali e carica da bassa quota. Tuttavia, subisce seri danni."
  },
  "earthPower": {
    name: "Geoforza",
    effect: "Ha una certa probabilità (10%) di ridurre la Difesa Speciale del bersaglio di 1 grado."
  ...
  "gigaImpact": {
    name: "Gigaimpatto",
    effect: "Il Pokémon carica il bersaglio usando tutta la propria forza, ma al turno successivo deve riposarsi."
  },
  "nastyPlot": {
    name: "Congiura",
  ...
  "avalanche": {
    name: "Slavina",
    effect: "Chi la usa entra in uno stato di attesa per contrattacco. Se questa mossa viene usata di nuovo, lo stato di attesa termina e l'Unità attacca. Mentre questo stato è attivo, l'Unità non può fare altre opzioni. Se chi la usa subisce un attacco semplice, lo stato d'attesa termina e l'Unità attacca il bersaglio al doppio della potenza."
  },
  "iceShard": {
    name: "Geloscheggia",
  ...
  "thunderFang": {
    name: "Fulmindenti",
    effect: "Ha una certa probabilità (10%) di far tentennare il bersaglio. Ha una certa probabilità (10%) di paralizzare il bersaglio."
  },
  "iceFang": {
    name: "Gelodenti",
    effect: "Ha una certa probabilità (10%) di far tentennare il bersaglio. Ha una certa probabilità (10%) di congelare il bersaglio."
  },
  "fireFang": {
    name: "Rogodenti",
  ...
  "flashCannon": {
    name: "Cannonflash",
    effect: "Il Pokémon attacca raccogliendo e rilasciando energia luminosa. Può ridurre la Difesa Speciale del bersaglio."
  },
  "rockClimb": {
    name: "Scalaroccia",
  ...
  "defog": {
    name: "Scacciabruma",
    effect: "Annulla le trasformazioni del terreno di lotta. Annulla gli effetti sul campo avversario. Riduce l'elusione del bersaglio di 1 grado."
  },
  "trickRoom": {
    name: "Distortozona",
  ...
  "dracoMeteor": {
    name: "Dragobolide",
    effect: "Il Pokémon attacca con meteore che cadono dal cielo, ma il contraccolpo riduce di molto il suo Attacco Speciale."
  },
  "discharge": {
    name: "Scarica",
    effect: "Ha una certa probabilità (30%) di paralizzare il bersaglio."
  ...
  "captivate": {
    name: "Incanto",
    effect: "Se i nemici che ha intorno sono del sesso opposto a chi la usa, saranno ammaliati e il loro Attacco Speciale diminuirà di molto."
  },
  "stealthRock": {
    name: "Levitoroccia",
  ...
  "judgment": {
    name: "Giudizio",
    effect: "Il Pokémon rilascia numerosi colpi di luce. Il tipo varia a seconda della lastra che ha."
  },
  "bugBite": {
    name: "Coleomorso",
    effect: "Il Pokémon attacca mordendo. Se il bersaglio ha una bacca, gliela mangia e ne può sfruttare gli effetti."
  },
  "chargeBeam": {
    name: "Raggioscossa",
  ...
  "headSmash": {
    name: "Zuccata",
    effect: "Chi la usa subisce una quantità di danni pari a circa il 33% dei danni inflitti al bersaglio."
  },
  "doubleHit": {
    name: "Doppiosmash",
    effect: "Il Pokémon attacca il bersaglio colpendolo due volte di fila con la coda, una liana o simili."
  },
  "roarOfTime": {
    name: "Fragortempo",
  ...
  "wideGuard": {
    name: "Bodyguard",
    effect: "Chi la usa entra in uno stato di difesa. Se questa mossa viene usata di nuovo, lo stato di difesa termina. Finché l'Unità è in stato di difesa, non può fare altre azioni. Tutte le mosse verso l'intero campo alleato vengono neutralizzate. Poi, lo stato di difesa si interrompe."
  },
  "guardSplit": {
    name: "Paridifesa",
  ...
  "venoshock": {
    name: "Velenoshock",
    effect: "Raddoppia la potenza di questa mossa quando il bersaglio è avvelenato o iperavvelenato."
  },
  "autotomize": {
    name: "Sganciapesi",
  ...
  "smackDown": {
    name: "Abbattimento",
    effect: "Il Pokémon lancia una pietra o un proiettile contro un bersaglio in volo e lo fa cadere."
  },
  "stormThrow": {
    name: "Tempestretta",
  ...
  "heavySlam": {
    name: "Pesobomba",
    effect: "Il Pokémon si lancia contro il bersaglio con tutto il proprio peso. Più è pesante rispetto al bersaglio, maggiore è la potenza della mossa."
  },
  "synchronoise": {
    name: "Sincrumore",
  ...
  "flameCharge": {
    name: "Nitrocarica",
    effect: "Aumenta la Velocità di chi la usa di 1 grado."
  },
  "coil": {
    name: "Arrotola",
  ...
  "acidSpray": {
    name: "Acidobomba",
    effect: "Il Pokémon attacca il bersaglio con un acido altamente corrosivo, riducendone di molto la Difesa Speciale."
  },
  "foulPlay": {
    name: "Ripicca",
  ...
  "simpleBeam": {
    name: "Ondisinvolta",
    effect: "Il Pokémon emette un misterioso raggio psichico che trasforma l'abilità del bersaglio in Disinvoltura."
  },
  "entrainment": {
    name: "Saltamicizia",
  ...
  "afterYou": {
    name: "Cortesia",
    effect: "Il Pokémon aiuta un bersaglio permettendogli di agire subito dopo."
  },
  "round": {
    name: "Coro",
    effect: "Chi la usa attacca il bersaglio con una melodia. Se usata durante lo stesso turno da più Pokémon, la potenza della mossa aumenta."
  },
  "echoedVoice": {
    name: "Echeggiavoce",
    effect: "Chi la usa attacca il bersaglio con la propria voce echeggiante. Se usata a ripetizione da uno o più Pokémon, la potenza della mossa aumenta."
  },
  "chipAway": {
    name: "Insidia",
    effect: "Chi la usa attacca non appena il bersaglio abbassa la guardia. Il danno inflitto prescinde dalle modifiche alle statistiche del bersaglio."
  },
  "clearSmog": {
    name: "Pulifumo",
  ...
  "storedPower": {
    name: "Veicolaforza",
    effect: "Più sono state aumentate le statistiche di chi la usa, più questa mossa è potente."
  },
  "quickGuard": {
    name: "Anticipo",
    effect: "Il Pokémon protegge sé e gli alleati dagli attacchi ad alta priorità."
  },
  "allySwitch": {
    name: "Cambiaposto",
  ...
  "scald": {
    name: "Idrovampata",
    effect: "Il Pokémon attacca il bersaglio con un getto d'acqua bollente che può anche scottarlo."
  },
  "shellSmash": {
    name: "Gettaguscio",
    effect: "Il Pokémon si disfa del guscio. Difesa e Difesa Speciale diminuiscono, ma aumentano di molto Attacco, Attacco Speciale e Velocità."
  },
  "healPulse": {
    name: "Curapulsar",
  ...
  "hex": {
    name: "Sciagura",
    effect: "Raddoppia la potenza di questa mossa quando il bersaglio è affetto da problemi di stato."
  },
  "skyDrop": {
    name: "Cadutalibera",
  ...
  "retaliate": {
    name: "Nemesi",
    effect: "Il Pokémon vendica un alleato messo KO. Se ciò è accaduto al turno precedente, la potenza della mossa aumenta."
  },
  "finalGambit": {
    name: "Azzardo",
    effect: "Il Pokémon attacca rischiando il tutto per tutto. Va KO, ma infligge al bersaglio un danno pari ai PS che ha perso."
  },
  "bestow": {
    name: "Cediregalo",
    effect: "Chi la usa consegna il proprio strumento al bersaglio, se questi ne è sprovvisto."
  },
  "inferno": {
    name: "Marchiatura",
    effect: "Scotta il bersaglio."
  ...
  "struggleBug": {
    name: "Entomoblocco",
    effect: "Riduce l'Attacco Speciale del bersaglio di 1 grado."
  },
  "bulldoze": {
    name: "Battiterra",
    effect: "Chi la usa calpesta il terreno e scatena un terremoto che danneggia gli altri Pokémon attorno, riducendone la Velocità."
  },
  "frostBreath": {
    name: "Alitogelido",
    effect: "Brutto colpo quando l'attacco va a segno, salvo casi particolare."
  },
  "dragonTail": {
    name: "Codadrago",
  ...
  "workUp": {
    name: "Cuordileone",
    effect: "Il Pokémon si tira su di morale, aumentando il proprio Attacco e l'Attacco Speciale."
  },
  "electroweb": {
    name: "Elettrotela",
    effect: "Riduce la Velocità del bersaglio di 1 grado."
  ...
  "wildCharge": {
    name: "Sprizzalampo",
    effect: "Chi la usa subisce una quantità di danni pari a 1/5 del danno inflitto."
  },
  "drillRun": {
    name: "Giravvita",
  ...
  "hornLeech": {
    name: "Legnicorno",
    effect: "Il Pokémon infilza il bersaglio con le corna e assorbe una quantità di PS pari a metà del danno inflitto."
  },
  "sacredSword": {
    name: "Spadasolenne",
    effect: "Attacca ignorando gli aumenti delle statistiche del bersaglio."
  },
  "razorShell": {
    name: "Conchilama",
    effect: "Ha una certa probabilità (50%) di ridurre la Difesa del bersaglio di 1 grado."
  ...
  "heatCrash": {
    name: "Marchiafuoco",
    effect: "Il Pokémon carica con il suo corpo rovente. Più è pesante rispetto al bersaglio, maggiore è la potenza della mossa."
  },
  "leafTornado": {
    name: "Vorticerba",
  ...
  "psystrike": {
    name: "Psicobotta",
    effect: "Infligge danni in base alla Difesa del bersaglio, anziché alla Difesa Speciale."
  },
  "tailSlap": {
    name: "Spazzasberla",
  ...
  "hurricane": {
    name: "Tifone",
    effect: "Va sempre a segno quando piove. Ha una certa probabilità (30%) di confondere il bersaglio."
  },
  "headCharge": {
    name: "Ricciolata",
  ...
  "relicSong": {
    name: "Cantoantico",
    effect: "Il Pokémon attacca il bersaglio intonando un'antica melodia che ne colpisce lo spirito. Può anche farlo addormentare."
  },
  "secretSword": {
    name: "Spadamistica",
  ...
  "boltStrike": {
    name: "Lucesiluro",
    effect: "Il Pokémon si avvolge con una possente carica elettrica e attacca scagliandosi contro il bersaglio. Può anche paralizzarlo."
  },
  "blueFlare": {
    name: "Fuocoblu",
    effect: "Il Pokémon attacca il bersaglio avvolgendolo con magnifiche e intense fiamme blu che possono anche scottarlo."
  },
  "fieryDance": {
    name: "Voldifuoco",
  ...
  "icicleCrash": {
    name: "Scagliagelo",
    effect: "Il Pokémon attacca violentemente il bersaglio con grosse stalattiti di ghiaccio che possono anche farlo tentennare."
  },
  "vCreate": {
    name: "Generatore V",
  ...
  "belch": {
    name: "Rutto",
    effect: "Il Pokémon attacca il bersaglio con un rutto potente. Per utilizzare questa mossa, deve aver mangiato la propria bacca o quella di un altro Pokémon."
  },
  "rototiller": {
    name: "Aracampo",
  ...
  "fellStinger": {
    name: "Pungiglione",
    effect: "Quando il Pokémon manda KO il bersaglio con questa mossa, aumenta moltissimo il suo Attacco."
  },
  "phantomForce": {
    name: "Spettrotuffo",
    effect: "Chi la usa entra in modalità Spettrotuffo. Dopo un certo lasso di tempo, la modalità Spettrotuffo termina e chi la usa attacca. Mentre la modalità Spettrotuffo è attiva, chi la usa non può fare altre azioni. Mentre questa modalità e attiva, le mosse avversarie che hanno come bersaglio chi la usa falliscono. Se l'Unità subisce un attacco con un'Unimossa o una mossa UniDynamax mentre è attiva, la modalità Spettrotuffo termina."
  },
  "trickOrTreat": {
    name: "Halloween",
    effect: "Il Pokémon invita il bersaglio a festeggiare Halloween, facendogli così acquisire anche il tipo Spettro."
  },
  "nobleRoar": {
    name: "Urlo",
    effect: "Riduce l'Attacco e l'Attacco Speciale del bersaglio di 1 grado."
  },
  "ionDeluge": {
    name: "Pioggiaplasma",
  ...
  "drainingKiss": {
    name: "Assorbibacio",
    effect: "Il Pokémon assorbe energia dal bersaglio con un bacio, recuperando così PS in quantità pari o superiore alla metà del danno inflitto."
  },
  "craftyShield": {
    name: "Truccodifesa",
  ...
  "grassyTerrain": {
    name: "Campo Erboso",
    effect: "Per cinque turni il terreno entra nello stato di Campo Erboso: i Pokémon a terra recuperano PS a ogni turno e la potenza delle mosse di tipo Erba aumenta."
  },
  "mistyTerrain": {
    name: "Campo Nebbioso",
    effect: "Per cinque turni il terreno entra nello stato di Campo Nebbioso: i Pokémon a terra sono immuni ai problemi di stato e la potenza delle mosse Drago è dimezzata."
  },
  "electrify": {
  ...
  "playRough": {
    name: "Carineria",
    effect: "Ha una certa percentuale (10%) di ridurre l'Attacco del bersaglio di 1 grado."
  },
  "fairyWind": {
    name: "Vento di Fata",
  ...
  "moonblast": {
    name: "Forza Lunare",
    effect: "Il Pokémon sfrutta il potere della luna per attaccare il bersaglio. Può anche ridurne l'Attacco Speciale."
  },
  "boomburst": {
    name: "Ondaboato",
    effect: "Chi la usa attacca gli altri Pokémon attorno con la forza di un boato distruttivo."
  },
  "fairyLock": {
    name: "Blocco Fatato",
  ...
  "kingsShield": {
    name: "Scudo Reale",
    effect: "Chi la usa entra in uno stato di difesa. Se questa mossa viene usata di nuovo, lo stato di difesa termina. Finché l'Unità è in stato di difesa, non può fare altre azioni. L'attacco semplice che bersaglia chi la usa mentre è in uno stato di difesa viene neutralizzato. Poi, lo stato di difesa si interrompe. Se subisce un attacco semplice fisico, l'Attacco dell'avversario che l'ha sferrato viene ridotto di 2 gradi."
  },
  "playNice": {
    name: "Simpatia",
  ...
  "confide": {
    name: "Confidenza",
    effect: "Il Pokémon svela dei segreti al bersaglio, distraendolo e riducendone l'Attacco Speciale."
  },
  "diamondStorm": {
    name: "Diamantempesta",
  ...
  "waterShuriken": {
    name: "Acqualame",
    effect: "Chi la usa attacca sempre per primo, colpendo il bersaglio con uno shuriken d'acqua da due a cinque volte di fila."
  },
  "mysticalFire": {
    name: "Magifiamma",
  ...
  "spikyShield": {
    name: "Agodifesa",
    effect: "Il Pokémon si protegge dagli attacchi, riducendo inoltre i PS di chi entra in contatto con lui."
  },
  "aromaticMist": {
    name: "Nebularoma",
  ...
  "eerieImpulse": {
    name: "Elettromistero",
    effect: "Riduce l'Attacco Speciale del bersaglio di 2 gradi."
  },
  "venomDrench": {
    name: "Velenotrappola",
    effect: "Riduce l'Attacco, l'Attacco Speciale e la Velocità di 1 grado quando il bersaglio è avvelenato o iperavvelenato. Funziona solo se il bersaglio è avvelenato o iperavvelenato."
  },
  "powder": {
    name: "Pulviscoppio",
  ...
  "electricTerrain": {
    ...
    effect: "Per cinque turni il terreno entra nello stato di Campo Elettrico: i Pokémon a terra non si addormentano e la potenza delle mosse di tipo Elettro aumenta."
  },
  "dazzlingGleam": {
    name: "Magibrillio",
    effect: "Il Pokémon emette una luce potentissima che infligge danni agli avversari."
  },
  "celebrate": {
    name: "Auguri",
  ...
  "holdHands": {
    ...
    effect: "Il Pokémon e un alleato si prendono per mano e la cosa li riempie di felicità."
  },
  "babyDollEyes": {
  ...
  "powerUpPunch": {
    name: "Crescipugno",
    effect: "Aumenta l'Attacco di chi la usa di 1 grado."
  },
  "oblivionWing": {
    name: "Ali del Fato",
    effect: "Questa mossa aumenta il recupero di PS di chi la usa in proporzione al danno inferto al bersaglio. Ogni utilizzo fa recuperare fino a circa il 50% dei PS massimi di chi la usa."
  },
  "thousandArrows": {
    name: "Mille Frecce",
  ...
  "lightOfRuin": {
    name: "Luce Nefasta",
    effect: "Concentra il potere del Fiore Eterno in un raggio di luce potentissimo. Provoca contraccolpo di ½."
  },
  "originPulse": {
    name: "Primopulsar",
    effect: "Non ha effetti aggiuntivi."
  ...
  "dragonAscent": {
    ...
    effect: "Riduce la Difesa e la Difesa Speciale di chi la usa di 1 grado."
  },
  "hyperspaceFury": {
  ...
  "shoreUp": {
    name: "Sabbiaccumulo",
    effect: "Il Pokémon recupera metà dei propri PS massimi. Durante le tempeste di sabbia ne recupera di più."
  },
  "firstImpression": {
    name: "Schermaglia",
    effect: "Fallisce se non è la prima mossa che l'Unità usa alla sua entrata in campo."
  },
  "banefulBunker": {
    name: "Fortino",
  ...
  "darkestLariat": {
    name: "Braccioteso",
    effect: "Attacca ignorando gli aumenti alle statistiche del bersaglio."
  },
  "sparklingAria": {
    name: "Canto Effimero",
    effect: "Non ha effetti aggiuntivi."
  ...
  "iceHammer": {
    name: "Martelgelo",
    effect: "Riduce la Velocità di chi la usa di 1 grado."
  },
  "floralHealing": {
    name: "Cura Floreale",
  ...
  "strengthSap": {
    name: "Assorbiforza",
    effect: "Il Pokémon recupera una quantità di PS pari all'Attacco del bersaglio, che vedrà diminuire questa statistica."
  },
  "solarBlade": {
    name: "Lama Solare",
  ...
  "spotlight": {
    name: "Riflettore",
    effect: "Chi la usa accende un riflettore sopra il bersaglio deviando su di lui per quel turno tutti gli attacchi dei suoi nemici"
  },
  "toxicThread": {
    name: "Velenotela",
  ...
  "lunge": {
    name: "Assalto",
    effect: "Il Pokémon attacca lanciandosi con tutte le sue forze sul bersaglio e ne riduce l'Attacco."
  },
  "fireLash": {
  ...
  "powerTrip": {
    name: "Tracotanza",
    effect: "Aumenta la potenza di questa mossa in proporzione all'aumento delle statistiche di chi la usa."
  },
  "burnUp": {
    name: "Ultima Fiamma",
  ...
  "revelationDance": {
    name: "Mutadanza",
    effect: "Il Pokémon si lancia in una danza e attacca con tutte le sue forze. Il tipo della mossa corrisponde al tipo di chi la usa."
  },
  "coreEnforcer": {
    name: "Nucleocastigo",
  ...
  "tropKick": {
    name: "Tropicalcio",
    effect: "Riduce l'Attacco del bersaglio di 1 grado."
  },
  "instruct": {
    name: "Imposizione",
  ...
  "beakBlast": {
    name: "Cannonbecco",
    effect: "Chi la usa entra in uno stato di attesa per contrattacco. Se questa mossa viene usata di nuovo, lo stato di attesa termina e l'Unità attacca. Mentre questo stato è attivo, l'Unità non può fare altre azioni. Se chi la usa subisce un attacco semplice mentre è in uno stato di attacco per contrattacco, lo stato di attesa termina e l'Unità attacca. Se subisce un attacco semplice fisico, l'avversario che l'ha sferrato viene scottato."
  },
  "clangingScales": {
    name: "Clamorsquame",
    effect: "Riduce la Difesa di chi la usa di 1 grado."
  },
  "dragonHammer": {
    name: "Marteldrago",
  ...
  "shellTrap": {
    name: "Gusciotrappola",
    effect: "Il guscio del Pokémon diventa una trappola. Se un avversario sferra una mossa fisica, innesca un'esplosione e subisce dei danni."
  },
  "fleurCannon": {
    name: "Cannonfiore",
  ...
  "stompingTantrum": {
    name: "Battipiedi",
    effect: "Raddoppia la potenza di questa mossa quando la mossa precendente di chi la usa fallisce."
  },
  "shadowBone": {
    name: "Ossotetro",
    effect: "Ha una certa probabilità (20%) di ridurre la Difesa del bersaglio di 1 grado."
  ...
  "tearfulLook": {
    name: "Occhionilucidi",
    effect: "Il Pokémon guarda il bersaglio con gli occhi pieni di lacrime e gli fa perdere lo spirito combattivo, riducendone l'Attacco e l'Attacco Speciale."
  },
  "zingZap": {
    name: "Elettropizzico",
    effect: "Ha una certa probabilità (30%) di far tentennare il bersaglio."
  ...
  "multiAttack": {
    name: "Multiattacco",
    effect: "Il Pokémon si avvolge in un potente campo energetico e attacca scontrandosi contro il bersaglio. Il tipo della mossa varia in base alla ROM installata."
  },
  ...
  "snipeShot": {
    name: "Tiromirato",
    effect: "Il Pokémon può attaccare un bersaglio ignorando gli effetti di mosse e abilità che attirano altre mosse."
  },
  "jawLock": {
    name: "Morsostretto",
    effect: "Il Pokémon e il bersaglio non possono essere sostituiti finché non vanno KO. L'effetto svanisce se uno dei due lascia il campo."
  },
  "stuffCheeks": {
    name: "Riempiguance",
    effect: "Se il Pokémon ha con sé una bacca, la mangia e la sua Difesa aumenta di molto."
  },
  "noRetreat": {
    name: "Spalle al Muro",
  ...
  "tarShot": {
    name: "Colpocatrame",
    effect: "Il Pokémon getta catrame appiccicoso sul bersaglio abbassandone la Velocità e rendendolo vulnerabile al tipo Fuoco."
  },
  "magicPowder": {
    name: "Magipolvere",
    effect: "Il Pokémon getta addosso al bersaglio una polvere magica che lo rende di tipo Psico."
  },
  "dragonDarts": {
    name: "Dragofrecce",
    effect: "Il Pokémon attacca due volte sparando Dreepy. Quando sono presenti due bersagli, vengono attaccati entrambi una sola volta."
  },
  "teatime": {
    name: "Ora del Tè",
  ...
  "octolock": {
    name: "Tentacolock",
    effect: "Il Pokémon immobilizza il bersaglio impedendogli di lasciare il campo e ne diminuisce la Difesa e la Difesa Speciale a ogni turno."
  },
  "boltBeak": {
    name: "Beccoshock",
    effect: "Il Pokémon attacca il bersaglio con il becco appuntito carico d'elettricità. Se attacca per primo, la potenza della mossa raddoppia."
  },
  "fishiousRend": {
    name: "Branchiomorso",
    effect: "Il Pokémon morde il bersaglio con le dure branchie. Se attacca per primo, la potenza della mossa raddoppia."
  },
  "courtChange": {
    name: "Cambiocampo",
    effect: "Il Pokémon inverte gli effetti attivi sul campo alleato e sul campo avversario grazie a una forza misteriosa."
  },
  "maxFlare": {
    name: "Dynafiammata",
  ...
  "clangorousSoul": {
    name: "Dracofonia",
    effect: "Il Pokémon sacrifica un po' dei suoi PS per aumentare tutte le sue statistiche."
  },
  "bodyPress": {
    name: "Schiacciacorpo",
    effect: "Il Pokémon attacca schiacciando il bersaglio con il suo corpo. Più la Difesa è alta, maggiori sono i danni inflitti."
  },
  "decorate": {
    name: "Decorazione",
    effect: "Il Pokémon agghinda il bersaglio con delle decorazioni aumentandone di molto l'Attacco e l'Attacco Speciale."
  },
  "drumBeating": {
    name: "Tamburattacco",
    effect: "Il Pokémon percuote il proprio tamburo per controllarne le radici e attaccare il bersaglio, riducendone la Velocità."
  },
  "snapTrap": {
    name: "Tagliola",
    effect: "Il Pokémon intrappola il bersaglio in una tagliola e lo attacca per quattro o cinque turni."
  },
  "pyroBall": {
    name: "Palla Infuocata",
    effect: "Il Pokémon attacca con una palla creata incendiando una piccola pietra. Può anche scottare il bersaglio."
  },
  "behemothBlade": {
  ...
  "breakingSwipe": {
    name: "Vastoimpatto",
    effect: "Il Pokémon attacca il bersaglio con la sua robusta coda riducendone l'Attacco."
  },
  "branchPoke": {
    name: "Ramostoccata",
    effect: "Il Pokémon attacca il bersaglio con un ramo incredibilmente appuntito."
  },
  "overdrive": {
    name: "Overdrive",
    effect: "Il Pokémon suona la chitarra o il basso creando un'onda sonora potentissima con cui attacca il bersaglio."
  },
  "appleAcid": {
    name: "Acido Malico",
  ...
  "spiritBreak": {
    name: "Frantumanima",
    effect: "Il Pokémon attacca il bersaglio con un tale impeto da fargli perdere la voglia di lottare e ne riduce l'Attacco Speciale."
  },
  "strangeSteam": {
  ...
  "obstruct": {
    name: "Sbarramento",
    effect: "Il Pokémon elude tutti gli attacchi. Se la mossa è usata in successione può fallire. Chi entra in contatto con il Pokémon vede diminuire la propria Difesa di molto."
  },
  "falseSurrender": {
    name: "Supplicolpo",
    effect: "Il Pokémon finge di abbassare la testa a mo' di supplica e attacca il bersaglio con i suoi capelli scarmigliati. Questo attacco va sempre a segno."
  },
  "meteorAssault": {
    name: "Sfolgorassalto",
    effect: "Il Pokémon attacca il bersaglio brandendo un grosso gambo, ma perde l'equilibrio e nel turno successivo non può agire."
  },
  "eternabeam": {
  ...
  "expandingForce": {
    name: "Vastenergia",
    effect: "Il Pokémon attacca il bersaglio con energia psichica. Se usata quando è attivo un Campo Psichico, la mossa aumenta di potenza e danneggia tutti gli avversari."
  },
  "steelRoller": {
    name: "Ferrorullo",
    effect: "Il Pokémon attacca eliminando lo stato del terreno di lotta. La mossa fallisce se nel terreno non è attivo alcuno stato."
  },
  "scaleShot": {
    name: "Squamacolpo",
  ...
  "meteorBeam": {
    name: "Raggiometeora",
    effect: "Il Pokémon accumula l'energia dello spazio nel primo turno per aumentare l'Attacco Speciale, quindi attacca nel turno successivo."
  },
  "shellSideArm": {
    name: "Armaguscio",
  ...
  "mistyExplosion": {
    name: "Nebbioscoppio",
    effect: "Chi la usa attacca tutti i Pokémon che ha intorno, ma poi va KO. La potenza della mossa aumenta quando è attivo un Campo Nebbioso."
  },
  "grassyGlide": {
    name: "Erboscivolata",
    effect: "Il Pokémon attacca il bersaglio scivolando sul terreno. Se usato quando è attivo un Campo Erboso, questo attacco ha priorità alta."
  },
  "risingVoltage": {
    name: "Elettroimpennata",
    effect: "Il Pokémon attacca con dell'elettricità che si alza dal suolo. La potenza della mossa raddoppia quando l'avversario si trova in un Campo Elettrico."
  },
  "terrainPulse": {
    name: "Campopulsar",
    effect: "Il Pokémon attacca sfruttando l'energia del terreno di lotta. Il tipo e la potenza della mossa variano a seconda dello stato del terreno stesso."
  },
  "skitterSmack": {
    name: "Strisciacolpo",
    effect: "Il Pokémon attacca il bersaglio strisciandogli alle spalle e riducendo il suo Attacco Speciale."
  },
  "burningJealousy": {
    name: "Fiamminvidia",
    effect: "Il Pokémon attacca con la forza dell'invidia, causando una scottatura a tutti i Pokémon le cui statistiche sono aumentate durante quel turno."
  },
  "lashOut": {
    name: "Sfogarabbia",
    effect: "Il Pokémon attacca il bersaglio con tutta la propria ira. Se ha subito riduzioni delle statistiche durante quel turno, la potenza della mossa raddoppia."
  },
  "poltergeist": {
    name: "Poltergeist",
    effect: "Il Pokémon attacca utilizzando lo strumento del bersaglio. La mossa fallisce se quest'ultimo non ha uno strumento."
  },
  "corrosiveGas": {
    name: "Gas Corrosivo",
  ...
  "coaching": {
    name: "Coaching",
    effect: "Il Pokémon aumenta l'Attacco e la Difesa di tutti gli alleati dando loro indicazioni precise."
  },
  "flipTurn": {
    name: "Virata",
    effect: "Il Pokémon fa marcia indietro per farsi sostituire subito dopo aver sferrato l'attacco."
  ...
  "scorchingSands": {
    name: "Sabbiardente",
    effect: "Il Pokémon attacca il bersaglio scagliandogli addosso della sabbia incandescente. Può anche scottarlo."
  },
  "jungleHealing": {
    name: "Giunglacura",
  ...
  "fieryWrath": {
    name: "Furia Ardente",
    effect: "Il Pokémon attacca trasformando la sua rabbia in un'aura simile a fiamme. Può anche far tentennare il bersaglio."
  },
  "thunderousKick": {
    name: "Calcio Tonante",
  ...
  "direClaw": {
    name: "Artigli Fatali",
    effect: "Il Pokémon attacca il bersaglio con artigli distruttori mirando a un brutto colpo. Può anche causargli avvelenamento, paralisi o sonno.Il Pokémon attacca il bersaglio con artigli distruttori. Può anche causargli avvelenamento, paralisi o sonno."
  },
  "psyshieldBash": {
    name: "Barrierassalto",
  ...
  "stoneAxe": {
    name: "Rocciascure",
    effect: "Il Pokémon attacca il bersaglio con delle scuri di roccia, mirando a un brutto colpo. I frammenti di roccia dispersi dall'attacco restano sospesi intorno al bersaglio.Il Pokémon attacca il bersaglio con delle scuri di roccia. I frammenti rocciosi dispersi dall'attacco restano sospesi intorno al bersaglio."
  },
  "springtideStorm": {
  ...
  "gMaxMeltdown": {
    ...
    effect: "Attacco di tipo Acciaio eseguito da Melmetal Gigamax. Impedisce ai nemici di usare la stessa mossa due volte di seguito."
  },
  "gMaxFoamBurst": {
    name: "Gigaschiuma",
  ...
  "glaiveRush": {
    name: "Spadoncarica",
    effect: "Il Pokémon si lancia in una carica avventata. Nel turno successivo, l'attacco che subisce dal bersaglio andrà sempre a segno, infliggendo il doppio dei danni.[Versione 1.1.0]Il Pokémon si lancia in una carica avventata. Fino al suo prossimo turno, il Pokémon riceverà il doppio dei danni dagli attacchi altrui, che andranno sempre a segno.[Dalla versione 1.2.0]"
  },
  "revivalBlessing": {
  ...
  "blazingTorque": {
    name: "Turboustione",
    effect: "Chi la usa colpisce il nemico con il suo motore. Può causare una scottatura."
  },
  "wickedTorque": {
    name: "Turbotenebra",
    effect: "Chi la usa colpisce il nemico con il suo motore. Può addormentare."
  },
  "noxiousTorque": {
    name: "Turbotossina",
    effect: "Chi la usa colpisce il nemico con il suo motore. Può causare un avvelenamento."
  },
  "combatTorque": {
    name: "Turborissa",
    effect: "Chi la usa colpisce il nemico con il suo motore. Può causare una paralisi."
  },
  "magicalTorque": {
    name: "Turboincanto",
    effect: "Chi la usa colpisce il nemico con il suo motore. Può confondere."
  },
  "bloodMoon": {
    name: "Luna Rossa",
  ...
  "psychicNoise": {
    name: "Psicorumore",
    effect: "Il Pokémon investe il bersaglio con insopportabili onde sonore che gli impediscono di recuperare PS con mosse, abilità o strumenti che ha con sé per due turni."
  },
  "upperHand": {
    name: "Colpo di Mano",
