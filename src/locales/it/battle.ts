...
export const battle: SimpleTranslationEntries = {
  ...
  "statsAnd": "e",
  "stats": "statistiche",
  "statRose_one": "{{stats}} di {{pokemonNameWithAffix}} è aumentato/a!",
  "statRose_other": "{stats}} di {{pokemonNameWithAffix}} sono aumentati/e!",
  "statSharplyRose_one": "{{stats}} di {{pokemonNameWithAffix}} è aumentato/a molto!",
  "statSharplyRose_other": "{stats}} di {{pokemonNameWithAffix}} sono aumentati/e molto!",
  "statRoseDrastically_one": "{{stats}} di {{pokemonNameWithAffix}} è aumentato/a drasticamente!",
  "statRoseDrastically_other": "{stats}} di {{pokemonNameWithAffix}} sono aumentati/e drasticamente!",
  "statWontGoAnyHigher_one": "{{stats}} di {{pokemonNameWithAffix}} non può aumentare più di così!",
  "statWontGoAnyHigher_other": "{stats}} di {{pokemonNameWithAffix}} non possono aumentare più di così!",
  "statFell_one": "{{stats}} di {{pokemonNameWithAffix}} è diminuito/a!",
  "statFell_other": "{{stats}} di {{pokemonNameWithAffix}} sono diminuiti/e!",
  "statHarshlyFell_one": "{{stats}} di {{pokemonNameWithAffix}} è diminuito/a molto!",
  "statHarshlyFell_other": "{{stats}} di {{pokemonNameWithAffix}} sono diminuiti/e molto!",
  "statSeverelyFell_one": "{{stats}} di {{pokemonNameWithAffix}} è diminuito/a drasticamente!",
  "statSeverelyFell_other": "{{stats}} di {{pokemonNameWithAffix}} sono diminuiti/e drasticamente!",
  "statWontGoAnyLower_one": "{{stats}} di {{pokemonNameWithAffix}} non può diminuire più di così!",
  "statWontGoAnyLower_other": "{{stats}} di {{pokemonNameWithAffix}} non possono diminuire più di così!",
  ...
  "battlerTagsMagnetRisenOnAdd": "{{pokemonNameWithAffix}} si solleva in aria a causa dell’elettromagnetismo!",
  "battlerTagsMagnetRisenOnRemove": "L’effetto dell’elettromagnetismo di {{pokemonNameWithAffix}} è terminato!",
  ...
  "battlerTagsStockpilingOnAdd": "{{pokemonNameWithAffix}} ha usato Accumulo\nper la {{stockpiledCount}}ª volta!"
} as const;
