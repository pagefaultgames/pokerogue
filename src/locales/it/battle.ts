...
export const battle: SimpleTranslationEntries = {
  ...
  learnMoveLimitReached:
    "Tuttavia, {{pokemonName}} \nconosce già quattro mosse.",
  learnMoveReplaceQuestion:
    "Vuoi che ne dimentichi una e al suo \nposto la sostituisca con {{moveName}}?",
  ...
  learnMoveForgetSuccess:
    "{{pokemonName}} ha dimenticato la mossa\n{{moveName}}.",
  levelCapUp: "Il livello massimo\nè aumentato a {{levelCap}}!",
  moveNotImplemented:
    "{{moveName}} non è ancora implementata e non può essere selezionata.",
