...
export const ability: AbilityTranslationEntries = {
  ...
  grimNeigh: {
    name: "Nitrito Nero",
    description: "Quando manda KO il nemico, emette un nitrito agghiacciante, aumentando il proprio Attacco Speciale."
  },
  asOneGlastrier: {
    name: "Sintonia Equina",
    description: "Il Pokémon ha una doppia abilità: Agitazione di Calyrex e Nitrito Bianco di Glastrier.Il Pokémon ha una doppia abilità: Agitazione di Calyrex e Nitrito Nero di Spectrier."
  },
  asOneSpectrier: {
    name: "Sintonia Equina",
    description: "Il Pokémon ha una doppia abilità: Agitazione di Calyrex e Nitrito Bianco di Glastrier.Il Pokémon ha una doppia abilità: Agitazione di Calyrex e Nitrito Nero di Spectrier."
