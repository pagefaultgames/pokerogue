...
export const ability: AbilityTranslationEntries = {
  ...
  hospitality: {
    name: "Albergamemorie",
    description:
      "Il Pokémon riporta alla mente vecchi ricordi, facendo risplendere la Maschera Turchese e aumentando la propria Velocità.",
  },
  toxicChain: {
    name: "Albergamemorie",
    description:
      "Il Pokémon riporta alla mente vecchi ricordi, facendo risplendere la Maschera Pozzo e aumentando la propria Difesa Speciale.",
  },
  embodyAspectTeal: {
    name: "Albergamemorie",
    description:
      "Il Pokémon riporta alla mente vecchi ricordi, facendo risplendere la Maschera Focolare e aumentando il proprio Attacco.",
  },
