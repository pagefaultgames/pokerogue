...
export const modifierType: ModifierTypeTranslationEntries = {
  ModifierType: {
    ...
    "ASSAULT_VEST": { name: "Veste de Combat", description: "Augmente de 50% la Défense Spéciale du porteur, mais le contraint à ne pas utiliser de capacités non offensives (à l’exception de Moi d’Abord)." },
