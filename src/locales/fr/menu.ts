...
export const menu: SimpleTranslationEntries = {
  ...
  logInOrCreateAccount:
    "Connectez-vous ou créez un compte pour commencer. Aucun e-mail requis !",
  ...
  registrationAgeWarning:
    "Vous confirmez en vous inscrivant que vous avez 13 ans ou plus.",
  backToLogin: "Retour",
  failedToLoadSaveData:
    "Échec du chargement des données. Veuillez recharger la page.\nSi cela continue, veuillez contacter l’administrateur.",
