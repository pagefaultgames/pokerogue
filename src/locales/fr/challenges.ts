...
export const challenges: SimpleTranslationEntries = {
  ...
  "singleType.desc.0": "Vous ne pouvez choisir que des Poékmon du type sélectionnée.",
  ...
  "singleType.value.15": "Psy",
  "singleType.desc.15": "Vous ne pouvez choisir que des Pokémon de type Psy.",
