...
export const battle: SimpleTranslationEntries = {
  ...
  multiWildAppeared:
    "Un {{pokemonName1}} et un {{pokemonName2}}\nsauvages apparaissent !",
  ...
  learnMoveForgetSuccess:
    "{{pokemonName}} oublie comment\nutiliser {{moveName}}.",
  levelCapUp: "La limite de niveau\na été augmentée à {{levelCap}} !",
  moveNotImplemented:
    "{{moveName}} n’est pas encore implémenté et ne peut pas être sélectionné.",
  ...
  noPokeballMulti:
    "Impossible ! On ne peut pas viser\nquand il y a deux Pokémon !",
  noPokeballStrong:
