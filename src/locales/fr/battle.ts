...
export const battle: SimpleTranslationEntries = {
  ...
  "statRoseMultiple": "{{stats}} de {{pokemonNameWithAffix}}\naugmentent !",
  "statSharplyRoseMultiple": "{{stats}} de {{pokemonNameWithAffix}}\naugmentent beaucoup !",
  "statRoseDrasticallyMultiple": "{{stats}} de {{pokemonNameWithAffix}}\naugmentent énormément !",
  "statWontGoAnyHigherMultiple": "{{stats}} de {{pokemonNameWithAffix}}\nne peuvent plus augmenter !",
  "statFellMultiple": "{{stats}} de {{pokemonNameWithAffix}}\nbaissent !",
  "statHarshlyFellMultiple": "{{stats}} de {{pokemonNameWithAffix}}\nbaissent beaucoup !",
  "statSeverelyFellMultiple": "{{stats}} de {{pokemonNameWithAffix}}\nbaissent énormément !",
  "statWontGoAnyLowerMultiple": "{{stats}} de {{pokemonNameWithAffix}}\nne peuvent plus baisser !",
