...
export const move: MoveTranslationEntries = {
  ...
  bouncyBubble: {
    name: "Évo-Thalasso",
    effect:
      "Évoli frappe l’adversaire avec des bulles d’eau qu’il absorbe ensuite pour récupérer un nombre de PV égal à la moitié des dégâts infligés à l’ennemi.",
  },
  buzzyBuzz: {
    name: "Évo-Dynamo",
  ...
  sizzlySlide: {
    name: "Évo-Flambo",
    effect:
      "Évoli s’embrase et percure violemment l’adversaire. Brûle aussi l’ennemi.",
  },
  glitzyGlow: {
    name: "Évo-Psycho",
    effect:
