...
export const move: MoveTranslationEntries = {
  ...
  "dynamaxCannon": {
    name: "Canon Dynamax",
    effect: "Le lanceur attaque en libérant l’énergie concentrée dans son noyau. Inflige deux fois plus de dégâts si l’adversaire a un niveau plus élevé que le lanceur."
  },
  "snipeShot": {
