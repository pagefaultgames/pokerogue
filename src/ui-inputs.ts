...
export class UiInputs {
  ...
  getActionsKeyDown(): ActionKeys {
    const actions: ActionKeys = {
      ...
      [Button.ACTION]:          () => this.buttonDirection(Button.ACTION),
      [Button.CANCEL]:          () => this.buttonDirection(Button.CANCEL),
      [Button.MENU]:            () => this.buttonMenu(),
      [Button.STATS]:           () => this.buttonStats(true),
      [Button.CYCLE_SHINY]:     () => this.buttonDirection(Button.CYCLE_SHINY),
      [Button.CYCLE_FORM]:      () => this.buttonDirection(Button.CYCLE_FORM),
      [Button.CYCLE_GENDER]:    () => this.buttonDirection(Button.CYCLE_GENDER),
      [Button.CYCLE_ABILITY]:   () => this.buttonDirection(Button.CYCLE_ABILITY),
      [Button.CYCLE_NATURE]:    () => this.buttonDirection(Button.CYCLE_NATURE),
      [Button.CYCLE_VARIANT]:   () => this.buttonDirection(Button.CYCLE_VARIANT),
