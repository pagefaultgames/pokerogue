...
import type { CFG_KEYBOARD_QWERTY } from "#inputs/cfg-keyboard-qwerty";
 ...
 */
export interface PadConfig<T extends DeviceMapping> {
...
export interface KeyboardConfig {
  ...
  readonly padID: "default";
  /** The type of controller layout */
  readonly padType: "keyboard";
 ...
 */
export type InterfaceConfig = GamepadConfig | typeof CFG_KEYBOARD_QWERTY;

export type CustomInterfaceConfig =
  | CustomGamepadConfig
  | (typeof CFG_KEYBOARD_QWERTY & Required<Pick<typeof CFG_KEYBOARD_QWERTY, "custom">>);
