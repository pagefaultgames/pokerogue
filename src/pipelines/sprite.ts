...
export default class SpritePipeline extends FieldSpritePipeline {
  ...
  onBind(gameObject: Phaser.GameObjects.GameObject): void {
    ...
    const isEntityObj = sprite.parentContainer instanceof Pokemon || sprite.parentContainer instanceof Trainer || sprite.parentContainer instanceof MysteryEncounterIntro;
