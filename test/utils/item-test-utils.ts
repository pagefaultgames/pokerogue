 ...
 *
 * @param itemId - The {@linkcode ApplicableHeldItemId | ID} of the `HeldItem` class instance to apply
 ...
 *
 * This ensures that items whose functionality depend on stack count or other properties
 * are applied consistently with how they would be during normal gameplay.
 */
