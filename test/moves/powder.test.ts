...
describe("Moves - Powder", () => {
  ...
  it("should cancel Fire-type moves generated by the target's Dancer ability", async () => {
    game.override.battleStyle("double").enemySpecies(Species.BLASTOISE).enemyAbility(AbilityId.DANCER);
  ...
  it("should cancel Fiery Dance, then prevent it from triggering Dancer", async () => {
    game.override.ability(AbilityId.DANCER).enemyMoveset(Moves.FIERY_DANCE);
  ...
  it("should cancel Grass Pledge if used after ally's Fire Pledge", async () => {
    game.override.enemyMoveset([Moves.FIRE_PLEDGE, Moves.GRASS_PLEDGE]).battleStyle("double");
  ...
  it("should cancel Fire Pledge if used before ally's Water Pledge", async () => {
    game.override.enemyMoveset([Moves.FIRE_PLEDGE, Moves.WATER_PLEDGE]).battleStyle("double");
