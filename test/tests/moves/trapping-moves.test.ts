...
describe("Moves - Trapping Moves", () => {
  ...
  // TODO: add tests once command phase is refactored enough to allow for unit testing
  ...
  // NB: Tests for damaging trapping moves are in test/battler-tags/damage-over-time.test.ts
  // alongside Salt Cure and company
});
