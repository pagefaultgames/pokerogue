...
describe("Game Over Phase", () => {
  ...
  it("winning a run should give allRewards", async () => {
    ...
    expect(game.phaseInterceptor.phaseLog.includes("RibbonRewardPhase")).toBe(true);
  ...
  it("losing a run should not give allRewards", async () => {
    ...
    expect(game.phaseInterceptor.phaseLog.includes("RibbonRewardPhase")).toBe(false);
    expect(game.phaseInterceptor.phaseLog.includes("GameOverRewardPhase")).toBe(false);
